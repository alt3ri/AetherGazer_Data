...
function slot0.OverrideRenderer(slot0, slot1, slot2)
	slot0:SetRenderer(slot1 or slot0.groupRenderer_, slot2 or slot0.itemRenderer_)
end
...
function slot0.SelectGroup(slot0, slot1)
	...
	slot0.tree_:SelectGroup(slot2, false)
