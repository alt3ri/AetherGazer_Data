...
function slot0.StartScroll(slot0, slot1, slot2, slot3)
	...
	if slot0.scrollRect_.vertical then
		slot0.scrollRect_.verticalNormalizedPosition = 1 - (slot3 or slot2 and (math.ceil(slot2 / slot0.perLineNum_) == math.ceil(slot4 / slot0.perLineNum_) and 0 or uv0 < slot6 - slot7 and 1 or (slot6 - slot7) / (uv0 + 1)) or 0)
	else
