local var_0_0 = class("RoguelikeMapView_2_1", ReduxView)
...
function var_0_0.BindRedPoint(arg_22_0)
	manager.redPoint:bindUIandKey(arg_22_0.BtnReward.transform, string.format("%s_%s", RedPointConst.STRATEGY_MATRIX_REWARD, arg_22_0.activity_id))
end

function var_0_0.UnBindRedPoint(arg_23_0)
	manager.redPoint:unbindUIandKey(arg_23_0.BtnReward.transform, string.format("%s_%s", RedPointConst.STRATEGY_MATRIX_REWARD, arg_23_0.activity_id))
end
