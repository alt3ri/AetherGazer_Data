...
function slot0.OnEnter(slot0)
	...
	for slot6, slot7 in ipairs(ActivityCfg[slot0.parkour_activity_id] and slot1.sub_activity_list or {}) do
...
function slot0.Refresh(slot0)
	...
	if ItemCfg[slot1] then
		...
		slot0.m_des.text = ItemTools.getItemDesc(slot1)
	end
...
function slot0.SetSelectIndex(slot0, slot1, slot2)
	...
	ParkourData:SetParkourCollectRedPoint(slot0.parkour_activity_id, slot0.loseList[slot1])
