...
function slot0.RefreshTime(slot0)
	...
	elseif slot2 < slot0.stopTime_ then
		slot0.timeTxt_.text = string.format(GetTips("LEFT_TIME"), manager.time:GetLostTimeStr(slot0.stopTime_))
		slot0.timer_ = Timer.New(function ()
			...
			uv1.timeTxt_.text = string.format(GetTips("LEFT_TIME"), manager.time:GetLostTimeStr(uv1.stopTime_))
		end, 1, -1)
