...
function slot0.InitFromServer(slot0, slot1)
	...
	for slot5, slot6 in ipairs(cleanProtoTable(slot1.card_combine_list)) do
		table.insert(slot0.completeCardCombineList, slot6)
	end

	for slot5, slot6 in ipairs(cleanProtoTable(slot1.card_reward_list)) do
...
function slot0.GetNewCombineList(slot0, slot1, slot2, slot3)
	...
	for slot10, slot11 in ipairs(slot2) do
		for slot16, slot17 in ipairs(uv3[uv2[slot11].id]) do
			slot19 = true
...
function slot0.RefreshScore(slot0)
	...
	uv1 = slot1
	slot2 = slot0:GetCardsListByType(slot0.CARD_PLACE_TYPE.ENEMYCOMBINE)
