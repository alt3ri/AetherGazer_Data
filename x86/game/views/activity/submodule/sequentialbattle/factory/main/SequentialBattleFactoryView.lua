...
function slot0.Init(slot0)
	...
	for slot4, slot5 in ipairs(ActivityCfg[slot0.GetActivityID(slot4)].sub_activity_list) do
...
function slot0.OnEnter(slot0)
	...
	slot4 = slot0.selectChapterHandler_

	manager.notify:RegistListener(SEQUENTIAL_BATTLE_SELECT_CHAPTER, slot4)
...
function slot0.OnExit(slot0)
	...
	manager.redPoint:unbindUIandKey(slot0.rewardBtn_.transform, slot4(slot5, RedPointConst.SEQUENTIAL_BATTLE_REWARD, slot0.selectID_))
...
function slot0.RefreshRightPanel(slot0)
	...
	slot0.portraitImage_.sprite = getSpriteWithoutAtlas("TextureConfig/MardukUI/boss/Portrait/" .. slot1.portrait)

	slot0.adaptImg_:AdaptImg()

	slot0.nameText_.text = GetI18NText(slot1.stage_name)
	slot0.descText_.text = GetI18NText(slot1.stage_desc)
end
