...
function slot0.OnEnter(slot0)
	...
	slot0.nameText1_.text = GetI18NText(SequentialBattleChapterCfg[slot0.activityID_].stage_name)
	slot0.nameText2_.text = GetI18NText(SequentialBattleChapterCfg[slot0.activityID_].stage_name)
