...
function slot0.RefreshUI(slot0)
	...
	slot4 = ActivityCfg[slot0.params_.mainActivityID].sub_activity_list

	slot0.indexCon_:SetSelectedState(table.indexof(slot4, slot0.activityID_))

	slot0.name_.text = GetI18NText(slot0.cfg_.name)
	slot0.list_ = slot0.cfg_.qa_id

	for slot4 = 1, #slot0.chooseName_ do
		slot0.chooseName_[slot4].text = GetI18NText(slot0.cfg_.name)
	end
...
function slot0.Reset(slot0)
	...
	for slot5 = 1, #slot0.curAnsCfg_.answer_desc do
		...
		if slot0.curAnsCfg_.answer_desc[slot5] == "<nickname>" then
			slot0.chooseText_[slot5].text = GetI18NText(PlayerData:GetPlayerInfo().nick)
		else
			slot0.chooseText_[slot5].text = GetI18NText(slot0.curAnsCfg_.answer_desc[slot5])
		end
	...
	slot0.desc_.text = GetI18NText(slot0.curAnsCfg_.question_desc)
...
function slot0.Update(slot0)
	...
	slot5 = slot0.curChoose_
	slot0.ans_.text = GetI18NText(slot0.curAnsCfg_.hero_comment[slot5])

	slot0.stateCon_:SetSelectedState("result")
