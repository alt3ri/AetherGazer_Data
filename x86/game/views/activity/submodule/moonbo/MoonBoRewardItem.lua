...
function slot0.AwardIndexItem(slot0, slot1, slot2)
	...
	if MoonBoData:GetRewardIsShow(MoonBoCfg[slot0.levelNum_].reward_level, slot3[1]) then
		ControllerUtil.GetController(slot2.transform_, "received"):SetSelectedState("false")
	else
...
function slot0.RefreshUI(slot0, slot1, slot2)
	slot0.levelNum_ = MoonBoCfg.get_id_list_by_activity_id[slot2][#MoonBoCfg.get_id_list_by_activity_id[slot2] - slot1 + 1]
