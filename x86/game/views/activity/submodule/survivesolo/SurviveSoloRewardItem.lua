...
function slot0.RefreshUI(slot0)
	slot0.level_.text = GetI18NText(BattleSoloSlayerCfg[slot0.cfg_.stage_id].name)
	slot1 = SurviveSoloData:GetData(slot0.activityID_)

	for slot5 = 1, 3 do
		slot6 = slot0.cfg_.reward_item_list[slot5]
		slot10 = slot6[1]
		slot0.title_[slot5].text = string.format(GetTips("ACTIVITY_SOLO_SLAYER_REWARD"), slot10)
