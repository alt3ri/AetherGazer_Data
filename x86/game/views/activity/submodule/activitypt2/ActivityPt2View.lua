...
function slot0.InitUI(slot0)
	...
	for slot5, slot6 in ipairs(ActivityPt2Cfg.get_id_list_by_activity_id[ActivityCfg[slot0.params_.mainActivityId].sub_activity_list[1]]) do
	...
	for slot5, slot6 in ipairs(ActivityPt2Cfg.get_id_list_by_activity_id[slot1[2]]) do
	...
	for slot5, slot6 in ipairs(ActivityPt2Cfg.get_id_list_by_activity_id[slot1[3]]) do
