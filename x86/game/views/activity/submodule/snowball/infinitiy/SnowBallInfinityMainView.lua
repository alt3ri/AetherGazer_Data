	...
	function slot2()
		...
		OsirisAction.OpenPoolBox(uv1.poolID, slot2, function (slot0)
			if isSuccess(slot0.result) then
				...
				manager.audio:PlayEffect("minigame_activity_2_6_snowball", "minigame_activity_2_6_snowball_icebreak", slot6)

				slot2 = {}

				for slot6, slot7 in ipairs(uv0) do
					for slot11, slot12 in ipairs(uv1.list:GetItemList()) do
...
function slot0.SelectListener(slot0, slot1)
	...
	slot6 = GetTips("ACTIVITY_SNOWBALL_ICE_TALK" .. math.random(1, 4))

	manager.notify:Invoke(DORM_CHARACTER_PLAY_SUBTITLE, SnowballGameMgr.GetInstance():GetPlayerEID(), slot6, true)
...
function slot0.UpdateView(slot0)
	...
	for slot4, slot5 in pairs(slot0.levelList:GetItemList()) do
