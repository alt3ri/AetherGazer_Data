...
function slot0.OnSelectStageItem(slot0, slot1, slot2)
	...
	if slot0.list_:GetItemList()[slot2] then
		...
		slot0.tween_ = LeanTween.value(slot0.m_scrollContent, slot0.m_scrollContent.transform.localPosition.x, -slot4.transform_.localPosition.x + slot0.m_scrollViewTrans.rect.width / 3 - slot4.transform_.rect.width / 2, 0.2):setOnUpdate(LuaHelper.FloatAction(function (slot0)
