...
function slot0.AddUIListeners(slot0)
	slot0:AddBtnListener(slot0.shopBtn_, nil, function ()
		...
		for slot6, slot7 in ipairs(ActivityShopCfg.get_id_list_by_activity_theme[ActivityShopCfg[ActivityPtScrollTools.GetShopActivityID(uv0.mainActivityID_)].activity_theme]) do
