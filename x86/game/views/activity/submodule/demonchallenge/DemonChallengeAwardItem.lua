...
function slot0.RefreshUI(slot0)
	...
	slot2 = ""
	slot0.Desctext_.text = GetI18NText((slot0.levelIndex_ ~= 1 or GetTips("CLEAR_NORMAL_DIFFICULTY")) and (slot0.levelIndex_ ~= 2 or GetTips("CLEAR_DIFFICULTY")) and GetTips("CLEAR_EXTREME_DIFFICULTY"))
...
function slot0.IndexItem(slot0, slot1, slot2)
	slot2:RefreshData(rewardToItemTemplate(slot0.rewardCfg_[slot1]))
