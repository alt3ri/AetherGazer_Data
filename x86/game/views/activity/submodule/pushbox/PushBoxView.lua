...
function slot0.InitMap(slot0)
	slot4 = slot0.cellPanel_
	slot5 = slot0.boxPanel_
	slot0.boxItem_, slot0.cellItem_, slot0.goalTbl_ = PushBoxTool:InitMap(slot0.id_, slot4, slot5, slot0.mapContent_, slot0.cellTemplate_, slot0.boxTemplate_)
...
function slot0.OnStop(slot0)
	...
	slot0:BoxStop(slot0.curBoxIndex_)
