...
function slot0.OnEnter(slot0)
	...
	slot0.questionText_.text = GetI18NText(ActivitySpringFestivalRiddleCfg[slot0.questionID_].question)
...
function slot0.OnExit(slot0)
	...
	slot4 = slot0.riddleAnswerTipsHandler_

	manager.notify:RemoveListener(SPRING_FESTIVAL_RIDDLE_ANSWER_ERROR, slot4)
	slot0:StopTimer()
	slot0:StopTipsTimer()
...
function slot0.ShowAnswerTips(slot0)
	slot0.tipsText_.text = GetI18NText(string.format(GetTips("ACTIVITY_SPRING_FESTIVAL_RIDDLE_ERROR_CD"), GameSetting.activity_spring_festival_riddle_punish_time.value[1]))
