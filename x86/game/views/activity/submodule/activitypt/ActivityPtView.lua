...
function slot0.InitUI(slot0)
	...
	for slot4, slot5 in ipairs(ActivityPtRepeatCfg.get_id_list_by_activity_id[slot0.params_.activityID]) do
...
function slot0.AddUIListener(slot0)
	slot0.indexController_:AddSelectChangeListener(function (slot0)
	...
	function slot5()
		...
		for slot5, slot6 in ipairs(ActivityShopCfg.get_id_list_by_activity_theme[ActivityShopCfg[uv0.params_.activityID].activity_theme]) do
	...
	slot0:AddBtnListener(slot0.exchangeBtn_, slot4, slot5)
