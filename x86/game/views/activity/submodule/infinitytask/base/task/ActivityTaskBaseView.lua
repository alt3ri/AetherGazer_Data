...
function slot0.OnEnter(slot0)
	slot0.scrollHelper_:StartScroll(#TaskData2:GetActivityTaskSortList(slot0.activityID_))
...
function slot0.RefreshItem(slot0, slot1, slot2)
	slot2:SetData(TaskData2:GetActivityTaskSortList(slot0.activityID_)[slot1].id)
end
