...
function slot0.AddUIListener(slot0)
	...
	slot0.m_fishEvent:AddListenerType1(UnityEngine.EventSystems.EventTriggerType.PointerDown, LuaHelper.EventTriggerAction1(function (slot0, slot1)
...
function slot0.NewGame(slot0)
	...
	slot0.m_icon.sprite = getSpriteWithoutAtlas("TextureConfig/EmptyDream/letter_role_title/" .. slot1.icon)
...
function slot0.DoTween(slot0, slot1)
	...
	slot0.tween = LeanTween.rotateAroundLocal(slot0.m_arror.gameObject, Vector3.New(0, 0, -1), 360, 2):setOnUpdate(LuaHelper.FloatAction(function (slot0)
