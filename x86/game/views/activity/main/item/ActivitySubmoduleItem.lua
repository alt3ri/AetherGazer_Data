...
function slot0.Ctor(slot0, slot1, slot2, slot3)
	...
	slot0.activityId_ = ActivityTools.GetReprintActivityID(slot2)
...
function slot0.RefreshUI(slot0)
	if slot0.nameText_ then
		slot0.nameText_.text = ActivityCfg[slot0.activityId_].remark
	end
end
...
function slot0.RefreshLock(slot0)
	...
	if slot0.bgImg_ then
		slot0.bgImg_.sprite = getSpriteWithoutAtlas("TextureConfig/SummerUI/" .. uv0[slot0.gameObject_.name])
	end
