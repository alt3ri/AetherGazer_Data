...
function var_0_1.InitUI(arg_3_0)
	...
	arg_3_0.scrollHelper_ = LuaList.New(handler(arg_3_0, arg_3_0.IndexItem), arg_3_0.scrollView_, HeroClueTaskItem)
...
function var_0_1.AddUIListener(arg_4_0)
	...
	arg_4_0:AddBtnListener(arg_4_0.descBtn_, nil, function()
		local var_7_0 = GetTips("ACTIVITY_HERO_CLUE_DESC")
...
function var_0_1.Show(arg_9_0, arg_9_1)
	...
	if arg_9_1 == true then
		arg_9_0:RefreshUI()
		manager.redPoint:bindUIandKey(arg_9_0.playBtn_.transform, string.format("%s_%d", RedPointConst.HERO_CLUE_PLAY, arg_9_0.activityID_))
		arg_9_0:RegistEventListener(OSIRIS_TASK_UPDATE, arg_9_0.taskUpdateHandler_)
	else
		manager.redPoint:unbindUIandKey(arg_9_0.playBtn_.transform, string.format("%s_%s", RedPointConst.HERO_CLUE_PLAY, arg_9_0.activityID_))
...
function var_0_1.UpdateData(arg_13_0)
	arg_13_0:RefreshUI()
	HeroClueAction.UpdateDrawRedPoint(arg_13_0.activityID_)
end
