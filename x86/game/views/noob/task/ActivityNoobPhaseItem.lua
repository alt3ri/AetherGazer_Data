...
function slot0.SetData(slot0, slot1, slot2)
	slot0:BindRedPoint(slot2)

	slot0.taskType_ = slot1
	slot0.phase_ = slot2
	slot0.titleText_.text = "0" .. slot2
	slot0.titleText2_.text = string.format(GetTips("ACTIVITY_GREENHORN_TASK_STAGE"), slot2)
...
function slot0.GetItemState(slot0)
	slot1 = TaskTools:GetNoobTaskSortList(slot0.taskType_, slot0.phase_)
	slot0.isLock_ = false
