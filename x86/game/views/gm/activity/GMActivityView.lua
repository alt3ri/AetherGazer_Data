...
function slot0.AddListeners(slot0)
	...
	slot0:AddBtnListener(slot0.okBtn_, nil, function ()
		...
		for slot17, slot18 in ipairs(GMData:GetActivityList()) do
			slot19 = string.format("$ wjhd set %s %s %s", slot18, manager.time:Table2ServerTime({
