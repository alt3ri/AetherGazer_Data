...
function slot0.OnEnter(slot0)
	...
	slot0.portrait_.sprite = getSpriteWithoutAtlas("TextureConfig/Character/Portrait/" .. SkinCfg[slot0.skinID_].picture_id)
	slot0.name_.text = ItemTools.getItemName(slot0.skinID_)
