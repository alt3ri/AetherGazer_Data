...
function slot0.OnListChange(slot0, slot1, slot2, slot3)
	...
	for slot7, slot8 in pairs(slot0.completeScrollHelper_:GetItemList()) do
...
function slot0.SelectHero(slot0, slot1)
	...
	for slot5, slot6 in pairs(slot0.curScrollHelper_:GetItemList()) do
...
function slot0.AddUIListener(slot0)
	...
	slot0:AddBtnListener(slot0.allHeroBtn_, slot4, slot5)
...
function slot0.OnEnter(slot0)
	...
	slot0:RegistEventListener(FAVORITE_HERO, slot6(slot0, slot0.OnHeroFavorite))
...
function slot0.OnHeroUpdate(slot0, slot1)
	for slot5, slot6 in pairs(slot0.shortScrollHelper_:GetItemList()) do
		if slot6.heroId_ == slot1 then
			slot6:SetHeroData(slot1, slot6.heroDataType_)
		end
	end

	for slot5, slot6 in pairs(slot0.completeScrollHelper_:GetItemList()) do
		if slot6.heroId_ == slot1 then
			slot6:SetHeroData(slot1, slot6.heroDataType_)
		end
	end
