...
function slot0.RefreshEquip(slot0)
	for slot5, slot6 in ipairs(slot0.equipList_) do
		...
		slot0.lvText_[slot9].text = GetTips("LEVEL") .. tostring(slot6:GetLevel())
		...
		slot14 = ItemCfg[slot7].icon

		SetSpriteWithoutAtlasAsync(slot0.equipIcon_[slot9], SpritePathCfg.EquipIcon_s.path .. slot14)
