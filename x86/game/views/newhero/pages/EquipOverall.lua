...
function slot0.RefreshAttr(slot0, slot1, slot2)
	for slot7 = 1, 4 do
		slot0.attrItem_[slot7]:RefreshData(slot0, {
			index = slot7,
			attrS = slot0.heroViewProxy_:CalHeroEquipAttribute(slot2, slot1)
		})
	end
end
...
function slot0.RefreshSuit(slot0, slot1, slot2)
	slot0.suitList_ = EquipTools.CountActiveSuit(slot0.heroViewProxy_:GetEquipDataList(slot2, slot1))
