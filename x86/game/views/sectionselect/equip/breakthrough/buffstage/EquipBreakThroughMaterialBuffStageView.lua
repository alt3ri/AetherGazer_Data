...
function slot0.AddListeners(slot0)
	slot0:AddBtnListener(slot0.okBtn_, nil, function ()
		...
		EquipBreakThroughMaterialAction.ChooseBuff(uv0.mapStageID_, EquipBreakThroughMaterialData:GetStageData()[uv0.mapStageID_].buffList[uv0.selectIndex_], function (slot0)
