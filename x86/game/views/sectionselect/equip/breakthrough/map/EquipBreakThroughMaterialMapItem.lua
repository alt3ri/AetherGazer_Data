...
function slot0.RefreshItemState(slot0)
	...
	if slot3.stage_type == 1 then
		slot0.nameText_.text = GetTips("EQUIP_BREAK_STAGE_TYPE_1")
	elseif slot3.stage_type == 2 then
		slot0.nameText_.text = GetTips("EQUIP_BREAK_STAGE_TYPE_2")
	elseif slot3.stage_type == 3 then
		slot0.nameText_.text = GetTips("EQUIP_BREAK_STAGE_TYPE_3")
	elseif slot3.stage_type == 4 then
		slot0.nameText_.text = GetTips("EQUIP_BREAK_STAGE_TYPE_4")
	else
		slot0.nameText_.text = GetTips("EQUIP_BREAK_STAGE_TYPE_5")
	end
