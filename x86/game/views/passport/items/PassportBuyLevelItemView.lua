...
function slot0.indexItem(slot0, slot1, slot2)
	slot2:RefreshData({
		id = slot0.rewards_[slot1].id,
		number = slot0.rewards_[slot1].num
	})
end
...
function slot0.UpdateView(slot0)
	...
	slot0.levelLabel_.text = string.format(GetTips("BATTLEPASS_LEVEL_UNLOCK_REWARD"), slot2)
	slot0.rewards_ = {}
	...
	slot0.rewards_ = mergeReward(formatRewardCfgList(slot0.rewards_))
