...
function slot0.SetData(slot0, slot1, slot2)
	...
	slot11 = PolyhedronData:GetHeroUsingSkinInfo(slot2).id
	slot0.m_heroIcon.sprite = getSpriteViaConfig("HeroLittleIcon", slot11)
	...
	slot11 = slot6
	slot0.suitList = slot0:GetEquipSuit(slot5, slot11)
