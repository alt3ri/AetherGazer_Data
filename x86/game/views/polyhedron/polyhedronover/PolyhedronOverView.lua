...
function slot0.OnEnter(slot0)
	...
	PolyhedronTools.CalPolyhedronDifficultyAttr({}, slot0.difficulty)
	...
	slot0.difficultyList:StartScroll(#slot0.difficultyEffectList)
	...
	slot5 = table.keys(slot0.artifact_group_data)

	table.sort(slot5, PolyhedronTools.ArtifactSubTypeSorter)

	slot6 = 1

	for slot10, slot11 in ipairs(slot5) do
		slot12 = slot0.artifact_group_data[slot11]

		if not slot0.artifactGroupList[slot6] then
			slot0.artifactGroupList[slot6] = PolyhedronOverArtifactGroup.New(Object.Instantiate(slot0.m_artifactGroup, slot0.m_artifactContent))
		end

		slot0.artifactGroupList[slot6]:SetActive(true)
		slot0.artifactGroupList[slot6]:SetData(slot11, slot12)
		slot0.artifactGroupList[slot6]:RegistCallBack(slot0.clickhandler)

		slot6 = slot6 + 1
	end

	for slot11 = slot6, #slot0.artifactGroupList do
		slot0.artifactGroupList[slot11]:SetActive(false)
	end
