...
function slot0.InitUI(slot0)
	...
	slot0.panelController_ = ControllerUtil.GetController(slot0.panelTrs_, "name")
...
function slot0.AddUIListener(slot0)
	...
	slot0:AddBtnListener(slot0.closeSectionBtn_, slot4, function ()
...
function slot0.RefreshContent(slot0)
	...
	slot0.itempanelAni3_:Play("BossSwitchUI1", 0, slot5)
