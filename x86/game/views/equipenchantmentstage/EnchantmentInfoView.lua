...
function slot0.InitUI(slot0)
	...
	slot0.diffCon3 = ControllerUtil.GetController(slot0.levelbtn3.transform, "conName")
...
function slot0.OnEnter(slot0)
	...
	slot0.tipText_.text = string.format(GetTips("TIME_DISPLAY_2"), TimeMgr:DescCDTime(slot0:during()))
...
function slot0.RefreshCoundown(slot0)
	...
	slot0.timer_ = Timer.New(function ()
		uv0 = uv1:during()
		uv1.tipText_.text = string.format(GetTips("TIME_DISPLAY_2"), TimeMgr:DescCDTime(uv0))
...
function slot0.RefreshContent(slot0)
	...
	slot0.itempanelAni_:Play("aniEnchantmentStageUI_itemPanel", 0, slot5)
...
function slot0.ShowAffixInfo(slot0, slot1, slot2)
	...
	if slot2 and slot2 ~= "" then
		...
		slot0.affixnameText_.text = GetI18NText(getAffixName(slot2))
	else
