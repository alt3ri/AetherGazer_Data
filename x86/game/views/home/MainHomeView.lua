...
function slot0.OnExit(slot0)
	...
	slot4 = slot0.shakingAniHandler_

	manager.notify:RemoveListener(SHAKING_MOBILE, slot4)
...
function slot0.HideTimeline(slot0)
	if slot0.timelines_ then
		for slot5, slot6 in pairs(slot0.timelines_:GetComponentsInChildren(typeof(UnityEngine.Transform), true):ToTable()) do
