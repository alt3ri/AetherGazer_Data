...
function slot0.OnClick(slot0)
	if not slot0.isOpen_ then
		ShowTips(string.format(GetTips("UNLOCK_CONDITION_ACTIVITY_TIPS"), GetI18NText(ActivityCfg[WarchessLevelCfg[slot0.preStageID_].type].remark), WarchessLevelCfg[slot0.preStageID_].name_level))
	else
...
function slot0.RefreshUI(slot0)
	...
	slot0.textName_.text = GetI18NText(slot5.name)
