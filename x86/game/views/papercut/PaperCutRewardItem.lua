...
function slot0.RefreshUI(slot0)
	slot0.descText_.text = string.format(GetTips("ACTIVITY_CUT_POINT_REWARD"), GetI18NText(PaperCutCfg[slot0.activityID_].name), ActivityPointRewardCfg[slot0.taskID_].need)
