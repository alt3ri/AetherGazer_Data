...
function slot0.RefreshImage(slot0)
	slot0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/EmptyDream/paperCut/" .. PaperCutCfg[slot0.activityID_].picture)
end

function slot0.RefreshTitle(slot0)
	slot0.titleText_.text = GetI18NText(PaperCutCfg[slot0.activityID_].name)
end
