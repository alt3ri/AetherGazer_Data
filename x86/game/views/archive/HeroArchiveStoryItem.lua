...
function slot0.RefreshUI(slot0, slot1, slot2)
	...
	slot0.titleText_.text = GetI18NText(HeroRecordCfg[slot2].plot_title[slot1])
...
function slot0.AddUIListener(slot0)
	slot0:AddBtnListener(slot0.playbtnBtn_, nil, function ()
		manager.redPoint:SetRedPointIndependent(uv0.playbtnBtn_.transform, false)
		manager.story:StartStoryById(uv0.storyLinId_, function (slot0)
