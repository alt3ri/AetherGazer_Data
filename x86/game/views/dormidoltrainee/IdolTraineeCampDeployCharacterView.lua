...
function slot0.Init(slot0)
	...
	slot4 = IdolTraineeCampCharacterItem
	slot0.characterScroll = LuaList.New(handler(slot0, slot0.IndexItem), slot0.heroList_, slot4)
	slot0.targets = {}
...
function slot0.EndDragHeroList(slot0, slot1, slot2)
	if slot0.isDraggingHeroList then
		slot0.heroList_:OnEndDrag(slot1)
