...
function slot0.Init(slot0)
	...
	slot0.talkController = ControllerUtil.GetController(slot0.m_talkController, "talk")
	slot0.playerComList = {}
...
function slot0.OnEnter(slot0)
	...
	slot0:RegistEventListener(START_COOPERATION_BATTLE, slot4(slot0, slot0.BattleStart))
