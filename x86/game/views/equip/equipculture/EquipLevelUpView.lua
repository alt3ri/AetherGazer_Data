...
function slot0.InitUI(slot0)
	...
	slot0.scrollHelper = LuaList.New(handler(slot0, slot0.indexItem), slot0.listGo_, slot4)
	slot0.attrs = {}
...
function slot0.RefreshListSelect(slot0)
	for slot4, slot5 in pairs(slot0.scrollHelper:GetItemList()) do
...
function slot0.GetItemList(slot0)
	...
	for slot6, slot7 in ipairs(ItemCfg.get_id_list_by_type[ItemConst.ITEM_TYPE.MATERIAL]) do
