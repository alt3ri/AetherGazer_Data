...
function slot0.RefreshDes(slot0)
	...
	slot0.nameText1_.text = GetI18NText(slot2.suit_name) .. "·" .. GetI18NText(slot2.name)
	slot7 = slot2.name
	slot0.nameText2_.text = GetI18NText(slot2.suit_name) .. "·" .. GetI18NText(slot7)
	slot0.frontDesText_.text = GetCfgDescription(AstrolabeEffectCfg[slot1].desc[1], 1)
