...
function slot0.InitUI(slot0)
	...
	slot0.comboController_ = slot0.m_comboSkillController_:GetController("name")
	slot0.campController_ = slot0.m_campAddController_:GetController("name")
end

function slot0.AddUIListener(slot0)
	slot0:AddBtnListener(slot0.m_campAddBtn, nil, function ()
		slot0, slot1 = PolyhedronTools.GetRaceEffect(uv0.fightHeroArray)
...
function slot0.IndexFightHeroItem(slot0, slot1, slot2)
	slot2:SetFightData(slot0.polyhedronInfo, slot0.fightHeroArray[slot1], slot0.heroViewProxy_)
...
function slot0.IndexHeroItem(slot0, slot1, slot2)
	slot2:SetData(slot0.polyhedronInfo, slot0.heroArray[slot1], slot0.heroViewProxy_)
	slot2:RegistCallBack(function (slot0)
		uv0:HeroClick(slot0)
	end)
end
...
function slot0.Dispose(slot0)
	if slot0.fightHeroList then
		slot0.fightHeroList:Dispose()

		slot0.fightHeroList = nil
	end
