...
function slot0.AddUIListener(slot0)
	...
	slot0:AddBtnListener(slot0.m_heroBtn, nil, function ()
		...
		uv0.heroList = {}
		uv0.fight_hero_id_list = uv0.polyhedronInfo:GetHeroList()
...
function slot0.RefreshUI(slot0)
	...
	slot0.m_heroIcon.sprite = getSpriteViaConfig("HeroLittleIcon", PolyhedronData:GetHeroUsingSkinInfo(slot1).id)
	slot10 = 1
	...
	slot0.suitList = slot0:GetEquipSuit(slot7, slot8)
	slot12 = 1
