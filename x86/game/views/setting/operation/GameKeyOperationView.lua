...
function slot0.InitUI(slot0)
	...
	slot4 = slot0.miniGameBindingGo_
	slot0.bindings_[uv0.MiniGame] = GameKeyBindingContent.New(slot4)
...
function slot0.SaveData(slot0)
	...
	slot0.oldGamepadType_ = slot0.gamepadType_
	slot5 = slot0.layoutName_
	slot0.oldLayoutJson_ = LuaForGamepad.GetLayoutJson(slot0.layoutName_, LuaForGamepad.GetDefaultLayoutFileName(slot5))

	LuaForGamepad.SetDeviceEnable(HID_TYPES.Xbox, slot0.gamepadEnable_)
	LuaForGamepad.SetDeviceEnable(HID_TYPES.PS4, slot0.gamepadEnable_)
