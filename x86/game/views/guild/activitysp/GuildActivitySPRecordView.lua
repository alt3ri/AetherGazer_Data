slot0 = class("GuildActivitySPRecordView", ReduxView)
...
function slot0.InitUI(slot0)
	...
	slot0.recordList_ = LuaList.New(handler(slot0, slot0.indexItem), slot0.uiListGo_, GuildActivitySPRecordItemView)
end
