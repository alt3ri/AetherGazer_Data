...
function slot1.GetHeroList(slot0)
	...
	for slot6, slot7 in ipairs(GuildActivitySPData:GetFightHeroList()) do
...
function slot1.GetHeroTeam(slot0)
	slot0.heroTeam_, slot0.lockStateList_, slot0.lockHeroList_, slot4 = GetLocalHeroTeam(slot0.params_.stageType, slot0.params_.stageID, slot0.params_.activityID)
	slot0.heroTrialList_ = slot4

	for slot4, slot5 in ipairs(slot0.heroTeam_) do
		slot6 = false

		for slot10, slot11 in ipairs(GuildActivitySPData:GetFightHeroList()) do
