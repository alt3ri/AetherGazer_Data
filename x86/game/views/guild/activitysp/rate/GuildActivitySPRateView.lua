slot0 = class("GuildActivitySPRateView", ReduxView)
...
function slot0.InitUI(slot0)
	...
	slot0.premissItemList_ = LuaList.New(handler(slot0, slot0.RefreshItem), slot0.uiList_, GuildActivitySPRatePremissItem)
...
function slot0.OnEnter(slot0)
	...
	slot0.curRateID_ = GuildActivitySPData:GetCurRateID(slot0.activityID_)

	if table.keyof(ActivityClubSPLevelSettingCfg.get_id_list_by_activity[slot0.activityID_], slot0.curRateID_) then
		slot0.nextRateID_ = slot1[slot2 + 1]
	end

	if slot0.nextRateID_ ~= nil then
		slot0.premissIDList_ = ActivityClubSPLevelSettingCfg[slot0.nextRateID_].condition
...
function slot0.RefreshUI(slot0)
	...
	slot1 = ActivityClubSPLevelSettingCfg[slot0.curRateID_]
