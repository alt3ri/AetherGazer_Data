slot0 = class("GuildActivitySPFilterView", ReduxView)
...
function slot0.InitDropDown(slot0)
	...
	slot0.sortTypeDropdown_.options:Add(UnityEngine.UI.Dropdown.OptionData.New(GetTips("ACTIVITY_CLUB_QSDK"), nil))
...
function slot0.EnergySorter(slot0, slot1, slot2)
	if GuildActivitySPData:GetHeroFatigue(slot1.id) ~= GuildActivitySPData:GetHeroFatigue(slot2.id) then
