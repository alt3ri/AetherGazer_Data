...
function slot0.InitData(slot0)
	slot0.rankDataList_ = GuildData:GetRankList()

	table.sort(slot0.rankDataList_, function (slot0, slot1)
...
function slot0.UpdateView(slot0)
	...
	slot0.m_frame.sprite = getSpriteWithoutAtlas("TextureConfig/Frame/" .. PlayerData:GetPlayerInfo().icon_frame)
end
