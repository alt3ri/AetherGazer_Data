...
function slot0.AddListeners(slot0)
	...
	slot0:AddBtnListener(slot0.buttonOk_, nil, function ()
		...
		slot2, slot3 = textLimit(uv0.inputFieldNotice_.text, GameSetting.club_share_max.value[1])
		uv0.inputFieldNotice_.text = GetI18NText(slot2)

		if not nameRule(uv0.inputFieldNotice_.text) then
