...
function slot1.RefreshEnemyUI(slot0)
	slot0.bossIcon_.sprite = getSpriteWithoutAtlas("TextureConfig/MardukUI/boss/solo384x172/" .. ActivitySoloChallengeCfg[slot0.activityID_].boss_id_list[slot0.selectHeroPos_])
end
