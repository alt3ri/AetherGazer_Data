...
function slot1.Init(slot0)
	...
	slot4 = nil
	slot0.adaptImg_ = slot0:FindCom("SelfAdaptImage", slot4, slot0.roleTras_)
...
function slot1.RefreshDifficultyState(slot0)
	for slot5, slot6 in ipairs(slot0.difficultyStateList_) do
		if table.keyof(SoloChallengeData:GetCompletedActivityList()[slot0.selectActivityID_], slot5) ~= nil then
