...
function slot0.RefreshFightOrder(slot0)
	if slot0.stageID_ ~= -1 and table.keyof(ActivitySoloChallengeCfg[slot0.activityID_].stage_id[SoloChallengeData:GetSelectedDifficultyIndex(slot0.activityID_)][2], slot0.stageID_) ~= nil then
