...
function slot1.RefreshAstrolabeEffect(slot0)
	...
	for slot8 = 1, slot2 do
		slot15 = HeroAstrolabeCfg[HeroAstrolabeCfg.get_id_list_by_hero_astrolabe_suit_id[slot1[slot8].id][1]].suit_name

		for slot15 = 1, slot1[slot8].num do
			slot4 = "" .. string.format("<size=32><color=#FFFFFF>%s\n\n</color></size>", GetI18NText(slot15)) .. GetI18NText(SkillTools.GetAstrolabeDescByServant(slot9[slot15], slot0.heroInfo_.servantId)) .. (slot15 == slot11 and "" or "\n\n")
		end
	...
	slot0.desText_.text = GetI18NText(slot4)
end
