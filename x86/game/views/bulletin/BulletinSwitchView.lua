...
function slot0.AddUIListener(slot0)
	...
	slot0:AddBtnListener(slot0.closeBtn_, slot4, slot5)
...
function slot0.OnEnter(slot0)
	...
	slot0:UpdateBtnItems()
	slot0:SetViewProp("bulletinID", slot0.params_.bulletinID)

	slot4 = slot0
	slot5 = "bulletinID"

	slot0.contentView_:SetBulletInId(slot0.GetViewProp(slot4, slot5))
