slot0 = class("ActivityRaceRankView", ReduxView)
slot1 = {
	ALL = 1,
	GUILD = 2
}
...
function slot0.UIName(slot0)
	return ActivityRaceRankTools.GetRankUIName(slot0.params_.activityID)
end
...
function slot0.InitUI(slot0)
	...
	slot0.scrollHelper_ = LuaList.New(handler(slot0, slot0.IndexItem), slot0.listGo_, ActivityRaceRankTools.GetRankItemClass(slot0.params_.activityID))
end
