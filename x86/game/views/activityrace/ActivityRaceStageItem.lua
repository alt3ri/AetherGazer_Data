...
function slot0.AddListeners(slot0)
	slot0:AddBtnListener(slot0.button_, nil, function ()
		if uv0.isLock_ then
			...
			ShowTips(string.format(GetTips("ACTIVITY_RACE_UNLOCK"), GetI18NText(BattleActivityRaceStageCfg[slot0[table.keyof(slot0, uv0.stageID_) - 1]].name)))
...
function slot0.RefreshTitle(slot0)
	slot0.titleText_.text = GetI18NText(BattleActivityRaceStageCfg[slot0.stageID_].name)
end
