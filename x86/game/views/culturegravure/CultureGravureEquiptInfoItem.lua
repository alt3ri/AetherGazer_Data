...
function slot0.Init(slot0)
	...
	slot0.posNumController_ = ControllerUtil.GetController(slot0.transform_, "num")
...
function slot0.RefreshUI(slot0)
	slot4 = slot0.equipIDList_[1]
	slot0.nameText_.text = EquipSuitCfg[EquipCfg[slot4].suit].name

	slot0.posNumController_:SetSelectedState(#slot0.equipIDList_)
