...
function slot0.AddUIListener(slot0)
	slot0:AddBtnListener(slot0.Btn_, nil, function ()
		PlayerRedPoint:CancelStickerUnlock(uv0.info_.id)
...
function slot0.RefreshItem(slot0, slot1)
	...
	slot0.text_.text = ItemTools.getItemName(slot0.info_.id)

	slot0:RefreshState()
	manager.redPoint:unbindUIandKey(slot0.redPoint_)
	manager.redPoint:bindUIandKey(slot0.redPoint_, RedPointConst.STICKER_UNLOCK .. "_" .. slot0.info_.id)
end
