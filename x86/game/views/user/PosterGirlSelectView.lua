local var_0_0 = class("PosterGirlSelectView", ReduxView)
...
function var_0_0.OnPageBtnClick(arg_12_0)
	ActionCreators.ChangePosterGirl(arg_12_0.clickedId_):next(function(arg_13_0)
		if isSuccess(arg_13_0.result) then
			ActionCreators.PlayerPosterGirlChange(arg_12_0.clickedId_)
			arg_12_0:Back()
		end
	end)
end
...
function var_0_0.OnListBtnClick(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in ipairs(arg_14_0.scrollHelper:GetItemS()) do
	...
	local var_14_0 = arg_14_0.clickedId_ ~= arg_14_0.model_.posterGirl
...
function var_0_0.Render(arg_15_0)
	...
	if arg_15_0.model_.sortList ~= var_15_0.sortList then
		...
		arg_15_0:RefreshUI(var_15_0.posterGirl)
	end
end
...
function var_0_0.RefreshUI(arg_16_0, arg_16_1)
	...
	for iter_16_0, iter_16_1 in ipairs(arg_16_0.scrollHelper:GetItemS()) do
		if iter_16_1:GetItemId() == arg_16_1 then
...
function var_0_0.OnEnter(arg_19_0)
	...
	arg_19_0:RefreshUI(arg_19_0.model_.posterGirl)
