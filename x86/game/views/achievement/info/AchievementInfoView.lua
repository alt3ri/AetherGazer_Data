...
function slot0.Init(slot0)
	...
	slot4 = AchievementInfoItem
	slot0.achievementUIList_ = LuaList.New(handler(slot0, slot0.RefreshItem), slot0.uiList_, slot4)
...
function slot0.OnEnter(slot0)
	...
	manager.windowBar:SetBarCanAdd(CurrencyConst.CURRENCY_TYPE_DIAMOND, slot4)
