...
function var_0_1.InitUI(arg_3_0)
	...
	arg_3_0.allReceiveController_ = ControllerUtil.GetController(arg_3_0.listPanelTrans_, "clear")
...
function var_0_1.RefreshReceiveBtn(arg_11_0)
	...
	arg_11_0.allReceiveController_:SetSelectedState(var_11_0 == 1 and "true" or "false")
end
