...
function slot0.InitUI(slot0)
	...
	LeanTween.alphaCanvas(slot0.mask_, 0, 0.1):setOnComplete(LuaHelper.VoidAction(function ()
...
function slot0.SetLevelTitle(slot0)
	...
	slot0.lvText_.text = GetI18NText(BattleMatrixStageCfg[slot0.stageData:GetStageId()].name)
...
function slot0.RefreshRewardItemS(slot0)
	...
	for slot5 = 1, #slot1 do
		...
		slot0.rewardItems_[slot5]:RefreshData(slot1[slot5])
		slot0.rewardItems_[slot5]:SetBottomText("<color=#%s>" .. slot1[slot5].number .. "</color>")
	end
end
