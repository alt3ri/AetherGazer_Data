...
function slot1.RefreshMythicFinalUI(slot0)
	slot1 = nil
	slot1 = slot0.stageData:GetDest() == 0 and 1 or slot0.stageData:GetDest()
	slot0.teamindextext_.text = string.format(slot1 .. "/" .. #MythicData:GetCurLevelIdList())
	slot0.teamtext_.text = GetTips("TEAM_" .. slot1)
end
