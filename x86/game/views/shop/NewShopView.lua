...
function slot0.UpdateShopList(slot0, slot1)
	...
	for slot6, slot7 in pairs(slot0.list1:GetItemList()) do
		slot7:CloseTimer()
	end
...
function slot0.GetShowList(slot0, slot1)
	...
	slot0.lineCount = math.floor(slot0.item1Trs_.rect.width / slot0.shopItemTrs_.rect.width)
