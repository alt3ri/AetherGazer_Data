...
function slot0.InitEquipDropdownData(slot0)
	...
	slot0.positionDropdown_.options:Add(UnityEngine.UI.Dropdown.OptionData.New(slot6(slot1)))
	...
	slot0.suitDropdown_.options:Add(UnityEngine.UI.Dropdown.OptionData.New(string.format(slot3), slot8))
...
function slot0.GetShopSuits(slot0)
	...
	for slot7, slot8 in ipairs(ShopData.GetShop(slot0.shopId_).shopItemIDs) do
