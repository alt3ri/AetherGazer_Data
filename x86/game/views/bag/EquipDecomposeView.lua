...
function slot0.InitUI(slot0)
	...
	slot0.equipInfo_:RegisterSkillClick(handler(slot4, slot0.SkillClick))
...
function slot0.AddUIListener(slot0)
	...
	slot0:AddBtnListener(slot0.btnOrder_, slot4, function ()
...
function slot0.OnEnter(slot0)
	...
	slot0:RegistEventListener(EQUIP_FILTER_CONFIRM, slot4(slot5, slot0.OnEquipFilterConfirm))
	slot0.posController_:SetSelectedState(0)
...
function slot0.GetItemList(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	for slot13 = #EquipData:GetEquipListComplex(slot1, slot2, slot3, slot4, slot5), 1, -1 do
...
function slot0.OnEquipDecompose(slot0, slot1, slot2)
	if isSuccess(slot1.result) then
		...
		slot7 = slot0.rewardList_

		slot0:Go("reward", slot6)

		slot0.usedEquipList_ = {}
		slot0.currentSelectNum_ = 0

		slot0.btnController_:SetSelectedState("grey")
		slot0:RefreshData()
...
function slot0.RefreshSelect(slot0)
	for slot4, slot5 in pairs(slot0.equipItemList_:GetItemList()) do
...
function slot0.ClearSelect(slot0)
	slot0.usedEquipList_ = {}
	slot0.currentSelectNum_ = 0
	slot4 = slot0.currentSelectNum_
	slot5 = slot0.totalNum_
	slot0.selectNum_.text = string.format("%s/%s", slot4, slot5)
