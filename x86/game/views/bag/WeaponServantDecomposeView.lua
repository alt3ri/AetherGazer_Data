...
function slot0.InitUI(slot0)
	...
	slot4 = CommonItemView
	slot0.returnItemList_ = LuaList.New(handler(slot0, slot0.indexRewardItem), slot0.returnItemListGo_, slot4)
...
function slot0.RefreshSelect(slot0)
	for slot4, slot5 in pairs(slot0.servantItemList_:GetItemList()) do
