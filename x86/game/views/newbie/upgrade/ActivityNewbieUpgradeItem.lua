...
function var_0_0.AddListeners(arg_2_0)
	arg_2_0:AddBtnListener(arg_2_0.button_, nil, function()
		...
		if arg_2_0.isFinish_ and not table.keyof(ActivityNewbieData:GetUpgradeFinishList(), var_3_1) then
			ActivityNewbieAction.ReceiveUpgradeReward(var_3_1, function(arg_4_0)
				if isSuccess(arg_4_0.result) then
					getReward2(arg_4_0.reward_list)
					ActivityNewbieData:SetUpgradeFinish(var_3_1)
...
function var_0_0.RefreshUI(arg_6_0)
	...
	if arg_6_0.isFinish_ then
		if table.keyof(ActivityNewbieData:GetUpgradeFinishList(), var_6_1) then
