...
function slot0.OnEnter(slot0)
	...
	BattleFieldData:SetCacheChapterClient(getChapterToggle(slot0.chapterClientID_), slot7)
	WarChessData:SetChapterClientID(slot0.chapterClientID_)
	slot0:RefreshItems()
...
function slot0.UpdateChapterList(slot0)
	...
	for slot4, slot5 in pairs(ChapterClientCfg[slot0.chapterClientID_].chapter_list) do
