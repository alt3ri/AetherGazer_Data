slot0 = class("SectionSelectHeroStrategyMatrixView", SectionSelectHeroBaseView)
...
function slot0.GetHeroCfg(slot0, slot1)
	return SkinCfg[StrategyMatrixData:GetHeroSkin(slot0.matrix_activity_id, slot1)]
end
