local var_0_0 = class("ActivityMatrixProcessEquipReplaceView", MatrixProcessEquipReplaceView)

function var_0_0.InitUI(arg_1_0)
	arg_1_0:BindCfgUI()

	arg_1_0.item_ = ActivityMatrixProcessRewardItem.New(arg_1_0.m_item)
	arg_1_0.list_ = LuaList.New(handler(arg_1_0, arg_1_0.indexItem), arg_1_0.m_list, ActivityMatrixProcessRewardItem)
end
