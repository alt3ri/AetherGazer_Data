...
function slot0.SetStandardData(slot0, slot1)
	...
	slot0.astrolabeController:SetSelectedIndex(slot10)
	...
	slot0.equipController:SetSelectedIndex(slot15)
...
function slot0.SetData(slot0, slot1)
	...
	slot0.astrolabeController:SetSelectedIndex(slot8)
	...
	slot0.equipController:SetSelectedIndex(slot12)
