...
function slot0.SetData(slot0, slot1, slot2)
	...
	slot0.quickTrainingCfg_ = BattleQuickTrainingCfg[ActivityQuickTrainingCfg[slot0.activityId_].stage_id]
...
function slot0.UpdateView(slot0)
	slot0.nameLabel.text = GetI18NText(slot0.quickTrainingCfg_.name)
	slot5 = slot0.activityId_
	slot0.scoreLabel1_.text = MardukSpecialData:GetPoint(slot5)
