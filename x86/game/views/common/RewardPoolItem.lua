...
function slot0.SetData(slot0, slot1, slot2)
	slot0.commonItem_:RefreshData(rewardToItemTemplate(slot1))
	slot0.commonItem_:RegistCallBack(function ()
		if uv0.clickCallback_ == nil or uv0.clickCallback_() then
...
function slot0.Dispose(slot0)
	...
	for slot5, slot6 in pairs(slot0.commonItemGo_:GetComponentsInChildren(typeof(Animator), true):ToTable()) do
		slot6.enabled = true
	end

	for slot6, slot7 in pairs(slot0.commonItemGo_:GetComponentsInChildren(typeof(CanvasGroup), true):ToTable()) do
		slot7.alpha = 1
	end
