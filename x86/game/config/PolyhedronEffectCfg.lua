return {
	...
	[201] = {
		...
		icon = "effect_1",
		moment = 1,
		desc = "修正者最大生命值上限提高<color=#FF9500>5%</color>，攻击力提高<color=#FF9500>5%</color>。",
		params = {
			{
				11,
				50
	...
	[202] = {
		...
		icon = "effect_1",
		moment = 1,
		desc = "修正者最大生命值上限提高<color=#FF9500>10%</color>，攻击力提高<color=#FF9500>10%</color>。",
		params = {
			{
				11,
				100
	...
	[203] = {
		...
		icon = "effect_2",
		moment = 1,
		desc = "全队恢复自身<color=#FF9500>25%</color>的血量。",
		params = {
			250
		}
	},
