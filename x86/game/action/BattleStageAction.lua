manager.net:Bind(24009, function (slot0)
	BattleStageData:InitPlotData(slot0.user_chapter_list)
...
return {
	...
	UpdateRedPoint = function ()
		for slot3, slot4 in pairs(BattleStageData:GetChapterStarList()) do
	...
	UpdateActivityRedPoint = function ()
		for slot3, slot4 in pairs(BattleStageData:GetStageData()) do
