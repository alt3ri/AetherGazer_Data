slot0 = {
	...
	OnSubmitTaskList = function (slot0, slot1, slot2)
		...
		elseif slot2.type == TaskConst.TASK_TYPE.PASSPORT_MULTIPLE_TASK_TYPE then
			...
			slot7, slot8 = nil
			slot12 = deepClone(mergeReward(formatRewardCfgList(slot6)))
			slot7, slot8, slot6 = slot0:FilterPassportWeeklyBonus(TaskConst.TASK_TYPE.PASSPORT_DAILY, slot12)
	...
	PostSubmitTaskList_DAILY = function (slot0, slot1, slot2)
		for slot6, slot7 in ipairs(ActivityPtCfg[ActivityPtConst.TASK_DAILY_ACTIVITY_PT].target) do
	...
	PostSubmitTaskList_WEEK = function (slot0, slot1, slot2)
		for slot6, slot7 in ipairs(ActivityPtCfg[ActivityPtConst.TASK_WEEK_ACTIVITY_PT].target) do
