...
manager.net:Bind(36007, function (slot0)
	GuildActivityData:UpdateSelfGridDataFromServer(slot0)
end)
manager.net:Bind(36009, function (slot0)
...
return {
	...
	Register = function (slot0)
		manager.net:SendWithLoadingNew(36010, {}, 36011, function (slot0, slot1)
	...
	EnterGuildWarField = function (slot0)
		manager.net:SendWithLoadingNew(36012, {}, 36013, function (slot0, slot1)
			if isSuccess(slot0.result) then
	...
	ExitGuildWarField = function (slot0)
		manager.net:SendWithLoadingNew(36014, {}, 36015, function (slot0, slot1)
			if isSuccess(slot0.result) then
				uv0()
			else
				ShowTips(GetTips(slot0.result))
