...
function StrategyMartixUserTemplata.SetData(slot0, slot1)
	...
	slot0.roguelike_score = slot1.score
	slot2 = slot1.matrix
...
function StrategyMartixUserTemplata.UpdateProcess(slot0, slot1)
	...
	slot0.phase = StrategyMatrixPhaseTemplate.New(slot0.activity_id, slot1.phase)
...
function StrategyMartixUserTemplata.RoguelikeScore(slot0)
	return slot0.roguelike_score or 0
end
