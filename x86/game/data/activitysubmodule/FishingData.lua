...
function slot0.OnFishingResult(slot0, slot1, slot2, slot3)
	...
	slot7 = GameSetting.activity_fishing_fish_max.value[1]
	uv0.today_treasure_num = math.min(uv0.today_treasure_num + slot3, slot7)
...
function slot0.OnReceiveFriendsFish(slot0, slot1, slot2, slot3)
	...
	manager.notify:Invoke(RECEIVE_FISH_CHANGE, slot7)
...
function slot0.OnBuySuccess(slot0, slot1, slot2, slot3)
	if uv0.fish_infos[slot1] then
		uv0.fish_infos[slot1].num = uv0.fish_infos[slot1].num + (slot2 or 1)
