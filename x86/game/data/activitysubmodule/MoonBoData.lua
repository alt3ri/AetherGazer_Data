...
function slot0.Init(slot0)
	...
	slot0.isOpenReprintActivity_ = false
	slot5 = 0
	slot6 = 0
	slot0.freshTime_ = TimeMgr.GetInstance():GetNextTime(GameSetting.refresh_time1.value[1][1], slot5, slot6)
...
function slot0.SetData(slot0, slot1)
	if slot1.activity_id == ActivityConst.MOONBO or slot1.activity_id == ActivityConst.ACTIVITY_2_4_MOONBO then
...
function slot0.FreshCanGetCount(slot0)
	...
	slot0.isOpenReprintActivity_ = ActivityData:GetActivityIsOpen(ActivityConst.ACTIVITY_2_4_MOONBO)

	if slot0.isOpenActivity_ or slot0.isOpenReprintActivity_ then
		slot1 = 0
