...
return {
	Enter = function (slot0)
		...
		for slot5 = 1, nullable(Dorm.storage:PickData("idol.camp.camera"), "gameObject").transform.childCount do
		...
		for slot6, slot7 in Dorm.storage:ForeachData("idol.camp.wall", slot6) do
