...
function slot0.Init(slot0, slot1)
	...
	slot0.customerEntityManager:MapToDormStorageData(DormUtils.EIdNamespace(DormEnum.CharacterType.RestaurantNormalCustomer), nil)
...
function slot0.Reset(slot0)
	...
	slot4 = DormEnum.ItemType.Pan

	Dorm.storage:ClearData(uv0.ItemEidNameSpace(slot4))
...
function slot0.Find(slot0)
	for slot4, slot5 in pairs(slot0.itemGenDistribution.weights) do
		...
		for slot10, slot11 in Dorm.storage:ForeachData(slot0.ItemEidNameSpace(slot4), slot10) do
...
function slot0.OnConnectItemSuccess(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	slot13 = slot4.gridCoord
	slot12 = uv0

	table.insert({}, slot0:GridCoordToPos(slot13) + slot12)
