...
return function (slot0)
	...
	if uv0(slot0.targetID) and not slot4:HasTrainStarted() then
		...
		Dorm.DormEntityManager.AttachToEntityCMD(slot2, slot8, slot12)
		Dorm.DormEntityManager.PlayAnimeDuringInteract(slot2, uv2)

		for slot12 = 2, slot4:GetTrainCartNum() do
		...
		slot10:SetOnAbort(function ()
			...
			Dorm.DormEntityManager.KeepAsInteractNotEnd(uv0, uv1, slot3)
