...
function slot0.RegisterEvent(slot0)
	manager.notify:RegistListener(DORM_RESTAURANT_NEW_CUSTOMER, function (slot0)
		uv0:AIInit(slot0)
	end)
	manager.notify:RegistListener(ON_DORM_CHARACTER_MOVE_FINISH, function (slot0, slot1)
	...
	manager.notify:RegistListener(ON_DORM_CHARACTER_INTERACT_FINISH, function (slot0, slot1)
		if not uv0.SpecialCustomerTargetList[slot0] then
			return
		end
	...
	manager.notify:RegistListener(DORM_RESTAURANT_INTERACT_CUSTOMER, function (slot0)
