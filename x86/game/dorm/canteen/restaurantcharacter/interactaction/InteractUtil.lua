slot0 = {
	...
	NewTask = function (slot0, slot1, slot2)
		slot3 = DormCharacterActionManager.taskRunner:NewTask(slot2):SetCancellationSrc(slot1)
	...
	RefreshFoodContainer = function (slot0, slot1)
		...
		for slot10 = 1, slot5.foodList and #slot5.foodList or 0 do
			slot11 = (slot1 or slot5.foodList)[slot10]

			if slot10 <= (slot3 and #slot3 or 0) then
