...
function slot0.UpdateRoleDatas(slot0, slot1)
	...
	table.insert(slot0.roleDataInLua, BattleController.GetInstance():SetPolyhedronHeroData(slot2, slot2:GetPolyhedronLeader(), PolyhedronHeroCfg[slot2:GetLeaderHeroId()].standard_id, slot11, slot12))
