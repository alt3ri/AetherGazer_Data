slot0 = class("BattleSkadiLittleGameTemplate", BattleBaseStageTemplate)
...
function slot0.Ctor(slot0, slot1, slot2)
	...
	slot0.stageID_ = ActivityCrossWaveCfg[slot1].stage_id
	slot0.cfg = BattleCrosswaveCfg[slot0.stageID_]
end
