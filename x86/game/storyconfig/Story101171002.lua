		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				...
				if uv0.var_.actorSpriteComps10036 then
					for slot18, slot19 in pairs(uv0.var_.actorSpriteComps10036:ToTable()) do
						if slot19 then
	...
	Play117102007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				...
				if uv0.var_.actorSpriteComps10036 then
					for slot17, slot18 in pairs(uv0.var_.actorSpriteComps10036:ToTable()) do
						if slot18 then
