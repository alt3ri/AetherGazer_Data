return {
	Play101101001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if uv0.bgs_.B01b:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB01b = slot9:GetColor("_Color").a
					uv0.var_.alphaMatValueB01b = slot9
				end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueB01b then
					slot11 = uv0.var_.alphaMatValueB01b
					slot12 = slot11:GetColor("_Color")
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueB01b, 1, (uv0.time_ - slot7) / slot8)

					slot11:SetColor("_Color", slot12)
				end
			end

			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 and uv0.var_.alphaMatValueB01b then
				slot9 = uv0.var_.alphaMatValueB01b
			...
			if 1.79999995231628 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(101101001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101001", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101001", "story_v_out_101101.awb") / 1000 + slot15 then
						uv0.duration_ = slot24 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_101101", "101101001", "story_v_out_101101.awb")

						uv0:RecordAudio("101101001", slot25)
						uv0:RecordAudio("101101001", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101001", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101001", "story_v_out_101101.awb")
				end
	...
	Play101101002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(101101002).content)
	...
	Play101101003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2021_tpose, Vector3.New(0, -0.6, 0.2), (uv0.time_ - slot8) / slot9)
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -0.6, 0.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(101101003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101003", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101003", "story_v_out_101101.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_101101", "101101003", "story_v_out_101101.awb")

						uv0:RecordAudio("101101003", slot20)
						uv0:RecordAudio("101101003", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101003", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101003", "story_v_out_101101.awb")
				end
	...
	Play101101004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 and uv0.var_.characterEffect2021_tpose == nil then
				uv0.var_.characterEffect2021_tpose = uv0.actors_["2021_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 and uv0.var_.characterEffect2021_tpose then
				uv0.var_.characterEffect2021_tpose.fillFlat = false
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(101101004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101004", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101004", "story_v_out_101101.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_101101", "101101004", "story_v_out_101101.awb")

						uv0:RecordAudio("101101004", slot15)
						uv0:RecordAudio("101101004", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101004", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101004", "story_v_out_101101.awb")
				end
	...
	Play101101005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect2022_tpose == nil then
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.characterEffect2022_tpose then
					...
					uv0.var_.characterEffect2022_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot7) / slot8)
				end
			end

			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 and uv0.var_.characterEffect2022_tpose then
				uv0.var_.characterEffect2022_tpose.fillFlat = true
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2021_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot10) / slot11)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(101101005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101005", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101005", "story_v_out_101101.awb") / 1000 + slot17 then
						uv0.duration_ = slot25 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_101101", "101101005", "story_v_out_101101.awb")

						uv0:RecordAudio("101101005", slot26)
						uv0:RecordAudio("101101005", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101005", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101005", "story_v_out_101101.awb")
				end
	...
	Play101101006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(101101006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101006", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101006", "story_v_out_101101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_101101", "101101006", "story_v_out_101101.awb")

						uv0:RecordAudio("101101006", slot22)
						uv0:RecordAudio("101101006", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101006", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101006", "story_v_out_101101.awb")
				end
	...
	Play101101007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101101007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101007", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101007", "story_v_out_101101.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_101101", "101101007", "story_v_out_101101.awb")

						uv0:RecordAudio("101101007", slot12)
						uv0:RecordAudio("101101007", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101007", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101007", "story_v_out_101101.awb")
				end
	...
	Play101101008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101008
		slot1.duration_ = 4.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101101008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101008", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101008", "story_v_out_101101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101101", "101101008", "story_v_out_101101.awb")

						uv0:RecordAudio("101101008", slot18)
						uv0:RecordAudio("101101008", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101008", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101008", "story_v_out_101101.awb")
				end
	...
	Play101101009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101009
		slot1.duration_ = 2.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101101009).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101009", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101009", "story_v_out_101101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101101", "101101009", "story_v_out_101101.awb")

						uv0:RecordAudio("101101009", slot18)
						uv0:RecordAudio("101101009", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101009", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101009", "story_v_out_101101.awb")
				end
	...
	Play101101010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(101101010).content)
				uv0.text_.text = slot17
	...
	Play101101011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(101101011).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101011", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101011", "story_v_out_101101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_101101", "101101011", "story_v_out_101101.awb")

						uv0:RecordAudio("101101011", slot22)
						uv0:RecordAudio("101101011", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101011", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101011", "story_v_out_101101.awb")
				end
	...
	Play101101012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(101101012).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101012", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101012", "story_v_out_101101.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_101101", "101101012", "story_v_out_101101.awb")

						uv0:RecordAudio("101101012", slot20)
						uv0:RecordAudio("101101012", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101012", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101012", "story_v_out_101101.awb")
				end
	...
	Play101101013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(101101013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101013", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101013", "story_v_out_101101.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_101101", "101101013", "story_v_out_101101.awb")

						uv0:RecordAudio("101101013", slot17)
						uv0:RecordAudio("101101013", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101013", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101013", "story_v_out_101101.awb")
				end
	...
	Play101101014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101101014).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101014", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101014", "story_v_out_101101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101101", "101101014", "story_v_out_101101.awb")

						uv0:RecordAudio("101101014", slot18)
						uv0:RecordAudio("101101014", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101014", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101014", "story_v_out_101101.awb")
				end
	...
	Play101101015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101101015).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101015", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101015", "story_v_out_101101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101101", "101101015", "story_v_out_101101.awb")

						uv0:RecordAudio("101101015", slot18)
						uv0:RecordAudio("101101015", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101015", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101015", "story_v_out_101101.awb")
				end
	...
	Play101101016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101101016).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101016", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101016", "story_v_out_101101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101101", "101101016", "story_v_out_101101.awb")

						uv0:RecordAudio("101101016", slot18)
						uv0:RecordAudio("101101016", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101016", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101016", "story_v_out_101101.awb")
				end
	...
	Play101101017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101017
		slot1.duration_ = 7.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101101017).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101017", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101017", "story_v_out_101101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101101", "101101017", "story_v_out_101101.awb")

						uv0:RecordAudio("101101017", slot18)
						uv0:RecordAudio("101101017", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101017", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101017", "story_v_out_101101.awb")
				end
	...
	Play101101018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(101101018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101018", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101018", "story_v_out_101101.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_101101", "101101018", "story_v_out_101101.awb")

						uv0:RecordAudio("101101018", slot11)
						uv0:RecordAudio("101101018", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101018", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101018", "story_v_out_101101.awb")
				end
	...
	Play101101019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101101019).content)
				uv0.text_.text = slot13
	...
	Play101101020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(101101020).content)
				uv0.text_.text = slot6
	...
	Play101101021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101021
		slot1.duration_ = 8.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("1148ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1302cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101101021).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101021", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101021", "story_v_out_101101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101101", "101101021", "story_v_out_101101.awb")

						uv0:RecordAudio("101101021", slot18)
						uv0:RecordAudio("101101021", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101021", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101021", "story_v_out_101101.awb")
				end
	...
	Play101101022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101101022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(101101022).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101101", "101101022", "story_v_out_101101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101101", "101101022", "story_v_out_101101.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_101101", "101101022", "story_v_out_101101.awb")

						uv0:RecordAudio("101101022", slot21)
						uv0:RecordAudio("101101022", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101101", "101101022", "story_v_out_101101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101101", "101101022", "story_v_out_101101.awb")
				end
