return {
	Play410121001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121001
		slot1.duration_ = 6.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.2 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(410121001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121001", "story_v_out_410121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410121", "410121001", "story_v_out_410121.awb") / 1000 + slot16 then
						uv0.duration_ = slot25 + slot16
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_410121", "410121001", "story_v_out_410121.awb")

						uv0:RecordAudio("410121001", slot26)
						uv0:RecordAudio("410121001", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410121", "410121001", "story_v_out_410121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410121", "410121001", "story_v_out_410121.awb")
				end
	...
	Play410121002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(410121002).content)
	...
	Play410121003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(410121003).content)
	...
	Play410121004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_4021")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(410121004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121004", "story_v_out_410121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410121", "410121004", "story_v_out_410121.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_410121", "410121004", "story_v_out_410121.awb")

						uv0:RecordAudio("410121004", slot10)
						uv0:RecordAudio("410121004", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410121", "410121004", "story_v_out_410121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410121", "410121004", "story_v_out_410121.awb")
				end
	...
	Play410121005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(410121005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121005", "story_v_out_410121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410121", "410121005", "story_v_out_410121.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_410121", "410121005", "story_v_out_410121.awb")

						uv0:RecordAudio("410121005", slot16)
						uv0:RecordAudio("410121005", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410121", "410121005", "story_v_out_410121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410121", "410121005", "story_v_out_410121.awb")
				end
	...
	Play410121006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(410121006).content)
				uv0.text_.text = slot10
	...
	Play410121007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(410121007).content)
				uv0.text_.text = slot4
	...
	Play410121008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(410121008).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121008", "story_v_out_410121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410121", "410121008", "story_v_out_410121.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_410121", "410121008", "story_v_out_410121.awb")

						uv0:RecordAudio("410121008", slot16)
						uv0:RecordAudio("410121008", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410121", "410121008", "story_v_out_410121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410121", "410121008", "story_v_out_410121.awb")
				end
	...
	Play410121009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(410121009).content)
				uv0.text_.text = slot10
	...
	Play410121010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_128", "se_story_128_stab", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(410121010).content)
	...
	Play410121011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(410121011).content)
				uv0.text_.text = slot4
	...
	Play410121012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(410121012).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121012", "story_v_out_410121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410121", "410121012", "story_v_out_410121.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_410121", "410121012", "story_v_out_410121.awb")

						uv0:RecordAudio("410121012", slot16)
						uv0:RecordAudio("410121012", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410121", "410121012", "story_v_out_410121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410121", "410121012", "story_v_out_410121.awb")
				end
	...
	Play410121013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(410121013).content)
	...
	Play410121014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121014
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(410121014).content)
				uv0.text_.text = slot4
	...
	Play410121015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410121015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(410121015).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121015", "story_v_out_410121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410121", "410121015", "story_v_out_410121.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_410121", "410121015", "story_v_out_410121.awb")

						uv0:RecordAudio("410121015", slot16)
						uv0:RecordAudio("410121015", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410121", "410121015", "story_v_out_410121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410121", "410121015", "story_v_out_410121.awb")
				end
