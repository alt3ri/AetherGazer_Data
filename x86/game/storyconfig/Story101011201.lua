		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if uv0.bgs_.B03f:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB03f = slot11:GetColor("_Color").a
					uv0.var_.alphaMatValueB03f = slot11
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				if uv0.var_.alphaMatValueB03f then
					...
					slot14.a = Mathf.Lerp(uv0.var_.alphaOldValueB03f, 1, (uv0.time_ - slot9) / slot10)
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0, -1.2, -5.8), (uv0.time_ - slot13) / slot14)
			...
			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(0, -1.2, -5.8)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(101121001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121001", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121001", "story_v_out_101121.awb") / 1000 + slot19 then
						uv0.duration_ = slot28 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_101121", "101121001", "story_v_out_101121.awb")

						uv0:RecordAudio("101121001", slot29)
						uv0:RecordAudio("101121001", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121001", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121001", "story_v_out_101121.awb")
				end
	...
	Play101121002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101121002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121002", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121002", "story_v_out_101121.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_101121", "101121002", "story_v_out_101121.awb")

						uv0:RecordAudio("101121002", slot13)
						uv0:RecordAudio("101121002", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121002", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121002", "story_v_out_101121.awb")
				end
	...
	Play101121003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(101121003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121003", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121003", "story_v_out_101121.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_101121", "101121003", "story_v_out_101121.awb")

						uv0:RecordAudio("101121003", slot14)
						uv0:RecordAudio("101121003", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121003", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121003", "story_v_out_101121.awb")
				end
	...
	Play101121004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101121004).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121004", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121004", "story_v_out_101121.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_101121", "101121004", "story_v_out_101121.awb")

						uv0:RecordAudio("101121004", slot13)
						uv0:RecordAudio("101121004", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121004", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121004", "story_v_out_101121.awb")
				end
	...
	Play101121005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(101121005).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121005", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121005", "story_v_out_101121.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_101121", "101121005", "story_v_out_101121.awb")

						uv0:RecordAudio("101121005", slot14)
						uv0:RecordAudio("101121005", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121005", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121005", "story_v_out_101121.awb")
				end
	...
	Play101121006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101121006).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121006", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121006", "story_v_out_101121.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_101121", "101121006", "story_v_out_101121.awb")

						uv0:RecordAudio("101121006", slot13)
						uv0:RecordAudio("101121006", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121006", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121006", "story_v_out_101121.awb")
				end
	...
	Play101121007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(101121007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121007", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121007", "story_v_out_101121.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_101121", "101121007", "story_v_out_101121.awb")

						uv0:RecordAudio("101121007", slot15)
						uv0:RecordAudio("101121007", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121007", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121007", "story_v_out_101121.awb")
				end
	...
	Play101121008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101121008).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121008", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121008", "story_v_out_101121.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_101121", "101121008", "story_v_out_101121.awb")

						uv0:RecordAudio("101121008", slot13)
						uv0:RecordAudio("101121008", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121008", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121008", "story_v_out_101121.awb")
				end
	...
	Play101121009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(101121009).content)
	...
	Play101121010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(101121010).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121010", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121010", "story_v_out_101121.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_101121", "101121010", "story_v_out_101121.awb")

						uv0:RecordAudio("101121010", slot14)
						uv0:RecordAudio("101121010", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121010", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121010", "story_v_out_101121.awb")
				end
	...
	Play101121011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101121011).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121011", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121011", "story_v_out_101121.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_101121", "101121011", "story_v_out_101121.awb")

						uv0:RecordAudio("101121011", slot13)
						uv0:RecordAudio("101121011", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121011", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121011", "story_v_out_101121.awb")
				end
	...
	Play101121012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101121012).content)
	...
	Play101121013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.characterEffect10002_tpose then
					uv0.var_.characterEffect10002_tpose.fillFlat = true
					uv0.var_.characterEffect10002_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot4) / slot5)
				end
			end
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot10) / slot11)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(101121013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121013", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121013", "story_v_out_101121.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_101121", "101121013", "story_v_out_101121.awb")

						uv0:RecordAudio("101121013", slot23)
						uv0:RecordAudio("101121013", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121013", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121013", "story_v_out_101121.awb")
				end
	...
	Play101121014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(101121014).content)
				uv0.text_.text = slot4
	...
	Play101121015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(101121015).content)
				uv0.text_.text = slot4
	...
	Play101121016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101121016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121016", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121016", "story_v_out_101121.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101121", "101121016", "story_v_out_101121.awb")

						uv0:RecordAudio("101121016", slot18)
						uv0:RecordAudio("101121016", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121016", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121016", "story_v_out_101121.awb")
				end
	...
	Play101121017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(101121017).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121017", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121017", "story_v_out_101121.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_101121", "101121017", "story_v_out_101121.awb")

						uv0:RecordAudio("101121017", slot21)
						uv0:RecordAudio("101121017", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121017", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121017", "story_v_out_101121.awb")
				end
	...
	Play101121018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(101121018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121018", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121018", "story_v_out_101121.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_101121", "101121018", "story_v_out_101121.awb")

						uv0:RecordAudio("101121018", slot17)
						uv0:RecordAudio("101121018", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121018", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121018", "story_v_out_101121.awb")
				end
	...
	Play101121019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101121019).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121019", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121019", "story_v_out_101121.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101121", "101121019", "story_v_out_101121.awb")

						uv0:RecordAudio("101121019", slot18)
						uv0:RecordAudio("101121019", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121019", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121019", "story_v_out_101121.awb")
				end
	...
	Play101121020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(101121020).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121020", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121020", "story_v_out_101121.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_101121", "101121020", "story_v_out_101121.awb")

						uv0:RecordAudio("101121020", slot11)
						uv0:RecordAudio("101121020", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121020", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121020", "story_v_out_101121.awb")
				end
	...
	Play101121021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101121021).content)
				uv0.text_.text = slot7
	...
	Play101121022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(101121022).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121022", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121022", "story_v_out_101121.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_101121", "101121022", "story_v_out_101121.awb")

						uv0:RecordAudio("101121022", slot14)
						uv0:RecordAudio("101121022", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121022", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121022", "story_v_out_101121.awb")
				end
	...
	Play101121023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101121023).content)
				uv0.text_.text = slot13
	...
	Play101121024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101121024).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121024", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121024", "story_v_out_101121.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101121", "101121024", "story_v_out_101121.awb")

						uv0:RecordAudio("101121024", slot18)
						uv0:RecordAudio("101121024", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121024", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121024", "story_v_out_101121.awb")
				end
	...
	Play101121025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(0, -1.23, -5.8), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0, -1.23, -5.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(101121025).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121025", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121025", "story_v_out_101121.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_101121", "101121025", "story_v_out_101121.awb")

						uv0:RecordAudio("101121025", slot24)
						uv0:RecordAudio("101121025", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121025", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121025", "story_v_out_101121.awb")
				end
	...
	Play101121026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101121026).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121026", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121026", "story_v_out_101121.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_101121", "101121026", "story_v_out_101121.awb")

						uv0:RecordAudio("101121026", slot12)
						uv0:RecordAudio("101121026", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121026", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121026", "story_v_out_101121.awb")
				end
	...
	Play101121027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(101121027).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121027", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121027", "story_v_out_101121.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_101121", "101121027", "story_v_out_101121.awb")

						uv0:RecordAudio("101121027", slot11)
						uv0:RecordAudio("101121027", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121027", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121027", "story_v_out_101121.awb")
				end
	...
	Play101121028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(101121028).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121028", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121028", "story_v_out_101121.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_101121", "101121028", "story_v_out_101121.awb")

						uv0:RecordAudio("101121028", slot25)
						uv0:RecordAudio("101121028", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121028", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121028", "story_v_out_101121.awb")
				end
	...
	Play101121029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(101121029).content)
				uv0.text_.text = slot18
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121029", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121029", "story_v_out_101121.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_101121", "101121029", "story_v_out_101121.awb")

						uv0:RecordAudio("101121029", slot23)
						uv0:RecordAudio("101121029", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121029", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121029", "story_v_out_101121.awb")
				end
	...
	Play101121030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(101121030).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121030", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121030", "story_v_out_101121.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_101121", "101121030", "story_v_out_101121.awb")

						uv0:RecordAudio("101121030", slot11)
						uv0:RecordAudio("101121030", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121030", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121030", "story_v_out_101121.awb")
				end
	...
	Play101121031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(101121031).content)
				uv0.text_.text = slot16
	...
	Play101121032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101121032).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121032", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121032", "story_v_out_101121.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101121", "101121032", "story_v_out_101121.awb")

						uv0:RecordAudio("101121032", slot18)
						uv0:RecordAudio("101121032", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121032", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121032", "story_v_out_101121.awb")
				end
	...
	Play101121033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(101121033).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121033", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121033", "story_v_out_101121.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_101121", "101121033", "story_v_out_101121.awb")

						uv0:RecordAudio("101121033", slot15)
						uv0:RecordAudio("101121033", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121033", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121033", "story_v_out_101121.awb")
				end
	...
	Play101121034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(101121034).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_101121", "101121034", "story_v_out_101121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101121", "101121034", "story_v_out_101121.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_101121", "101121034", "story_v_out_101121.awb")

						uv0:RecordAudio("101121034", slot14)
						uv0:RecordAudio("101121034", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101121", "101121034", "story_v_out_101121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101121", "101121034", "story_v_out_101121.awb")
				end
	...
	Play101121035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101121035).content)
				uv0.text_.text = slot7
