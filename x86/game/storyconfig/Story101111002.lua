return {
	Play111102001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102001
		slot1.duration_ = 7
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play111102002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.D06b == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.D06b:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueD06b = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueD06b = slot6
				end

				uv0.var_.alphaOldValueD06b = 0
			end

			slot5 = 1.5

			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueD06b then
					slot8 = uv0.var_.alphaMatValueD06b
					slot9 = slot8:GetColor("_Color")
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueD06b, 1, (uv0.time_ - slot4) / slot5)

					slot8:SetColor("_Color", slot9)
				end
			end

			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 and uv0.var_.alphaMatValueD06b then
				slot6 = uv0.var_.alphaMatValueD06b
			...
			if 1.63333333333333 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.mask_.enabled = true
				uv0.mask_.raycastTarget = true
			...
			if 2 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				uv0:PlayTimeline("1094ui_story", "StoryTimeline/CharAction/1094/1094action/1094action6_2")
			end
			...
			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				slot18.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1094ui_story, Vector3.New(0, -0.84, -6.1), (uv0.time_ - slot19) / slot20)
			...
			if uv0.time_ >= slot19 + slot20 and uv0.time_ < slot19 + slot20 + slot0 then
				slot18.localPosition = Vector3.New(0, -0.84, -6.1)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot22 + slot0 and uv0.var_.characterEffect1094ui_story == nil then
			...
			if slot22 <= uv0.time_ and uv0.time_ < slot22 + slot23 then
				if uv0.var_.characterEffect1094ui_story then
					...
					uv0.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot22) / slot23)
				end
			end

			if uv0.time_ >= slot22 + slot23 and uv0.time_ < slot22 + slot23 + slot0 and uv0.var_.characterEffect1094ui_story then
				uv0.var_.characterEffect1094ui_story.fillFlat = true
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot24 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot26 + slot0 then
				...
				slot30 = uv0:FormatText(uv0:GetWordFromCfg(111102001).content)
				uv0.text_.text = slot30

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (34 <= 0 and slot27 or slot27 * utf8.len(slot30) / slot31) > 0 and slot27 < slot33 then
	...
	Play111102002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111102002).content)
	...
	Play111102003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.15 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				if not uv0.var_.effect123 then
					slot3 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_slash_01"))
					slot3.name = "123"
					uv0.var_.effect123 = slot3
				end
			...
			if 0.15 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0.var_.shakeOldPos = manager.ui.mainCamera.transform.localPosition
			end
			...
			if uv0.time_ >= slot6 + 2.65 and uv0.time_ < slot6 + slot7 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(111102003).content)
	...
	Play111102004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102004
		slot1.duration_ = 4.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.8 < uv0.time_ and uv0.time_ <= slot8 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 and uv0.var_.effect123 then
				Object.Destroy(slot12)

				uv0.var_.effect123 = nil
			end
			...
			if uv0.time_ >= slot12 + 2.65 and uv0.time_ < slot12 + slot13 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				if not uv0.var_.effect111 then
					slot19 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_slash_02"))
					slot19.name = "111"
					uv0.var_.effect111 = slot19
				end

				if slot17:Find("") then
					slot19.transform.parent = slot20
				else
					slot19.transform.parent = slot17
				end

				slot19.transform.localPosition = Vector3.New(0, 0, 0.15)
				slot19.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			if 0.8 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(111102004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102004", "story_v_out_111102.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111102", "111102004", "story_v_out_111102.awb") / 1000 + slot19 then
						uv0.duration_ = slot28 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_111102", "111102004", "story_v_out_111102.awb")

						uv0:RecordAudio("111102004", slot29)
						uv0:RecordAudio("111102004", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111102", "111102004", "story_v_out_111102.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111102", "111102004", "story_v_out_111102.awb")
				end
	...
	Play111102005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102005
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = manager.ui.mainCamera.transform

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.var_.effect111 then
				Object.Destroy(slot4)

				uv0.var_.effect111 = nil
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111102005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102005", "story_v_out_111102.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111102", "111102005", "story_v_out_111102.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_111102", "111102005", "story_v_out_111102.awb")

						uv0:RecordAudio("111102005", slot13)
						uv0:RecordAudio("111102005", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111102", "111102005", "story_v_out_111102.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111102", "111102005", "story_v_out_111102.awb")
				end
	...
	Play111102006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111102006).content)
				uv0.text_.text = slot8
	...
	Play111102007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111102007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102007", "story_v_out_111102.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111102", "111102007", "story_v_out_111102.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111102", "111102007", "story_v_out_111102.awb")

						uv0:RecordAudio("111102007", slot18)
						uv0:RecordAudio("111102007", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111102", "111102007", "story_v_out_111102.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111102", "111102007", "story_v_out_111102.awb")
				end
	...
	Play111102008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111102008).content)
				uv0.text_.text = slot8
	...
	Play111102009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111102009).content)
				uv0.text_.text = slot8
	...
	Play111102010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111102010).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102010", "story_v_out_111102.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111102", "111102010", "story_v_out_111102.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111102", "111102010", "story_v_out_111102.awb")

						uv0:RecordAudio("111102010", slot18)
						uv0:RecordAudio("111102010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111102", "111102010", "story_v_out_111102.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111102", "111102010", "story_v_out_111102.awb")
				end
	...
	Play111102011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111102011).content)
	...
	Play111102012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102012
		slot1.duration_ = 4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111102012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102012", "story_v_out_111102.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111102", "111102012", "story_v_out_111102.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111102", "111102012", "story_v_out_111102.awb")

						uv0:RecordAudio("111102012", slot15)
						uv0:RecordAudio("111102012", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111102", "111102012", "story_v_out_111102.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111102", "111102012", "story_v_out_111102.awb")
				end
	...
	Play111102013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111102013).content)
				uv0.text_.text = slot8
	...
	Play111102014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111102014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102014", "story_v_out_111102.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111102", "111102014", "story_v_out_111102.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111102", "111102014", "story_v_out_111102.awb")

						uv0:RecordAudio("111102014", slot14)
						uv0:RecordAudio("111102014", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111102", "111102014", "story_v_out_111102.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111102", "111102014", "story_v_out_111102.awb")
				end
	...
	Play111102015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111102015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111102015).content)
				uv0.text_.text = slot7
