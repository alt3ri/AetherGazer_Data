return {
	Play100032001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032001
		slot1.duration_ = 7.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if uv0.bgs_.A06:GetComponent("SpriteRenderer") then
					slot12.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot13 = slot12.material
					uv0.var_.alphaOldValueA06 = slot13:GetColor("_Color").a
					uv0.var_.alphaMatValueA06 = slot13
				end

				uv0.var_.alphaOldValueA06 = 0
			end

			slot12 = 1.5

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.alphaMatValueA06 then
					slot15 = uv0.var_.alphaMatValueA06
					slot16 = slot15:GetColor("_Color")
					slot16.a = Mathf.Lerp(uv0.var_.alphaOldValueA06, 1, (uv0.time_ - slot11) / slot12)

					slot15:SetColor("_Color", slot16)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.alphaMatValueA06 then
				slot13 = uv0.var_.alphaMatValueA06
			...
			if uv0.time_ >= slot18 + 1.79999995231628 and uv0.time_ < slot18 + slot19 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(100032001).content)
				uv0.text_.text = slot26

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (14 <= 0 and slot22 or slot22 * utf8.len(slot26) / slot27) > 0 and slot22 < slot29 then
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032001", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032001", "story_v_out_100032.awb") / 1000 + slot21 then
						uv0.duration_ = slot30 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_100032", "100032001", "story_v_out_100032.awb")

						uv0:RecordAudio("100032001", slot31)
						uv0:RecordAudio("100032001", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032001", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032001", "story_v_out_100032.awb")
				end
	...
	Play100032002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1148ui_story, Vector3.New(0.7, -0.8, -6.2), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0.7, -0.8, -6.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(100032002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032002", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032002", "story_v_out_100032.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_100032", "100032002", "story_v_out_100032.awb")

						uv0:RecordAudio("100032002", slot22)
						uv0:RecordAudio("100032002", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032002", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032002", "story_v_out_100032.awb")
				end
	...
	Play100032003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(100032003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032003", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032003", "story_v_out_100032.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100032", "100032003", "story_v_out_100032.awb")

						uv0:RecordAudio("100032003", slot18)
						uv0:RecordAudio("100032003", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032003", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032003", "story_v_out_100032.awb")
				end
	...
	Play100032004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032004
		slot1.duration_ = 4.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("1148ui_story", "StoryTimeline/CharAction/1148/1148actionlink/1148action442")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(100032004).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032004", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032004", "story_v_out_100032.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100032", "100032004", "story_v_out_100032.awb")

						uv0:RecordAudio("100032004", slot18)
						uv0:RecordAudio("100032004", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032004", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032004", "story_v_out_100032.awb")
				end
	...
	Play100032005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032005
		slot1.duration_ = 6.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(100032005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032005", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032005", "story_v_out_100032.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_100032", "100032005", "story_v_out_100032.awb")

						uv0:RecordAudio("100032005", slot13)
						uv0:RecordAudio("100032005", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032005", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032005", "story_v_out_100032.awb")
				end
	...
	Play100032006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("1084ui_story", "StoryTimeline/CharAction/1084/1084actionlink/1084action454")
			end

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("1148ui_story", "StoryTimeline/CharAction/1148/1148actionlink/1148action425")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(100032006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032006", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032006", "story_v_out_100032.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_100032", "100032006", "story_v_out_100032.awb")

						uv0:RecordAudio("100032006", slot20)
						uv0:RecordAudio("100032006", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032006", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032006", "story_v_out_100032.awb")
				end
	...
	Play100032007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_0", "se_story_0_wings_stones", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(100032007).content)
	...
	Play100032008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032008
		slot1.duration_ = 4.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(100032008).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032008", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032008", "story_v_out_100032.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100032", "100032008", "story_v_out_100032.awb")

						uv0:RecordAudio("100032008", slot18)
						uv0:RecordAudio("100032008", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032008", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032008", "story_v_out_100032.awb")
				end
	...
	Play100032009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032009
		slot1.duration_ = 4.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(100032009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032009", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032009", "story_v_out_100032.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_100032", "100032009", "story_v_out_100032.awb")

						uv0:RecordAudio("100032009", slot21)
						uv0:RecordAudio("100032009", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032009", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032009", "story_v_out_100032.awb")
				end
	...
	Play100032010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story", "se_story_enemy_activity", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[12].name)
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_3016")

				uv0.callingController_:SetSelectedState("normal")

				slot10 = uv0:FormatText(uv0:GetWordFromCfg(100032010).content)
	...
	Play100032011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(100032011).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032011", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032011", "story_v_out_100032.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100032", "100032011", "story_v_out_100032.awb")

						uv0:RecordAudio("100032011", slot18)
						uv0:RecordAudio("100032011", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032011", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032011", "story_v_out_100032.awb")
				end
	...
	Play100032012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1039ui_story, Vector3.New(0.7, -1.01, -5.9), (uv0.time_ - slot12) / slot13)
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(0.7, -1.01, -5.9)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(100032012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032012", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032012", "story_v_out_100032.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_100032", "100032012", "story_v_out_100032.awb")

						uv0:RecordAudio("100032012", slot25)
						uv0:RecordAudio("100032012", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032012", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032012", "story_v_out_100032.awb")
				end
	...
	Play100032013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 100032013
		slot1.duration_ = 4.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(100032013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032013", "story_v_out_100032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_100032", "100032013", "story_v_out_100032.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_100032", "100032013", "story_v_out_100032.awb")

						uv0:RecordAudio("100032013", slot19)
						uv0:RecordAudio("100032013", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_100032", "100032013", "story_v_out_100032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_100032", "100032013", "story_v_out_100032.awb")
				end
