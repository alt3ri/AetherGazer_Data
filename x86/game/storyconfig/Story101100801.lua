return {
	Play110081001 = function (slot0, slot1)
		...
		slot1.curTalkId_ = 110081001
		slot1.duration_ = 5.055999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 2 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.fswt_.text = uv0:FormatText(uv0:GetWordFromCfg(110081001).content)
			...
			slot3 = 18
			slot4 = 1.2
			slot7, slot8 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081001).content), 1)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				if uv0.bgs_.OS0105:GetComponent("SpriteRenderer") then
					slot14.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot15 = slot14.material
					uv0.var_.alphaOldValueOS0105 = slot15:GetColor("_Color").a
					uv0.var_.alphaMatValueOS0105 = slot15
				end

				uv0.var_.alphaOldValueOS0105 = 0
			end

			slot14 = 1.5

			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				if uv0.var_.alphaMatValueOS0105 then
					slot17 = uv0.var_.alphaMatValueOS0105
					slot18 = slot17:GetColor("_Color")
					slot18.a = Mathf.Lerp(uv0.var_.alphaOldValueOS0105, 1, (uv0.time_ - slot13) / slot14)

					slot17:SetColor("_Color", slot18)
				end
			end

			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 and uv0.var_.alphaMatValueOS0105 then
				slot15 = uv0.var_.alphaMatValueOS0105
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081001", "story_v_out_110081.awb") / 1000 > 0 and 3.056 < slot19 and uv0.duration_ < slot19 + slot17 then
				slot18 = slot19
	...
	Play110081002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081001).content), 2)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081002", "story_v_out_110081.awb") / 1000 > 0 and 4.888 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
	...
	Play110081003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081001).content), 3)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081003", "story_v_out_110081.awb") / 1000 > 0 and 11.905 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081001).content), 4)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081004", "story_v_out_110081.awb") / 1000 > 0 and 4.954 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 22
			slot3 = 1.46666666666667
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081001).content), 5)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081005", "story_v_out_110081.awb") / 1000 > 0 and 3.774 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 33
			slot3 = 2.2
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081001).content), 6)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081006", "story_v_out_110081.awb") / 1000 > 0 and 8.48 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.fswtw_.percent = 0
				uv0.fswt_.text = uv0:FormatText(uv0:GetWordFromCfg(110081007).content)
			...
			slot3 = 78
			slot4 = 5.2
			slot7, slot8 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081007).content), 1)
			...
			slot9 = math.max(5.2, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081007", "story_v_out_110081.awb") / 1000 > 0 and 15.562 < slot12 and uv0.duration_ < slot12 + slot10 then
				slot11 = slot12
	...
	Play110081008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081007).content), 2)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081008", "story_v_out_110081.awb") / 1000 > 0 and 3.973 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 18
			slot3 = 1.2
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081007).content), 3)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081009", "story_v_out_110081.awb") / 1000 > 0 and 3.866 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 67
			slot3 = 4.46666666666667
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081007).content), 4)
			...
			slot8 = math.max(4.46666666666667, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081010", "story_v_out_110081.awb") / 1000 > 0 and 14.898 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081007).content), 5)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081011", "story_v_out_110081.awb") / 1000 > 0 and 3.504 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081007).content), 6)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081012", "story_v_out_110081.awb") / 1000 > 0 and 7.866 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.fswtw_.percent = 0
				uv0.fswt_.text = uv0:FormatText(uv0:GetWordFromCfg(110081013).content)
			...
			slot3 = 9
			slot4 = 0.6
			slot7, slot8 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081013).content), 1)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081013", "story_v_out_110081.awb") / 1000 > 0 and 1.381 < slot12 and uv0.duration_ < slot12 + slot10 then
				slot11 = slot12
				uv0.duration_ = slot12 + slot10
			end
	...
	Play110081014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081013).content), 2)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081014", "story_v_out_110081.awb") / 1000 > 0 and 5.432 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 36
			slot3 = 2.4
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081013).content), 3)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081015", "story_v_out_110081.awb") / 1000 > 0 and 7.866 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081013).content), 4)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081016", "story_v_out_110081.awb") / 1000 > 0 and 10.208 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play110081017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(110081013).content), 5)
			...
			if manager.audio:GetVoiceLength("story_v_out_110081", "110081017", "story_v_out_110081.awb") / 1000 > 0 and 3.73 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
