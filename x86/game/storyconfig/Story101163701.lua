return {
	Play116371001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116371001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371001", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371001", "story_v_out_116371.awb") / 1000 + slot9 then
						uv0.duration_ = slot18 + slot9
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116371", "116371001", "story_v_out_116371.awb")

						uv0:RecordAudio("116371001", slot19)
						uv0:RecordAudio("116371001", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371001", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371001", "story_v_out_116371.awb")
				end
	...
	Play116371002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371002).content)
	...
	Play116371003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116371003).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371003", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371003", "story_v_out_116371.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116371", "116371003", "story_v_out_116371.awb")

						uv0:RecordAudio("116371003", slot19)
						uv0:RecordAudio("116371003", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371003", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371003", "story_v_out_116371.awb")
				end
	...
	Play116371004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116371004).content)
	...
	Play116371005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371005).content)
				uv0.text_.text = slot4
	...
	Play116371006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371006).content)
				uv0.text_.text = slot4
	...
	Play116371007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371007).content)
				uv0.text_.text = slot4
	...
	Play116371008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371008", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371008", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116371", "116371008", "story_v_out_116371.awb")

						uv0:RecordAudio("116371008", slot10)
						uv0:RecordAudio("116371008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371008", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371008", "story_v_out_116371.awb")
				end
	...
	Play116371009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371009).content)
				uv0.text_.text = slot5
	...
	Play116371010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116371010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371010", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371010", "story_v_out_116371.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116371", "116371010", "story_v_out_116371.awb")

						uv0:RecordAudio("116371010", slot18)
						uv0:RecordAudio("116371010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371010", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371010", "story_v_out_116371.awb")
				end
	...
	Play116371011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116371011).content)
	...
	Play116371012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371012).content)
				uv0.text_.text = slot5
	...
	Play116371013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371013).content)
				uv0.text_.text = slot5
	...
	Play116371014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(116371014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371014", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371014", "story_v_out_116371.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116371", "116371014", "story_v_out_116371.awb")

						uv0:RecordAudio("116371014", slot14)
						uv0:RecordAudio("116371014", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371014", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371014", "story_v_out_116371.awb")
				end
	...
	Play116371015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116371015).content)
				uv0.text_.text = slot8
	...
	Play116371016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116371016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371016", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371016", "story_v_out_116371.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116371", "116371016", "story_v_out_116371.awb")

						uv0:RecordAudio("116371016", slot17)
						uv0:RecordAudio("116371016", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371016", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371016", "story_v_out_116371.awb")
				end
	...
	Play116371017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116371017).content)
				uv0.text_.text = slot8
	...
	Play116371018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116371018).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371018", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371018", "story_v_out_116371.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116371", "116371018", "story_v_out_116371.awb")

						uv0:RecordAudio("116371018", slot18)
						uv0:RecordAudio("116371018", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371018", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371018", "story_v_out_116371.awb")
				end
	...
	Play116371019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116371019).content)
				uv0.text_.text = slot8
	...
	Play116371020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116371020).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371020", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371020", "story_v_out_116371.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116371", "116371020", "story_v_out_116371.awb")

						uv0:RecordAudio("116371020", slot18)
						uv0:RecordAudio("116371020", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371020", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371020", "story_v_out_116371.awb")
				end
	...
	Play116371021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116371021).content)
				uv0.text_.text = slot8
	...
	Play116371022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371022).content)
				uv0.text_.text = slot5
	...
	Play116371023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371023).content)
				uv0.text_.text = slot5
	...
	Play116371024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371024).content)
				uv0.text_.text = slot5
	...
	Play116371025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116371025).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371025", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371025", "story_v_out_116371.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116371", "116371025", "story_v_out_116371.awb")

						uv0:RecordAudio("116371025", slot18)
						uv0:RecordAudio("116371025", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371025", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371025", "story_v_out_116371.awb")
				end
	...
	Play116371026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.fswt_.text = uv0:FormatText(uv0:GetWordFromCfg(116371026).content)
			...
			slot12 = 47
			slot13 = 3.13333333333333
			slot16, slot17 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371026).content), 1)
			...
			slot18 = math.max(3.13333333333333, uv0.talkMaxDuration)
			...
			slot19 = 2.01666666666667

			if manager.audio:GetVoiceLength("story_v_out_116371", "116371026", "story_v_out_116371.awb") / 1000 > 0 and 12.771 < slot21 and uv0.duration_ < slot21 + slot19 then
				slot20 = slot21
			...
			if 2.01666666666667 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				uv0.allBtn_.enabled = false
			end

			if uv0.time_ >= slot22 + 3.13333333333333 and uv0.time_ < slot22 + slot23 + slot0 then
	...
	Play116371027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371026).content), 2)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371027", "story_v_out_116371.awb") / 1000 > 0 and 11.978 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
	...
	Play116371028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 54
			slot3 = 3.6
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371026).content), 3)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371028", "story_v_out_116371.awb") / 1000 > 0 and 12.541 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play116371029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371026).content), 4)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371029", "story_v_out_116371.awb") / 1000 > 0 and 10.376 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play116371030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371026).content), 5)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371030", "story_v_out_116371.awb") / 1000 > 0 and 7.269 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play116371031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371026).content), 6)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371031", "story_v_out_116371.awb") / 1000 > 0 and 12.886 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
			...
			if uv0.time_ >= slot12 + 3.66666666666667 and uv0.time_ < slot12 + slot13 + slot0 then
				uv0.allBtn_.enabled = true
			end
		end
	end,
	Play116371032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.fswtw_.percent = 0
				uv0.fswt_.text = uv0:FormatText(uv0:GetWordFromCfg(116371032).content)
			...
			slot3 = 60
			slot4 = 4
			slot7, slot8 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371032).content), 2)
			...
			slot9 = math.max(4, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371032", "story_v_out_116371.awb") / 1000 > 0 and 15.092 < slot12 and uv0.duration_ < slot12 + slot10 then
				slot11 = slot12
			...
			if uv0.time_ >= slot13 + 4.01666666666667 and uv0.time_ < slot13 + slot14 + slot0 then
				uv0.allBtn_.enabled = true
			end
		end
	end,
	Play116371033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 46
			slot3 = 5.4
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371032).content), 3)
			...
			slot8 = math.max(5.4, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371033", "story_v_out_116371.awb") / 1000 > 0 and 12.734 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play116371034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 45
			slot3 = 3
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371032).content), 4)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371034", "story_v_out_116371.awb") / 1000 > 0 and 11.492 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play116371035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 0
			slot3 = -4
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371032).content), 1)
			...
			slot10 = 33
			slot11 = 2.2
			slot14, slot15 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371032).content), 5)
			...
			slot16 = math.max(2.2, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371035", "story_v_out_116371.awb") / 1000 > 0 and 9.995 < slot19 and uv0.duration_ < slot19 + slot17 then
				slot18 = slot19
			...
			if uv0.time_ >= slot20 + 2.2 and uv0.time_ < slot20 + slot21 + slot0 then
				uv0.allBtn_.enabled = true
			end
		end
	end,
	Play116371036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 30
			slot3 = 2
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371032).content), 6)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371036", "story_v_out_116371.awb") / 1000 > 0 and 10.256 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play116371037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 18
			slot3 = 1.2
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371032).content), 7)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371037", "story_v_out_116371.awb") / 1000 > 0 and 8.27 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play116371038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116371032).content), 8)
			...
			if manager.audio:GetVoiceLength("story_v_out_116371", "116371038", "story_v_out_116371.awb") / 1000 > 0 and 3.594 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play116371039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(116371039).content)
	...
	Play116371040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371040).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371040", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371040", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116371", "116371040", "story_v_out_116371.awb")

						uv0:RecordAudio("116371040", slot10)
						uv0:RecordAudio("116371040", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371040", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371040", "story_v_out_116371.awb")
				end
	...
	Play116371041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371041).content)
				uv0.text_.text = slot4
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371041", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371041", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot8 + slot1
					end

					if slot3.prefab_name ~= "" and uv0.actors_[slot3.prefab_name] ~= nil then
						slot9 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot3.prefab_name].transform, "story_v_out_116371", "116371041", "story_v_out_116371.awb")

						uv0:RecordAudio("116371041", slot9)
						uv0:RecordAudio("116371041", slot9)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371041", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371041", "story_v_out_116371.awb")
				end
	...
	Play116371042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371042).content)
				uv0.text_.text = slot4
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371042", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371042", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot8 + slot1
					end

					if slot3.prefab_name ~= "" and uv0.actors_[slot3.prefab_name] ~= nil then
						slot9 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot3.prefab_name].transform, "story_v_out_116371", "116371042", "story_v_out_116371.awb")

						uv0:RecordAudio("116371042", slot9)
						uv0:RecordAudio("116371042", slot9)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371042", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371042", "story_v_out_116371.awb")
				end
	...
	Play116371043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371043).content)
				uv0.text_.text = slot4
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371043", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371043", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot8 + slot1
					end

					if slot3.prefab_name ~= "" and uv0.actors_[slot3.prefab_name] ~= nil then
						slot9 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot3.prefab_name].transform, "story_v_out_116371", "116371043", "story_v_out_116371.awb")

						uv0:RecordAudio("116371043", slot9)
						uv0:RecordAudio("116371043", slot9)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371043", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371043", "story_v_out_116371.awb")
				end
	...
	Play116371044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371044).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371044", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371044", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116371", "116371044", "story_v_out_116371.awb")

						uv0:RecordAudio("116371044", slot10)
						uv0:RecordAudio("116371044", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371044", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371044", "story_v_out_116371.awb")
				end
	...
	Play116371045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10032ui_story, Vector3.New(0, -1.1, -5.9), (uv0.time_ - slot6) / slot7)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116371045).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371045", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371045", "story_v_out_116371.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116371", "116371045", "story_v_out_116371.awb")

						uv0:RecordAudio("116371045", slot19)
						uv0:RecordAudio("116371045", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371045", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371045", "story_v_out_116371.awb")
				end
	...
	Play116371046 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116371046).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371046", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371046", "story_v_out_116371.awb") / 1000 + slot4 then
						uv0.duration_ = slot11 + slot4
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116371", "116371046", "story_v_out_116371.awb")

						uv0:RecordAudio("116371046", slot12)
						uv0:RecordAudio("116371046", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371046", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371046", "story_v_out_116371.awb")
				end
	...
	Play116371047 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371047).content)
				uv0.text_.text = slot4
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371047", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371047", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot8 + slot1
					end

					if slot3.prefab_name ~= "" and uv0.actors_[slot3.prefab_name] ~= nil then
						slot9 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot3.prefab_name].transform, "story_v_out_116371", "116371047", "story_v_out_116371.awb")

						uv0:RecordAudio("116371047", slot9)
						uv0:RecordAudio("116371047", slot9)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371047", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371047", "story_v_out_116371.awb")
				end
	...
	Play116371048 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371048).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371048", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371048", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116371", "116371048", "story_v_out_116371.awb")

						uv0:RecordAudio("116371048", slot10)
						uv0:RecordAudio("116371048", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371048", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371048", "story_v_out_116371.awb")
				end
	...
	Play116371049 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(116371049).content)
	...
	Play116371050 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371050).content)
				uv0.text_.text = slot4
	...
	Play116371051 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(116371051).content)
				uv0.text_.text = slot9
	...
	Play116371052 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116371052).content)
				uv0.text_.text = slot7
	...
	Play116371053 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371053).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371053", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371053", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116371", "116371053", "story_v_out_116371.awb")

						uv0:RecordAudio("116371053", slot10)
						uv0:RecordAudio("116371053", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371053", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371053", "story_v_out_116371.awb")
				end
	...
	Play116371054 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371054).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371054", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371054", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116371", "116371054", "story_v_out_116371.awb")

						uv0:RecordAudio("116371054", slot10)
						uv0:RecordAudio("116371054", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371054", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371054", "story_v_out_116371.awb")
				end
	...
	Play116371055 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(116371055).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371055", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371055", "story_v_out_116371.awb") / 1000 + slot13 then
						uv0.duration_ = slot22 + slot13
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_116371", "116371055", "story_v_out_116371.awb")

						uv0:RecordAudio("116371055", slot23)
						uv0:RecordAudio("116371055", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371055", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371055", "story_v_out_116371.awb")
				end
	...
	Play116371056 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116371056).content)
				uv0.text_.text = slot7
	...
	Play116371057 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116371057).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371057", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371057", "story_v_out_116371.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116371", "116371057", "story_v_out_116371.awb")

						uv0:RecordAudio("116371057", slot10)
						uv0:RecordAudio("116371057", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371057", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371057", "story_v_out_116371.awb")
				end
	...
	Play116371058 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116371058).content)
	...
	Play116371059 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371059).content)
				uv0.text_.text = slot4
	...
	Play116371060 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116371060).content)
				uv0.text_.text = slot4
	...
	Play116371061 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116371061).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371061", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371061", "story_v_out_116371.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116371", "116371061", "story_v_out_116371.awb")

						uv0:RecordAudio("116371061", slot18)
						uv0:RecordAudio("116371061", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371061", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371061", "story_v_out_116371.awb")
				end
	...
	Play116371062 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116371062).content)
				uv0.text_.text = slot7
	...
	Play116371063 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116371063).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371063", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371063", "story_v_out_116371.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116371", "116371063", "story_v_out_116371.awb")

						uv0:RecordAudio("116371063", slot17)
						uv0:RecordAudio("116371063", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371063", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371063", "story_v_out_116371.awb")
				end
	...
	Play116371064 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116371064).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_116371", "116371064", "story_v_out_116371.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116371", "116371064", "story_v_out_116371.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116371", "116371064", "story_v_out_116371.awb")

						uv0:RecordAudio("116371064", slot12)
						uv0:RecordAudio("116371064", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116371", "116371064", "story_v_out_116371.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116371", "116371064", "story_v_out_116371.awb")
				end
	...
	Play116371065 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116371065).content)
				uv0.text_.text = slot7
	...
	Play116371066 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116371066).content)
