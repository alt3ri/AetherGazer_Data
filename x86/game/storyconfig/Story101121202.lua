return {
	Play112122001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.73333333333333 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_activity_1_2_1", "se_story_activity_1_2_1_huge_waves", "")
			end
			...
			if 2.33333333333333 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(112122001).content)
	...
	Play112122002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(112122002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112122", "112122002", "story_v_out_112122.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112122", "112122002", "story_v_out_112122.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_112122", "112122002", "story_v_out_112122.awb")

						uv0:RecordAudio("112122002", slot19)
						uv0:RecordAudio("112122002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112122", "112122002", "story_v_out_112122.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112122", "112122002", "story_v_out_112122.awb")
				end
	...
	Play112122003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(112122003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112122", "112122003", "story_v_out_112122.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112122", "112122003", "story_v_out_112122.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112122", "112122003", "story_v_out_112122.awb")

						uv0:RecordAudio("112122003", slot22)
						uv0:RecordAudio("112122003", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112122", "112122003", "story_v_out_112122.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112122", "112122003", "story_v_out_112122.awb")
				end
	...
	Play112122004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122004
		slot1.duration_ = 3.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(112122004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112122", "112122004", "story_v_out_112122.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112122", "112122004", "story_v_out_112122.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_112122", "112122004", "story_v_out_112122.awb")

						uv0:RecordAudio("112122004", slot25)
						uv0:RecordAudio("112122004", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112122", "112122004", "story_v_out_112122.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112122", "112122004", "story_v_out_112122.awb")
				end
	...
	Play112122005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(112122005).content)
	...
	Play112122006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(112122006).content)
	...
	Play112122007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(112122007).content)
	...
	Play112122008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122008
		slot1.duration_ = 1.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112122008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112122", "112122008", "story_v_out_112122.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112122", "112122008", "story_v_out_112122.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_112122", "112122008", "story_v_out_112122.awb")

						uv0:RecordAudio("112122008", slot10)
						uv0:RecordAudio("112122008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112122", "112122008", "story_v_out_112122.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112122", "112122008", "story_v_out_112122.awb")
				end
	...
	Play112122009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122009
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_activity_1_2_1", "se_story_activity_1_2_1_underwater_loop02", "")
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(112122009).content)
	...
	Play112122010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112122010).content)
				uv0.text_.text = slot5
	...
	Play112122011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(112122011).content)
				uv0.text_.text = slot4
	...
	Play112122012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(112122012).content)
				uv0.text_.text = slot4
	...
	Play112122013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122013
		slot1.duration_ = 2.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112122013).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_112122", "112122013", "story_v_out_112122.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112122", "112122013", "story_v_out_112122.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_112122", "112122013", "story_v_out_112122.awb")

						uv0:RecordAudio("112122013", slot10)
						uv0:RecordAudio("112122013", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112122", "112122013", "story_v_out_112122.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112122", "112122013", "story_v_out_112122.awb")
				end
	...
	Play112122014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122014
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(112122014).content)
				uv0.text_.text = slot4
	...
	Play112122015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122015
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(112122015).content)
	...
	Play112122016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(112122016).content)
				uv0.text_.text = slot4
	...
	Play112122017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112122017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(112122017).content)
				uv0.text_.text = slot4
