return {
	Play105092001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.B03f:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB03f = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueB03f = slot7
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueB03f then
					...
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueB03f, 1, (uv0.time_ - slot5) / slot6)

					slot9:SetColor("_Color", slot10)
				end
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.alphaMatValueB03f then
				slot7 = uv0.var_.alphaMatValueB03f
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105092001).content)
	...
	Play105092002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092002
		slot1.duration_ = 2.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105092002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092002", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092002", "story_v_out_105092.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_105092", "105092002", "story_v_out_105092.awb")

						uv0:RecordAudio("105092002", slot21)
						uv0:RecordAudio("105092002", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092002", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092002", "story_v_out_105092.awb")
				end
	...
	Play105092003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect1013ui_story == nil then
				uv0.var_.characterEffect1013ui_story = uv0.actors_["1013ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.characterEffect1013ui_story then
					...
					uv0.var_.characterEffect1013ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot6) / slot7)
				end
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.characterEffect1013ui_story then
				uv0.var_.characterEffect1013ui_story.fillFlat = true
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0.7, -1.2, -5.8), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0.7, -1.2, -5.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105092003).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092003", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092003", "story_v_out_105092.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_105092", "105092003", "story_v_out_105092.awb")

						uv0:RecordAudio("105092003", slot21)
						uv0:RecordAudio("105092003", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092003", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092003", "story_v_out_105092.awb")
				end
	...
	Play105092004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092004
		slot1.duration_ = 5.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105092004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092004", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092004", "story_v_out_105092.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105092", "105092004", "story_v_out_105092.awb")

						uv0:RecordAudio("105092004", slot18)
						uv0:RecordAudio("105092004", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092004", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092004", "story_v_out_105092.awb")
				end
	...
	Play105092005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(105092005).content)
	...
	Play105092006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092006
		slot1.duration_ = 2.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(105092006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092006", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092006", "story_v_out_105092.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_105092", "105092006", "story_v_out_105092.awb")

						uv0:RecordAudio("105092006", slot13)
						uv0:RecordAudio("105092006", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092006", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092006", "story_v_out_105092.awb")
				end
	...
	Play105092007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092007
		slot1.duration_ = 8.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("1013ui_story", "StoryTimeline/CharAction/1013/1013actionlink/1013action41011")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105092007).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092007", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092007", "story_v_out_105092.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105092", "105092007", "story_v_out_105092.awb")

						uv0:RecordAudio("105092007", slot18)
						uv0:RecordAudio("105092007", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092007", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092007", "story_v_out_105092.awb")
				end
	...
	Play105092008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092008
		slot1.duration_ = 6.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(105092008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092008", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092008", "story_v_out_105092.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_105092", "105092008", "story_v_out_105092.awb")

						uv0:RecordAudio("105092008", slot16)
						uv0:RecordAudio("105092008", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092008", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092008", "story_v_out_105092.awb")
				end
	...
	Play105092009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105092009).content)
				uv0.text_.text = slot13
	...
	Play105092010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(105092010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092010", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092010", "story_v_out_105092.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_105092", "105092010", "story_v_out_105092.awb")

						uv0:RecordAudio("105092010", slot17)
						uv0:RecordAudio("105092010", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092010", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092010", "story_v_out_105092.awb")
				end
	...
	Play105092011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105092011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092011", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092011", "story_v_out_105092.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105092", "105092011", "story_v_out_105092.awb")

						uv0:RecordAudio("105092011", slot10)
						uv0:RecordAudio("105092011", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092011", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092011", "story_v_out_105092.awb")
				end
	...
	Play105092012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(105092012).content)
	...
	Play105092013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(105092013).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092013", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092013", "story_v_out_105092.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_105092", "105092013", "story_v_out_105092.awb")

						uv0:RecordAudio("105092013", slot13)
						uv0:RecordAudio("105092013", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092013", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092013", "story_v_out_105092.awb")
				end
	...
	Play105092014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105092014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105092014).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105092", "105092014", "story_v_out_105092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105092", "105092014", "story_v_out_105092.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105092", "105092014", "story_v_out_105092.awb")

						uv0:RecordAudio("105092014", slot10)
						uv0:RecordAudio("105092014", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105092", "105092014", "story_v_out_105092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105092", "105092014", "story_v_out_105092.awb")
				end
