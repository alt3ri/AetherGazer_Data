return {
	Play62101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_15 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 and arg_1_1.var_.characterEffect1111ui_story == nil then
			...
			if arg_1_1.time_ >= var_4_15 + var_4_16 and arg_1_1.time_ < var_4_15 + var_4_16 + arg_4_0 and arg_1_1.var_.characterEffect1111ui_story then
				arg_1_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if var_4_20 < arg_1_1.time_ and arg_1_1.time_ <= var_4_20 + arg_4_0 then
				...
				local var_4_23 = arg_1_1.bgs_.B06
			...
			local var_4_45 = 0.5
			local var_4_46 = 2.45666666666667
			...
			if var_4_49 < arg_1_1.time_ and arg_1_1.time_ <= var_4_49 + arg_4_0 then
				...
				local var_4_53 = arg_1_1:GetWordFromCfg(62101001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101001", "story_v_chess_62101.awb") ~= 0 then
					local var_4_58 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101001", "story_v_chess_62101.awb") / 1000
					...
					if var_4_53.prefab_name ~= "" and arg_1_1.actors_[var_4_53.prefab_name] ~= nil then
						local var_4_59 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_53.prefab_name].transform, "story_v_chess_62101", "62101001", "story_v_chess_62101.awb")

						arg_1_1:RecordAudio("62101001", var_4_59)
						arg_1_1:RecordAudio("62101001", var_4_59)
					else
	...
	Play62101002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				arg_7_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action2_2")
			end

			local var_10_1 = 0

			if var_10_1 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				arg_7_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1104cva")
			end
			...
			if var_10_2 < arg_7_1.time_ and arg_7_1.time_ <= var_10_2 + arg_10_0 then
				...
				local var_10_5 = arg_7_1:GetWordFromCfg(62101002)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101002", "story_v_chess_62101.awb") ~= 0 then
					local var_10_10 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101002", "story_v_chess_62101.awb") / 1000
					...
					if var_10_5.prefab_name ~= "" and arg_7_1.actors_[var_10_5.prefab_name] ~= nil then
						local var_10_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_7_1.actors_[var_10_5.prefab_name].transform, "story_v_chess_62101", "62101002", "story_v_chess_62101.awb")

						arg_7_1:RecordAudio("62101002", var_10_11)
						arg_7_1:RecordAudio("62101002", var_10_11)
					else
						arg_7_1:AudioAction("play", "voice", "story_v_chess_62101", "62101002", "story_v_chess_62101.awb")
					end

					arg_7_1:RecordHistoryTalkVoice("story_v_chess_62101", "62101002", "story_v_chess_62101.awb")
				end
	...
	Play62101003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play62101004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_6 < arg_11_1.time_ and arg_11_1.time_ <= var_14_6 + arg_14_0 then
				...
				local var_14_8 = arg_11_1:GetWordFromCfg(62101003)
	...
	Play62101004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 62101004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play62101005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_4 < arg_15_1.time_ and arg_15_1.time_ <= var_18_4 + arg_18_0 then
				arg_15_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action4_1")
			end
			...
			if var_18_6 < arg_15_1.time_ and arg_15_1.time_ <= var_18_6 + arg_18_0 then
				...
				local var_18_9 = arg_15_1:GetWordFromCfg(62101004)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101004", "story_v_chess_62101.awb") ~= 0 then
					local var_18_14 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101004", "story_v_chess_62101.awb") / 1000
					...
					if var_18_9.prefab_name ~= "" and arg_15_1.actors_[var_18_9.prefab_name] ~= nil then
						local var_18_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_15_1.actors_[var_18_9.prefab_name].transform, "story_v_chess_62101", "62101004", "story_v_chess_62101.awb")

						arg_15_1:RecordAudio("62101004", var_18_15)
						arg_15_1:RecordAudio("62101004", var_18_15)
					else
						arg_15_1:AudioAction("play", "voice", "story_v_chess_62101", "62101004", "story_v_chess_62101.awb")
					end

					arg_15_1:RecordHistoryTalkVoice("story_v_chess_62101", "62101004", "story_v_chess_62101.awb")
				end
	...
	Play62101005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 62101005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play62101006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_6 < arg_19_1.time_ and arg_19_1.time_ <= var_22_6 + arg_22_0 then
				...
				local var_22_9 = arg_19_1:GetWordFromCfg(62101005)
	...
	Play62101006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 62101006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play62101007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_4 < arg_23_1.time_ and arg_23_1.time_ <= var_26_4 + arg_26_0 then
				arg_23_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111actionlink/1111action442")
			end
			...
			if var_26_6 < arg_23_1.time_ and arg_23_1.time_ <= var_26_6 + arg_26_0 then
				...
				local var_26_9 = arg_23_1:GetWordFromCfg(62101006)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101006", "story_v_chess_62101.awb") ~= 0 then
					local var_26_14 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101006", "story_v_chess_62101.awb") / 1000
					...
					if var_26_9.prefab_name ~= "" and arg_23_1.actors_[var_26_9.prefab_name] ~= nil then
						local var_26_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_23_1.actors_[var_26_9.prefab_name].transform, "story_v_chess_62101", "62101006", "story_v_chess_62101.awb")

						arg_23_1:RecordAudio("62101006", var_26_15)
						arg_23_1:RecordAudio("62101006", var_26_15)
					else
						arg_23_1:AudioAction("play", "voice", "story_v_chess_62101", "62101006", "story_v_chess_62101.awb")
					end

					arg_23_1:RecordHistoryTalkVoice("story_v_chess_62101", "62101006", "story_v_chess_62101.awb")
				end
	...
	Play62101007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 62101007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play62101008(arg_27_1)
			end
		end
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_6 < arg_27_1.time_ and arg_27_1.time_ <= var_30_6 + arg_30_0 then
				...
				local var_30_9 = arg_27_1:GetWordFromCfg(62101007)
	...
	Play62101008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 62101008
		...
		function arg_31_1.playNext_(arg_33_0)
			if arg_33_0 == 1 then
				arg_31_0:Play62101009(arg_31_1)
			end
		end
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_4 < arg_31_1.time_ and arg_31_1.time_ <= var_34_4 + arg_34_0 then
				arg_31_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3104cva")
			end
			...
			if var_34_5 < arg_31_1.time_ and arg_31_1.time_ <= var_34_5 + arg_34_0 then
				...
				local var_34_8 = arg_31_1:GetWordFromCfg(62101008)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101008", "story_v_chess_62101.awb") ~= 0 then
					local var_34_13 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101008", "story_v_chess_62101.awb") / 1000
					...
					if var_34_8.prefab_name ~= "" and arg_31_1.actors_[var_34_8.prefab_name] ~= nil then
						local var_34_14 = LuaForUtil.PlayVoiceWithCriLipsync(arg_31_1.actors_[var_34_8.prefab_name].transform, "story_v_chess_62101", "62101008", "story_v_chess_62101.awb")

						arg_31_1:RecordAudio("62101008", var_34_14)
						arg_31_1:RecordAudio("62101008", var_34_14)
					else
						arg_31_1:AudioAction("play", "voice", "story_v_chess_62101", "62101008", "story_v_chess_62101.awb")
					end

					arg_31_1:RecordHistoryTalkVoice("story_v_chess_62101", "62101008", "story_v_chess_62101.awb")
				end
	...
	Play62101009 = function(arg_35_0, arg_35_1)
		arg_35_1.time_ = 0
		arg_35_1.frameCnt_ = 0
		arg_35_1.state_ = "playing"
		arg_35_1.curTalkId_ = 62101009
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_0 + arg_38_0 then
				arg_35_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action2_2")
			end

			local var_38_1 = 0

			if var_38_1 < arg_35_1.time_ and arg_35_1.time_ <= var_38_1 + arg_38_0 then
				arg_35_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3104cva")
			end
			...
			if var_38_2 < arg_35_1.time_ and arg_35_1.time_ <= var_38_2 + arg_38_0 then
				...
				local var_38_4 = arg_35_1:FormatText(StoryNameCfg[67].name)
				...
				local var_38_5 = arg_35_1:GetWordFromCfg(62101009)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62101", "62101009", "story_v_chess_62101.awb") ~= 0 then
					local var_38_10 = manager.audio:GetVoiceLength("story_v_chess_62101", "62101009", "story_v_chess_62101.awb") / 1000
					...
					if var_38_5.prefab_name ~= "" and arg_35_1.actors_[var_38_5.prefab_name] ~= nil then
						local var_38_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_35_1.actors_[var_38_5.prefab_name].transform, "story_v_chess_62101", "62101009", "story_v_chess_62101.awb")

						arg_35_1:RecordAudio("62101009", var_38_11)
						arg_35_1:RecordAudio("62101009", var_38_11)
					else
						arg_35_1:AudioAction("play", "voice", "story_v_chess_62101", "62101009", "story_v_chess_62101.awb")
					end

					arg_35_1:RecordHistoryTalkVoice("story_v_chess_62101", "62101009", "story_v_chess_62101.awb")
				end
