return {
	Play108091001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091001
		slot1.duration_ = 4.4
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play108091002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.C05a == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.C05a:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueC05a = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueC05a = slot6
				end

				uv0.var_.alphaOldValueC05a = 0
			end

			slot5 = 1.5

			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueC05a then
					slot8 = uv0.var_.alphaMatValueC05a
					slot9 = slot8:GetColor("_Color")
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueC05a, 1, (uv0.time_ - slot4) / slot5)

					slot8:SetColor("_Color", slot9)
				end
			end

			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 and uv0.var_.alphaMatValueC05a then
				slot6 = uv0.var_.alphaMatValueC05a
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(108091001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108091", "108091001", "story_v_out_108091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108091", "108091001", "story_v_out_108091.awb") / 1000 + slot21 then
						uv0.duration_ = slot30 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_108091", "108091001", "story_v_out_108091.awb")

						uv0:RecordAudio("108091001", slot31)
						uv0:RecordAudio("108091001", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108091", "108091001", "story_v_out_108091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108091", "108091001", "story_v_out_108091.awb")
				end
	...
	Play108091002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091002
		slot1.duration_ = 5.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(108091002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108091", "108091002", "story_v_out_108091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108091", "108091002", "story_v_out_108091.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_108091", "108091002", "story_v_out_108091.awb")

						uv0:RecordAudio("108091002", slot13)
						uv0:RecordAudio("108091002", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108091", "108091002", "story_v_out_108091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108091", "108091002", "story_v_out_108091.awb")
				end
	...
	Play108091003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(108091003).content)
	...
	Play108091004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(108091004).content)
				uv0.text_.text = slot4
	...
	Play108091005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(108091005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108091", "108091005", "story_v_out_108091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108091", "108091005", "story_v_out_108091.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_108091", "108091005", "story_v_out_108091.awb")

						uv0:RecordAudio("108091005", slot19)
						uv0:RecordAudio("108091005", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108091", "108091005", "story_v_out_108091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108091", "108091005", "story_v_out_108091.awb")
				end
	...
	Play108091006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(108091006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108091", "108091006", "story_v_out_108091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108091", "108091006", "story_v_out_108091.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_108091", "108091006", "story_v_out_108091.awb")

						uv0:RecordAudio("108091006", slot12)
						uv0:RecordAudio("108091006", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108091", "108091006", "story_v_out_108091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108091", "108091006", "story_v_out_108091.awb")
				end
	...
	Play108091007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(108091007).content)
				uv0.text_.text = slot8
	...
	Play108091008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_8", "se_story_8_fire03", "")
			end

			slot4 = 0.508333333333333

			if 0.366666666665667 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_8", "se_story_8_lastcharge_loop", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(108091008).content)
				uv0.text_.text = slot8
	...
	Play108091009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108091009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108091", "108091009", "story_v_out_108091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108091", "108091009", "story_v_out_108091.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108091", "108091009", "story_v_out_108091.awb")

						uv0:RecordAudio("108091009", slot10)
						uv0:RecordAudio("108091009", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108091", "108091009", "story_v_out_108091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108091", "108091009", "story_v_out_108091.awb")
				end
	...
	Play108091010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0:AudioAction("stop", "music", "se_story_8", "se_story_8_lastcharge_loop", "")
			end

			slot12 = 1

			if 0.466666666666667 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_8", "se_story_8_shuashua", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(108091010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108091", "108091010", "story_v_out_108091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108091", "108091010", "story_v_out_108091.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_108091", "108091010", "story_v_out_108091.awb")

						uv0:RecordAudio("108091010", slot22)
						uv0:RecordAudio("108091010", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108091", "108091010", "story_v_out_108091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108091", "108091010", "story_v_out_108091.awb")
				end
	...
	Play108091011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(108091011).content)
	...
	Play108091012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 108091012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("1038ui_story", "StoryTimeline/CharAction/1038/1038action/1038action7_2")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(108091012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108091", "108091012", "story_v_out_108091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108091", "108091012", "story_v_out_108091.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_108091", "108091012", "story_v_out_108091.awb")

						uv0:RecordAudio("108091012", slot18)
						uv0:RecordAudio("108091012", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108091", "108091012", "story_v_out_108091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108091", "108091012", "story_v_out_108091.awb")
				end
