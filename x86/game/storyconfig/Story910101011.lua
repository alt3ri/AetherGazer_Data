	...
	Play910101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_32 < arg_1_1.time_ and arg_1_1.time_ <= var_4_32 + arg_4_0 then
				...
				if var_4_33 then
					arg_1_1.var_.alphaOldValue1070 = var_4_33.alpha
					arg_1_1.var_.characterEffect1070 = var_4_33
				end
			...
			if var_4_32 <= arg_1_1.time_ and arg_1_1.time_ < var_4_32 + var_4_34 then
				...
				local var_4_36 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1070, 1, var_4_35)

				if arg_1_1.var_.characterEffect1070 then
					arg_1_1.var_.characterEffect1070.alpha = var_4_36
				end
			end

			if arg_1_1.time_ >= var_4_32 + var_4_34 and arg_1_1.time_ < var_4_32 + var_4_34 + arg_4_0 and arg_1_1.var_.characterEffect1070 then
			...
			if var_4_37 < arg_1_1.time_ and arg_1_1.time_ <= var_4_37 + arg_4_0 then
				...
				local var_4_40 = arg_1_1:FormatText(StoryNameCfg[318].name)
				...
				local var_4_41 = arg_1_1:GetWordFromCfg(910101001)
	...
	Play910101002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_7 < arg_7_1.time_ and arg_7_1.time_ <= var_10_7 + arg_10_0 then
				...
				local var_10_9 = arg_7_1:FormatText(StoryNameCfg[318].name)
				...
				local var_10_10 = arg_7_1:GetWordFromCfg(910101002)
	...
	Play910101003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_7 < arg_11_1.time_ and arg_11_1.time_ <= var_14_7 + arg_14_0 then
				...
				local var_14_9 = arg_11_1:FormatText(StoryNameCfg[318].name)
				...
				local var_14_10 = arg_11_1:GetWordFromCfg(910101003)
