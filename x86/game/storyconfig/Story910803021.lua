return {
	Play910820001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_41 < arg_1_1.time_ and arg_1_1.time_ <= var_4_41 + arg_4_0 then
				...
				local var_4_45 = arg_1_1:GetWordFromCfg(910820001)
	...
	Play910820002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_8 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 and arg_7_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_7_1.time_ >= var_10_8 + var_10_9 and arg_7_1.time_ < var_10_8 + var_10_9 + arg_10_0 and arg_7_1.var_.actorSpriteComps1111 then
				local var_10_12 = 1
			...
			if var_10_13 < arg_7_1.time_ and arg_7_1.time_ <= var_10_13 + arg_10_0 then
				...
				local var_10_15 = arg_7_1:FormatText(StoryNameCfg[67].name)
				...
				local var_10_16 = arg_7_1:GetWordFromCfg(910820002)
	...
	Play910820003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_6 < arg_11_1.time_ and arg_11_1.time_ <= var_14_6 + arg_14_0 then
				...
				local var_14_9 = arg_11_1:GetWordFromCfg(910820003)
	...
	Play910820004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_13 < arg_15_1.time_ and arg_15_1.time_ <= var_18_13 + arg_18_0 then
				...
				local var_18_16 = arg_15_1:GetWordFromCfg(910820004)
	...
	Play910820005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_6 < arg_19_1.time_ and arg_19_1.time_ <= var_22_6 + arg_22_0 then
				...
				local var_22_9 = arg_19_1:GetWordFromCfg(910820005)
	...
	Play910820006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_13 < arg_23_1.time_ and arg_23_1.time_ <= var_26_13 + arg_26_0 then
				...
				local var_26_16 = arg_23_1:GetWordFromCfg(910820006)
	...
	Play910820007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_6 < arg_27_1.time_ and arg_27_1.time_ <= var_30_6 + arg_30_0 then
				...
				local var_30_8 = arg_27_1:FormatText(StoryNameCfg[623].name)
				...
				local var_30_9 = arg_27_1:GetWordFromCfg(910820007)
	...
	Play910820008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_0 < arg_31_1.time_ and arg_31_1.time_ <= var_34_0 + arg_34_0 then
				...
				local var_34_3 = arg_31_1:GetWordFromCfg(910820008)
	...
	Play910820009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_0 + arg_38_0 then
				...
				local var_38_2 = arg_35_1:GetWordFromCfg(910820009)
	...
	Play910820010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_13 < arg_39_1.time_ and arg_39_1.time_ <= var_42_13 + arg_42_0 then
				...
				local var_42_16 = arg_39_1:GetWordFromCfg(910820010)
	...
	Play910820011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_8 < arg_43_1.time_ and arg_43_1.time_ <= var_46_8 + arg_46_0 and arg_43_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_43_1.time_ >= var_46_8 + var_46_9 and arg_43_1.time_ < var_46_8 + var_46_9 + arg_46_0 and arg_43_1.var_.actorSpriteComps1111 then
				local var_46_12 = 1
			...
			if var_46_13 < arg_43_1.time_ and arg_43_1.time_ <= var_46_13 + arg_46_0 then
				...
				local var_46_15 = arg_43_1:FormatText(StoryNameCfg[67].name)
				...
				local var_46_16 = arg_43_1:GetWordFromCfg(910820011)
	...
	Play910820012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_13 < arg_47_1.time_ and arg_47_1.time_ <= var_50_13 + arg_50_0 then
				...
				local var_50_16 = arg_47_1:GetWordFromCfg(910820012)
	...
	Play910820013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if var_54_8 < arg_51_1.time_ and arg_51_1.time_ <= var_54_8 + arg_54_0 and arg_51_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_51_1.time_ >= var_54_8 + var_54_9 and arg_51_1.time_ < var_54_8 + var_54_9 + arg_54_0 and arg_51_1.var_.actorSpriteComps1111 then
				local var_54_12 = 1
			...
			if var_54_13 < arg_51_1.time_ and arg_51_1.time_ <= var_54_13 + arg_54_0 then
				...
				local var_54_15 = arg_51_1:FormatText(StoryNameCfg[67].name)
				...
				local var_54_16 = arg_51_1:GetWordFromCfg(910820013)
	...
	Play910820014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if var_58_8 < arg_55_1.time_ and arg_55_1.time_ <= var_58_8 + arg_58_0 and arg_55_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_55_1.time_ >= var_58_8 + var_58_9 and arg_55_1.time_ < var_58_8 + var_58_9 + arg_58_0 and arg_55_1.var_.actorSpriteComps1111 then
				local var_58_12 = 1
			...
			if var_58_13 < arg_55_1.time_ and arg_55_1.time_ <= var_58_13 + arg_58_0 then
				...
				local var_58_15 = arg_55_1:FormatText(StoryNameCfg[67].name)
				...
				local var_58_16 = arg_55_1:GetWordFromCfg(910820014)
	...
	Play910820015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if var_62_1 < arg_59_1.time_ and arg_59_1.time_ <= var_62_1 + arg_62_0 and arg_59_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_59_1.time_ >= var_62_1 + var_62_2 and arg_59_1.time_ < var_62_1 + var_62_2 + arg_62_0 and arg_59_1.var_.actorSpriteComps1111 then
				local var_62_5 = 0.5
			...
			if var_62_6 < arg_59_1.time_ and arg_59_1.time_ <= var_62_6 + arg_62_0 then
				...
				local var_62_8 = arg_59_1:GetWordFromCfg(910820015)
	...
	Play910820016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if var_66_0 < arg_63_1.time_ and arg_63_1.time_ <= var_66_0 + arg_66_0 then
				...
				local var_66_2 = arg_63_1:FormatText(StoryNameCfg[623].name)
				...
				local var_66_3 = arg_63_1:GetWordFromCfg(910820016)
	...
	Play910820017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if var_70_0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_0 + arg_70_0 then
				...
				local var_70_3 = arg_67_1:GetWordFromCfg(910820017)
	...
	Play910820018 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if var_74_8 < arg_71_1.time_ and arg_71_1.time_ <= var_74_8 + arg_74_0 and arg_71_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_71_1.time_ >= var_74_8 + var_74_9 and arg_71_1.time_ < var_74_8 + var_74_9 + arg_74_0 and arg_71_1.var_.actorSpriteComps1111 then
				local var_74_12 = 1
			...
			if var_74_13 < arg_71_1.time_ and arg_71_1.time_ <= var_74_13 + arg_74_0 then
				...
				local var_74_15 = arg_71_1:FormatText(StoryNameCfg[67].name)
				...
				local var_74_16 = arg_71_1:GetWordFromCfg(910820018)
	...
	Play910820019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			...
			if var_78_1 < arg_75_1.time_ and arg_75_1.time_ <= var_78_1 + arg_78_0 and arg_75_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_75_1.time_ >= var_78_1 + var_78_2 and arg_75_1.time_ < var_78_1 + var_78_2 + arg_78_0 and arg_75_1.var_.actorSpriteComps1111 then
				local var_78_5 = 0.5
			...
			if var_78_6 < arg_75_1.time_ and arg_75_1.time_ <= var_78_6 + arg_78_0 then
				...
				local var_78_9 = arg_75_1:GetWordFromCfg(910820019)
	...
	Play910820020 = function(arg_79_0, arg_79_1)
		...
		function arg_79_1.onSingleLineUpdate_(arg_82_0)
			...
			if var_82_0 < arg_79_1.time_ and arg_79_1.time_ <= var_82_0 + arg_82_0 then
				...
				local var_82_2 = arg_79_1:GetWordFromCfg(910820020)
	...
	Play910820021 = function(arg_83_0, arg_83_1)
		...
		function arg_83_1.onSingleLineUpdate_(arg_86_0)
			...
			if var_86_0 < arg_83_1.time_ and arg_83_1.time_ <= var_86_0 + arg_86_0 then
				...
				local var_86_3 = arg_83_1:GetWordFromCfg(910820021)
	...
	Play910820022 = function(arg_87_0, arg_87_1)
		...
		function arg_87_1.onSingleLineUpdate_(arg_90_0)
			...
			if var_90_0 < arg_87_1.time_ and arg_87_1.time_ <= var_90_0 + arg_90_0 then
				...
				local var_90_3 = arg_87_1:GetWordFromCfg(910820022)
	...
	Play910820023 = function(arg_91_0, arg_91_1)
		...
		function arg_91_1.onSingleLineUpdate_(arg_94_0)
			...
			if var_94_13 < arg_91_1.time_ and arg_91_1.time_ <= var_94_13 + arg_94_0 then
				...
				local var_94_16 = arg_91_1:GetWordFromCfg(910820023)
	...
	Play910820024 = function(arg_95_0, arg_95_1)
		...
		function arg_95_1.onSingleLineUpdate_(arg_98_0)
			local var_98_0 = arg_95_1.actors_["1111"]
			local var_98_1 = 0

			if var_98_1 < arg_95_1.time_ and arg_95_1.time_ <= var_98_1 + arg_98_0 and arg_95_1.var_.actorSpriteComps1111 == nil then
				arg_95_1.var_.actorSpriteComps1111 = var_98_0:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_95_1.time_ >= var_98_1 + var_98_2 and arg_95_1.time_ < var_98_1 + var_98_2 + arg_98_0 and arg_95_1.var_.actorSpriteComps1111 then
				local var_98_5 = 0.5
			...
			if var_98_6 < arg_95_1.time_ and arg_95_1.time_ <= var_98_6 + arg_98_0 then
				...
				local var_98_8 = arg_95_1:FormatText(StoryNameCfg[623].name)
				...
				local var_98_9 = arg_95_1:GetWordFromCfg(910820024)
	...
	Play910820025 = function(arg_99_0, arg_99_1)
		...
		function arg_99_1.onSingleLineUpdate_(arg_102_0)
			...
			if var_102_0 < arg_99_1.time_ and arg_99_1.time_ <= var_102_0 + arg_102_0 then
				...
				local var_102_2 = arg_99_1:GetWordFromCfg(910820025)
	...
	Play910820026 = function(arg_103_0, arg_103_1)
		...
		function arg_103_1.onSingleLineUpdate_(arg_106_0)
			...
			if var_106_0 < arg_103_1.time_ and arg_103_1.time_ <= var_106_0 + arg_106_0 then
				...
				local var_106_2 = arg_103_1:GetWordFromCfg(910820026)
	...
	Play910820027 = function(arg_107_0, arg_107_1)
		...
		function arg_107_1.onSingleLineUpdate_(arg_110_0)
			...
			if var_110_0 < arg_107_1.time_ and arg_107_1.time_ <= var_110_0 + arg_110_0 then
				...
				local var_110_3 = arg_107_1:GetWordFromCfg(910820027)
	...
	Play910820028 = function(arg_111_0, arg_111_1)
		...
		function arg_111_1.onSingleLineUpdate_(arg_114_0)
			local var_114_0 = arg_111_1.actors_["1111"].transform
			local var_114_1 = 0

			if var_114_1 < arg_111_1.time_ and arg_111_1.time_ <= var_114_1 + arg_114_0 then
				arg_111_1.var_.moveOldPos1111 = var_114_0.localPosition
			...
			if var_114_1 <= arg_111_1.time_ and arg_111_1.time_ < var_114_1 + var_114_4 then
				...
				local var_114_6 = Vector3.New(-100, -290, -350)

				var_114_0.localPosition = Vector3.Lerp(arg_111_1.var_.moveOldPos1111, var_114_6, var_114_5)
			end

			if arg_111_1.time_ >= var_114_1 + var_114_4 and arg_111_1.time_ < var_114_1 + var_114_4 + arg_114_0 then
				var_114_0.localPosition = Vector3.New(-100, -290, -350)
			end

			local var_114_7 = arg_111_1.actors_["1111"]
			local var_114_8 = 0

			if var_114_8 < arg_111_1.time_ and arg_111_1.time_ <= var_114_8 + arg_114_0 and arg_111_1.var_.actorSpriteComps1111 == nil then
				arg_111_1.var_.actorSpriteComps1111 = var_114_7:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_111_1.time_ >= var_114_8 + var_114_9 and arg_111_1.time_ < var_114_8 + var_114_9 + arg_114_0 and arg_111_1.var_.actorSpriteComps1111 then
				local var_114_12 = 1
			...
			if var_114_17 < arg_111_1.time_ and arg_111_1.time_ <= var_114_17 + arg_114_0 then
				...
				local var_114_19 = arg_111_1:FormatText(StoryNameCfg[67].name)
				...
				local var_114_20 = arg_111_1:GetWordFromCfg(910820028)
