return {
	Play101031001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031001
		slot1.duration_ = 7.69933333333333
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if uv0.bgs_.B10a:GetComponent("SpriteRenderer") then
					slot10.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot11 = slot10.material
					uv0.var_.alphaOldValueB10a = slot11:GetColor("_Color").a
					uv0.var_.alphaMatValueB10a = slot11
				end

				uv0.var_.alphaOldValueB10a = 0
			end

			slot10 = 1.5

			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				if uv0.var_.alphaMatValueB10a then
					slot13 = uv0.var_.alphaMatValueB10a
					slot14 = slot13:GetColor("_Color")
					slot14.a = Mathf.Lerp(uv0.var_.alphaOldValueB10a, 1, (uv0.time_ - slot9) / slot10)

					slot13:SetColor("_Color", slot14)
				end
			end

			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.alphaMatValueB10a then
				slot11 = uv0.var_.alphaMatValueB10a
			...
			if 0.833333333333333 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1035ui_story, Vector3.New(0, -1.05, -5.6), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -1.05, -5.6)
			...
			if 0.833333333333333 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
			...
			if 0.833333333333333 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(101031001).content)
				uv0.text_.text = slot22

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (20 <= 0 and slot18 or slot18 * utf8.len(slot22) / slot23) > 0 and slot18 < slot25 then
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031001", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031001", "story_v_out_101031.awb") / 1000 + slot17 then
						uv0.duration_ = slot26 + slot17
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_101031", "101031001", "story_v_out_101031.awb")

						uv0:RecordAudio("101031001", slot27)
						uv0:RecordAudio("101031001", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031001", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031001", "story_v_out_101031.awb")
				end
	...
	Play101031002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031002
		slot1.duration_ = 7.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if uv0.actors_["2044_tpose"] == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 and uv0.var_.characterEffect2044_tpose == nil then
				uv0.var_.characterEffect2044_tpose = uv0.actors_["2044_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				...
				if uv0.var_.characterEffect2044_tpose then
					uv0.var_.characterEffect2044_tpose.fillFlat = false
				end
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.characterEffect2044_tpose then
				uv0.var_.characterEffect2044_tpose.fillFlat = false
			end

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos2044_tpose = uv0.actors_["2044_tpose"].transform.localPosition
			end

			slot9 = 0.001

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2044_tpose, Vector3.New(0, -1.15, -2.3), (uv0.time_ - slot8) / slot9)
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -1.15, -2.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0:PlayTimeline("2044_tpose", "StoryTimeline/CharAction/story2044/story2044action/2044action1_1")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(101031002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031002", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031002", "story_v_out_101031.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_101031", "101031002", "story_v_out_101031.awb")

						uv0:RecordAudio("101031002", slot23)
						uv0:RecordAudio("101031002", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031002", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031002", "story_v_out_101031.awb")
				end
	...
	Play101031003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031003
		slot1.duration_ = 8.2
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play101031004(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.characterEffect2044_tpose == nil then
				uv0.var_.characterEffect2044_tpose = uv0.actors_["2044_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				if uv0.var_.characterEffect2044_tpose then
					uv0.var_.characterEffect2044_tpose.fillFlat = true
					uv0.var_.characterEffect2044_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot2) / slot3)
				end
			end

			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 and uv0.var_.characterEffect2044_tpose then
				uv0.var_.characterEffect2044_tpose.fillFlat = true
				uv0.var_.characterEffect2044_tpose.fillRatio = 0.5
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2044_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot5) / slot6)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1035ui_story, Vector3.New(0, -1.05, -5.6), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -1.05, -5.6)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0:PlayTimeline("1035ui_story", "StoryTimeline/CharAction/1035/1035action/1035action5_1")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(101031003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031003", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031003", "story_v_out_101031.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_101031", "101031003", "story_v_out_101031.awb")

						uv0:RecordAudio("101031003", slot20)
						uv0:RecordAudio("101031003", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031003", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031003", "story_v_out_101031.awb")
				end
	...
	Play101031004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1035ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(101031004).content)
	...
	Play101031005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(-0.7, -1.51, -4.3), (uv0.time_ - slot6) / slot7)
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(-0.7, -1.51, -4.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(101031005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031005", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031005", "story_v_out_101031.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_101031", "101031005", "story_v_out_101031.awb")

						uv0:RecordAudio("101031005", slot19)
						uv0:RecordAudio("101031005", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031005", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031005", "story_v_out_101031.awb")
				end
	...
	Play101031006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031006
		slot1.duration_ = 2.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1035ui_story, Vector3.New(0.7, -1.05, -5.6), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(0.7, -1.05, -5.6)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0:PlayTimeline("1035ui_story", "StoryTimeline/CharAction/1035/1035action/1035action3_2")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(101031006).content)
				uv0.text_.text = slot18
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031006", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031006", "story_v_out_101031.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_101031", "101031006", "story_v_out_101031.awb")

						uv0:RecordAudio("101031006", slot23)
						uv0:RecordAudio("101031006", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031006", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031006", "story_v_out_101031.awb")
				end
	...
	Play101031007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.characterEffect1035ui_story then
					...
					uv0.var_.characterEffect1035ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot5) / slot6)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101031007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031007", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031007", "story_v_out_101031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101031", "101031007", "story_v_out_101031.awb")

						uv0:RecordAudio("101031007", slot18)
						uv0:RecordAudio("101031007", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031007", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031007", "story_v_out_101031.awb")
				end
	...
	Play101031008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(101031008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031008", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031008", "story_v_out_101031.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_101031", "101031008", "story_v_out_101031.awb")

						uv0:RecordAudio("101031008", slot11)
						uv0:RecordAudio("101031008", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031008", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031008", "story_v_out_101031.awb")
				end
	...
	Play101031009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(101031009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031009", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031009", "story_v_out_101031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_101031", "101031009", "story_v_out_101031.awb")

						uv0:RecordAudio("101031009", slot17)
						uv0:RecordAudio("101031009", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031009", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031009", "story_v_out_101031.awb")
				end
	...
	Play101031010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(101031010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031010", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031010", "story_v_out_101031.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_101031", "101031010", "story_v_out_101031.awb")

						uv0:RecordAudio("101031010", slot24)
						uv0:RecordAudio("101031010", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031010", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031010", "story_v_out_101031.awb")
				end
	...
	Play101031011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(101031011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031011", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031011", "story_v_out_101031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_101031", "101031011", "story_v_out_101031.awb")

						uv0:RecordAudio("101031011", slot10)
						uv0:RecordAudio("101031011", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031011", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031011", "story_v_out_101031.awb")
				end
	...
	Play101031012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031012
		slot1.duration_ = 6.266
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101031012).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031012", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031012", "story_v_out_101031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101031", "101031012", "story_v_out_101031.awb")

						uv0:RecordAudio("101031012", slot18)
						uv0:RecordAudio("101031012", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031012", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031012", "story_v_out_101031.awb")
				end
	...
	Play101031013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(101031013).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031013", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031013", "story_v_out_101031.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_101031", "101031013", "story_v_out_101031.awb")

						uv0:RecordAudio("101031013", slot16)
						uv0:RecordAudio("101031013", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031013", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031013", "story_v_out_101031.awb")
				end
	...
	Play101031014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("3008ui_story", "StoryTimeline/CharAction/3008/3008action/3008action6_2")
			end

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("3008ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3202cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101031014).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031014", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031014", "story_v_out_101031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101031", "101031014", "story_v_out_101031.awb")

						uv0:RecordAudio("101031014", slot18)
						uv0:RecordAudio("101031014", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031014", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031014", "story_v_out_101031.awb")
				end
	...
	Play101031015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031015
		slot1.duration_ = 9.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(101031015).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031015", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031015", "story_v_out_101031.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_101031", "101031015", "story_v_out_101031.awb")

						uv0:RecordAudio("101031015", slot16)
						uv0:RecordAudio("101031015", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031015", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031015", "story_v_out_101031.awb")
				end
	...
	Play101031016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101031016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101031016).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101031", "101031016", "story_v_out_101031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101031", "101031016", "story_v_out_101031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101031", "101031016", "story_v_out_101031.awb")

						uv0:RecordAudio("101031016", slot18)
						uv0:RecordAudio("101031016", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101031", "101031016", "story_v_out_101031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101031", "101031016", "story_v_out_101031.awb")
				end
