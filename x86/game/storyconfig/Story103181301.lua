return {
	Play318131001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.26666666666667 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:AudioAction("play", "music", "bgm_activity_2_10_ui", "bgm_activity_2_10_ui", "bgm_activity_2_10_ui.awb")
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(318131001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131001", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131001", "story_v_out_318131.awb") / 1000 + slot9 then
						uv0.duration_ = slot18 + slot9
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_318131", "318131001", "story_v_out_318131.awb")

						uv0:RecordAudio("318131001", slot19)
						uv0:RecordAudio("318131001", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131001", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131001", "story_v_out_318131.awb")
				end
	...
	Play318131002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318131002).content)
	...
	Play318131003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318131003).content)
				uv0.text_.text = slot4
	...
	Play318131004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(318131004).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131004", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131004", "story_v_out_318131.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_318131", "318131004", "story_v_out_318131.awb")

						uv0:RecordAudio("318131004", slot19)
						uv0:RecordAudio("318131004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131004", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131004", "story_v_out_318131.awb")
				end
	...
	Play318131005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(318131005).content)
	...
	Play318131006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318131006).content)
				uv0.text_.text = slot4
	...
	Play318131007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131007
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0:ShowWeapon(uv0.var_["1150ui_story" .. "Animator"].transform, false)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318131007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131007", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131007", "story_v_out_318131.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_318131", "318131007", "story_v_out_318131.awb")

						uv0:RecordAudio("318131007", slot16)
						uv0:RecordAudio("318131007", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131007", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131007", "story_v_out_318131.awb")
				end
	...
	Play318131008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:PlayTimeline("1150ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0201cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(318131008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131008", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131008", "story_v_out_318131.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_318131", "318131008", "story_v_out_318131.awb")

						uv0:RecordAudio("318131008", slot14)
						uv0:RecordAudio("318131008", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131008", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131008", "story_v_out_318131.awb")
				end
	...
	Play318131009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131009
		slot1.duration_ = 9.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(318131009).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131009", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131009", "story_v_out_318131.awb") / 1000 + slot4 then
						uv0.duration_ = slot11 + slot4
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_318131", "318131009", "story_v_out_318131.awb")

						uv0:RecordAudio("318131009", slot12)
						uv0:RecordAudio("318131009", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131009", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131009", "story_v_out_318131.awb")
				end
	...
	Play318131010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318131010).content)
				uv0.text_.text = slot4
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131010", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131010", "story_v_out_318131.awb") / 1000 + slot1 then
						uv0.duration_ = slot8 + slot1
					end

					if slot3.prefab_name ~= "" and uv0.actors_[slot3.prefab_name] ~= nil then
						slot9 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot3.prefab_name].transform, "story_v_out_318131", "318131010", "story_v_out_318131.awb")

						uv0:RecordAudio("318131010", slot9)
						uv0:RecordAudio("318131010", slot9)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131010", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131010", "story_v_out_318131.awb")
				end
	...
	Play318131011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1199ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot7) / slot8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(318131011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131011", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131011", "story_v_out_318131.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_318131", "318131011", "story_v_out_318131.awb")

						uv0:RecordAudio("318131011", slot21)
						uv0:RecordAudio("318131011", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131011", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131011", "story_v_out_318131.awb")
				end
	...
	Play318131012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131012
		slot1.duration_ = 5.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0:AudioAction("play", "music", "se_story_122_03", "se_story_122_03_swordlight", "")
			end
			...
			if 0.6 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(318131012).content)
	...
	Play318131013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_swordhit01", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(318131013).content)
	...
	Play318131014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131014
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318131014).content)
				uv0.text_.text = slot4
	...
	Play318131015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131015
		slot1.duration_ = 9.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(318131015).content)
				uv0.text_.text = slot14

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (20 <= 0 and slot10 or slot10 * utf8.len(slot14) / slot15) > 0 and slot10 < slot17 then
					uv0.talkMaxDuration = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131015", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131015", "story_v_out_318131.awb") / 1000 + slot9 then
						uv0.duration_ = slot18 + slot9
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_318131", "318131015", "story_v_out_318131.awb")

						uv0:RecordAudio("318131015", slot19)
						uv0:RecordAudio("318131015", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131015", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131015", "story_v_out_318131.awb")
				end
	...
	Play318131016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131016
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play318131017(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.LX0106 == nil then
				slot2 = Object.Instantiate(uv0.paintGo_)
				slot2:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. slot1)
				slot2.name = slot1
				slot2.transform.parent = uv0.stage_.transform
			...
			if 2 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPosLX0106 = uv0.bgs_.LX0106.transform.localPosition
			end

			slot14 = 4

			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPosLX0106, Vector3.New(0, 1, 9.5), (uv0.time_ - slot13) / slot14)
			end

			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(0, 1, 9.5)
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(318131016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131016", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131016", "story_v_out_318131.awb") / 1000 + slot17 then
						uv0.duration_ = slot26 + slot17
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_318131", "318131016", "story_v_out_318131.awb")

						uv0:RecordAudio("318131016", slot27)
						uv0:RecordAudio("318131016", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131016", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131016", "story_v_out_318131.awb")
				end
	...
	Play318131017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_120_00", "se_story_120_00_sword01", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(318131017).content)
				uv0.text_.text = slot6
	...
	Play318131018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318131018).content)
				uv0.text_.text = slot4
	...
	Play318131019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318131019).content)
				uv0.text_.text = slot11
	...
	Play318131020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318131020).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131020", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131020", "story_v_out_318131.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318131", "318131020", "story_v_out_318131.awb")

						uv0:RecordAudio("318131020", slot10)
						uv0:RecordAudio("318131020", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131020", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131020", "story_v_out_318131.awb")
				end
	...
	Play318131021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131021
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318131021).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131021", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131021", "story_v_out_318131.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318131", "318131021", "story_v_out_318131.awb")

						uv0:RecordAudio("318131021", slot10)
						uv0:RecordAudio("318131021", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131021", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131021", "story_v_out_318131.awb")
				end
	...
	Play318131022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318131022).content)
				uv0.text_.text = slot4
	...
	Play318131023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(318131023).content)
				uv0.text_.text = slot6
	...
	Play318131024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131024
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318131024).content)
				uv0.text_.text = slot4
	...
	Play318131025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318131025
		slot1.duration_ = 6.099999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPosLX0106, Vector3.New(-2, 0, 3), (uv0.time_ - slot6) / slot7)
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(-2, 0, 3)
			end

			if 0.516666666666667 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPosLX0106 = uv0.bgs_.LX0106.transform.localPosition
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPosLX0106, Vector3.New(-2, -0.3, 3), (uv0.time_ - slot9) / slot10)
			end

			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(-2, -0.3, 3)
			end

			if 0.999999999999 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.allBtn_.enabled = false
			end

			if uv0.time_ >= slot11 + 2.51666666666767 and uv0.time_ < slot11 + slot12 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 0.999999999999 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(318131025).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318131", "318131025", "story_v_out_318131.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318131", "318131025", "story_v_out_318131.awb") / 1000 + slot13 then
						uv0.duration_ = slot22 + slot13
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_318131", "318131025", "story_v_out_318131.awb")

						uv0:RecordAudio("318131025", slot23)
						uv0:RecordAudio("318131025", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318131", "318131025", "story_v_out_318131.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318131", "318131025", "story_v_out_318131.awb")
				end
