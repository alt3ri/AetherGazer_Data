return {
	Play102031001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.B03b:GetComponent("SpriteRenderer") then
					slot6.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot7 = slot6.material
					uv0.var_.alphaOldValueB03b = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueB03b = slot7
				end

				uv0.var_.alphaOldValueB03b = 0
			end

			slot6 = 1.5

			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueB03b then
					slot9 = uv0.var_.alphaMatValueB03b
					slot10 = slot9:GetColor("_Color")
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueB03b, 1, (uv0.time_ - slot5) / slot6)

					slot9:SetColor("_Color", slot10)
				end
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.alphaMatValueB03b then
				slot7 = uv0.var_.alphaMatValueB03b
			...
			if 1.16666666666667 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0:AudioAction("play", "music", "bgm_story_scheme", "bgm_story_scheme", "bgm_story_scheme")
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(102031001).content)
	...
	Play102031002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos4010ui_story, Vector3.New(0, -1.59, -5.2), (uv0.time_ - slot6) / slot7)
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(0, -1.59, -5.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(102031002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031002", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031002", "story_v_out_102031.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_102031", "102031002", "story_v_out_102031.awb")

						uv0:RecordAudio("102031002", slot19)
						uv0:RecordAudio("102031002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031002", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031002", "story_v_out_102031.awb")
				end
	...
	Play102031003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102031003).content)
	...
	Play102031004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031004
		slot1.duration_ = 6.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if uv0.time_ >= slot4 + 0.366666666666667 and uv0.time_ < slot4 + slot5 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 1.1 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(102031004).content)
	...
	Play102031005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("4010ui_story", "StoryTimeline/CharAction/story4010/story4010action/4010action3_1")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102031005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031005", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031005", "story_v_out_102031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102031", "102031005", "story_v_out_102031.awb")

						uv0:RecordAudio("102031005", slot18)
						uv0:RecordAudio("102031005", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031005", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031005", "story_v_out_102031.awb")
				end
	...
	Play102031006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.characterEffect3009ui_story then
					...
					uv0.var_.characterEffect3009ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot3) / slot4)
				end
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0, -1.75, -4.8), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, -1.75, -4.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0:PlayTimeline("3009ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3101cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102031006).content)
	...
	Play102031007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(102031007).content)
	...
	Play102031008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(102031008).content)
				uv0.text_.text = slot4
	...
	Play102031009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031009
		slot1.duration_ = 3.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0.7, -1.75, -4.8), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(0.7, -1.75, -4.8)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102031009).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031009", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031009", "story_v_out_102031.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102031", "102031009", "story_v_out_102031.awb")

						uv0:RecordAudio("102031009", slot21)
						uv0:RecordAudio("102031009", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031009", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031009", "story_v_out_102031.awb")
				end
	...
	Play102031010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:PlayTimeline("3009ui_story", "StoryTimeline/CharAction/story3009/3009action/3009action2_2")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(102031010).content)
	...
	Play102031011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031011
		slot1.duration_ = 4.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(102031011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031011", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031011", "story_v_out_102031.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_102031", "102031011", "story_v_out_102031.awb")

						uv0:RecordAudio("102031011", slot14)
						uv0:RecordAudio("102031011", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031011", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031011", "story_v_out_102031.awb")
				end
	...
	Play102031012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102031012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031012", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031012", "story_v_out_102031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102031", "102031012", "story_v_out_102031.awb")

						uv0:RecordAudio("102031012", slot17)
						uv0:RecordAudio("102031012", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031012", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031012", "story_v_out_102031.awb")
				end
	...
	Play102031013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031013
		slot1.duration_ = 8.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102031013).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031013", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031013", "story_v_out_102031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102031", "102031013", "story_v_out_102031.awb")

						uv0:RecordAudio("102031013", slot17)
						uv0:RecordAudio("102031013", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031013", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031013", "story_v_out_102031.awb")
				end
	...
	Play102031014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031014
		slot1.duration_ = 5.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102031014).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031014", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031014", "story_v_out_102031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102031", "102031014", "story_v_out_102031.awb")

						uv0:RecordAudio("102031014", slot17)
						uv0:RecordAudio("102031014", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031014", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031014", "story_v_out_102031.awb")
				end
	...
	Play102031015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:PlayTimeline("4010ui_story", "StoryTimeline/CharAction/story4010/story4010actionlink/4010action424")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(102031015).content)
				uv0.text_.text = slot9
	...
	Play102031016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(102031016).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031016", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031016", "story_v_out_102031.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_102031", "102031016", "story_v_out_102031.awb")

						uv0:RecordAudio("102031016", slot14)
						uv0:RecordAudio("102031016", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031016", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031016", "story_v_out_102031.awb")
				end
	...
	Play102031017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("3009ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3204cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102031017).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031017", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031017", "story_v_out_102031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102031", "102031017", "story_v_out_102031.awb")

						uv0:RecordAudio("102031017", slot17)
						uv0:RecordAudio("102031017", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031017", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031017", "story_v_out_102031.awb")
				end
	...
	Play102031018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("4010ui_story", "StoryTimeline/CharAction/story4010/story4010actionlink/4010action443")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102031018).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031018", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031018", "story_v_out_102031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102031", "102031018", "story_v_out_102031.awb")

						uv0:RecordAudio("102031018", slot18)
						uv0:RecordAudio("102031018", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031018", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031018", "story_v_out_102031.awb")
				end
	...
	Play102031019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031019
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102031019).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031019", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031019", "story_v_out_102031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102031", "102031019", "story_v_out_102031.awb")

						uv0:RecordAudio("102031019", slot18)
						uv0:RecordAudio("102031019", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031019", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031019", "story_v_out_102031.awb")
				end
	...
	Play102031020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("4010ui_story", "StoryTimeline/CharAction/story4010/story4010action/4010action3_2")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102031020).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031020", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031020", "story_v_out_102031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102031", "102031020", "story_v_out_102031.awb")

						uv0:RecordAudio("102031020", slot18)
						uv0:RecordAudio("102031020", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031020", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031020", "story_v_out_102031.awb")
				end
	...
	Play102031021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102031021).content)
				uv0.text_.text = slot7
	...
	Play102031022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031022
		slot1.duration_ = 9
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play102031023(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.S0204 == nil then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				for slot10, slot11 in pairs(uv0.bgs_) do
					if slot10 ~= "S0204" then
						slot11.transform.localPosition = Vector3.New(0, 100, 0)
					end
				end
			end

			if 1.967 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0.var_.moveOldPos4010ui_story = uv0.actors_["4010ui_story"].transform.localPosition
			end
			...
			if 1.967 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0.var_.moveOldPos3009ui_story = uv0.actors_["3009ui_story"].transform.localPosition
			end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot7) / slot8)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102031022).content)
	...
	Play102031023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031023
		slot1.duration_ = 7.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102031023).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031023", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031023", "story_v_out_102031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102031", "102031023", "story_v_out_102031.awb")

						uv0:RecordAudio("102031023", slot10)
						uv0:RecordAudio("102031023", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031023", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031023", "story_v_out_102031.awb")
				end
	...
	Play102031024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102031024).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031024", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031024", "story_v_out_102031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102031", "102031024", "story_v_out_102031.awb")

						uv0:RecordAudio("102031024", slot10)
						uv0:RecordAudio("102031024", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031024", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031024", "story_v_out_102031.awb")
				end
	...
	Play102031025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031025
		slot1.duration_ = 6.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_3009")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102031025).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031025", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031025", "story_v_out_102031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102031", "102031025", "story_v_out_102031.awb")

						uv0:RecordAudio("102031025", slot10)
						uv0:RecordAudio("102031025", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031025", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031025", "story_v_out_102031.awb")
				end
	...
	Play102031026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031026
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102031026).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031026", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031026", "story_v_out_102031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102031", "102031026", "story_v_out_102031.awb")

						uv0:RecordAudio("102031026", slot10)
						uv0:RecordAudio("102031026", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031026", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031026", "story_v_out_102031.awb")
				end
	...
	Play102031027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031027
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102031027).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031027", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031027", "story_v_out_102031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102031", "102031027", "story_v_out_102031.awb")

						uv0:RecordAudio("102031027", slot10)
						uv0:RecordAudio("102031027", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031027", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031027", "story_v_out_102031.awb")
				end
	...
	Play102031028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031028
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(102031028).content)
				uv0.text_.text = slot10
	...
	Play102031029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102031029
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102031029).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102031", "102031029", "story_v_out_102031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102031", "102031029", "story_v_out_102031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102031", "102031029", "story_v_out_102031.awb")

						uv0:RecordAudio("102031029", slot18)
						uv0:RecordAudio("102031029", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102031", "102031029", "story_v_out_102031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102031", "102031029", "story_v_out_102031.awb")
				end
