return {
	Play116271001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116271001).content)
	...
	Play116271002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116271002).content)
	...
	Play116271003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271003
		slot1.duration_ = 8.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116271003).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271003", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271003", "story_v_out_116271.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116271", "116271003", "story_v_out_116271.awb")

						uv0:RecordAudio("116271003", slot10)
						uv0:RecordAudio("116271003", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271003", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271003", "story_v_out_116271.awb")
				end
	...
	Play116271004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116271004).content)
				uv0.text_.text = slot5
	...
	Play116271005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116271005).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271005", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271005", "story_v_out_116271.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116271", "116271005", "story_v_out_116271.awb")

						uv0:RecordAudio("116271005", slot10)
						uv0:RecordAudio("116271005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271005", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271005", "story_v_out_116271.awb")
				end
	...
	Play116271006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116271006).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271006", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271006", "story_v_out_116271.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116271", "116271006", "story_v_out_116271.awb")

						uv0:RecordAudio("116271006", slot10)
						uv0:RecordAudio("116271006", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271006", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271006", "story_v_out_116271.awb")
				end
	...
	Play116271007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271007).content)
	...
	Play116271008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271008).content)
				uv0.text_.text = slot4
	...
	Play116271009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271009
		slot1.duration_ = 2.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116271009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271009", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271009", "story_v_out_116271.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116271", "116271009", "story_v_out_116271.awb")

						uv0:RecordAudio("116271009", slot19)
						uv0:RecordAudio("116271009", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271009", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271009", "story_v_out_116271.awb")
				end
	...
	Play116271010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116271010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271010", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271010", "story_v_out_116271.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116271", "116271010", "story_v_out_116271.awb")

						uv0:RecordAudio("116271010", slot11)
						uv0:RecordAudio("116271010", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271010", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271010", "story_v_out_116271.awb")
				end
	...
	Play116271011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116271011).content)
	...
	Play116271012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116271012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271012", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271012", "story_v_out_116271.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116271", "116271012", "story_v_out_116271.awb")

						uv0:RecordAudio("116271012", slot15)
						uv0:RecordAudio("116271012", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271012", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271012", "story_v_out_116271.awb")
				end
	...
	Play116271013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271013
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[267].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play116271014(uv1)
			end
		end
	...
	Play116271014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271014
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot5 = 0.566666666666667

			if 0.258333333333333 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_16", "se_story_16_gun02", "")
			end

			if 0.258333333333333 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
			...
			if uv0.time_ >= slot9 + 0.858333333333333 and uv0.time_ < slot9 + slot10 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116271014).content)
				uv0.text_.text = slot14

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (33 <= 0 and slot12 or slot12 * utf8.len(slot14) / slot15) > 0 and slot12 < slot17 then
					uv0.talkMaxDuration = slot17
	...
	Play116271015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116271015).content)
				uv0.text_.text = slot6
	...
	Play116271016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116271016).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271016", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271016", "story_v_out_116271.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116271", "116271016", "story_v_out_116271.awb")

						uv0:RecordAudio("116271016", slot10)
						uv0:RecordAudio("116271016", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271016", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271016", "story_v_out_116271.awb")
				end
	...
	Play116271017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116271017).content)
				uv0.text_.text = slot8
	...
	Play116271018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116271018).content)
	...
	Play116271019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271019).content)
				uv0.text_.text = slot4
	...
	Play116271020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271020).content)
				uv0.text_.text = slot4
	...
	Play116271021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271021).content)
				uv0.text_.text = slot4
	...
	Play116271022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271022).content)
				uv0.text_.text = slot4
	...
	Play116271023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_16", "se_story_16_gun03", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116271023).content)
				uv0.text_.text = slot6
	...
	Play116271024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271024
		slot1.duration_ = 9
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play116271025(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.SK0101 == nil then
				slot2 = Object.Instantiate(uv0.paintGo_)
				slot2:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. slot1)
				slot2.name = slot1
				slot2.transform.parent = uv0.stage_.transform
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosSK0101 = uv0.bgs_.SK0101.transform.localPosition
			end

			slot9 = 2.5

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPosSK0101, Vector3.New(0, 1, 9.5), (uv0.time_ - slot8) / slot9)
			end
			...
			if uv0.time_ >= slot10 + 0.499999999999 and uv0.time_ < slot10 + slot11 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(116271024).content)
	...
	Play116271025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271025
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271025).content)
				uv0.text_.text = slot4
	...
	Play116271026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271026
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271026).content)
				uv0.text_.text = slot4
	...
	Play116271027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271027
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116271027).content)
				uv0.text_.text = slot5
	...
	Play116271028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271028
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116271028).content)
				uv0.text_.text = slot4
	...
	Play116271029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271029
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot13 + slot0 and uv0.var_.characterEffect2078ui_story == nil then
			...
			if 4 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(116271029).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271029", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271029", "story_v_out_116271.awb") / 1000 + slot15 then
						uv0.duration_ = slot24 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_116271", "116271029", "story_v_out_116271.awb")

						uv0:RecordAudio("116271029", slot25)
						uv0:RecordAudio("116271029", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271029", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271029", "story_v_out_116271.awb")
				end
	...
	Play116271030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271030
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(116271030).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271030", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271030", "story_v_out_116271.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_116271", "116271030", "story_v_out_116271.awb")

						uv0:RecordAudio("116271030", slot21)
						uv0:RecordAudio("116271030", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271030", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271030", "story_v_out_116271.awb")
				end
	...
	Play116271031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271031
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116271031).content)
				uv0.text_.text = slot8
	...
	Play116271032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271032
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116271032).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271032", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271032", "story_v_out_116271.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116271", "116271032", "story_v_out_116271.awb")

						uv0:RecordAudio("116271032", slot13)
						uv0:RecordAudio("116271032", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271032", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271032", "story_v_out_116271.awb")
				end
	...
	Play116271033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271033
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(116271033).content)
	...
	Play116271034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271034
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116271034).content)
				uv0.text_.text = slot8
	...
	Play116271035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271035
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect2079ui_story == nil then
				uv0.var_.characterEffect2079ui_story = uv0.actors_["2079ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(116271035).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271035", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271035", "story_v_out_116271.awb") / 1000 + slot13 then
						uv0.duration_ = slot22 + slot13
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_116271", "116271035", "story_v_out_116271.awb")

						uv0:RecordAudio("116271035", slot23)
						uv0:RecordAudio("116271035", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271035", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271035", "story_v_out_116271.awb")
				end
	...
	Play116271036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271036
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(116271036).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271036", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271036", "story_v_out_116271.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_116271", "116271036", "story_v_out_116271.awb")

						uv0:RecordAudio("116271036", slot20)
						uv0:RecordAudio("116271036", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271036", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271036", "story_v_out_116271.awb")
				end
	...
	Play116271037 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271037
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(116271037).content)
				uv0.text_.text = slot11
	...
	Play116271038 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271038
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116271038).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271038", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271038", "story_v_out_116271.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116271", "116271038", "story_v_out_116271.awb")

						uv0:RecordAudio("116271038", slot19)
						uv0:RecordAudio("116271038", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271038", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271038", "story_v_out_116271.awb")
				end
	...
	Play116271039 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271039
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116271039).content)
				uv0.text_.text = slot8
	...
	Play116271040 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271040
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_16", "se_story_16_bullet", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116271040).content)
				uv0.text_.text = slot14
	...
	Play116271041 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271041
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116271041).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271041", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271041", "story_v_out_116271.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116271", "116271041", "story_v_out_116271.awb")

						uv0:RecordAudio("116271041", slot10)
						uv0:RecordAudio("116271041", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271041", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271041", "story_v_out_116271.awb")
				end
	...
	Play116271042 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116271042
		slot1.duration_ = 8.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116271042).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_116271", "116271042", "story_v_out_116271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116271", "116271042", "story_v_out_116271.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116271", "116271042", "story_v_out_116271.awb")

						uv0:RecordAudio("116271042", slot17)
						uv0:RecordAudio("116271042", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116271", "116271042", "story_v_out_116271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116271", "116271042", "story_v_out_116271.awb")
				end
