return {
	Play111121001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.D09a:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueD09a = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueD09a = slot6
				end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueD09a then
					...
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueD09a, 1, (uv0.time_ - slot4) / slot5)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111121001).content)
	...
	Play111121002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111121002).content)
	...
	Play111121003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121003
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[115].name)
			uv0.choices_[2].txt.text = uv0:FormatText(StoryChoiceCfg[116].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play111121004(uv1)
			end

			if slot0 == 2 then
				uv0:Play111121005(uv1)
			end
		end
	...
	Play111121004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111121004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121004", "story_v_out_111121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111121", "111121004", "story_v_out_111121.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111121", "111121004", "story_v_out_111121.awb")

						uv0:RecordAudio("111121004", slot10)
						uv0:RecordAudio("111121004", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111121", "111121004", "story_v_out_111121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111121", "111121004", "story_v_out_111121.awb")
				end
	...
	Play111121005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121005
		slot1.duration_ = 7.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111121005).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121005", "story_v_out_111121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111121", "111121005", "story_v_out_111121.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111121", "111121005", "story_v_out_111121.awb")

						uv0:RecordAudio("111121005", slot10)
						uv0:RecordAudio("111121005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111121", "111121005", "story_v_out_111121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111121", "111121005", "story_v_out_111121.awb")
				end
	...
	Play111121006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_activity_1_1", "se_story_activity_1_1_hel_cannon", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(111121006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121006", "story_v_out_111121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111121", "111121006", "story_v_out_111121.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_111121", "111121006", "story_v_out_111121.awb")

						uv0:RecordAudio("111121006", slot21)
						uv0:RecordAudio("111121006", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111121", "111121006", "story_v_out_111121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111121", "111121006", "story_v_out_111121.awb")
				end
	...
	Play111121007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(111121007).content)
				uv0.text_.text = slot16

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (14 <= 0 and slot12 or slot12 * utf8.len(slot16) / slot17) > 0 and slot12 < slot19 then
					uv0.talkMaxDuration = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121007", "story_v_out_111121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111121", "111121007", "story_v_out_111121.awb") / 1000 + slot11 then
						uv0.duration_ = slot20 + slot11
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_111121", "111121007", "story_v_out_111121.awb")

						uv0:RecordAudio("111121007", slot21)
						uv0:RecordAudio("111121007", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111121", "111121007", "story_v_out_111121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111121", "111121007", "story_v_out_111121.awb")
				end
	...
	Play111121008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121008
		slot1.duration_ = 2.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111121008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121008", "story_v_out_111121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111121", "111121008", "story_v_out_111121.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111121", "111121008", "story_v_out_111121.awb")

						uv0:RecordAudio("111121008", slot14)
						uv0:RecordAudio("111121008", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111121", "111121008", "story_v_out_111121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111121", "111121008", "story_v_out_111121.awb")
				end
	...
	Play111121009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111121009).content)
	...
	Play111121010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111121010).content)
				uv0.text_.text = slot5
	...
	Play111121011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121011
		slot1.duration_ = 8
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play111121012(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.D10_1 == nil then
				slot2 = Object.Instantiate(uv0.paintGo_)
				slot2:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. slot1)
				slot2.name = slot1
				slot2.transform.parent = uv0.stage_.transform
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueD09a then
					slot8 = uv0.var_.alphaMatValueD09a
					slot9 = slot8:GetColor("_Color")
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueD09a, 0, (uv0.time_ - slot4) / slot5)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if uv0.bgs_.D10_1:GetComponent("SpriteRenderer") then
					slot8.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot9 = slot8.material
					uv0.var_.alphaOldValueD10_1 = slot9:GetColor("_Color").a
					uv0.var_.alphaMatValueD10_1 = slot9
				end

				uv0.var_.alphaOldValueD10_1 = 0
			end

			slot8 = 1.5

			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueD10_1 then
					slot11 = uv0.var_.alphaMatValueD10_1
					slot12 = slot11:GetColor("_Color")
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueD10_1, 1, (uv0.time_ - slot7) / slot8)

					slot11:SetColor("_Color", slot12)
				end
			end

			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 and uv0.var_.alphaMatValueD10_1 then
				slot9 = uv0.var_.alphaMatValueD10_1
			...
			if 3 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(111121011).content)
	...
	Play111121012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111121012).content)
				uv0.text_.text = slot5
	...
	Play111121013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121013
		slot1.duration_ = 4.5
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play111121014(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:PlayTimeline("1094ui_story", "StoryTimeline/CharAction/1094/1094actionlink/1094action423")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111121013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121013", "story_v_out_111121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111121", "111121013", "story_v_out_111121.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111121", "111121013", "story_v_out_111121.awb")

						uv0:RecordAudio("111121013", slot18)
						uv0:RecordAudio("111121013", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111121", "111121013", "story_v_out_111121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111121", "111121013", "story_v_out_111121.awb")
				end
	...
	Play111121014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111121014
		slot1.duration_ = 4.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111121014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121014", "story_v_out_111121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111121", "111121014", "story_v_out_111121.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_111121", "111121014", "story_v_out_111121.awb")

						uv0:RecordAudio("111121014", slot13)
						uv0:RecordAudio("111121014", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111121", "111121014", "story_v_out_111121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111121", "111121014", "story_v_out_111121.awb")
				end
