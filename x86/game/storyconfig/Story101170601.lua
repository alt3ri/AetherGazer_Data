return {
	Play117061001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot7.transform.localPosition = Vector3.New(0, 0, 0.03)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(117061001).content)
	...
	Play117061002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.effecthuo then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(117061002).content)
	...
	Play117061003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(117061003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061003", "story_v_out_117061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117061", "117061003", "story_v_out_117061.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_117061", "117061003", "story_v_out_117061.awb")

						uv0:RecordAudio("117061003", slot20)
						uv0:RecordAudio("117061003", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117061", "117061003", "story_v_out_117061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117061", "117061003", "story_v_out_117061.awb")
				end
	...
	Play117061004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117061004).content)
	...
	Play117061005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				if uv0.actors_["1033"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue1033 = slot19.alpha
					uv0.var_.characterEffect1033 = slot19
				end

				uv0.var_.alphaOldValue1033 = 0
			end

			slot19 = 0.333333333333333

			if slot18 <= uv0.time_ and uv0.time_ < slot18 + slot19 then
				if uv0.var_.characterEffect1033 then
					uv0.var_.characterEffect1033.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1033, 1, (uv0.time_ - slot18) / slot19)
				end
			end

			if uv0.time_ >= slot18 + slot19 and uv0.time_ < slot18 + slot19 + slot0 and uv0.var_.characterEffect1033 then
				uv0.var_.characterEffect1033.alpha = 1
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(117061005).content)
				uv0.text_.text = slot24

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (8 <= 0 and slot21 or slot21 * utf8.len(slot24) / slot25) > 0 and slot21 < slot27 then
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061005", "story_v_out_117061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117061", "117061005", "story_v_out_117061.awb") / 1000 + slot20 then
						uv0.duration_ = slot28 + slot20
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_117061", "117061005", "story_v_out_117061.awb")

						uv0:RecordAudio("117061005", slot29)
						uv0:RecordAudio("117061005", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117061", "117061005", "story_v_out_117061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117061", "117061005", "story_v_out_117061.awb")
				end
	...
	Play117061006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117061006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061006", "story_v_out_117061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117061", "117061006", "story_v_out_117061.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117061", "117061006", "story_v_out_117061.awb")

						uv0:RecordAudio("117061006", slot16)
						uv0:RecordAudio("117061006", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117061", "117061006", "story_v_out_117061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117061", "117061006", "story_v_out_117061.awb")
				end
	...
	Play117061007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061007
		slot1.duration_ = 2.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117061007).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061007", "story_v_out_117061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117061", "117061007", "story_v_out_117061.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117061", "117061007", "story_v_out_117061.awb")

						uv0:RecordAudio("117061007", slot16)
						uv0:RecordAudio("117061007", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117061", "117061007", "story_v_out_117061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117061", "117061007", "story_v_out_117061.awb")
				end
	...
	Play117061008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061008
		slot1.duration_ = 5.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117061008).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061008", "story_v_out_117061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117061", "117061008", "story_v_out_117061.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117061", "117061008", "story_v_out_117061.awb")

						uv0:RecordAudio("117061008", slot16)
						uv0:RecordAudio("117061008", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117061", "117061008", "story_v_out_117061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117061", "117061008", "story_v_out_117061.awb")
				end
	...
	Play117061009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117061009).content)
				uv0.text_.text = slot7
	...
	Play117061010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061010
		slot1.duration_ = 7.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(117061010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061010", "story_v_out_117061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117061", "117061010", "story_v_out_117061.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_117061", "117061010", "story_v_out_117061.awb")

						uv0:RecordAudio("117061010", slot13)
						uv0:RecordAudio("117061010", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117061", "117061010", "story_v_out_117061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117061", "117061010", "story_v_out_117061.awb")
				end
	...
	Play117061011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117061011).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117061", "117061011", "story_v_out_117061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117061", "117061011", "story_v_out_117061.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117061", "117061011", "story_v_out_117061.awb")

						uv0:RecordAudio("117061011", slot16)
						uv0:RecordAudio("117061011", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117061", "117061011", "story_v_out_117061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117061", "117061011", "story_v_out_117061.awb")
				end
	...
	Play117061012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117061012
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_17", "se_story_17_fireblast", "")
			end
			...
			if 1 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(117061012).content)
