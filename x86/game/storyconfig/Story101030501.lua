return {
	Play103051001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect1019ui_story == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if uv0.bgs_.B07b:GetComponent("SpriteRenderer") then
					slot12.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot13 = slot12.material
					uv0.var_.alphaOldValueB07b = slot13:GetColor("_Color").a
					uv0.var_.alphaMatValueB07b = slot13
				end

				uv0.var_.alphaOldValueB07b = 0
			end

			slot12 = 1.5

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.alphaMatValueB07b then
					slot15 = uv0.var_.alphaMatValueB07b
					slot16 = slot15:GetColor("_Color")
					slot16.a = Mathf.Lerp(uv0.var_.alphaOldValueB07b, 1, (uv0.time_ - slot11) / slot12)

					slot15:SetColor("_Color", slot16)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.alphaMatValueB07b then
				slot13 = uv0.var_.alphaMatValueB07b
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot15.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(0, -1.08, -5.9), (uv0.time_ - slot16) / slot17)
			...
			if uv0.time_ >= slot16 + slot17 and uv0.time_ < slot16 + slot17 + slot0 then
				slot15.localPosition = Vector3.New(0, -1.08, -5.9)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(103051001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051001", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051001", "story_v_out_103051.awb") / 1000 + slot21 then
						uv0.duration_ = slot30 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_103051", "103051001", "story_v_out_103051.awb")

						uv0:RecordAudio("103051001", slot31)
						uv0:RecordAudio("103051001", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051001", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051001", "story_v_out_103051.awb")
				end
	...
	Play103051002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051002
		slot1.duration_ = 8.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_3", "se_story_3_wrongpassword", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[51].name)
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(103051002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051002", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051002", "story_v_out_103051.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_103051", "103051002", "story_v_out_103051.awb")

						uv0:RecordAudio("103051002", slot15)
						uv0:RecordAudio("103051002", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051002", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051002", "story_v_out_103051.awb")
				end
	...
	Play103051003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(103051003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051003", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051003", "story_v_out_103051.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_103051", "103051003", "story_v_out_103051.awb")

						uv0:RecordAudio("103051003", slot25)
						uv0:RecordAudio("103051003", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051003", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051003", "story_v_out_103051.awb")
				end
	...
	Play103051004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(103051004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051004", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051004", "story_v_out_103051.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103051", "103051004", "story_v_out_103051.awb")

						uv0:RecordAudio("103051004", slot18)
						uv0:RecordAudio("103051004", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051004", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051004", "story_v_out_103051.awb")
				end
	...
	Play103051005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103051005).content)
	...
	Play103051006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(103051006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051006", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051006", "story_v_out_103051.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_103051", "103051006", "story_v_out_103051.awb")

						uv0:RecordAudio("103051006", slot10)
						uv0:RecordAudio("103051006", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051006", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051006", "story_v_out_103051.awb")
				end
	...
	Play103051007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(103051007).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051007", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051007", "story_v_out_103051.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_103051", "103051007", "story_v_out_103051.awb")

						uv0:RecordAudio("103051007", slot15)
						uv0:RecordAudio("103051007", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051007", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051007", "story_v_out_103051.awb")
				end
	...
	Play103051008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(103051008).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051008", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051008", "story_v_out_103051.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_103051", "103051008", "story_v_out_103051.awb")

						uv0:RecordAudio("103051008", slot25)
						uv0:RecordAudio("103051008", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051008", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051008", "story_v_out_103051.awb")
				end
	...
	Play103051009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_3", "se_story_3_verified", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(103051009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051009", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051009", "story_v_out_103051.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103051", "103051009", "story_v_out_103051.awb")

						uv0:RecordAudio("103051009", slot21)
						uv0:RecordAudio("103051009", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051009", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051009", "story_v_out_103051.awb")
				end
	...
	Play103051010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(103051010).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051010", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051010", "story_v_out_103051.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103051", "103051010", "story_v_out_103051.awb")

						uv0:RecordAudio("103051010", slot18)
						uv0:RecordAudio("103051010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051010", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051010", "story_v_out_103051.awb")
				end
	...
	Play103051011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103051011).content)
				uv0.text_.text = slot8
	...
	Play103051012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(103051012).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051012", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051012", "story_v_out_103051.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_103051", "103051012", "story_v_out_103051.awb")

						uv0:RecordAudio("103051012", slot10)
						uv0:RecordAudio("103051012", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051012", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051012", "story_v_out_103051.awb")
				end
	...
	Play103051013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051013
		slot1.duration_ = 3.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(103051013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051013", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051013", "story_v_out_103051.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103051", "103051013", "story_v_out_103051.awb")

						uv0:RecordAudio("103051013", slot17)
						uv0:RecordAudio("103051013", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051013", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051013", "story_v_out_103051.awb")
				end
	...
	Play103051014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(103051014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051014", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051014", "story_v_out_103051.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_103051", "103051014", "story_v_out_103051.awb")

						uv0:RecordAudio("103051014", slot16)
						uv0:RecordAudio("103051014", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051014", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051014", "story_v_out_103051.awb")
				end
	...
	Play103051015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103051015).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051015", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051015", "story_v_out_103051.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_103051", "103051015", "story_v_out_103051.awb")

						uv0:RecordAudio("103051015", slot13)
						uv0:RecordAudio("103051015", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051015", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051015", "story_v_out_103051.awb")
				end
	...
	Play103051016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051016
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[18].name)
			uv0.choices_[2].txt.text = uv0:FormatText(StoryChoiceCfg[19].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play103051017(uv1)
			end

			if slot0 == 2 then
				uv0:Play103051018(uv1)
			end
		end
	...
	Play103051017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051017
		slot1.duration_ = 7.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103051017).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051017", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051017", "story_v_out_103051.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_103051", "103051017", "story_v_out_103051.awb")

						uv0:RecordAudio("103051017", slot13)
						uv0:RecordAudio("103051017", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051017", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051017", "story_v_out_103051.awb")
				end
	...
	Play103051019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103051019).content)
				uv0.text_.text = slot8
	...
	Play103051020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051020
		slot1.duration_ = 7.766
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103051020).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051020", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051020", "story_v_out_103051.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_103051", "103051020", "story_v_out_103051.awb")

						uv0:RecordAudio("103051020", slot13)
						uv0:RecordAudio("103051020", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051020", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051020", "story_v_out_103051.awb")
				end
	...
	Play103051018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103051018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(103051018).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051018", "story_v_out_103051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103051", "103051018", "story_v_out_103051.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_103051", "103051018", "story_v_out_103051.awb")

						uv0:RecordAudio("103051018", slot10)
						uv0:RecordAudio("103051018", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103051", "103051018", "story_v_out_103051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103051", "103051018", "story_v_out_103051.awb")
				end
