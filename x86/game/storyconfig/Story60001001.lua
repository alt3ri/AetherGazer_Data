	...
	Play60001001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_33 < arg_1_1.time_ and arg_1_1.time_ <= var_4_33 + arg_4_0 then
				...
				local var_4_34 = "1019ui_story"

				arg_1_1:ShowWeapon(arg_1_1.var_[var_4_34 .. "Animator"].transform, false)
			end
			...
			if var_4_33 <= arg_1_1.time_ and arg_1_1.time_ < var_4_33 + var_4_35 then
				...
				local var_4_37 = Vector3.New(0, -1.08, -5.9)

				var_4_32.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1019ui_story, var_4_37, var_4_36)
			...
			if var_4_43 < arg_1_1.time_ and arg_1_1.time_ <= var_4_43 + arg_4_0 and arg_1_1.var_.characterEffect1019ui_story == nil then
			...
			if arg_1_1.time_ >= var_4_43 + var_4_44 and arg_1_1.time_ < var_4_43 + var_4_44 + arg_4_0 and arg_1_1.var_.characterEffect1019ui_story then
				arg_1_1.var_.characterEffect1019ui_story.fillFlat = false
			end
			...
			if var_4_48 < arg_1_1.time_ and arg_1_1.time_ <= var_4_48 + arg_4_0 then
				...
				local var_4_50 = arg_1_1:FormatText(StoryNameCfg[13].name)
				...
				local var_4_51 = arg_1_1:GetWordFromCfg(60001001)
			...
			local var_4_56 = math.max(var_4_49, arg_1_1.talkMaxDuration)

			if var_4_48 <= arg_1_1.time_ and arg_1_1.time_ < var_4_48 + var_4_56 then
				arg_1_1.typewritter.percent = (arg_1_1.time_ - var_4_48) / var_4_56

				arg_1_1.typewritter:SetDirty()
			end

			if arg_1_1.time_ >= var_4_48 + var_4_56 and arg_1_1.time_ < var_4_48 + var_4_56 + arg_4_0 then
	...
	Play60001002 = function(arg_5_0, arg_5_1)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
			...
			if var_8_1 < arg_5_1.time_ and arg_5_1.time_ <= var_8_1 + arg_8_0 then
				...
				local var_8_3 = arg_5_1:FormatText(StoryNameCfg[13].name)
				...
				local var_8_4 = arg_5_1:GetWordFromCfg(60001002)
	...
	Play60001003 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				arg_9_1:PlayTimeline("1019ui_story", "StoryTimeline/CharAction/1019/1019actionlink/1019action454")
			end
			...
			if var_12_2 < arg_9_1.time_ and arg_9_1.time_ <= var_12_2 + arg_12_0 then
				...
				local var_12_5 = arg_9_1:GetWordFromCfg(60001003)
	...
	Play60001004 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_6 < arg_13_1.time_ and arg_13_1.time_ <= var_16_6 + arg_16_0 then
				...
				local var_16_8 = arg_13_1:FormatText(StoryNameCfg[10].name)
	...
	Play60001006 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_4 < arg_21_1.time_ and arg_21_1.time_ <= var_24_4 + arg_24_0 then
				arg_21_1:PlayTimeline("1019ui_story", "StoryTimeline/CharAction/1019/1019actionlink/1019action446")
			end
			...
			if var_24_6 < arg_21_1.time_ and arg_21_1.time_ <= var_24_6 + arg_24_0 then
				...
				local var_24_9 = arg_21_1:GetWordFromCfg(60001006)
	...
	Play60001007 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				arg_25_1:PlayTimeline("1019ui_story", "StoryTimeline/CharAction/1019/1019actionlink/1019action465")
			end
			...
			if var_28_2 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_4 = arg_25_1:FormatText(StoryNameCfg[13].name)
				...
				local var_28_5 = arg_25_1:GetWordFromCfg(60001007)
	...
	Play60001008 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_1 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 then
				...
				local var_32_3 = arg_29_1:FormatText(StoryNameCfg[13].name)
				...
				local var_32_4 = arg_29_1:GetWordFromCfg(60001008)
	...
	Play60001011 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_6 < arg_41_1.time_ and arg_41_1.time_ <= var_44_6 + arg_44_0 then
				...
				local var_44_9 = arg_41_1:GetWordFromCfg(60001011)
	...
	Play60001012 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_6 < arg_45_1.time_ and arg_45_1.time_ <= var_48_6 + arg_48_0 then
				...
				local var_48_9 = arg_45_1:GetWordFromCfg(60001012)
	...
	Play60001014 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_0 + arg_56_0 then
				...
				local var_56_2 = arg_53_1:FormatText(StoryNameCfg[10].name)
