return {
	Play900000001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(900000001).content)
	...
	Play900000002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(900000002).content)
	...
	Play900000003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.5 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(900000003).content)
	...
	Play900000004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(900000004).content)
	...
	Play900000005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(900000005).content)
	...
	Play900000006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033, Vector3.New(0, -2000, 0), (uv0.time_ - slot5) / slot6)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(900000006).content)
				uv0.text_.text = slot11
	...
	Play900000007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(900000007).content)
	...
	Play900000008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019, Vector3.New(-210, -340, 200), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if uv0.actors_["1019"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue1019 = slot10.alpha
					uv0.var_.characterEffect1019 = slot10
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				if uv0.var_.characterEffect1019 then
					uv0.var_.characterEffect1019.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1019, 1, (uv0.time_ - slot9) / slot10)
				end
			end

			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.characterEffect1019 then
				uv0.var_.characterEffect1019.alpha = 1
			end

			slot11 = uv0.actors_["1033"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.var_.moveOldPos1033 = slot11.localPosition
				slot11.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("1033", 7)

				for slot17 = 0, slot11.childCount - 1 do
					if slot11:GetChild(slot17).name == "split_6" or not string.find(slot18.name, "split") then
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033, Vector3.New(0, -2000, 0), (uv0.time_ - slot12) / slot13)
			end
			...
			slot14 = uv0.actors_["1038"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0.var_.moveOldPos1038 = slot14.localPosition
				slot14.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("1038", 7)

				for slot20 = 0, slot14.childCount - 1 do
					if slot14:GetChild(slot20).name == "split_2" or not string.find(slot21.name, "split") then
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1038, Vector3.New(0, -2000, 0), (uv0.time_ - slot15) / slot16)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(900000008).content)
				uv0.text_.text = slot21

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (33 <= 0 and slot18 or slot18 * utf8.len(slot21) / slot22) > 0 and slot18 < slot24 then
	...
	Play900000009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot10 = uv0.actors_["1019"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPos1019 = slot10.localPosition
				slot10.localScale = Vector3.New(1, 1, 1)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019, Vector3.New(0, -2000, 200), (uv0.time_ - slot11) / slot12)
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0, -2000, 200)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(900000009).content)
				uv0.text_.text = slot17
	...
	Play900000010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(900000010).content)
				uv0.text_.text = slot17
	...
	Play900000011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019, Vector3.New(180, -340, 200), (uv0.time_ - slot2) / slot3)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.actors_["1019"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue1019 = slot6.alpha
					uv0.var_.characterEffect1019 = slot6
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.characterEffect1019 then
					uv0.var_.characterEffect1019.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1019, 1, (uv0.time_ - slot5) / slot6)
				end
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.characterEffect1019 then
				uv0.var_.characterEffect1019.alpha = 1
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(900000011).content)
				uv0.text_.text = slot17
	...
	Play900000012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(900000012).content)
				uv0.text_.text = slot17
	...
	Play900000013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(900000013).content)
				uv0.text_.text = slot11
	...
	Play900000014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 and uv0.var_.actorSpriteComps1019 == nil then
				uv0.var_.actorSpriteComps1019 = uv0.actors_["1019"]:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				...
				if uv0.var_.actorSpriteComps1019 then
					for slot17, slot18 in pairs(uv0.var_.actorSpriteComps1019:ToTable()) do
						if slot18 then
							slot19 = Mathf.Lerp(slot18.color.r, 0.5, slot13)
							slot18.color = Color.New(slot19, slot19, slot19)
						end
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.actorSpriteComps1019 then
				slot13 = 0.5
			...
			slot13 = uv0.actors_["1038"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPos1038 = slot13.localPosition
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1038, Vector3.New(0, -2000, 0), (uv0.time_ - slot14) / slot15)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(900000014).content)
	...
	Play900000015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(900000015).content)
				uv0.text_.text = slot17
	...
	Play900000016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(900000016).content)
				uv0.text_.text = slot11
	...
	Play900000017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot13 = uv0.actors_["1019"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPos1019 = slot13.localPosition
				slot13.localScale = Vector3.New(1, 1, 1)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019, Vector3.New(0, -2000, 200), (uv0.time_ - slot14) / slot15)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(900000017).content)
				uv0.text_.text = slot20
	...
	Play900000018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot4 = uv0.actors_["1019"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPos1019 = slot4.localPosition
				slot4.localScale = Vector3.New(1, 1, 1)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019, Vector3.New(-210, -340, 200), (uv0.time_ - slot5) / slot6)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if uv0.actors_["1019"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue1019 = slot12.alpha
					uv0.var_.characterEffect1019 = slot12
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.characterEffect1019 then
					uv0.var_.characterEffect1019.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1019, 1, (uv0.time_ - slot11) / slot12)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.characterEffect1019 then
				uv0.var_.characterEffect1019.alpha = 1
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(900000018).content)
				uv0.text_.text = slot17
	...
	Play900000019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019, Vector3.New(0, -2000, 200), (uv0.time_ - slot5) / slot6)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(900000019).content)
				uv0.text_.text = slot17
