return {
	Play61304001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 61304001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.333333333333333 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(61304001).content)
				uv0.text_.text = slot13

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (7 <= 0 and slot9 or slot9 * utf8.len(slot13) / slot14) > 0 and slot9 < slot16 then
