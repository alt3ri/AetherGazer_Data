return {
	Play122011001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(122011001).content)
	...
	Play122011002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011002).content)
	...
	Play122011003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011003).content)
				uv0.text_.text = slot4
	...
	Play122011004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if uv0.bgs_.XH0204_blur == nil then
			...
			if 1.999999999998 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(122011004).content)
	...
	Play122011005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if uv0.time_ >= slot7 + 2.000000000001 and uv0.time_ < slot7 + slot8 + slot0 then
				uv0.allBtn_.enabled = true
			end

			if uv0.bgs_.XH0508a_blur == nil then
			...
			if 1.999999999998 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
			...
			if 3.999999999999 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(122011005).content)
	...
	Play122011006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011006
		slot1.duration_ = 5
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play122011007(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				if uv0.bgs_.XH0508a:GetComponent("SpriteRenderer") then
					slot3.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot4 = slot3.material
					uv0.var_.alphaOldValueXH0508a = slot4:GetColor("_Color").a
					uv0.var_.alphaMatValueXH0508a = slot4
				end

				uv0.var_.alphaOldValueXH0508a = 1
			end

			slot3 = 0.6

			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				if uv0.var_.alphaMatValueXH0508a then
					slot6 = uv0.var_.alphaMatValueXH0508a
					slot7 = slot6:GetColor("_Color")
					slot7.a = Mathf.Lerp(uv0.var_.alphaOldValueXH0508a, 0, (uv0.time_ - slot2) / slot3)

					slot6:SetColor("_Color", slot7)
				end
			end

			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 and uv0.var_.alphaMatValueXH0508a then
				slot4 = uv0.var_.alphaMatValueXH0508a
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(122011006).content)
	...
	Play122011007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011007).content)
				uv0.text_.text = slot4
	...
	Play122011008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(122011008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_122011", "122011008", "story_v_out_122011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_122011", "122011008", "story_v_out_122011.awb") / 1000 + slot11 then
						uv0.duration_ = slot20 + slot11
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_122011", "122011008", "story_v_out_122011.awb")

						uv0:RecordAudio("122011008", slot21)
						uv0:RecordAudio("122011008", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_122011", "122011008", "story_v_out_122011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_122011", "122011008", "story_v_out_122011.awb")
				end
	...
	Play122011009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(122011009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_122011", "122011009", "story_v_out_122011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_122011", "122011009", "story_v_out_122011.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_122011", "122011009", "story_v_out_122011.awb")

						uv0:RecordAudio("122011009", slot10)
						uv0:RecordAudio("122011009", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_122011", "122011009", "story_v_out_122011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_122011", "122011009", "story_v_out_122011.awb")
				end
	...
	Play122011010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011010).content)
				uv0.text_.text = slot4
	...
	Play122011011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011011
		slot1.duration_ = 4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(122011011).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_122011", "122011011", "story_v_out_122011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_122011", "122011011", "story_v_out_122011.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_122011", "122011011", "story_v_out_122011.awb")

						uv0:RecordAudio("122011011", slot19)
						uv0:RecordAudio("122011011", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_122011", "122011011", "story_v_out_122011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_122011", "122011011", "story_v_out_122011.awb")
				end
	...
	Play122011012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(122011012).content)
				uv0.text_.text = slot8
	...
	Play122011013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(122011013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_122011", "122011013", "story_v_out_122011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_122011", "122011013", "story_v_out_122011.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_122011", "122011013", "story_v_out_122011.awb")

						uv0:RecordAudio("122011013", slot17)
						uv0:RecordAudio("122011013", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_122011", "122011013", "story_v_out_122011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_122011", "122011013", "story_v_out_122011.awb")
				end
	...
	Play122011014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011014
		slot1.duration_ = 3.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(122011014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_122011", "122011014", "story_v_out_122011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_122011", "122011014", "story_v_out_122011.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_122011", "122011014", "story_v_out_122011.awb")

						uv0:RecordAudio("122011014", slot25)
						uv0:RecordAudio("122011014", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_122011", "122011014", "story_v_out_122011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_122011", "122011014", "story_v_out_122011.awb")
				end
	...
	Play122011015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(122011015).content)
	...
	Play122011016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(122011016).content)
				uv0.text_.text = slot12
	...
	Play122011017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011017).content)
				uv0.text_.text = slot4
	...
	Play122011018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011018).content)
				uv0.text_.text = slot4
	...
	Play122011019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011019).content)
				uv0.text_.text = slot4
	...
	Play122011020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(122011020).content)
				uv0.text_.text = slot5
	...
	Play122011021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011021
		slot1.duration_ = 2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(122011021).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_122011", "122011021", "story_v_out_122011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_122011", "122011021", "story_v_out_122011.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_122011", "122011021", "story_v_out_122011.awb")

						uv0:RecordAudio("122011021", slot15)
						uv0:RecordAudio("122011021", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_122011", "122011021", "story_v_out_122011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_122011", "122011021", "story_v_out_122011.awb")
				end
	...
	Play122011022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011022).content)
				uv0.text_.text = slot4
	...
	Play122011023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011023
		slot1.duration_ = 3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(122011023).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_122011", "122011023", "story_v_out_122011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_122011", "122011023", "story_v_out_122011.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_122011", "122011023", "story_v_out_122011.awb")

						uv0:RecordAudio("122011023", slot17)
						uv0:RecordAudio("122011023", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_122011", "122011023", "story_v_out_122011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_122011", "122011023", "story_v_out_122011.awb")
				end
	...
	Play122011024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011024
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(122011024).content)
				uv0.text_.text = slot10
	...
	Play122011025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 122011025
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(122011025).content)
				uv0.text_.text = slot4
