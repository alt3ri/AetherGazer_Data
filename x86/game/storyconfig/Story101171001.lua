return {
	Play117101001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(117101001).content)
	...
	Play117101002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117101002).content)
	...
	Play117101003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(117101003).content)
				uv0.text_.text = slot6

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (10 <= 0 and slot4 or slot4 * utf8.len(slot6) / slot7) > 0 and slot4 < slot9 then
	...
	Play117101004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10035, Vector3.New(0, -410, -235), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(117101004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101004", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101004", "story_v_out_117101.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_117101", "117101004", "story_v_out_117101.awb")

						uv0:RecordAudio("117101004", slot20)
						uv0:RecordAudio("117101004", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101004", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101004", "story_v_out_117101.awb")
				end
	...
	Play117101005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10035, Vector3.New(0, -410, -235), (uv0.time_ - slot2) / slot3)
			end

			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 then
				slot1.localPosition = Vector3.New(0, -410, -235)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(117101005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101005", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101005", "story_v_out_117101.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_117101", "117101005", "story_v_out_117101.awb")

						uv0:RecordAudio("117101005", slot13)
						uv0:RecordAudio("117101005", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101005", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101005", "story_v_out_117101.awb")
				end
	...
	Play117101006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117101006).content)
	...
	Play117101007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101007", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101007", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101007", "story_v_out_117101.awb")

						uv0:RecordAudio("117101007", slot19)
						uv0:RecordAudio("117101007", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101007", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101007", "story_v_out_117101.awb")
				end
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				for slot11 = 0, slot5.childCount - 1 do
					if slot5:GetChild(slot11).name == "split_4" or not string.find(slot12.name, "split") then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.actorSpriteComps10035 == nil then
				uv0.var_.actorSpriteComps10035 = uv0.actors_["10035"]:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				...
				if uv0.var_.actorSpriteComps10035 then
					for slot15, slot16 in pairs(uv0.var_.actorSpriteComps10035:ToTable()) do
						if slot16 then
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.actorSpriteComps10035 then
				slot11 = 0.5
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				...
				if uv0.var_.actorSpriteComps1033 then
					for slot18, slot19 in pairs(uv0.var_.actorSpriteComps1033:ToTable()) do
						if slot19 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				if uv0.actors_["1033"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue1033 = slot16.alpha
					uv0.var_.characterEffect1033 = slot16
				end
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				if uv0.var_.characterEffect1033 then
					uv0.var_.characterEffect1033.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1033, 1, (uv0.time_ - slot15) / slot16)
				end
			end

			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 and uv0.var_.characterEffect1033 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(117101008).content)
				uv0.text_.text = slot21

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (29 <= 0 and slot18 or slot18 * utf8.len(slot21) / slot22) > 0 and slot18 < slot24 then
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101008", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101008", "story_v_out_117101.awb") / 1000 + slot17 then
						uv0.duration_ = slot25 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_117101", "117101008", "story_v_out_117101.awb")

						uv0:RecordAudio("117101008", slot26)
						uv0:RecordAudio("117101008", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101008", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101008", "story_v_out_117101.awb")
				end
	...
	Play117101009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117101009).content)
				uv0.text_.text = slot7
	...
	Play117101010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10035, Vector3.New(0, -2000, -235), (uv0.time_ - slot2) / slot3)
			end
			...
			slot5 = uv0.actors_["10034"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.var_.moveOldPos10034 = slot5.localPosition
				slot5.localScale = Vector3.New(1, 1, 1)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10034, Vector3.New(-390, -415, -290), (uv0.time_ - slot6) / slot7)
			end
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				if uv0.var_.characterEffect10034 then
					uv0.var_.characterEffect10034.alpha = Mathf.Lerp(uv0.var_.alphaOldValue10034, 1, (uv0.time_ - slot12) / slot13)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(117101010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101010", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101010", "story_v_out_117101.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_117101", "117101010", "story_v_out_117101.awb")

						uv0:RecordAudio("117101010", slot23)
						uv0:RecordAudio("117101010", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101010", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101010", "story_v_out_117101.awb")
				end
	...
	Play117101011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10035_split_5")

				uv0.callingController_:SetSelectedState("normal")

				slot8 = uv0:FormatText(uv0:GetWordFromCfg(117101011).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101011", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101011", "story_v_out_117101.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_117101", "117101011", "story_v_out_117101.awb")

						uv0:RecordAudio("117101011", slot13)
						uv0:RecordAudio("117101011", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101011", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101011", "story_v_out_117101.awb")
				end
	...
	Play117101012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(117101012).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101012", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101012", "story_v_out_117101.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_117101", "117101012", "story_v_out_117101.awb")

						uv0:RecordAudio("117101012", slot13)
						uv0:RecordAudio("117101012", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101012", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101012", "story_v_out_117101.awb")
				end
	...
	Play117101013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117101013).content)
				uv0.text_.text = slot7
	...
	Play117101014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101014", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101014", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101014", "story_v_out_117101.awb")

						uv0:RecordAudio("117101014", slot16)
						uv0:RecordAudio("117101014", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101014", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101014", "story_v_out_117101.awb")
				end
	...
	Play117101015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101015).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101015", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101015", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101015", "story_v_out_117101.awb")

						uv0:RecordAudio("117101015", slot16)
						uv0:RecordAudio("117101015", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101015", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101015", "story_v_out_117101.awb")
				end
	...
	Play117101016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101016).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101016", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101016", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101016", "story_v_out_117101.awb")

						uv0:RecordAudio("117101016", slot16)
						uv0:RecordAudio("117101016", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101016", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101016", "story_v_out_117101.awb")
				end
	...
	Play117101017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101017).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101017", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101017", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101017", "story_v_out_117101.awb")

						uv0:RecordAudio("117101017", slot16)
						uv0:RecordAudio("117101017", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101017", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101017", "story_v_out_117101.awb")
				end
	...
	Play117101018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101018).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101018", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101018", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101018", "story_v_out_117101.awb")

						uv0:RecordAudio("117101018", slot19)
						uv0:RecordAudio("117101018", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101018", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101018", "story_v_out_117101.awb")
				end
	...
	Play117101019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101019).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101019", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101019", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101019", "story_v_out_117101.awb")

						uv0:RecordAudio("117101019", slot16)
						uv0:RecordAudio("117101019", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101019", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101019", "story_v_out_117101.awb")
				end
	...
	Play117101020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101020).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101020", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101020", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101020", "story_v_out_117101.awb")

						uv0:RecordAudio("117101020", slot19)
						uv0:RecordAudio("117101020", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101020", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101020", "story_v_out_117101.awb")
				end
	...
	Play117101021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101021).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101021", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101021", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101021", "story_v_out_117101.awb")

						uv0:RecordAudio("117101021", slot19)
						uv0:RecordAudio("117101021", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101021", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101021", "story_v_out_117101.awb")
				end
	...
	Play117101022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(117101022).content)
	...
	Play117101023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101023).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101023", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101023", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101023", "story_v_out_117101.awb")

						uv0:RecordAudio("117101023", slot16)
						uv0:RecordAudio("117101023", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101023", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101023", "story_v_out_117101.awb")
				end
	...
	Play117101024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117101024).content)
				uv0.text_.text = slot7
	...
	Play117101025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101025).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101025", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101025", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101025", "story_v_out_117101.awb")

						uv0:RecordAudio("117101025", slot16)
						uv0:RecordAudio("117101025", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101025", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101025", "story_v_out_117101.awb")
				end
	...
	Play117101026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101026).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101026", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101026", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101026", "story_v_out_117101.awb")

						uv0:RecordAudio("117101026", slot19)
						uv0:RecordAudio("117101026", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101026", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101026", "story_v_out_117101.awb")
				end
	...
	Play117101027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101027).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101027", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101027", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101027", "story_v_out_117101.awb")

						uv0:RecordAudio("117101027", slot16)
						uv0:RecordAudio("117101027", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101027", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101027", "story_v_out_117101.awb")
				end
	...
	Play117101028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101028).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101028", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101028", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101028", "story_v_out_117101.awb")

						uv0:RecordAudio("117101028", slot16)
						uv0:RecordAudio("117101028", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101028", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101028", "story_v_out_117101.awb")
				end
	...
	Play117101029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101029).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101029", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101029", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101029", "story_v_out_117101.awb")

						uv0:RecordAudio("117101029", slot16)
						uv0:RecordAudio("117101029", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101029", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101029", "story_v_out_117101.awb")
				end
	...
	Play117101030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101030).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101030", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101030", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101030", "story_v_out_117101.awb")

						uv0:RecordAudio("117101030", slot16)
						uv0:RecordAudio("117101030", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101030", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101030", "story_v_out_117101.awb")
				end
	...
	Play117101031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(117101031).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101031", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101031", "story_v_out_117101.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_117101", "117101031", "story_v_out_117101.awb")

						uv0:RecordAudio("117101031", slot13)
						uv0:RecordAudio("117101031", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101031", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101031", "story_v_out_117101.awb")
				end
	...
	Play117101032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117101032).content)
				uv0.text_.text = slot4
	...
	Play117101033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101033).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101033", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101033", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101033", "story_v_out_117101.awb")

						uv0:RecordAudio("117101033", slot16)
						uv0:RecordAudio("117101033", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101033", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101033", "story_v_out_117101.awb")
				end
	...
	Play117101034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101034).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101034", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101034", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101034", "story_v_out_117101.awb")

						uv0:RecordAudio("117101034", slot19)
						uv0:RecordAudio("117101034", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101034", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101034", "story_v_out_117101.awb")
				end
	...
	Play117101035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(117101035).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101035", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101035", "story_v_out_117101.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_117101", "117101035", "story_v_out_117101.awb")

						uv0:RecordAudio("117101035", slot13)
						uv0:RecordAudio("117101035", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101035", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101035", "story_v_out_117101.awb")
				end
	...
	Play117101036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101036).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101036", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101036", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101036", "story_v_out_117101.awb")

						uv0:RecordAudio("117101036", slot19)
						uv0:RecordAudio("117101036", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101036", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101036", "story_v_out_117101.awb")
				end
	...
	Play117101037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(117101037).content)
				uv0.text_.text = slot10
	...
	Play117101038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117101038).content)
				uv0.text_.text = slot4
	...
	Play117101039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117101039).content)
				uv0.text_.text = slot4
	...
	Play117101040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117101040).content)
				uv0.text_.text = slot4
	...
	Play117101041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10034, Vector3.New(390, -415, -290), (uv0.time_ - slot11) / slot12)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				if uv0.actors_["10034"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue10034 = slot15.alpha
					uv0.var_.characterEffect10034 = slot15
				end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				if uv0.var_.characterEffect10034 then
					uv0.var_.characterEffect10034.alpha = Mathf.Lerp(uv0.var_.alphaOldValue10034, 1, (uv0.time_ - slot14) / slot15)
				end
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 and uv0.var_.characterEffect10034 then
				uv0.var_.characterEffect10034.alpha = 1
			end

			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 and uv0.var_.actorSpriteComps10034 == nil then
				uv0.var_.actorSpriteComps10034 = uv0.actors_["10034"]:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				...
				if uv0.var_.actorSpriteComps10034 then
					for slot23, slot24 in pairs(uv0.var_.actorSpriteComps10034:ToTable()) do
						if slot24 then
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 and uv0.var_.actorSpriteComps10034 then
				slot19 = 0.5
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(117101041).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101041", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101041", "story_v_out_117101.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_117101", "117101041", "story_v_out_117101.awb")

						uv0:RecordAudio("117101041", slot28)
						uv0:RecordAudio("117101041", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101041", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101041", "story_v_out_117101.awb")
				end
	...
	Play117101042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101042).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101042", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101042", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101042", "story_v_out_117101.awb")

						uv0:RecordAudio("117101042", slot10)
						uv0:RecordAudio("117101042", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101042", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101042", "story_v_out_117101.awb")
				end
	...
	Play117101043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117101043).content)
				uv0.text_.text = slot7
	...
	Play117101044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(117101044).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101044", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101044", "story_v_out_117101.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_117101", "117101044", "story_v_out_117101.awb")

						uv0:RecordAudio("117101044", slot13)
						uv0:RecordAudio("117101044", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101044", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101044", "story_v_out_117101.awb")
				end
	...
	Play117101045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101045).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101045", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101045", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101045", "story_v_out_117101.awb")

						uv0:RecordAudio("117101045", slot16)
						uv0:RecordAudio("117101045", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101045", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101045", "story_v_out_117101.awb")
				end
	...
	Play117101046 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101046).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101046", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101046", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101046", "story_v_out_117101.awb")

						uv0:RecordAudio("117101046", slot19)
						uv0:RecordAudio("117101046", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101046", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101046", "story_v_out_117101.awb")
				end
	...
	Play117101047 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101047).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101047", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101047", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101047", "story_v_out_117101.awb")

						uv0:RecordAudio("117101047", slot16)
						uv0:RecordAudio("117101047", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101047", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101047", "story_v_out_117101.awb")
				end
	...
	Play117101048 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(117101048).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101048", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101048", "story_v_out_117101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_117101", "117101048", "story_v_out_117101.awb")

						uv0:RecordAudio("117101048", slot22)
						uv0:RecordAudio("117101048", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101048", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101048", "story_v_out_117101.awb")
				end
	...
	Play117101049 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(117101049).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101049", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101049", "story_v_out_117101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_117101", "117101049", "story_v_out_117101.awb")

						uv0:RecordAudio("117101049", slot22)
						uv0:RecordAudio("117101049", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101049", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101049", "story_v_out_117101.awb")
				end
	...
	Play117101050 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117101050).content)
				uv0.text_.text = slot7
	...
	Play117101051 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101051).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101051", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101051", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101051", "story_v_out_117101.awb")

						uv0:RecordAudio("117101051", slot16)
						uv0:RecordAudio("117101051", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101051", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101051", "story_v_out_117101.awb")
				end
	...
	Play117101052 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101052).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101052", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101052", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101052", "story_v_out_117101.awb")

						uv0:RecordAudio("117101052", slot19)
						uv0:RecordAudio("117101052", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101052", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101052", "story_v_out_117101.awb")
				end
	...
	Play117101053 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101053).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101053", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101053", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101053", "story_v_out_117101.awb")

						uv0:RecordAudio("117101053", slot10)
						uv0:RecordAudio("117101053", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101053", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101053", "story_v_out_117101.awb")
				end
	...
	Play117101054 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101054).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101054", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101054", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101054", "story_v_out_117101.awb")

						uv0:RecordAudio("117101054", slot19)
						uv0:RecordAudio("117101054", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101054", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101054", "story_v_out_117101.awb")
				end
	...
	Play117101055 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101055).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101055", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101055", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101055", "story_v_out_117101.awb")

						uv0:RecordAudio("117101055", slot16)
						uv0:RecordAudio("117101055", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101055", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101055", "story_v_out_117101.awb")
				end
	...
	Play117101056 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101056).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101056", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101056", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101056", "story_v_out_117101.awb")

						uv0:RecordAudio("117101056", slot19)
						uv0:RecordAudio("117101056", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101056", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101056", "story_v_out_117101.awb")
				end
	...
	Play117101057 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101057).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101057", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101057", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101057", "story_v_out_117101.awb")

						uv0:RecordAudio("117101057", slot19)
						uv0:RecordAudio("117101057", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101057", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101057", "story_v_out_117101.awb")
				end
	...
	Play117101058 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101058).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101058", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101058", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101058", "story_v_out_117101.awb")

						uv0:RecordAudio("117101058", slot10)
						uv0:RecordAudio("117101058", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101058", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101058", "story_v_out_117101.awb")
				end
	...
	Play117101059 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101059).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101059", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101059", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101059", "story_v_out_117101.awb")

						uv0:RecordAudio("117101059", slot19)
						uv0:RecordAudio("117101059", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101059", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101059", "story_v_out_117101.awb")
				end
	...
	Play117101060 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(117101060).content)
				uv0.text_.text = slot10
	...
	Play117101061 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if uv0.actors_["10034"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue10034 = slot12.alpha
					uv0.var_.characterEffect10034 = slot12
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.characterEffect10034 then
					uv0.var_.characterEffect10034.alpha = Mathf.Lerp(uv0.var_.alphaOldValue10034, 1, (uv0.time_ - slot11) / slot12)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.characterEffect10034 then
				uv0.var_.characterEffect10034.alpha = 1
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(117101061).content)
				uv0.text_.text = slot23
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101061", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101061", "story_v_out_117101.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_117101", "117101061", "story_v_out_117101.awb")

						uv0:RecordAudio("117101061", slot28)
						uv0:RecordAudio("117101061", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101061", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101061", "story_v_out_117101.awb")
				end
	...
	Play117101062 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(117101062).content)
				uv0.text_.text = slot13
	...
	Play117101063 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101063).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101063", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101063", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101063", "story_v_out_117101.awb")

						uv0:RecordAudio("117101063", slot10)
						uv0:RecordAudio("117101063", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101063", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101063", "story_v_out_117101.awb")
				end
	...
	Play117101064 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101064).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101064", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101064", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101064", "story_v_out_117101.awb")

						uv0:RecordAudio("117101064", slot16)
						uv0:RecordAudio("117101064", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101064", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101064", "story_v_out_117101.awb")
				end
	...
	Play117101065 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(117101065).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101065", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101065", "story_v_out_117101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_117101", "117101065", "story_v_out_117101.awb")

						uv0:RecordAudio("117101065", slot22)
						uv0:RecordAudio("117101065", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101065", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101065", "story_v_out_117101.awb")
				end
	...
	Play117101066 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10034, Vector3.New(0, -2000, -290), (uv0.time_ - slot5) / slot6)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(117101066).content)
				uv0.text_.text = slot10
	...
	Play117101067 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101067).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101067", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101067", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101067", "story_v_out_117101.awb")

						uv0:RecordAudio("117101067", slot10)
						uv0:RecordAudio("117101067", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101067", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101067", "story_v_out_117101.awb")
				end
	...
	Play117101068 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117101068).content)
				uv0.text_.text = slot4
	...
	Play117101069 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101069).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101069", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101069", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101069", "story_v_out_117101.awb")

						uv0:RecordAudio("117101069", slot16)
						uv0:RecordAudio("117101069", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101069", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101069", "story_v_out_117101.awb")
				end
	...
	Play117101070 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117101070).content)
				uv0.text_.text = slot7
	...
	Play117101071 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101071).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101071", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101071", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101071", "story_v_out_117101.awb")

						uv0:RecordAudio("117101071", slot16)
						uv0:RecordAudio("117101071", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101071", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101071", "story_v_out_117101.awb")
				end
	...
	Play117101072 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(117101072).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101072", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101072", "story_v_out_117101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_117101", "117101072", "story_v_out_117101.awb")

						uv0:RecordAudio("117101072", slot22)
						uv0:RecordAudio("117101072", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101072", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101072", "story_v_out_117101.awb")
				end
	...
	Play117101073 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101073).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101073", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101073", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101073", "story_v_out_117101.awb")

						uv0:RecordAudio("117101073", slot16)
						uv0:RecordAudio("117101073", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101073", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101073", "story_v_out_117101.awb")
				end
	...
	Play117101074 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101074).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101074", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101074", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101074", "story_v_out_117101.awb")

						uv0:RecordAudio("117101074", slot19)
						uv0:RecordAudio("117101074", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101074", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101074", "story_v_out_117101.awb")
				end
	...
	Play117101075 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101075).content)
				uv0.text_.text = slot14

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (76 <= 0 and slot11 or slot11 * utf8.len(slot14) / slot15) > 0 and slot11 < slot17 then
					uv0.talkMaxDuration = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101075", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101075", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101075", "story_v_out_117101.awb")

						uv0:RecordAudio("117101075", slot19)
						uv0:RecordAudio("117101075", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101075", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101075", "story_v_out_117101.awb")
				end
	...
	Play117101076 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101076).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101076", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101076", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101076", "story_v_out_117101.awb")

						uv0:RecordAudio("117101076", slot10)
						uv0:RecordAudio("117101076", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101076", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101076", "story_v_out_117101.awb")
				end
	...
	Play117101077 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117101077).content)
				uv0.text_.text = slot4
	...
	Play117101078 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101078).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101078", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101078", "story_v_out_117101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117101", "117101078", "story_v_out_117101.awb")

						uv0:RecordAudio("117101078", slot19)
						uv0:RecordAudio("117101078", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101078", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101078", "story_v_out_117101.awb")
				end
	...
	Play117101079 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10034, Vector3.New(0, -2000, -290), (uv0.time_ - slot8) / slot9)
			end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033, Vector3.New(0, -2000, 0), (uv0.time_ - slot11) / slot12)
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(117101079).content)
				uv0.text_.text = slot17
	...
	Play117101080 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117101080).content)
				uv0.text_.text = slot4
	...
	Play117101081 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101081).content)
				uv0.text_.text = slot11
	...
	Play117101082 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10036, Vector3.New(-390, -445, -290), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.actorSpriteComps10036 == nil then
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.actorSpriteComps10036 then
					for slot12, slot13 in pairs(uv0.var_.actorSpriteComps10036:ToTable()) do
						if slot13 then
							slot14 = Mathf.Lerp(slot13.color.r, 1, slot8)
							slot13.color = Color.New(slot14, slot14, slot14)
						end
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.actorSpriteComps10036 then
				slot8 = 1
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if uv0.actors_["10036"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue10036 = slot10.alpha
					uv0.var_.characterEffect10036 = slot10
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				if uv0.var_.characterEffect10036 then
					uv0.var_.characterEffect10036.alpha = Mathf.Lerp(uv0.var_.alphaOldValue10036, 1, (uv0.time_ - slot9) / slot10)
				end
			end

			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.characterEffect10036 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(117101082).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101082", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101082", "story_v_out_117101.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_117101", "117101082", "story_v_out_117101.awb")

						uv0:RecordAudio("117101082", slot20)
						uv0:RecordAudio("117101082", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101082", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101082", "story_v_out_117101.awb")
				end
	...
	Play117101083 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101083).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101083", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101083", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101083", "story_v_out_117101.awb")

						uv0:RecordAudio("117101083", slot10)
						uv0:RecordAudio("117101083", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101083", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101083", "story_v_out_117101.awb")
				end
	...
	Play117101084 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(117101084).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101084", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101084", "story_v_out_117101.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_117101", "117101084", "story_v_out_117101.awb")

						uv0:RecordAudio("117101084", slot20)
						uv0:RecordAudio("117101084", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101084", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101084", "story_v_out_117101.awb")
				end
	...
	Play117101085 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101085).content)
				uv0.text_.text = slot11

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (60 <= 0 and slot8 or slot8 * utf8.len(slot11) / slot12) > 0 and slot8 < slot14 then
					uv0.talkMaxDuration = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101085", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101085", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101085", "story_v_out_117101.awb")

						uv0:RecordAudio("117101085", slot16)
						uv0:RecordAudio("117101085", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101085", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101085", "story_v_out_117101.awb")
				end
	...
	Play117101086 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101086).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101086", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101086", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101086", "story_v_out_117101.awb")

						uv0:RecordAudio("117101086", slot16)
						uv0:RecordAudio("117101086", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101086", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101086", "story_v_out_117101.awb")
				end
	...
	Play117101087 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101087).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101087", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101087", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101087", "story_v_out_117101.awb")

						uv0:RecordAudio("117101087", slot16)
						uv0:RecordAudio("117101087", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101087", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101087", "story_v_out_117101.awb")
				end
	...
	Play117101088 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101088).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101088", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101088", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101088", "story_v_out_117101.awb")

						uv0:RecordAudio("117101088", slot16)
						uv0:RecordAudio("117101088", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101088", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101088", "story_v_out_117101.awb")
				end
	...
	Play117101089 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101089).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101089", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101089", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101089", "story_v_out_117101.awb")

						uv0:RecordAudio("117101089", slot10)
						uv0:RecordAudio("117101089", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101089", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101089", "story_v_out_117101.awb")
				end
	...
	Play117101090 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.actors_["10036"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue10036 = slot6.alpha
					uv0.var_.characterEffect10036 = slot6
				end

				uv0.var_.alphaOldValue10036 = 1
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.characterEffect10036 then
					uv0.var_.characterEffect10036.alpha = Mathf.Lerp(uv0.var_.alphaOldValue10036, 0, (uv0.time_ - slot5) / slot6)
				end
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.characterEffect10036 then
				uv0.var_.characterEffect10036.alpha = 0
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(117101090).content)
				uv0.text_.text = slot10
	...
	Play117101091 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot4 = uv0.actors_["10036"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPos10036 = slot4.localPosition
				slot4.localScale = Vector3.New(1, 1, 1)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10036, Vector3.New(-390, -445, -290), (uv0.time_ - slot5) / slot6)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 and uv0.var_.actorSpriteComps10036 == nil then
				uv0.var_.actorSpriteComps10036 = uv0.actors_["10036"]:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				...
				if uv0.var_.actorSpriteComps10036 then
					for slot14, slot15 in pairs(uv0.var_.actorSpriteComps10036:ToTable()) do
						if slot15 then
							slot16 = Mathf.Lerp(slot15.color.r, 1, slot10)
							slot15.color = Color.New(slot16, slot16, slot16)
						end
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 and uv0.var_.actorSpriteComps10036 then
				slot10 = 1
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				if uv0.actors_["10036"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue10036 = slot15.alpha
					uv0.var_.characterEffect10036 = slot15
				end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				if uv0.var_.characterEffect10036 then
					uv0.var_.characterEffect10036.alpha = Mathf.Lerp(uv0.var_.alphaOldValue10036, 1, (uv0.time_ - slot14) / slot15)
				end
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 and uv0.var_.characterEffect10036 then
				uv0.var_.characterEffect10036.alpha = 1
			end
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				...
				if uv0.var_.actorSpriteComps1132 then
					for slot23, slot24 in pairs(uv0.var_.actorSpriteComps1132:ToTable()) do
						if slot24 then
							slot25 = Mathf.Lerp(slot24.color.r, 0.5, slot19)
							slot24.color = Color.New(slot25, slot25, slot25)
						end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(117101091).content)
				uv0.text_.text = slot23
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101091", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101091", "story_v_out_117101.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_117101", "117101091", "story_v_out_117101.awb")

						uv0:RecordAudio("117101091", slot28)
						uv0:RecordAudio("117101091", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101091", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101091", "story_v_out_117101.awb")
				end
	...
	Play117101092 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101092).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101092", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101092", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101092", "story_v_out_117101.awb")

						uv0:RecordAudio("117101092", slot16)
						uv0:RecordAudio("117101092", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101092", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101092", "story_v_out_117101.awb")
				end
	...
	Play117101093 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101093).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101093", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101093", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101093", "story_v_out_117101.awb")

						uv0:RecordAudio("117101093", slot10)
						uv0:RecordAudio("117101093", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101093", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101093", "story_v_out_117101.awb")
				end
	...
	Play117101094 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101094).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101094", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101094", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101094", "story_v_out_117101.awb")

						uv0:RecordAudio("117101094", slot16)
						uv0:RecordAudio("117101094", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101094", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101094", "story_v_out_117101.awb")
				end
	...
	Play117101095 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(117101095).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101095", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101095", "story_v_out_117101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117101", "117101095", "story_v_out_117101.awb")

						uv0:RecordAudio("117101095", slot16)
						uv0:RecordAudio("117101095", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101095", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101095", "story_v_out_117101.awb")
				end
	...
	Play117101096 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101096).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101096", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101096", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101096", "story_v_out_117101.awb")

						uv0:RecordAudio("117101096", slot10)
						uv0:RecordAudio("117101096", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101096", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101096", "story_v_out_117101.awb")
				end
	...
	Play117101097 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117101097).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101097", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101097", "story_v_out_117101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117101", "117101097", "story_v_out_117101.awb")

						uv0:RecordAudio("117101097", slot10)
						uv0:RecordAudio("117101097", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101097", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101097", "story_v_out_117101.awb")
				end
	...
	Play117101098 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.actors_["10036"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPos10036 = slot1.localPosition
				slot1.localScale = Vector3.New(1, 1, 1)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10036, Vector3.New(-390, -445, -290), (uv0.time_ - slot2) / slot3)
			end

			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 then
				slot1.localPosition = Vector3.New(-390, -445, -290)
			end

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 and uv0.var_.actorSpriteComps10036 == nil then
				uv0.var_.actorSpriteComps10036 = uv0.actors_["10036"]:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				...
				if uv0.var_.actorSpriteComps10036 then
					for slot11, slot12 in pairs(uv0.var_.actorSpriteComps10036:ToTable()) do
						if slot12 then
							slot13 = Mathf.Lerp(slot12.color.r, 1, slot7)
							slot12.color = Color.New(slot13, slot13, slot13)
						end
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.actorSpriteComps10036 then
				slot7 = 1
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(117101098).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117101", "117101098", "story_v_out_117101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117101", "117101098", "story_v_out_117101.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_117101", "117101098", "story_v_out_117101.awb")

						uv0:RecordAudio("117101098", slot24)
						uv0:RecordAudio("117101098", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117101", "117101098", "story_v_out_117101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117101", "117101098", "story_v_out_117101.awb")
				end
	...
	Play117101099 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(117101099).content)
				uv0.text_.text = slot10
	...
	Play117101100 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117101100).content)
				uv0.text_.text = slot14
	...
	Play117101101 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(117101101).content)
