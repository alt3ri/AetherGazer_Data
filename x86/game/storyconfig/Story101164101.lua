return {
	Play116411001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(116411001).content)
	...
	Play116411002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116411002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411002", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411002", "story_v_out_116411.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116411", "116411002", "story_v_out_116411.awb")

						uv0:RecordAudio("116411002", slot19)
						uv0:RecordAudio("116411002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411002", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411002", "story_v_out_116411.awb")
				end
	...
	Play116411003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116411003).content)
	...
	Play116411004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116411004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411004", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411004", "story_v_out_116411.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411004", "story_v_out_116411.awb")

						uv0:RecordAudio("116411004", slot18)
						uv0:RecordAudio("116411004", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411004", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411004", "story_v_out_116411.awb")
				end
	...
	Play116411005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116411005).content)
				uv0.text_.text = slot8
	...
	Play116411006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116411006).content)
	...
	Play116411007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116411007).content)
				uv0.text_.text = slot5
	...
	Play116411008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116411008).content)
	...
	Play116411009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116411009).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411009", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411009", "story_v_out_116411.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411009", "story_v_out_116411.awb")

						uv0:RecordAudio("116411009", slot18)
						uv0:RecordAudio("116411009", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411009", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411009", "story_v_out_116411.awb")
				end
	...
	Play116411010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116411010).content)
				uv0.text_.text = slot8
	...
	Play116411011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot13) / slot14)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot16 + slot0 and uv0.var_.characterEffect10025ui_story == nil then
				uv0.var_.characterEffect10025ui_story = uv0.actors_["10025ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if uv0.time_ >= slot16 + slot17 and uv0.time_ < slot16 + slot17 + slot0 and uv0.var_.characterEffect10025ui_story then
				uv0.var_.characterEffect10025ui_story.fillFlat = false
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				slot25 = uv0:FormatText(uv0:GetWordFromCfg(116411011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411011", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411011", "story_v_out_116411.awb") / 1000 + slot20 then
						uv0.duration_ = slot29 + slot20
					end

					if slot24.prefab_name ~= "" and uv0.actors_[slot24.prefab_name] ~= nil then
						slot30 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot24.prefab_name].transform, "story_v_out_116411", "116411011", "story_v_out_116411.awb")

						uv0:RecordAudio("116411011", slot30)
						uv0:RecordAudio("116411011", slot30)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411011", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411011", "story_v_out_116411.awb")
				end
	...
	Play116411012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411012
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(116411012).content)
	...
	Play116411013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411013
		slot1.duration_ = 4.066
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[347].name)
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116411013).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411013", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411013", "story_v_out_116411.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116411", "116411013", "story_v_out_116411.awb")

						uv0:RecordAudio("116411013", slot10)
						uv0:RecordAudio("116411013", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411013", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411013", "story_v_out_116411.awb")
				end
	...
	Play116411014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116411014).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411014", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411014", "story_v_out_116411.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411014", "story_v_out_116411.awb")

						uv0:RecordAudio("116411014", slot18)
						uv0:RecordAudio("116411014", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411014", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411014", "story_v_out_116411.awb")
				end
	...
	Play116411015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116411015).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411015", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411015", "story_v_out_116411.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116411", "116411015", "story_v_out_116411.awb")

						uv0:RecordAudio("116411015", slot13)
						uv0:RecordAudio("116411015", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411015", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411015", "story_v_out_116411.awb")
				end
	...
	Play116411016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116411016).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411016", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411016", "story_v_out_116411.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411016", "story_v_out_116411.awb")

						uv0:RecordAudio("116411016", slot18)
						uv0:RecordAudio("116411016", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411016", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411016", "story_v_out_116411.awb")
				end
	...
	Play116411017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116411017).content)
				uv0.text_.text = slot8
	...
	Play116411018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116411018).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411018", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411018", "story_v_out_116411.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116411", "116411018", "story_v_out_116411.awb")

						uv0:RecordAudio("116411018", slot17)
						uv0:RecordAudio("116411018", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411018", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411018", "story_v_out_116411.awb")
				end
	...
	Play116411019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411019
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot12) / slot13)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(116411019).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411019", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411019", "story_v_out_116411.awb") / 1000 + slot19 then
						uv0.duration_ = slot28 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_116411", "116411019", "story_v_out_116411.awb")

						uv0:RecordAudio("116411019", slot29)
						uv0:RecordAudio("116411019", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411019", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411019", "story_v_out_116411.awb")
				end
	...
	Play116411020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411020
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(116411020).content)
				uv0.text_.text = slot15

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (29 <= 0 and slot11 or slot11 * utf8.len(slot15) / slot16) > 0 and slot11 < slot18 then
					uv0.talkMaxDuration = slot18
	...
	Play116411021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411021
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116411021).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411021", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411021", "story_v_out_116411.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411021", "story_v_out_116411.awb")

						uv0:RecordAudio("116411021", slot18)
						uv0:RecordAudio("116411021", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411021", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411021", "story_v_out_116411.awb")
				end
	...
	Play116411022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116411022).content)
				uv0.text_.text = slot8
	...
	Play116411023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411023
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3.80000000000001 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPos10025ui_story = uv0.actors_["10025ui_story"].transform.localPosition
			end
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot15 + slot0 and uv0.var_.characterEffect10025ui_story == nil then
				uv0.var_.characterEffect10025ui_story = uv0.actors_["10025ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 3.99999999999999 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(116411023).content)
				uv0.text_.text = slot24

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (26 <= 0 and slot20 or slot20 * utf8.len(slot24) / slot25) > 0 and slot20 < slot27 then
					uv0.talkMaxDuration = slot27
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411023", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411023", "story_v_out_116411.awb") / 1000 + slot19 then
						uv0.duration_ = slot28 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_116411", "116411023", "story_v_out_116411.awb")

						uv0:RecordAudio("116411023", slot29)
						uv0:RecordAudio("116411023", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411023", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411023", "story_v_out_116411.awb")
				end
	...
	Play116411024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116411024).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411024", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411024", "story_v_out_116411.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411024", "story_v_out_116411.awb")

						uv0:RecordAudio("116411024", slot18)
						uv0:RecordAudio("116411024", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411024", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411024", "story_v_out_116411.awb")
				end
	...
	Play116411025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411025
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116411025).content)
	...
	Play116411026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411026
		slot1.duration_ = 9.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116411026).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411026", "story_v_out_116411.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116411", "116411026", "story_v_out_116411.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411026", "story_v_out_116411.awb")

						uv0:RecordAudio("116411026", slot18)
						uv0:RecordAudio("116411026", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116411", "116411026", "story_v_out_116411.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116411", "116411026", "story_v_out_116411.awb")
				end
	...
	Play116411027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411027
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPosI05f = uv0.bgs_.I05f.transform.localPosition
			end

			slot6 = 3

			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPosI05f, Vector3.New(0.5, 1, 9), (uv0.time_ - slot5) / slot6)
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(0.5, 1, 9)
			end
			...
			if 1.23333333333333 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(116411027).content)
				uv0.text_.text = slot16
	...
	Play116411028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411028
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116411028).content)
	...
	Play116411029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411029
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116411029).content)
				uv0.text_.text = slot4
	...
	Play116411030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411030
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116411030).content)
	...
	Play116411031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116411031
		slot1.duration_ = 152.656666666666
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 2 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				manager.video:Play("SofdecAsset/story/101164101.usm", function (slot0)
					uv0:Skip(slot0)
