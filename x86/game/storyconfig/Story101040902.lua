return {
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.B04c:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB04c = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueB04c = slot7
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueB04c then
					...
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueB04c, 1, (uv0.time_ - slot5) / slot6)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104092001).content)
	...
	Play104092002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104092002).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092002", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092002", "story_v_out_104092.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104092", "104092002", "story_v_out_104092.awb")

						uv0:RecordAudio("104092002", slot19)
						uv0:RecordAudio("104092002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092002", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092002", "story_v_out_104092.awb")
				end
	...
	Play104092003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(104092003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092003", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092003", "story_v_out_104092.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104092", "104092003", "story_v_out_104092.awb")

						uv0:RecordAudio("104092003", slot22)
						uv0:RecordAudio("104092003", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092003", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092003", "story_v_out_104092.awb")
				end
	...
	Play104092004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(104092004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092004", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092004", "story_v_out_104092.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_104092", "104092004", "story_v_out_104092.awb")

						uv0:RecordAudio("104092004", slot28)
						uv0:RecordAudio("104092004", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092004", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092004", "story_v_out_104092.awb")
				end
	...
	Play104092005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(104092005).content)
				uv0.text_.text = slot23
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092005", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092005", "story_v_out_104092.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_104092", "104092005", "story_v_out_104092.awb")

						uv0:RecordAudio("104092005", slot28)
						uv0:RecordAudio("104092005", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092005", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092005", "story_v_out_104092.awb")
				end
	...
	Play104092006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot10) / slot11)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(104092006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092006", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092006", "story_v_out_104092.awb") / 1000 + slot20 then
						uv0.duration_ = slot28 + slot20
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_104092", "104092006", "story_v_out_104092.awb")

						uv0:RecordAudio("104092006", slot29)
						uv0:RecordAudio("104092006", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092006", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092006", "story_v_out_104092.awb")
				end
	...
	Play104092007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104092007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092007", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092007", "story_v_out_104092.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104092", "104092007", "story_v_out_104092.awb")

						uv0:RecordAudio("104092007", slot18)
						uv0:RecordAudio("104092007", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092007", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092007", "story_v_out_104092.awb")
				end
	...
	Play104092008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(104092008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092008", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092008", "story_v_out_104092.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_104092", "104092008", "story_v_out_104092.awb")

						uv0:RecordAudio("104092008", slot16)
						uv0:RecordAudio("104092008", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092008", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092008", "story_v_out_104092.awb")
				end
	...
	Play104092009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104092009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092009", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092009", "story_v_out_104092.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104092", "104092009", "story_v_out_104092.awb")

						uv0:RecordAudio("104092009", slot13)
						uv0:RecordAudio("104092009", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092009", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092009", "story_v_out_104092.awb")
				end
	...
	Play104092010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_4012")

				uv0.callingController_:SetSelectedState("normal")

				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104092010).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092010", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092010", "story_v_out_104092.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104092", "104092010", "story_v_out_104092.awb")

						uv0:RecordAudio("104092010", slot13)
						uv0:RecordAudio("104092010", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092010", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092010", "story_v_out_104092.awb")
				end
	...
	Play104092011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(104092011).content)
				uv0.text_.text = slot4

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (73 <= 0 and slot2 or slot2 * utf8.len(slot4) / slot5) > 0 and slot2 < slot7 then
	...
	Play104092012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104092012).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092012", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092012", "story_v_out_104092.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104092", "104092012", "story_v_out_104092.awb")

						uv0:RecordAudio("104092012", slot13)
						uv0:RecordAudio("104092012", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092012", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092012", "story_v_out_104092.awb")
				end
	...
	Play104092013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104092013).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092013", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092013", "story_v_out_104092.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104092", "104092013", "story_v_out_104092.awb")

						uv0:RecordAudio("104092013", slot13)
						uv0:RecordAudio("104092013", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092013", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092013", "story_v_out_104092.awb")
				end
	...
	Play104092014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104092014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092014", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092014", "story_v_out_104092.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104092", "104092014", "story_v_out_104092.awb")

						uv0:RecordAudio("104092014", slot10)
						uv0:RecordAudio("104092014", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092014", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092014", "story_v_out_104092.awb")
				end
	...
	Play104092015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104092015).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092015", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092015", "story_v_out_104092.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104092", "104092015", "story_v_out_104092.awb")

						uv0:RecordAudio("104092015", slot10)
						uv0:RecordAudio("104092015", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092015", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092015", "story_v_out_104092.awb")
				end
	...
	Play104092016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104092016).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092016", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092016", "story_v_out_104092.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104092", "104092016", "story_v_out_104092.awb")

						uv0:RecordAudio("104092016", slot10)
						uv0:RecordAudio("104092016", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092016", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092016", "story_v_out_104092.awb")
				end
	...
	Play104092017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104092017).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104092", "104092017", "story_v_out_104092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104092", "104092017", "story_v_out_104092.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104092", "104092017", "story_v_out_104092.awb")

						uv0:RecordAudio("104092017", slot10)
						uv0:RecordAudio("104092017", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104092", "104092017", "story_v_out_104092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104092", "104092017", "story_v_out_104092.awb")
				end
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				if uv0.bgs_.B04c:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB04c = slot4:GetColor("_Color").a
					uv0.var_.alphaMatValueB04c = slot4
				end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				if uv0.var_.alphaMatValueB04c then
					...
					slot7.a = Mathf.Lerp(uv0.var_.alphaOldValueB04c, 0, (uv0.time_ - slot2) / slot3)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if uv0.bgs_.S0406:GetComponent("SpriteRenderer") then
					slot7.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot8 = slot7.material
					uv0.var_.alphaOldValueS0406 = slot8:GetColor("_Color").a
					uv0.var_.alphaMatValueS0406 = slot8
				end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.alphaMatValueS0406 then
					...
					slot11.a = Mathf.Lerp(uv0.var_.alphaOldValueS0406, 1, (uv0.time_ - slot6) / slot7)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPosB04c = uv0.bgs_.B04c.transform.localPosition
			end
			...
			if 5.53333333333333 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.var_.moveOldPosS0406 = uv0.bgs_.S0406.transform.localPosition
			end
			...
			if 5.53333333333333 < uv0.time_ and uv0.time_ <= slot24 + slot0 then
				uv0.var_.moveOldPosS0406a = uv0.bgs_.S0406a.transform.localPosition
			end
			...
			if 6.03333333333333 < uv0.time_ and uv0.time_ <= slot31 + slot0 then
				...
				slot35 = uv0:FormatText(uv0:GetWordFromCfg(104092018).content)
				uv0.text_.text = slot35

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (2 <= 0 and slot32 or slot32 * utf8.len(slot35) / slot36) > 0 and slot32 < slot38 then
					uv0.talkMaxDuration = slot38

					if uv0.duration_ < slot38 + slot31 + 0.3 then
						uv0.duration_ = slot38 + slot31
					end
				end
