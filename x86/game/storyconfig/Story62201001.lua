return {
	Play62201001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_49 < arg_1_1.time_ and arg_1_1.time_ <= var_4_49 + arg_4_0 then
				...
				local var_4_53 = arg_1_1:GetWordFromCfg(62201001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201001", "story_v_chess_62201.awb") ~= 0 then
					local var_4_58 = manager.audio:GetVoiceLength("story_v_chess_62201", "62201001", "story_v_chess_62201.awb") / 1000
					...
					if var_4_53.prefab_name ~= "" and arg_1_1.actors_[var_4_53.prefab_name] ~= nil then
						local var_4_59 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_53.prefab_name].transform, "story_v_chess_62201", "62201001", "story_v_chess_62201.awb")

						arg_1_1:RecordAudio("62201001", var_4_59)
						arg_1_1:RecordAudio("62201001", var_4_59)
					else
	...
	Play62201002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 62201002
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_2 < arg_7_1.time_ and arg_7_1.time_ <= var_10_2 + arg_10_0 then
				...
				local var_10_4 = arg_7_1:FormatText(StoryNameCfg[67].name)
				...
				local var_10_5 = arg_7_1:GetWordFromCfg(62201002)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201002", "story_v_chess_62201.awb") ~= 0 then
					local var_10_10 = manager.audio:GetVoiceLength("story_v_chess_62201", "62201002", "story_v_chess_62201.awb") / 1000
					...
					if var_10_5.prefab_name ~= "" and arg_7_1.actors_[var_10_5.prefab_name] ~= nil then
						local var_10_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_7_1.actors_[var_10_5.prefab_name].transform, "story_v_chess_62201", "62201002", "story_v_chess_62201.awb")

						arg_7_1:RecordAudio("62201002", var_10_11)
						arg_7_1:RecordAudio("62201002", var_10_11)
					else
						arg_7_1:AudioAction("play", "voice", "story_v_chess_62201", "62201002", "story_v_chess_62201.awb")
					end

					arg_7_1:RecordHistoryTalkVoice("story_v_chess_62201", "62201002", "story_v_chess_62201.awb")
				end
	...
	Play62201003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 62201003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play62201004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_6 < arg_11_1.time_ and arg_11_1.time_ <= var_14_6 + arg_14_0 then
				...
				local var_14_9 = arg_11_1:GetWordFromCfg(62201003)
	...
	Play62201004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 62201004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play62201005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_1 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 then
				arg_15_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3101cva")
			end
			...
			if var_18_6 < arg_15_1.time_ and arg_15_1.time_ <= var_18_6 + arg_18_0 then
				...
				local var_18_9 = arg_15_1:GetWordFromCfg(62201004)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201004", "story_v_chess_62201.awb") ~= 0 then
					local var_18_14 = manager.audio:GetVoiceLength("story_v_chess_62201", "62201004", "story_v_chess_62201.awb") / 1000
					...
					if var_18_9.prefab_name ~= "" and arg_15_1.actors_[var_18_9.prefab_name] ~= nil then
						local var_18_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_15_1.actors_[var_18_9.prefab_name].transform, "story_v_chess_62201", "62201004", "story_v_chess_62201.awb")

						arg_15_1:RecordAudio("62201004", var_18_15)
						arg_15_1:RecordAudio("62201004", var_18_15)
					else
						arg_15_1:AudioAction("play", "voice", "story_v_chess_62201", "62201004", "story_v_chess_62201.awb")
					end

					arg_15_1:RecordHistoryTalkVoice("story_v_chess_62201", "62201004", "story_v_chess_62201.awb")
				end
	...
	Play62201005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 62201005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play62201006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_6 < arg_19_1.time_ and arg_19_1.time_ <= var_22_6 + arg_22_0 then
				...
				local var_22_9 = arg_19_1:GetWordFromCfg(62201005)
	...
	Play62201006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 62201006
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_1 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				arg_23_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1303cva")
			end
			...
			if var_26_6 < arg_23_1.time_ and arg_23_1.time_ <= var_26_6 + arg_26_0 then
				...
				local var_26_9 = arg_23_1:GetWordFromCfg(62201006)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201006", "story_v_chess_62201.awb") ~= 0 then
					local var_26_14 = manager.audio:GetVoiceLength("story_v_chess_62201", "62201006", "story_v_chess_62201.awb") / 1000
					...
					if var_26_9.prefab_name ~= "" and arg_23_1.actors_[var_26_9.prefab_name] ~= nil then
						local var_26_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_23_1.actors_[var_26_9.prefab_name].transform, "story_v_chess_62201", "62201006", "story_v_chess_62201.awb")

						arg_23_1:RecordAudio("62201006", var_26_15)
						arg_23_1:RecordAudio("62201006", var_26_15)
					else
						arg_23_1:AudioAction("play", "voice", "story_v_chess_62201", "62201006", "story_v_chess_62201.awb")
					end

					arg_23_1:RecordHistoryTalkVoice("story_v_chess_62201", "62201006", "story_v_chess_62201.awb")
				end
