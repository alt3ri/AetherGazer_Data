return {
	Play102081001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.characterEffect2022_tpose == nil then
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.characterEffect2022_tpose then
				uv0.var_.characterEffect2022_tpose.fillFlat = false
			end

			if uv0.bgs_.B02c == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				if uv0.bgs_.B02c:GetComponent("SpriteRenderer") then
					slot14.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot15 = slot14.material
					uv0.var_.alphaOldValueB02c = slot15:GetColor("_Color").a
					uv0.var_.alphaMatValueB02c = slot15
				end

				uv0.var_.alphaOldValueB02c = 0
			end

			slot14 = 1.5

			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				if uv0.var_.alphaMatValueB02c then
					slot17 = uv0.var_.alphaMatValueB02c
					slot18 = slot17:GetColor("_Color")
					slot18.a = Mathf.Lerp(uv0.var_.alphaOldValueB02c, 1, (uv0.time_ - slot13) / slot14)

					slot17:SetColor("_Color", slot18)
				end
			end

			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 and uv0.var_.alphaMatValueB02c then
				slot15 = uv0.var_.alphaMatValueB02c
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(0, -0.55, -0.3), (uv0.time_ - slot17) / slot18)
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 then
				slot16.localPosition = Vector3.New(0, -0.55, -0.3)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				...
				slot27 = uv0:FormatText(uv0:GetWordFromCfg(102081001).content)
				uv0.text_.text = slot27

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (15 <= 0 and slot23 or slot23 * utf8.len(slot27) / slot28) > 0 and slot23 < slot30 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081001", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081001", "story_v_out_102081.awb") / 1000 + slot22 then
						uv0.duration_ = slot31 + slot22
					end

					if slot26.prefab_name ~= "" and uv0.actors_[slot26.prefab_name] ~= nil then
						slot32 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot26.prefab_name].transform, "story_v_out_102081", "102081001", "story_v_out_102081.awb")

						uv0:RecordAudio("102081001", slot32)
						uv0:RecordAudio("102081001", slot32)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081001", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081001", "story_v_out_102081.awb")
				end
	...
	Play102081002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot11) / slot12)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2018_tpose, Vector3.New(0, -0.5, -0.7), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -0.5, -0.7)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(102081002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081002", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081002", "story_v_out_102081.awb") / 1000 + slot17 then
						uv0.duration_ = slot25 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_102081", "102081002", "story_v_out_102081.awb")

						uv0:RecordAudio("102081002", slot26)
						uv0:RecordAudio("102081002", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081002", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081002", "story_v_out_102081.awb")
				end
	...
	Play102081003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect2018_tpose == nil then
				uv0.var_.characterEffect2018_tpose = uv0.actors_["2018_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.characterEffect2018_tpose then
					...
					uv0.var_.characterEffect2018_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot6) / slot7)
				end
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.characterEffect2018_tpose then
				uv0.var_.characterEffect2018_tpose.fillFlat = true
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2018_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot9) / slot10)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(102081003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081003", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081003", "story_v_out_102081.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102081", "102081003", "story_v_out_102081.awb")

						uv0:RecordAudio("102081003", slot25)
						uv0:RecordAudio("102081003", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081003", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081003", "story_v_out_102081.awb")
				end
	...
	Play102081004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081004
		slot1.duration_ = 2.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102081004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081004", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081004", "story_v_out_102081.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102081", "102081004", "story_v_out_102081.awb")

						uv0:RecordAudio("102081004", slot22)
						uv0:RecordAudio("102081004", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081004", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081004", "story_v_out_102081.awb")
				end
	...
	Play102081005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(102081005).content)
	...
	Play102081006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081006
		slot1.duration_ = 5.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102081006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081006", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081006", "story_v_out_102081.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081006", "story_v_out_102081.awb")

						uv0:RecordAudio("102081006", slot17)
						uv0:RecordAudio("102081006", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081006", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081006", "story_v_out_102081.awb")
				end
	...
	Play102081007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081007
		slot1.duration_ = 3.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102081007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081007", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081007", "story_v_out_102081.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102081", "102081007", "story_v_out_102081.awb")

						uv0:RecordAudio("102081007", slot21)
						uv0:RecordAudio("102081007", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081007", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081007", "story_v_out_102081.awb")
				end
	...
	Play102081008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102081008).content)
	...
	Play102081009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081009
		slot1.duration_ = 1.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0, -1.2, -5.8), (uv0.time_ - slot14) / slot15)
				slot19 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot19.x, slot19.y, slot19.z)
				slot20 = slot13.localEulerAngles
				slot20.z = 0
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -1.2, -5.8)
				slot18 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot18.x, slot18.y, slot18.z)
				slot19 = slot13.localEulerAngles
				slot19.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0:PlayTimeline("10002_tpose", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3101cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(102081009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081009", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081009", "story_v_out_102081.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102081", "102081009", "story_v_out_102081.awb")

						uv0:RecordAudio("102081009", slot27)
						uv0:RecordAudio("102081009", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081009", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081009", "story_v_out_102081.awb")
				end
	...
	Play102081010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102081010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081010", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081010", "story_v_out_102081.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102081", "102081010", "story_v_out_102081.awb")

						uv0:RecordAudio("102081010", slot24)
						uv0:RecordAudio("102081010", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081010", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081010", "story_v_out_102081.awb")
				end
	...
	Play102081011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081011
		slot1.duration_ = 6.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(102081011).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081011", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081011", "story_v_out_102081.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102081", "102081011", "story_v_out_102081.awb")

						uv0:RecordAudio("102081011", slot27)
						uv0:RecordAudio("102081011", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081011", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081011", "story_v_out_102081.awb")
				end
	...
	Play102081012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(102081012).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081012", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081012", "story_v_out_102081.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102081", "102081012", "story_v_out_102081.awb")

						uv0:RecordAudio("102081012", slot25)
						uv0:RecordAudio("102081012", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081012", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081012", "story_v_out_102081.awb")
				end
	...
	Play102081013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102081013).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081013", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081013", "story_v_out_102081.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081013", "story_v_out_102081.awb")

						uv0:RecordAudio("102081013", slot17)
						uv0:RecordAudio("102081013", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081013", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081013", "story_v_out_102081.awb")
				end
	...
	Play102081014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081014
		slot1.duration_ = 7.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("10002_tpose", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3104cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102081014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081014", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081014", "story_v_out_102081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081014", "story_v_out_102081.awb")

						uv0:RecordAudio("102081014", slot18)
						uv0:RecordAudio("102081014", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081014", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081014", "story_v_out_102081.awb")
				end
	...
	Play102081015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081015
		slot1.duration_ = 6.914190599693
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102081015).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081015", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081015", "story_v_out_102081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081015", "story_v_out_102081.awb")

						uv0:RecordAudio("102081015", slot18)
						uv0:RecordAudio("102081015", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081015", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081015", "story_v_out_102081.awb")
				end
	...
	Play102081016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102081016).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081016", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081016", "story_v_out_102081.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081016", "story_v_out_102081.awb")

						uv0:RecordAudio("102081016", slot17)
						uv0:RecordAudio("102081016", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081016", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081016", "story_v_out_102081.awb")
				end
	...
	Play102081017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102081017).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081017", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081017", "story_v_out_102081.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081017", "story_v_out_102081.awb")

						uv0:RecordAudio("102081017", slot17)
						uv0:RecordAudio("102081017", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081017", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081017", "story_v_out_102081.awb")
				end
	...
	Play102081018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102081018).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081018", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081018", "story_v_out_102081.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102081", "102081018", "story_v_out_102081.awb")

						uv0:RecordAudio("102081018", slot12)
						uv0:RecordAudio("102081018", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081018", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081018", "story_v_out_102081.awb")
				end
	...
	Play102081019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081019
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102081019).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081019", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081019", "story_v_out_102081.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081019", "story_v_out_102081.awb")

						uv0:RecordAudio("102081019", slot17)
						uv0:RecordAudio("102081019", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081019", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081019", "story_v_out_102081.awb")
				end
	...
	Play102081020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(102081020).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081020", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081020", "story_v_out_102081.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102081", "102081020", "story_v_out_102081.awb")

						uv0:RecordAudio("102081020", slot20)
						uv0:RecordAudio("102081020", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081020", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081020", "story_v_out_102081.awb")
				end
	...
	Play102081021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102081021).content)
				uv0.text_.text = slot7
	...
	Play102081022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(102081022).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081022", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081022", "story_v_out_102081.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_102081", "102081022", "story_v_out_102081.awb")

						uv0:RecordAudio("102081022", slot14)
						uv0:RecordAudio("102081022", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081022", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081022", "story_v_out_102081.awb")
				end
	...
	Play102081023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(102081023).content)
	...
	Play102081024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102081024).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081024", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081024", "story_v_out_102081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081024", "story_v_out_102081.awb")

						uv0:RecordAudio("102081024", slot18)
						uv0:RecordAudio("102081024", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081024", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081024", "story_v_out_102081.awb")
				end
	...
	Play102081025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102081025).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081025", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081025", "story_v_out_102081.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102081", "102081025", "story_v_out_102081.awb")

						uv0:RecordAudio("102081025", slot24)
						uv0:RecordAudio("102081025", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081025", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081025", "story_v_out_102081.awb")
				end
	...
	Play102081026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081026
		slot1.duration_ = 3.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0, -1.2, -5.8), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -1.2, -5.8)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102081026).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081026", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081026", "story_v_out_102081.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102081", "102081026", "story_v_out_102081.awb")

						uv0:RecordAudio("102081026", slot21)
						uv0:RecordAudio("102081026", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081026", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081026", "story_v_out_102081.awb")
				end
	...
	Play102081027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081027
		slot1.duration_ = 7.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102081027).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081027", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081027", "story_v_out_102081.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102081", "102081027", "story_v_out_102081.awb")

						uv0:RecordAudio("102081027", slot24)
						uv0:RecordAudio("102081027", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081027", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081027", "story_v_out_102081.awb")
				end
	...
	Play102081028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081028
		slot1.duration_ = 9.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(102081028).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081028", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081028", "story_v_out_102081.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102081", "102081028", "story_v_out_102081.awb")

						uv0:RecordAudio("102081028", slot20)
						uv0:RecordAudio("102081028", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081028", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081028", "story_v_out_102081.awb")
				end
	...
	Play102081029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081029
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102081029).content)
	...
	Play102081030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081030
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102081030).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081030", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081030", "story_v_out_102081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081030", "story_v_out_102081.awb")

						uv0:RecordAudio("102081030", slot18)
						uv0:RecordAudio("102081030", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081030", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081030", "story_v_out_102081.awb")
				end
	...
	Play102081031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081031
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(102081031).content)
				uv0.text_.text = slot10
	...
	Play102081032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081032
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102081032).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081032", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081032", "story_v_out_102081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081032", "story_v_out_102081.awb")

						uv0:RecordAudio("102081032", slot18)
						uv0:RecordAudio("102081032", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081032", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081032", "story_v_out_102081.awb")
				end
	...
	Play102081033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081033
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 and uv0.var_.characterEffect2022_tpose == nil then
				uv0.var_.characterEffect2022_tpose = uv0.actors_["2022_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 and uv0.var_.characterEffect2022_tpose then
				uv0.var_.characterEffect2022_tpose.fillFlat = false
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 and uv0.var_.characterEffect2021_tpose == nil then
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 and uv0.var_.characterEffect2021_tpose then
				uv0.var_.characterEffect2021_tpose.fillFlat = false
			end
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2021_tpose, Vector3.New(-1.92, -0.6, 0.2), (uv0.time_ - slot17) / slot18)
				slot22 = manager.ui.mainCamera.transform.position - slot16.position
				slot16.forward = Vector3.New(slot22.x, slot22.y, slot22.z)
				slot23 = slot16.localEulerAngles
				slot23.z = 0
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 then
				slot16.localPosition = Vector3.New(-1.92, -0.6, 0.2)
				slot21 = manager.ui.mainCamera.transform.position - slot16.position
				slot16.forward = Vector3.New(slot21.x, slot21.y, slot21.z)
				slot22 = slot16.localEulerAngles
				slot22.z = 0
			...
			if slot21 <= uv0.time_ and uv0.time_ < slot21 + slot22 then
				slot20.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(0.7, -0.55, -0.3), (uv0.time_ - slot21) / slot22)
			...
			if uv0.time_ >= slot21 + slot22 and uv0.time_ < slot21 + slot22 + slot0 then
				slot20.localPosition = Vector3.New(0.7, -0.55, -0.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot24 + slot0 then
				...
				slot28 = uv0:FormatText(uv0:GetWordFromCfg(102081033).content)
				uv0.text_.text = slot28

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (18 <= 0 and slot25 or slot25 * utf8.len(slot28) / slot29) > 0 and slot25 < slot31 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081033", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081033", "story_v_out_102081.awb") / 1000 + slot24 then
						uv0.duration_ = slot32 + slot24
					end

					if slot27.prefab_name ~= "" and uv0.actors_[slot27.prefab_name] ~= nil then
						slot33 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot27.prefab_name].transform, "story_v_out_102081", "102081033", "story_v_out_102081.awb")

						uv0:RecordAudio("102081033", slot33)
						uv0:RecordAudio("102081033", slot33)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081033", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081033", "story_v_out_102081.awb")
				end
	...
	Play102081034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081034
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.characterEffect2022_tpose then
					uv0.var_.characterEffect2022_tpose.fillFlat = true
					uv0.var_.characterEffect2022_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot5) / slot6)
				end
			end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				if uv0.var_.characterEffect2021_tpose then
					...
					uv0.var_.characterEffect2021_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot8) / slot9)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(102081034).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081034", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081034", "story_v_out_102081.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102081", "102081034", "story_v_out_102081.awb")

						uv0:RecordAudio("102081034", slot20)
						uv0:RecordAudio("102081034", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081034", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081034", "story_v_out_102081.awb")
				end
	...
	Play102081035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102081035
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2021_tpose, Vector3.New(10, -0.6, 0.2), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(10, -0.6, 0.2)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102081035).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081035", "story_v_out_102081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102081", "102081035", "story_v_out_102081.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102081", "102081035", "story_v_out_102081.awb")

						uv0:RecordAudio("102081035", slot24)
						uv0:RecordAudio("102081035", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102081", "102081035", "story_v_out_102081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102081", "102081035", "story_v_out_102081.awb")
				end
