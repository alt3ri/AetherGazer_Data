return {
	Play111051001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051001
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111051001).content)
	...
	Play111051002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051002
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if uv0.time_ >= slot6 + 1.999999999999 and uv0.time_ < slot6 + slot7 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(111051002).content)
	...
	Play111051003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051003).content)
	...
	Play111051004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111051004).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051004", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051004", "story_v_out_111051.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_111051", "111051004", "story_v_out_111051.awb")

						uv0:RecordAudio("111051004", slot12)
						uv0:RecordAudio("111051004", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051004", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051004", "story_v_out_111051.awb")
				end
	...
	Play111051005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111051005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051005", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051005", "story_v_out_111051.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111051", "111051005", "story_v_out_111051.awb")

						uv0:RecordAudio("111051005", slot10)
						uv0:RecordAudio("111051005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051005", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051005", "story_v_out_111051.awb")
				end
	...
	Play111051006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051006).content)
				uv0.text_.text = slot4
	...
	Play111051007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111051007).content)
				uv0.text_.text = slot5
	...
	Play111051008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051008
		slot1.duration_ = 6.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111051008).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051008", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051008", "story_v_out_111051.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111051", "111051008", "story_v_out_111051.awb")

						uv0:RecordAudio("111051008", slot10)
						uv0:RecordAudio("111051008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051008", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051008", "story_v_out_111051.awb")
				end
	...
	Play111051009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111051009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051009", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051009", "story_v_out_111051.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_111051", "111051009", "story_v_out_111051.awb")

						uv0:RecordAudio("111051009", slot19)
						uv0:RecordAudio("111051009", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051009", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051009", "story_v_out_111051.awb")
				end
	...
	Play111051010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111051010).content)
				uv0.text_.text = slot7
	...
	Play111051011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051011).content)
				uv0.text_.text = slot4
	...
	Play111051012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051012).content)
				uv0.text_.text = slot4
	...
	Play111051013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111051013).content)
				uv0.text_.text = slot5
	...
	Play111051014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051014
		slot1.duration_ = 3.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111051014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051014", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051014", "story_v_out_111051.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111051", "111051014", "story_v_out_111051.awb")

						uv0:RecordAudio("111051014", slot15)
						uv0:RecordAudio("111051014", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051014", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051014", "story_v_out_111051.awb")
				end
	...
	Play111051015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111051015).content)
				uv0.text_.text = slot7
	...
	Play111051016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051016).content)
				uv0.text_.text = slot4
	...
	Play111051017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.bgs_.D09.transform

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0.var_.moveOldPosD09 = slot2.localPosition
				slot2.localScale = Vector3.New(1.1, 1.1, 1.1)
			end

			slot4 = 2.83333333333333

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPosD09, Vector3.New(0, 1, 10), (uv0.time_ - slot3) / slot4)
			end
			...
			if uv0.time_ >= slot5 + 2.83333333333333 and uv0.time_ < slot5 + slot6 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111051017).content)
				uv0.text_.text = slot10
	...
	Play111051018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111051018).content)
				uv0.text_.text = slot5
	...
	Play111051019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051019
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111051019).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051019", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051019", "story_v_out_111051.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111051", "111051019", "story_v_out_111051.awb")

						uv0:RecordAudio("111051019", slot18)
						uv0:RecordAudio("111051019", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051019", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051019", "story_v_out_111051.awb")
				end
	...
	Play111051020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111051020).content)
	...
	Play111051021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051021
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111051021).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051021", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051021", "story_v_out_111051.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111051", "111051021", "story_v_out_111051.awb")

						uv0:RecordAudio("111051021", slot14)
						uv0:RecordAudio("111051021", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051021", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051021", "story_v_out_111051.awb")
				end
	...
	Play111051022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111051022).content)
				uv0.text_.text = slot7
	...
	Play111051023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051023).content)
				uv0.text_.text = slot4
	...
	Play111051024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051024
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_activity_1_1", "se_story_activity_1_1_leaf", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111051024).content)
				uv0.text_.text = slot7
	...
	Play111051025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051025
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051025).content)
				uv0.text_.text = slot4
	...
	Play111051026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051026
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051026).content)
				uv0.text_.text = slot4
	...
	Play111051027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051027
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111051027).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051027", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051027", "story_v_out_111051.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111051", "111051027", "story_v_out_111051.awb")

						uv0:RecordAudio("111051027", slot18)
						uv0:RecordAudio("111051027", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051027", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051027", "story_v_out_111051.awb")
				end
	...
	Play111051028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051028
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111051028).content)
				uv0.text_.text = slot8
	...
	Play111051029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051029
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111051029).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051029", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051029", "story_v_out_111051.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111051", "111051029", "story_v_out_111051.awb")

						uv0:RecordAudio("111051029", slot14)
						uv0:RecordAudio("111051029", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051029", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051029", "story_v_out_111051.awb")
				end
	...
	Play111051030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051030
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111051030).content)
				uv0.text_.text = slot8
	...
	Play111051031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051031
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111051031).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111051", "111051031", "story_v_out_111051.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111051", "111051031", "story_v_out_111051.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111051", "111051031", "story_v_out_111051.awb")

						uv0:RecordAudio("111051031", slot15)
						uv0:RecordAudio("111051031", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111051", "111051031", "story_v_out_111051.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111051", "111051031", "story_v_out_111051.awb")
				end
	...
	Play111051032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051032
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111051032).content)
				uv0.text_.text = slot7
	...
	Play111051033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111051033
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111051033).content)
				uv0.text_.text = slot4
