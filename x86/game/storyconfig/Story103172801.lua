return {
	Play317281001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(317281001).content)
	...
	Play317281002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2078ui_story, Vector3.New(0, -1.28, -5.6), (uv0.time_ - slot3) / slot4)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(317281002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281002", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281002", "story_v_out_317281.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_317281", "317281002", "story_v_out_317281.awb")

						uv0:RecordAudio("317281002", slot19)
						uv0:RecordAudio("317281002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281002", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281002", "story_v_out_317281.awb")
				end
	...
	Play317281003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot18 <= uv0.time_ and uv0.time_ < slot18 + slot19 then
				slot17.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2078ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot18) / slot19)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot21 + slot0 and uv0.var_.characterEffect2078ui_story == nil then
				uv0.var_.characterEffect2078ui_story = uv0.actors_["2078ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot21 <= uv0.time_ and uv0.time_ < slot21 + slot22 then
				if uv0.var_.characterEffect2078ui_story then
					...
					uv0.var_.characterEffect2078ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot21) / slot22)
				end
			end

			if uv0.time_ >= slot21 + slot22 and uv0.time_ < slot21 + slot22 + slot0 and uv0.var_.characterEffect2078ui_story then
				uv0.var_.characterEffect2078ui_story.fillFlat = true
			...
			if 0 < uv0.time_ and uv0.time_ <= slot24 + slot0 then
				...
				slot28 = uv0:FormatText(uv0:GetWordFromCfg(317281003).content)
				uv0.text_.text = slot28

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (17 <= 0 and slot25 or slot25 * utf8.len(slot28) / slot29) > 0 and slot25 < slot31 then
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281003", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281003", "story_v_out_317281.awb") / 1000 + slot24 then
						uv0.duration_ = slot32 + slot24
					end

					if slot27.prefab_name ~= "" and uv0.actors_[slot27.prefab_name] ~= nil then
						slot33 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot27.prefab_name].transform, "story_v_out_317281", "317281003", "story_v_out_317281.awb")

						uv0:RecordAudio("317281003", slot33)
						uv0:RecordAudio("317281003", slot33)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281003", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281003", "story_v_out_317281.awb")
				end
	...
	Play317281004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281004
		slot1.duration_ = 8.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(317281004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281004", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281004", "story_v_out_317281.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_317281", "317281004", "story_v_out_317281.awb")

						uv0:RecordAudio("317281004", slot21)
						uv0:RecordAudio("317281004", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281004", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281004", "story_v_out_317281.awb")
				end
	...
	Play317281005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(317281005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281005", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281005", "story_v_out_317281.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_317281", "317281005", "story_v_out_317281.awb")

						uv0:RecordAudio("317281005", slot23)
						uv0:RecordAudio("317281005", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281005", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281005", "story_v_out_317281.awb")
				end
	...
	Play317281006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(317281006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281006", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281006", "story_v_out_317281.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_317281", "317281006", "story_v_out_317281.awb")

						uv0:RecordAudio("317281006", slot24)
						uv0:RecordAudio("317281006", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281006", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281006", "story_v_out_317281.awb")
				end
	...
	Play317281007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(317281007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281007", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281007", "story_v_out_317281.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_317281", "317281007", "story_v_out_317281.awb")

						uv0:RecordAudio("317281007", slot20)
						uv0:RecordAudio("317281007", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281007", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281007", "story_v_out_317281.awb")
				end
	...
	Play317281008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(317281008).content)
				uv0.text_.text = slot16

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (67 <= 0 and slot13 or slot13 * utf8.len(slot16) / slot17) > 0 and slot13 < slot19 then
					uv0.talkMaxDuration = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281008", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281008", "story_v_out_317281.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_317281", "317281008", "story_v_out_317281.awb")

						uv0:RecordAudio("317281008", slot21)
						uv0:RecordAudio("317281008", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281008", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281008", "story_v_out_317281.awb")
				end
	...
	Play317281009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(317281009).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281009", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281009", "story_v_out_317281.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_317281", "317281009", "story_v_out_317281.awb")

						uv0:RecordAudio("317281009", slot20)
						uv0:RecordAudio("317281009", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281009", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281009", "story_v_out_317281.awb")
				end
	...
	Play317281010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281010
		slot1.duration_ = 6.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(317281010).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281010", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281010", "story_v_out_317281.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_317281", "317281010", "story_v_out_317281.awb")

						uv0:RecordAudio("317281010", slot24)
						uv0:RecordAudio("317281010", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281010", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281010", "story_v_out_317281.awb")
				end
	...
	Play317281011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281011
		slot1.duration_ = 2.966
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(317281011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281011", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281011", "story_v_out_317281.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_317281", "317281011", "story_v_out_317281.awb")

						uv0:RecordAudio("317281011", slot10)
						uv0:RecordAudio("317281011", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281011", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281011", "story_v_out_317281.awb")
				end
	...
	Play317281012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(317281012).content)
	...
	Play317281013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(317281013).content)
				uv0.text_.text = slot5
	...
	Play317281014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281014
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(317281014).content)
				uv0.text_.text = slot5
	...
	Play317281015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(317281015).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281015", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281015", "story_v_out_317281.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_317281", "317281015", "story_v_out_317281.awb")

						uv0:RecordAudio("317281015", slot18)
						uv0:RecordAudio("317281015", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281015", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281015", "story_v_out_317281.awb")
				end
	...
	Play317281016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2079ui_story, Vector3.New(-0.7, -1.28, -5.6), (uv0.time_ - slot13) / slot14)
			...
			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(-0.7, -1.28, -5.6)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 and uv0.var_.characterEffect2078ui_story == nil then
				uv0.var_.characterEffect2078ui_story = uv0.actors_["2078ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				if uv0.var_.characterEffect2078ui_story then
					uv0.var_.characterEffect2078ui_story.fillFlat = true
					uv0.var_.characterEffect2078ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot16) / slot17)
				end
			end

			if uv0.time_ >= slot16 + slot17 and uv0.time_ < slot16 + slot17 + slot0 and uv0.var_.characterEffect2078ui_story then
				uv0.var_.characterEffect2078ui_story.fillFlat = true
				uv0.var_.characterEffect2078ui_story.fillRatio = 0.5
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(317281016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281016", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281016", "story_v_out_317281.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_317281", "317281016", "story_v_out_317281.awb")

						uv0:RecordAudio("317281016", slot27)
						uv0:RecordAudio("317281016", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281016", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281016", "story_v_out_317281.awb")
				end
	...
	Play317281017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(317281017).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281017", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281017", "story_v_out_317281.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_317281", "317281017", "story_v_out_317281.awb")

						uv0:RecordAudio("317281017", slot20)
						uv0:RecordAudio("317281017", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281017", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281017", "story_v_out_317281.awb")
				end
	...
	Play317281018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(317281018).content)
				uv0.text_.text = slot16

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (44 <= 0 and slot14 or slot14 * utf8.len(slot16) / slot17) > 0 and slot14 < slot19 then
					uv0.talkMaxDuration = slot19
	...
	Play317281019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281019
		slot1.duration_ = 4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(317281019).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281019", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281019", "story_v_out_317281.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_317281", "317281019", "story_v_out_317281.awb")

						uv0:RecordAudio("317281019", slot17)
						uv0:RecordAudio("317281019", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281019", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281019", "story_v_out_317281.awb")
				end
	...
	Play317281020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(317281020).content)
	...
	Play317281021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281021
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(317281021).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281021", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281021", "story_v_out_317281.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_317281", "317281021", "story_v_out_317281.awb")

						uv0:RecordAudio("317281021", slot18)
						uv0:RecordAudio("317281021", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281021", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281021", "story_v_out_317281.awb")
				end
	...
	Play317281022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317281022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1199ui_story, Vector3.New(0, -1.08, -5.9), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(317281022).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317281", "317281022", "story_v_out_317281.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317281", "317281022", "story_v_out_317281.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_317281", "317281022", "story_v_out_317281.awb")

						uv0:RecordAudio("317281022", slot25)
						uv0:RecordAudio("317281022", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317281", "317281022", "story_v_out_317281.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317281", "317281022", "story_v_out_317281.awb")
				end
