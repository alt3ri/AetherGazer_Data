return {
	Play112071001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_36 < arg_1_1.time_ and arg_1_1.time_ <= var_4_36 + arg_4_0 then
				...
				local var_4_39 = arg_1_1:GetWordFromCfg(112071001)
	...
	Play112071002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 112071002
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_19 < arg_7_1.time_ and arg_7_1.time_ <= var_10_19 + arg_10_0 then
				...
				local var_10_22 = arg_7_1:GetWordFromCfg(112071002)
				...
				if manager.audio:GetVoiceLength("story_v_out_112071", "112071002", "story_v_out_112071.awb") ~= 0 then
					local var_10_27 = manager.audio:GetVoiceLength("story_v_out_112071", "112071002", "story_v_out_112071.awb") / 1000
					...
					if var_10_22.prefab_name ~= "" and arg_7_1.actors_[var_10_22.prefab_name] ~= nil then
						local var_10_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_7_1.actors_[var_10_22.prefab_name].transform, "story_v_out_112071", "112071002", "story_v_out_112071.awb")

						arg_7_1:RecordAudio("112071002", var_10_28)
						arg_7_1:RecordAudio("112071002", var_10_28)
					else
						arg_7_1:AudioAction("play", "voice", "story_v_out_112071", "112071002", "story_v_out_112071.awb")
					end

					arg_7_1:RecordHistoryTalkVoice("story_v_out_112071", "112071002", "story_v_out_112071.awb")
				end
	...
	Play112071003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 112071003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play112071004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 <= arg_11_1.time_ and arg_11_1.time_ < var_14_0 + var_14_1 then
				...
				var_14_3.a = Mathf.Lerp(1, 0, var_14_2)
			...
			local var_14_6 = arg_11_1.actors_["1027ui_story"].transform
			local var_14_7 = 0

			if var_14_7 < arg_11_1.time_ and arg_11_1.time_ <= var_14_7 + arg_14_0 then
				arg_11_1.var_.moveOldPos1027ui_story = var_14_6.localPosition
			end
			...
			if var_14_7 <= arg_11_1.time_ and arg_11_1.time_ < var_14_7 + var_14_8 then
				...
				var_14_6.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1027ui_story, var_14_10, var_14_9)
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				local var_14_17 = LeanTween.value(arg_11_1.dialog_, 0, 1, 0.3)

				var_14_17:setOnUpdate(LuaHelper.FloatAction(function(arg_15_0)
					arg_11_1.dialogCg_.alpha = arg_15_0
				end))
				var_14_17:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_11_1.dialog_)
					var_14_17:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_14_18 = arg_11_1:GetWordFromCfg(112071003)
			...
			local var_14_23 = var_14_15 + 0.3
			local var_14_24 = math.max(var_14_16, arg_11_1.talkMaxDuration)

			if var_14_23 <= arg_11_1.time_ and arg_11_1.time_ < var_14_23 + var_14_24 then
				arg_11_1.typewritter.percent = (arg_11_1.time_ - var_14_23) / var_14_24
	...
	Play112071004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 112071004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play112071005(arg_17_1)
			end
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_0 + arg_20_0 then
				...
				local var_20_2 = arg_17_1:GetWordFromCfg(112071004)
	...
	Play112071005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 112071005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play112071006(arg_21_1)
			end
		end
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_2 = arg_21_1:GetWordFromCfg(112071005)
	...
	Play112071006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 112071006
		...
		function arg_25_1.playNext_(arg_27_0)
			if arg_27_0 == 1 then
				arg_25_0:Play112071007(arg_25_1)
			end
		end
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_3 = arg_25_1:GetWordFromCfg(112071006)
				...
				if manager.audio:GetVoiceLength("story_v_out_112071", "112071006", "story_v_out_112071.awb") ~= 0 then
					local var_28_8 = manager.audio:GetVoiceLength("story_v_out_112071", "112071006", "story_v_out_112071.awb") / 1000
					...
					if var_28_3.prefab_name ~= "" and arg_25_1.actors_[var_28_3.prefab_name] ~= nil then
						local var_28_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_3.prefab_name].transform, "story_v_out_112071", "112071006", "story_v_out_112071.awb")

						arg_25_1:RecordAudio("112071006", var_28_9)
						arg_25_1:RecordAudio("112071006", var_28_9)
					else
						arg_25_1:AudioAction("play", "voice", "story_v_out_112071", "112071006", "story_v_out_112071.awb")
					end

					arg_25_1:RecordHistoryTalkVoice("story_v_out_112071", "112071006", "story_v_out_112071.awb")
				end
	...
	Play112071007 = function(arg_29_0, arg_29_1)
		arg_29_1.time_ = 0
		arg_29_1.frameCnt_ = 0
		arg_29_1.state_ = "playing"
		arg_29_1.curTalkId_ = 112071007
		...
		function arg_29_1.playNext_(arg_31_0)
			if arg_31_0 == 1 then
				arg_29_0:Play112071008(arg_29_1)
			end
		end
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_1 <= arg_29_1.time_ and arg_29_1.time_ < var_32_1 + var_32_2 then
				...
				local var_32_4 = Vector3.New(0, -0.81, -5.8)
			...
			if arg_29_1.time_ >= var_32_1 + var_32_2 and arg_29_1.time_ < var_32_1 + var_32_2 + arg_32_0 then
				var_32_0.localPosition = Vector3.New(0, -0.81, -5.8)
			...
			if var_32_10 < arg_29_1.time_ and arg_29_1.time_ <= var_32_10 + arg_32_0 then
				arg_29_1:PlayTimeline("1027ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface2104cva")
			end

			local var_32_11 = arg_29_1.actors_["1027ui_story"]
			local var_32_12 = 0

			if var_32_12 < arg_29_1.time_ and arg_29_1.time_ <= var_32_12 + arg_32_0 and arg_29_1.var_.characterEffect1027ui_story == nil then
				arg_29_1.var_.characterEffect1027ui_story = var_32_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_32_12 <= arg_29_1.time_ and arg_29_1.time_ < var_32_12 + var_32_13 then
				...
				if arg_29_1.var_.characterEffect1027ui_story then
					arg_29_1.var_.characterEffect1027ui_story.fillFlat = false
				end
			end

			if arg_29_1.time_ >= var_32_12 + var_32_13 and arg_29_1.time_ < var_32_12 + var_32_13 + arg_32_0 and arg_29_1.var_.characterEffect1027ui_story then
				arg_29_1.var_.characterEffect1027ui_story.fillFlat = false
			end
			...
			if var_32_15 < arg_29_1.time_ and arg_29_1.time_ <= var_32_15 + arg_32_0 then
				...
				local var_32_17 = arg_29_1:FormatText(StoryNameCfg[56].name)
				...
				local var_32_18 = arg_29_1:GetWordFromCfg(112071007)
				...
				if manager.audio:GetVoiceLength("story_v_out_112071", "112071007", "story_v_out_112071.awb") ~= 0 then
					local var_32_23 = manager.audio:GetVoiceLength("story_v_out_112071", "112071007", "story_v_out_112071.awb") / 1000
					...
					if var_32_18.prefab_name ~= "" and arg_29_1.actors_[var_32_18.prefab_name] ~= nil then
						local var_32_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_18.prefab_name].transform, "story_v_out_112071", "112071007", "story_v_out_112071.awb")

						arg_29_1:RecordAudio("112071007", var_32_24)
						arg_29_1:RecordAudio("112071007", var_32_24)
					else
						arg_29_1:AudioAction("play", "voice", "story_v_out_112071", "112071007", "story_v_out_112071.awb")
					end

					arg_29_1:RecordHistoryTalkVoice("story_v_out_112071", "112071007", "story_v_out_112071.awb")
				end
	...
	Play112071008 = function(arg_33_0, arg_33_1)
		arg_33_1.time_ = 0
		arg_33_1.frameCnt_ = 0
		arg_33_1.state_ = "playing"
		arg_33_1.curTalkId_ = 112071008
		...
		function arg_33_1.playNext_(arg_35_0)
			if arg_35_0 == 1 then
				arg_33_0:Play112071009(arg_33_1)
			end
		end
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_9 < arg_33_1.time_ and arg_33_1.time_ <= var_36_9 + arg_36_0 then
				...
				local var_36_11 = arg_33_1:GetWordFromCfg(112071008)
	...
	Play112071009 = function(arg_37_0, arg_37_1)
		arg_37_1.time_ = 0
		arg_37_1.frameCnt_ = 0
		arg_37_1.state_ = "playing"
		arg_37_1.curTalkId_ = 112071009
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_0 + arg_40_0 then
				...
				local var_40_2 = arg_37_1:GetWordFromCfg(112071009)
