return {
	Play112052001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_36 < arg_1_1.time_ and arg_1_1.time_ <= var_4_36 + arg_4_0 then
				...
				local var_4_39 = arg_1_1:GetWordFromCfg(112052001)
	...
	Play112052002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 112052002
		arg_7_1.duration_ = 11.633
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_14 < arg_7_1.time_ and arg_7_1.time_ <= var_10_14 + arg_10_0 then
				arg_7_1:PlayTimeline("1027ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0104cva")
			end
			...
			if var_10_19 < arg_7_1.time_ and arg_7_1.time_ <= var_10_19 + arg_10_0 then
				...
				local var_10_22 = arg_7_1:GetWordFromCfg(112052002)
				...
				if manager.audio:GetVoiceLength("story_v_out_112052", "112052002", "story_v_out_112052.awb") ~= 0 then
					local var_10_27 = manager.audio:GetVoiceLength("story_v_out_112052", "112052002", "story_v_out_112052.awb") / 1000
					...
					if var_10_22.prefab_name ~= "" and arg_7_1.actors_[var_10_22.prefab_name] ~= nil then
						local var_10_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_7_1.actors_[var_10_22.prefab_name].transform, "story_v_out_112052", "112052002", "story_v_out_112052.awb")

						arg_7_1:RecordAudio("112052002", var_10_28)
						arg_7_1:RecordAudio("112052002", var_10_28)
					else
						arg_7_1:AudioAction("play", "voice", "story_v_out_112052", "112052002", "story_v_out_112052.awb")
					end

					arg_7_1:RecordHistoryTalkVoice("story_v_out_112052", "112052002", "story_v_out_112052.awb")
				end
	...
	Play112052003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 112052003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play112052004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				arg_11_1:AudioAction(var_14_17, var_14_18, "se_story", "se_story_quake", "")
			end
			...
			if var_14_19 < arg_11_1.time_ and arg_11_1.time_ <= var_14_19 + arg_14_0 then
				...
				local var_14_21 = arg_11_1:GetWordFromCfg(112052003)
	...
	Play112052004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 112052004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play112052005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_0 + arg_18_0 then
				...
				local var_18_2 = arg_15_1:GetWordFromCfg(112052004)
	...
	Play112052005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 112052005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play112052006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_10 < arg_19_1.time_ and arg_19_1.time_ <= var_22_10 + arg_22_0 then
				arg_19_1:PlayTimeline("1027ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3203cva")
			end

			local var_22_11 = arg_19_1.actors_["1027ui_story"]
			local var_22_12 = 0

			if var_22_12 < arg_19_1.time_ and arg_19_1.time_ <= var_22_12 + arg_22_0 and arg_19_1.var_.characterEffect1027ui_story == nil then
				arg_19_1.var_.characterEffect1027ui_story = var_22_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_19_1.time_ >= var_22_12 + var_22_13 and arg_19_1.time_ < var_22_12 + var_22_13 + arg_22_0 and arg_19_1.var_.characterEffect1027ui_story then
				arg_19_1.var_.characterEffect1027ui_story.fillFlat = false
			end
			...
			if var_22_15 < arg_19_1.time_ and arg_19_1.time_ <= var_22_15 + arg_22_0 then
				...
				local var_22_18 = arg_19_1:GetWordFromCfg(112052005)
				...
				if manager.audio:GetVoiceLength("story_v_out_112052", "112052005", "story_v_out_112052.awb") ~= 0 then
					local var_22_23 = manager.audio:GetVoiceLength("story_v_out_112052", "112052005", "story_v_out_112052.awb") / 1000
					...
					if var_22_18.prefab_name ~= "" and arg_19_1.actors_[var_22_18.prefab_name] ~= nil then
						local var_22_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_19_1.actors_[var_22_18.prefab_name].transform, "story_v_out_112052", "112052005", "story_v_out_112052.awb")

						arg_19_1:RecordAudio("112052005", var_22_24)
						arg_19_1:RecordAudio("112052005", var_22_24)
					else
						arg_19_1:AudioAction("play", "voice", "story_v_out_112052", "112052005", "story_v_out_112052.awb")
					end

					arg_19_1:RecordHistoryTalkVoice("story_v_out_112052", "112052005", "story_v_out_112052.awb")
				end
	...
	Play112052006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 112052006
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play112052007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_2 < arg_23_1.time_ and arg_23_1.time_ <= var_26_2 + arg_26_0 then
				...
				local var_26_5 = arg_23_1:GetWordFromCfg(112052006)
				...
				if manager.audio:GetVoiceLength("story_v_out_112052", "112052006", "story_v_out_112052.awb") ~= 0 then
					local var_26_10 = manager.audio:GetVoiceLength("story_v_out_112052", "112052006", "story_v_out_112052.awb") / 1000
					...
					if var_26_5.prefab_name ~= "" and arg_23_1.actors_[var_26_5.prefab_name] ~= nil then
						local var_26_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_23_1.actors_[var_26_5.prefab_name].transform, "story_v_out_112052", "112052006", "story_v_out_112052.awb")

						arg_23_1:RecordAudio("112052006", var_26_11)
						arg_23_1:RecordAudio("112052006", var_26_11)
					else
						arg_23_1:AudioAction("play", "voice", "story_v_out_112052", "112052006", "story_v_out_112052.awb")
					end

					arg_23_1:RecordHistoryTalkVoice("story_v_out_112052", "112052006", "story_v_out_112052.awb")
				end
	...
	Play112052007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 112052007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play112052008(arg_27_1)
			end
		end
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_1 < arg_27_1.time_ and arg_27_1.time_ <= var_30_1 + arg_30_0 then
				...
				local var_30_4 = arg_27_1:GetWordFromCfg(112052007)
				...
				if manager.audio:GetVoiceLength("story_v_out_112052", "112052007", "story_v_out_112052.awb") ~= 0 then
					local var_30_9 = manager.audio:GetVoiceLength("story_v_out_112052", "112052007", "story_v_out_112052.awb") / 1000
					...
					if var_30_4.prefab_name ~= "" and arg_27_1.actors_[var_30_4.prefab_name] ~= nil then
						local var_30_10 = LuaForUtil.PlayVoiceWithCriLipsync(arg_27_1.actors_[var_30_4.prefab_name].transform, "story_v_out_112052", "112052007", "story_v_out_112052.awb")

						arg_27_1:RecordAudio("112052007", var_30_10)
						arg_27_1:RecordAudio("112052007", var_30_10)
					else
						arg_27_1:AudioAction("play", "voice", "story_v_out_112052", "112052007", "story_v_out_112052.awb")
					end

					arg_27_1:RecordHistoryTalkVoice("story_v_out_112052", "112052007", "story_v_out_112052.awb")
				end
	...
	Play112052008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 112052008
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_9 < arg_31_1.time_ and arg_31_1.time_ <= var_34_9 + arg_34_0 then
				...
				local var_34_11 = arg_31_1:GetWordFromCfg(112052008)
