		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				...
				if uv0.var_.actorSpriteComps10064 then
					for slot16, slot17 in pairs(uv0.var_.actorSpriteComps10064:ToTable()) do
						if slot17 then
	...
	Play410041004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				...
				if uv0.var_.actorSpriteComps10064 then
					for slot11, slot12 in pairs(uv0.var_.actorSpriteComps10064:ToTable()) do
						if slot12 then
	...
	Play410041005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				...
				if uv0.var_.actorSpriteComps10064 then
					for slot8, slot9 in pairs(uv0.var_.actorSpriteComps10064:ToTable()) do
						if slot9 then
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.actorSpriteComps1012 then
					for slot12, slot13 in pairs(uv0.var_.actorSpriteComps1012:ToTable()) do
						if slot13 then
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				...
				if uv0.var_.actorSpriteComps10064 then
					for slot18, slot19 in pairs(uv0.var_.actorSpriteComps10064:ToTable()) do
						if slot19 then
	...
	Play410041024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				...
				if uv0.var_.actorSpriteComps10064 then
					for slot17, slot18 in pairs(uv0.var_.actorSpriteComps10064:ToTable()) do
						if slot18 then
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				...
				if uv0.var_.actorSpriteComps1060 then
					for slot25, slot26 in pairs(uv0.var_.actorSpriteComps1060:ToTable()) do
						if slot26 then
			...
			if slot22 <= uv0.time_ and uv0.time_ < slot22 + slot23 then
				...
				if uv0.var_.actorSpriteComps1056 then
					for slot28, slot29 in pairs(uv0.var_.actorSpriteComps1056:ToTable()) do
						if slot29 then
