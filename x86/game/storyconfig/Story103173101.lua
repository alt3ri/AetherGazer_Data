return {
	Play317311001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311001
		slot1.duration_ = 4.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot15.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1199ui_story, Vector3.New(0.7, -1.08, -5.9), (uv0.time_ - slot16) / slot17)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot19 + slot0 and uv0.var_.characterEffect1199ui_story == nil then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot25 + slot0 then
				...
				slot30 = uv0:FormatText(uv0:GetWordFromCfg(317311001).content)
				uv0.text_.text = slot30

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (13 <= 0 and slot26 or slot26 * utf8.len(slot30) / slot31) > 0 and slot26 < slot33 then
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311001", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311001", "story_v_out_317311.awb") / 1000 + slot25 then
						uv0.duration_ = slot34 + slot25
					end

					if slot29.prefab_name ~= "" and uv0.actors_[slot29.prefab_name] ~= nil then
						slot35 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot29.prefab_name].transform, "story_v_out_317311", "317311001", "story_v_out_317311.awb")

						uv0:RecordAudio("317311001", slot35)
						uv0:RecordAudio("317311001", slot35)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311001", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311001", "story_v_out_317311.awb")
				end
	...
	Play317311002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311002
		slot1.duration_ = 5.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(317311002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311002", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311002", "story_v_out_317311.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_317311", "317311002", "story_v_out_317311.awb")

						uv0:RecordAudio("317311002", slot21)
						uv0:RecordAudio("317311002", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311002", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311002", "story_v_out_317311.awb")
				end
	...
	Play317311003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(317311003).content)
				uv0.text_.text = slot26

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (20 <= 0 and slot23 or slot23 * utf8.len(slot26) / slot27) > 0 and slot23 < slot29 then
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311003", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311003", "story_v_out_317311.awb") / 1000 + slot22 then
						uv0.duration_ = slot30 + slot22
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_317311", "317311003", "story_v_out_317311.awb")

						uv0:RecordAudio("317311003", slot31)
						uv0:RecordAudio("317311003", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311003", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311003", "story_v_out_317311.awb")
				end
	...
	Play317311004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(317311004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311004", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311004", "story_v_out_317311.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_317311", "317311004", "story_v_out_317311.awb")

						uv0:RecordAudio("317311004", slot13)
						uv0:RecordAudio("317311004", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311004", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311004", "story_v_out_317311.awb")
				end
	...
	Play317311005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(317311005).content)
	...
	Play317311006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(317311006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311006", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311006", "story_v_out_317311.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_317311", "317311006", "story_v_out_317311.awb")

						uv0:RecordAudio("317311006", slot19)
						uv0:RecordAudio("317311006", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311006", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311006", "story_v_out_317311.awb")
				end
	...
	Play317311007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311007
		slot1.duration_ = 5.16666666666667
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.166666666666667 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.talkMaxDuration = 0
				uv0.dialogCg_.alpha = 1
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(317311007).content)
	...
	Play317311008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(317311008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311008", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311008", "story_v_out_317311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_317311", "317311008", "story_v_out_317311.awb")

						uv0:RecordAudio("317311008", slot10)
						uv0:RecordAudio("317311008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311008", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311008", "story_v_out_317311.awb")
				end
	...
	Play317311009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(317311009).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311009", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311009", "story_v_out_317311.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_317311", "317311009", "story_v_out_317311.awb")

						uv0:RecordAudio("317311009", slot18)
						uv0:RecordAudio("317311009", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311009", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311009", "story_v_out_317311.awb")
				end
	...
	Play317311010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(317311010).content)
	...
	Play317311011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(317311011).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311011", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311011", "story_v_out_317311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_317311", "317311011", "story_v_out_317311.awb")

						uv0:RecordAudio("317311011", slot10)
						uv0:RecordAudio("317311011", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311011", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311011", "story_v_out_317311.awb")
				end
	...
	Play317311012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(317311012).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311012", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311012", "story_v_out_317311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_317311", "317311012", "story_v_out_317311.awb")

						uv0:RecordAudio("317311012", slot10)
						uv0:RecordAudio("317311012", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311012", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311012", "story_v_out_317311.awb")
				end
	...
	Play317311013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(317311013).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311013", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311013", "story_v_out_317311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_317311", "317311013", "story_v_out_317311.awb")

						uv0:RecordAudio("317311013", slot10)
						uv0:RecordAudio("317311013", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311013", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311013", "story_v_out_317311.awb")
				end
	...
	Play317311014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(317311014).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311014", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311014", "story_v_out_317311.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_317311", "317311014", "story_v_out_317311.awb")

						uv0:RecordAudio("317311014", slot18)
						uv0:RecordAudio("317311014", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311014", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311014", "story_v_out_317311.awb")
				end
	...
	Play317311015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(317311015).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311015", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311015", "story_v_out_317311.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_317311", "317311015", "story_v_out_317311.awb")

						uv0:RecordAudio("317311015", slot21)
						uv0:RecordAudio("317311015", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311015", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311015", "story_v_out_317311.awb")
				end
	...
	Play317311016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if not uv0.var_.effectjisuijingzi then
					slot11 = Object.Instantiate(Asset.Load("Effect/Scene/fx_scence_pingmu_niuqu"))
					slot11.name = "jisuijingzi"
					uv0.var_.effectjisuijingzi = slot11
				end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				if not uv0.var_.effectF03daoguang1 then
					slot13 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_slash_01"))
					slot13.name = "daoguang1"
					uv0.var_.effectF03daoguang1 = slot13
				end
				...
				slot13.transform.localPosition = Vector3.New(0, 0, 0.44)
				slot13.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			slot13 = manager.ui.mainCamera.transform

			if 0.866666666666668 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.effectF03daoguang1 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(317311016).content)
				uv0.text_.text = slot18

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (27 <= 0 and slot16 or slot16 * utf8.len(slot18) / slot19) > 0 and slot16 < slot21 then
	...
	Play317311017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(317311017).content)
	...
	Play317311018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(317311018).content)
				uv0.text_.text = slot4
	...
	Play317311019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 317311019
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(317311019).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_317311", "317311019", "story_v_out_317311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_317311", "317311019", "story_v_out_317311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_317311", "317311019", "story_v_out_317311.awb")

						uv0:RecordAudio("317311019", slot10)
						uv0:RecordAudio("317311019", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_317311", "317311019", "story_v_out_317311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_317311", "317311019", "story_v_out_317311.awb")
				end
