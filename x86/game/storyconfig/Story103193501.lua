return {
	Play319351001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351001
		slot1.duration_ = 4.899333333332
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play319351002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				slot2 = uv0.fswbg_.transform:Find("textbox/adapt/content") or uv0.fswbg_.transform:Find("textbox/content")
				slot4 = slot2:GetComponent("RectTransform")
				slot2:GetComponent("Text").alignment = UnityEngine.TextAnchor.LowerCenter
				slot4.offsetMin = Vector2.New(0, 0)
				slot4.offsetMax = Vector2.New(0, 0)
			end
			...
			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.fswt_.text = uv0:FormatText(uv0:GetWordFromCfg(319351001).content)
			...
			slot4 = 6
			slot5 = 0.4
			slot8, slot9 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(319351001).content), 1)
			...
			slot10 = math.max(0.4, uv0.talkMaxDuration)
			...
			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot12 = uv0.cswt_:GetComponent("RectTransform")
				uv0.cswt_.alignment = UnityEngine.TextAnchor.MiddleCenter
				slot12.offsetMin = Vector2.New(410, 330)
				slot12.offsetMax = Vector2.New(-400, -175)
				uv0.cswt_.text = uv0:FormatText(uv0:GetWordFromCfg(419013).content)
			...
			slot16 = 1.73333333333333

			if manager.audio:GetVoiceLength("story_v_out_319351", "319351001", "story_v_out_319351.awb") / 1000 > 0 and 3.166 < slot18 and uv0.duration_ < slot18 + slot16 then
				slot17 = slot18
				uv0.duration_ = slot18 + slot16
			end

			if slot16 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				uv0:AudioAction("play", "voice", "story_v_out_319351", "319351001", "story_v_out_319351.awb")
			end
	...
	Play319351002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.366666666666666 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.fswbg_:SetActive(false)
				uv0.dialog_:SetActive(false)
				uv0:ShowNextGo(false)
			end
			...
			if 1.63333333333333 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(319351002).content)
	...
	Play319351003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319351003).content)
	...
	Play319351004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(319351004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351004", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351004", "story_v_out_319351.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_319351", "319351004", "story_v_out_319351.awb")

						uv0:RecordAudio("319351004", slot19)
						uv0:RecordAudio("319351004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351004", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351004", "story_v_out_319351.awb")
				end
	...
	Play319351005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(319351005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351005", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351005", "story_v_out_319351.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_319351", "319351005", "story_v_out_319351.awb")

						uv0:RecordAudio("319351005", slot24)
						uv0:RecordAudio("319351005", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351005", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351005", "story_v_out_319351.awb")
				end
	...
	Play319351006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(319351006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351006", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351006", "story_v_out_319351.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_319351", "319351006", "story_v_out_319351.awb")

						uv0:RecordAudio("319351006", slot12)
						uv0:RecordAudio("319351006", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351006", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351006", "story_v_out_319351.awb")
				end
	...
	Play319351007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(319351007).content)
				uv0.text_.text = slot7
	...
	Play319351008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351008
		slot1.duration_ = 8.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10058ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot12) / slot13)
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(319351008).content)
				uv0.text_.text = slot21

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (65 <= 0 and slot18 or slot18 * utf8.len(slot21) / slot22) > 0 and slot18 < slot24 then
	...
	Play319351009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319351009).content)
				uv0.text_.text = slot4
	...
	Play319351010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319351010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351010", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351010", "story_v_out_319351.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319351", "319351010", "story_v_out_319351.awb")

						uv0:RecordAudio("319351010", slot18)
						uv0:RecordAudio("319351010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351010", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351010", "story_v_out_319351.awb")
				end
	...
	Play319351011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351011
		slot1.duration_ = 6.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10058ui_story, Vector3.New(0.7, -0.98, -6.1), (uv0.time_ - slot8) / slot9)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(319351011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351011", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351011", "story_v_out_319351.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_319351", "319351011", "story_v_out_319351.awb")

						uv0:RecordAudio("319351011", slot23)
						uv0:RecordAudio("319351011", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351011", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351011", "story_v_out_319351.awb")
				end
	...
	Play319351012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351012
		slot1.duration_ = 8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(319351012).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351012", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351012", "story_v_out_319351.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_319351", "319351012", "story_v_out_319351.awb")

						uv0:RecordAudio("319351012", slot17)
						uv0:RecordAudio("319351012", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351012", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351012", "story_v_out_319351.awb")
				end
	...
	Play319351013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319351013).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351013", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351013", "story_v_out_319351.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319351", "319351013", "story_v_out_319351.awb")

						uv0:RecordAudio("319351013", slot18)
						uv0:RecordAudio("319351013", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351013", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351013", "story_v_out_319351.awb")
				end
	...
	Play319351014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(319351014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351014", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351014", "story_v_out_319351.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_319351", "319351014", "story_v_out_319351.awb")

						uv0:RecordAudio("319351014", slot16)
						uv0:RecordAudio("319351014", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351014", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351014", "story_v_out_319351.awb")
				end
	...
	Play319351015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(319351015).content)
				uv0.text_.text = slot7
	...
	Play319351016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
			...
			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPos1084ui_story = uv0.actors_["1084ui_story"].transform.localPosition
			end
			...
			if 2.43333333333333 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(319351016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351016", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351016", "story_v_out_319351.awb") / 1000 + slot15 then
						uv0.duration_ = slot24 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_319351", "319351016", "story_v_out_319351.awb")

						uv0:RecordAudio("319351016", slot25)
						uv0:RecordAudio("319351016", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351016", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351016", "story_v_out_319351.awb")
				end
	...
	Play319351017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319351017).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351017", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351017", "story_v_out_319351.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_319351", "319351017", "story_v_out_319351.awb")

						uv0:RecordAudio("319351017", slot10)
						uv0:RecordAudio("319351017", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351017", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351017", "story_v_out_319351.awb")
				end
	...
	Play319351018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(319351018).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351018", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351018", "story_v_out_319351.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_319351", "319351018", "story_v_out_319351.awb")

						uv0:RecordAudio("319351018", slot16)
						uv0:RecordAudio("319351018", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351018", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351018", "story_v_out_319351.awb")
				end
	...
	Play319351019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351019
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319351019).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351019", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351019", "story_v_out_319351.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_319351", "319351019", "story_v_out_319351.awb")

						uv0:RecordAudio("319351019", slot10)
						uv0:RecordAudio("319351019", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351019", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351019", "story_v_out_319351.awb")
				end
	...
	Play319351020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(319351020).content)
	...
	Play319351021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351021
		slot1.duration_ = 13.1666666666667
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play319351022(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 3 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.characterEffect10058ui_story == nil then
				uv0.var_.characterEffect10058ui_story = uv0.actors_["10058ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 2.66666666666667 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.talkMaxDuration = 0
				uv0.dialogCg_.alpha = 1
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(319351021).content)
				uv0.text_.text = slot18
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351021", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351021", "story_v_out_319351.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_319351", "319351021", "story_v_out_319351.awb")

						uv0:RecordAudio("319351021", slot23)
						uv0:RecordAudio("319351021", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351021", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351021", "story_v_out_319351.awb")
				end
	...
	Play319351022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319351022).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351022", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351022", "story_v_out_319351.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_319351", "319351022", "story_v_out_319351.awb")

						uv0:RecordAudio("319351022", slot10)
						uv0:RecordAudio("319351022", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351022", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351022", "story_v_out_319351.awb")
				end
	...
	Play319351023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351023
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(319351023).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351023", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351023", "story_v_out_319351.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_319351", "319351023", "story_v_out_319351.awb")

						uv0:RecordAudio("319351023", slot24)
						uv0:RecordAudio("319351023", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351023", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351023", "story_v_out_319351.awb")
				end
	...
	Play319351024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319351024).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351024", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351024", "story_v_out_319351.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319351", "319351024", "story_v_out_319351.awb")

						uv0:RecordAudio("319351024", slot18)
						uv0:RecordAudio("319351024", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351024", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351024", "story_v_out_319351.awb")
				end
	...
	Play319351025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(319351025).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351025", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351025", "story_v_out_319351.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_319351", "319351025", "story_v_out_319351.awb")

						uv0:RecordAudio("319351025", slot21)
						uv0:RecordAudio("319351025", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351025", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351025", "story_v_out_319351.awb")
				end
	...
	Play319351026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351026
		slot1.duration_ = 5.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319351026).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351026", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351026", "story_v_out_319351.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_319351", "319351026", "story_v_out_319351.awb")

						uv0:RecordAudio("319351026", slot10)
						uv0:RecordAudio("319351026", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351026", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351026", "story_v_out_319351.awb")
				end
	...
	Play319351027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351027
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319351027).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351027", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351027", "story_v_out_319351.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319351", "319351027", "story_v_out_319351.awb")

						uv0:RecordAudio("319351027", slot18)
						uv0:RecordAudio("319351027", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351027", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351027", "story_v_out_319351.awb")
				end
	...
	Play319351028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351028
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319351028).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351028", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351028", "story_v_out_319351.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319351", "319351028", "story_v_out_319351.awb")

						uv0:RecordAudio("319351028", slot18)
						uv0:RecordAudio("319351028", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351028", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351028", "story_v_out_319351.awb")
				end
	...
	Play319351029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351029
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(319351029).content)
				uv0.text_.text = slot16
	...
	Play319351030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351030
		slot1.duration_ = 9.43266666666667
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2.36666666666667 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
			...
			if 2.36666666666667 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect1095ui_story == nil then
			...
			if 2.36666666666667 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
			...
			if 1.4 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				slot11 = manager.ui.mainCamera.transform.localPosition
				slot13 = uv0.bgs_.ST74
			...
			if 1.4 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.mask_.enabled = true
				uv0.mask_.raycastTarget = true
			...
			if 2.36666666666667 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(319351030).content)
				uv0.text_.text = slot20

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (30 <= 0 and slot16 or slot16 * utf8.len(slot20) / slot21) > 0 and slot16 < slot23 then
					uv0.talkMaxDuration = slot23
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351030", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351030", "story_v_out_319351.awb") / 1000 + slot15 then
						uv0.duration_ = slot24 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_319351", "319351030", "story_v_out_319351.awb")

						uv0:RecordAudio("319351030", slot25)
						uv0:RecordAudio("319351030", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351030", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351030", "story_v_out_319351.awb")
				end
	...
	Play319351031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351031
		slot1.duration_ = 4.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(319351031).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351031", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351031", "story_v_out_319351.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_319351", "319351031", "story_v_out_319351.awb")

						uv0:RecordAudio("319351031", slot24)
						uv0:RecordAudio("319351031", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351031", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351031", "story_v_out_319351.awb")
				end
	...
	Play319351032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351032
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(319351032).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351032", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351032", "story_v_out_319351.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_319351", "319351032", "story_v_out_319351.awb")

						uv0:RecordAudio("319351032", slot16)
						uv0:RecordAudio("319351032", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351032", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351032", "story_v_out_319351.awb")
				end
	...
	Play319351033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351033
		slot1.duration_ = 6.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319351033).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351033", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351033", "story_v_out_319351.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319351", "319351033", "story_v_out_319351.awb")

						uv0:RecordAudio("319351033", slot18)
						uv0:RecordAudio("319351033", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351033", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351033", "story_v_out_319351.awb")
				end
	...
	Play319351034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351034
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(319351034).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351034", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351034", "story_v_out_319351.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_319351", "319351034", "story_v_out_319351.awb")

						uv0:RecordAudio("319351034", slot16)
						uv0:RecordAudio("319351034", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351034", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351034", "story_v_out_319351.awb")
				end
	...
	Play319351035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351035
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(319351035).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351035", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351035", "story_v_out_319351.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_319351", "319351035", "story_v_out_319351.awb")

						uv0:RecordAudio("319351035", slot12)
						uv0:RecordAudio("319351035", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351035", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351035", "story_v_out_319351.awb")
				end
	...
	Play319351036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351036
		slot1.duration_ = 2.033
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319351036).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351036", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351036", "story_v_out_319351.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319351", "319351036", "story_v_out_319351.awb")

						uv0:RecordAudio("319351036", slot18)
						uv0:RecordAudio("319351036", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351036", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351036", "story_v_out_319351.awb")
				end
	...
	Play319351037 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351037
		slot1.duration_ = 5.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(319351037).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351037", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351037", "story_v_out_319351.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_319351", "319351037", "story_v_out_319351.awb")

						uv0:RecordAudio("319351037", slot16)
						uv0:RecordAudio("319351037", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351037", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351037", "story_v_out_319351.awb")
				end
	...
	Play319351038 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351038
		slot1.duration_ = 4.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319351038).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351038", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351038", "story_v_out_319351.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_319351", "319351038", "story_v_out_319351.awb")

						uv0:RecordAudio("319351038", slot10)
						uv0:RecordAudio("319351038", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351038", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351038", "story_v_out_319351.awb")
				end
	...
	Play319351039 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351039
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2.63333333333333 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(319351039).content)
				uv0.text_.text = slot16
	...
	Play319351040 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351040
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319351040).content)
				uv0.text_.text = slot4
	...
	Play319351041 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351041
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot1 <= uv0.time_ and uv0.time_ < slot1 + slot2 then
				slot4 = Color.New(0.7924528, 0.4269517, 0.1084016)
				slot4.a = Mathf.Lerp(1, 0, (uv0.time_ - slot1) / slot2)
				uv0.mask_.color = slot4
			end

			if uv0.time_ >= slot1 + slot2 and uv0.time_ < slot1 + slot2 + slot0 then
				slot3 = Color.New(0.7924528, 0.4269517, 0.1084016)
				uv0.mask_.enabled = false
				slot3.a = 0
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot6 = Color.New(0.7924528, 0.4269517, 0.1084016)
				slot6.a = Mathf.Lerp(1, 0, (uv0.time_ - slot3) / slot4)
				uv0.mask_.color = slot6
			end

			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 then
				slot5 = Color.New(0.7924528, 0.4269517, 0.1084016)
				uv0.mask_.enabled = false
				slot5.a = 0
				uv0.mask_.color = slot5
			end
			...
			if 1.83333333333333 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319351041).content)
				uv0.text_.text = slot8

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (39 <= 0 and slot6 or slot6 * utf8.len(slot8) / slot9) > 0 and slot6 < slot11 then
	...
	Play319351042 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351042
		slot1.duration_ = 5.258
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play319351043(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 3 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
				uv0.var_.characterEffect1084ui_story = uv0.actors_["1084ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 2.825 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.talkMaxDuration = 0
				uv0.dialogCg_.alpha = 1
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(319351042).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351042", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351042", "story_v_out_319351.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_319351", "319351042", "story_v_out_319351.awb")

						uv0:RecordAudio("319351042", slot21)
						uv0:RecordAudio("319351042", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351042", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351042", "story_v_out_319351.awb")
				end
	...
	Play319351043 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351043
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(-0.7, -0.97, -6), (uv0.time_ - slot13) / slot14)
				slot18 = manager.ui.mainCamera.transform.position - slot12.position
				slot12.forward = Vector3.New(slot18.x, slot18.y, slot18.z)
				slot19 = slot12.localEulerAngles
				slot19.z = 0
			...
			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(-0.7, -0.97, -6)
				slot17 = manager.ui.mainCamera.transform.position - slot12.position
				slot12.forward = Vector3.New(slot17.x, slot17.y, slot17.z)
				slot18 = slot12.localEulerAngles
				slot18.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(319351043).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_319351", "319351043", "story_v_out_319351.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319351", "319351043", "story_v_out_319351.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_319351", "319351043", "story_v_out_319351.awb")

						uv0:RecordAudio("319351043", slot24)
						uv0:RecordAudio("319351043", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319351", "319351043", "story_v_out_319351.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319351", "319351043", "story_v_out_319351.awb")
				end
	...
	Play319351044 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351044
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
				uv0.var_.characterEffect1084ui_story = uv0.actors_["1084ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot25 = uv0:FormatText(uv0:GetWordFromCfg(319351044).content)
	...
	Play319351045 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351045
		slot1.duration_ = 7.3921013015788
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2.3921013015788 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(319351045).content)
				uv0.text_.text = slot9
	...
	Play319351046 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351046
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319351046).content)
				uv0.text_.text = slot4
	...
	Play319351047 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319351047
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319351047).content)
				uv0.text_.text = slot4
