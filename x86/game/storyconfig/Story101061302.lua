return {
	Play106132001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(106132001).content)
	...
	Play106132002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(106132002).content)
	...
	Play106132003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(106132003).content)
				uv0.text_.text = slot4
	...
	Play106132004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(106132004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132004", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132004", "story_v_out_106132.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106132", "106132004", "story_v_out_106132.awb")

						uv0:RecordAudio("106132004", slot18)
						uv0:RecordAudio("106132004", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132004", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132004", "story_v_out_106132.awb")
				end
	...
	Play106132005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(106132005).content)
	...
	Play106132006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(106132006).content)
	...
	Play106132007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(106132007).content)
	...
	Play106132008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(106132008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132008", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132008", "story_v_out_106132.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106132", "106132008", "story_v_out_106132.awb")

						uv0:RecordAudio("106132008", slot17)
						uv0:RecordAudio("106132008", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132008", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132008", "story_v_out_106132.awb")
				end
	...
	Play106132009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(106132009).content)
				uv0.text_.text = slot10
	...
	Play106132010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(106132010).content)
	...
	Play106132011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(106132011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132011", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132011", "story_v_out_106132.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_106132", "106132011", "story_v_out_106132.awb")

						uv0:RecordAudio("106132011", slot20)
						uv0:RecordAudio("106132011", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132011", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132011", "story_v_out_106132.awb")
				end
	...
	Play106132012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(106132012).content)
				uv0.text_.text = slot10
	...
	Play106132013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(106132013).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132013", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132013", "story_v_out_106132.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106132", "106132013", "story_v_out_106132.awb")

						uv0:RecordAudio("106132013", slot17)
						uv0:RecordAudio("106132013", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132013", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132013", "story_v_out_106132.awb")
				end
	...
	Play106132014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(106132014).content)
				uv0.text_.text = slot12
	...
	Play106132015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(106132015).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132015", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132015", "story_v_out_106132.awb") / 1000 + slot1 then
						uv0.duration_ = slot10 + slot1
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_106132", "106132015", "story_v_out_106132.awb")

						uv0:RecordAudio("106132015", slot11)
						uv0:RecordAudio("106132015", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132015", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132015", "story_v_out_106132.awb")
				end
	...
	Play106132016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(106132016).content)
				uv0.text_.text = slot12
	...
	Play106132017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(106132017).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132017", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132017", "story_v_out_106132.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_106132", "106132017", "story_v_out_106132.awb")

						uv0:RecordAudio("106132017", slot19)
						uv0:RecordAudio("106132017", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132017", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132017", "story_v_out_106132.awb")
				end
	...
	Play106132018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(106132018).content)
				uv0.text_.text = slot10
	...
	Play106132019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(106132019).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132019", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132019", "story_v_out_106132.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106132", "106132019", "story_v_out_106132.awb")

						uv0:RecordAudio("106132019", slot18)
						uv0:RecordAudio("106132019", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132019", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132019", "story_v_out_106132.awb")
				end
	...
	Play106132020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1099ui_story, Vector3.New(0, -1.08, -5.9), (uv0.time_ - slot12) / slot13)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(106132020).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132020", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132020", "story_v_out_106132.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_106132", "106132020", "story_v_out_106132.awb")

						uv0:RecordAudio("106132020", slot28)
						uv0:RecordAudio("106132020", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132020", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132020", "story_v_out_106132.awb")
				end
	...
	Play106132021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(106132021).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132021", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132021", "story_v_out_106132.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106132", "106132021", "story_v_out_106132.awb")

						uv0:RecordAudio("106132021", slot18)
						uv0:RecordAudio("106132021", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132021", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132021", "story_v_out_106132.awb")
				end
	...
	Play106132022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(106132022).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132022", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132022", "story_v_out_106132.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106132", "106132022", "story_v_out_106132.awb")

						uv0:RecordAudio("106132022", slot17)
						uv0:RecordAudio("106132022", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132022", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132022", "story_v_out_106132.awb")
				end
	...
	Play106132023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(106132023).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132023", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132023", "story_v_out_106132.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106132", "106132023", "story_v_out_106132.awb")

						uv0:RecordAudio("106132023", slot18)
						uv0:RecordAudio("106132023", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132023", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132023", "story_v_out_106132.awb")
				end
	...
	Play106132024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(106132024).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132024", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132024", "story_v_out_106132.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106132", "106132024", "story_v_out_106132.awb")

						uv0:RecordAudio("106132024", slot17)
						uv0:RecordAudio("106132024", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132024", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132024", "story_v_out_106132.awb")
				end
	...
	Play106132025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(106132025).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132025", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132025", "story_v_out_106132.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_106132", "106132025", "story_v_out_106132.awb")

						uv0:RecordAudio("106132025", slot11)
						uv0:RecordAudio("106132025", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132025", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132025", "story_v_out_106132.awb")
				end
	...
	Play106132026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(106132026).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132026", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132026", "story_v_out_106132.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106132", "106132026", "story_v_out_106132.awb")

						uv0:RecordAudio("106132026", slot18)
						uv0:RecordAudio("106132026", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132026", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132026", "story_v_out_106132.awb")
				end
	...
	Play106132027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(106132027).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132027", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132027", "story_v_out_106132.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106132", "106132027", "story_v_out_106132.awb")

						uv0:RecordAudio("106132027", slot17)
						uv0:RecordAudio("106132027", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132027", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132027", "story_v_out_106132.awb")
				end
	...
	Play106132028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPosC01b = uv0.bgs_.C01b.transform.localPosition
			end
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				if uv0.bgs_.C07_1:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueC07_1 = slot18:GetColor("_Color").a
					uv0.var_.alphaMatValueC07_1 = slot18
				end
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				if uv0.var_.alphaMatValueC07_1 then
					...
					slot21.a = Mathf.Lerp(uv0.var_.alphaOldValueC07_1, 1, (uv0.time_ - slot16) / slot17)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				if uv0.bgs_.C01b:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueC01b = slot21:GetColor("_Color").a
					uv0.var_.alphaMatValueC01b = slot21
				end
			...
			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				if uv0.var_.alphaMatValueC01b then
					...
					slot24.a = Mathf.Lerp(uv0.var_.alphaOldValueC01b, 0, (uv0.time_ - slot19) / slot20)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot23 + slot0 then
				...
				slot27 = uv0:FormatText(uv0:GetWordFromCfg(106132028).content)
	...
	Play106132029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.5 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(106132029).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132029", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132029", "story_v_out_106132.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_106132", "106132029", "story_v_out_106132.awb")

						uv0:RecordAudio("106132029", slot20)
						uv0:RecordAudio("106132029", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132029", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132029", "story_v_out_106132.awb")
				end
	...
	Play106132030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(106132030).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132030", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132030", "story_v_out_106132.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_106132", "106132030", "story_v_out_106132.awb")

						uv0:RecordAudio("106132030", slot25)
						uv0:RecordAudio("106132030", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132030", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132030", "story_v_out_106132.awb")
				end
	...
	Play106132031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(106132031).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132031", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132031", "story_v_out_106132.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_106132", "106132031", "story_v_out_106132.awb")

						uv0:RecordAudio("106132031", slot22)
						uv0:RecordAudio("106132031", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132031", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132031", "story_v_out_106132.awb")
				end
	...
	Play106132032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10004ui_story, Vector3.New(0, -1.1, -5.6), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(106132032).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132032", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132032", "story_v_out_106132.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_106132", "106132032", "story_v_out_106132.awb")

						uv0:RecordAudio("106132032", slot24)
						uv0:RecordAudio("106132032", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132032", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132032", "story_v_out_106132.awb")
				end
	...
	Play106132033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(106132033).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132033", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132033", "story_v_out_106132.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_106132", "106132033", "story_v_out_106132.awb")

						uv0:RecordAudio("106132033", slot22)
						uv0:RecordAudio("106132033", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132033", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132033", "story_v_out_106132.awb")
				end
	...
	Play106132034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(106132034).content)
				uv0.text_.text = slot7
	...
	Play106132035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(106132035).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_106132", "106132035", "story_v_out_106132.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_106132", "106132035", "story_v_out_106132.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_106132", "106132035", "story_v_out_106132.awb")

						uv0:RecordAudio("106132035", slot13)
						uv0:RecordAudio("106132035", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_106132", "106132035", "story_v_out_106132.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_106132", "106132035", "story_v_out_106132.awb")
				end
