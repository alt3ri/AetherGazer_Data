		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.actorSpriteComps1038 then
					for slot12, slot13 in pairs(uv0.var_.actorSpriteComps1038:ToTable()) do
						if slot13 then
	...
	Play115261031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				...
				if uv0.var_.actorSpriteComps1038 then
					for slot16, slot17 in pairs(uv0.var_.actorSpriteComps1038:ToTable()) do
						if slot17 then
	...
	Play115261083 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				...
				if uv0.var_.actorSpriteComps10030 then
					for slot16, slot17 in pairs(uv0.var_.actorSpriteComps10030:ToTable()) do
						if slot17 then
							slot18 = Mathf.Lerp(slot17.color.r, 1, slot12)
							slot17.color = Color.New(slot18, slot18, slot18)
						end
	...
	Play115261095 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				...
				if uv0.var_.actorSpriteComps10030 then
					for slot20, slot21 in pairs(uv0.var_.actorSpriteComps10030:ToTable()) do
						if slot21 then
