return {
	Play116231001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116231001).content)
	...
	Play116231002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116231002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231002", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231002", "story_v_out_116231.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116231", "116231002", "story_v_out_116231.awb")

						uv0:RecordAudio("116231002", slot19)
						uv0:RecordAudio("116231002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231002", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231002", "story_v_out_116231.awb")
				end
	...
	Play116231003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231003
		slot1.duration_ = 5.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0.7, -1.1, -5.9), (uv0.time_ - slot3) / slot4)
				slot8 = manager.ui.mainCamera.transform.position - slot2.position
				slot2.forward = Vector3.New(slot8.x, slot8.y, slot8.z)
				slot9 = slot2.localEulerAngles
				slot9.z = 0
			...
			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 then
				slot2.localPosition = Vector3.New(0.7, -1.1, -5.9)
				slot7 = manager.ui.mainCamera.transform.position - slot2.position
				slot2.forward = Vector3.New(slot7.x, slot7.y, slot7.z)
				slot8 = slot2.localEulerAngles
				slot8.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(116231003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231003", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231003", "story_v_out_116231.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116231", "116231003", "story_v_out_116231.awb")

						uv0:RecordAudio("116231003", slot22)
						uv0:RecordAudio("116231003", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231003", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231003", "story_v_out_116231.awb")
				end
	...
	Play116231004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116231004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231004", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231004", "story_v_out_116231.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116231", "116231004", "story_v_out_116231.awb")

						uv0:RecordAudio("116231004", slot18)
						uv0:RecordAudio("116231004", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231004", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231004", "story_v_out_116231.awb")
				end
	...
	Play116231005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231005
		slot1.duration_ = 8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot3.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot4) / slot5)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(116231005).content)
	...
	Play116231006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116231006).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231006", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231006", "story_v_out_116231.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116231", "116231006", "story_v_out_116231.awb")

						uv0:RecordAudio("116231006", slot18)
						uv0:RecordAudio("116231006", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231006", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231006", "story_v_out_116231.awb")
				end
	...
	Play116231007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116231007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231007", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231007", "story_v_out_116231.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116231", "116231007", "story_v_out_116231.awb")

						uv0:RecordAudio("116231007", slot13)
						uv0:RecordAudio("116231007", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231007", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231007", "story_v_out_116231.awb")
				end
	...
	Play116231008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231008
		slot1.duration_ = 7.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116231008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231008", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231008", "story_v_out_116231.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116231", "116231008", "story_v_out_116231.awb")

						uv0:RecordAudio("116231008", slot15)
						uv0:RecordAudio("116231008", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231008", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231008", "story_v_out_116231.awb")
				end
	...
	Play116231009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231009
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.233333333333333 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_16", "se_story_16_train_loop", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPosI06b = uv0.bgs_.I06b.transform.localPosition
			end

			slot15 = 4

			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPosI06b, Vector3.New(0, 1, 7), (uv0.time_ - slot14) / slot15)
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, 1, 7)
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(116231009).content)
	...
	Play116231010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116231010).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231010", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231010", "story_v_out_116231.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116231", "116231010", "story_v_out_116231.awb")

						uv0:RecordAudio("116231010", slot18)
						uv0:RecordAudio("116231010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231010", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231010", "story_v_out_116231.awb")
				end
	...
	Play116231011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(116231011).content)
	...
	Play116231012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231012
		slot1.duration_ = 5.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1111ui_story, Vector3.New(0, -0.83, -6), (uv0.time_ - slot6) / slot7)
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(0, -0.83, -6)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116231012).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231012", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231012", "story_v_out_116231.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116231", "116231012", "story_v_out_116231.awb")

						uv0:RecordAudio("116231012", slot18)
						uv0:RecordAudio("116231012", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231012", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231012", "story_v_out_116231.awb")
				end
	...
	Play116231013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116231013).content)
	...
	Play116231014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231014
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116231014).content)
	...
	Play116231015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231015
		slot1.duration_ = 6.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0204cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116231015).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231015", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231015", "story_v_out_116231.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116231", "116231015", "story_v_out_116231.awb")

						uv0:RecordAudio("116231015", slot18)
						uv0:RecordAudio("116231015", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231015", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231015", "story_v_out_116231.awb")
				end
	...
	Play116231016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.45 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116231016).content)
				uv0.text_.text = slot12

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (58 <= 0 and slot10 or slot10 * utf8.len(slot12) / slot13) > 0 and slot10 < slot15 then
					uv0.talkMaxDuration = slot15
	...
	Play116231017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116231017).content)
				uv0.text_.text = slot5
	...
	Play116231018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116231018).content)
	...
	Play116231019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116231019).content)
				uv0.text_.text = slot5
	...
	Play116231020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231020
		slot1.duration_ = 4.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116231020).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231020", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231020", "story_v_out_116231.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116231", "116231020", "story_v_out_116231.awb")

						uv0:RecordAudio("116231020", slot18)
						uv0:RecordAudio("116231020", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231020", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231020", "story_v_out_116231.awb")
				end
	...
	Play116231021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116231021).content)
				uv0.text_.text = slot7
	...
	Play116231022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231022
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116231022).content)
				uv0.text_.text = slot10
	...
	Play116231023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231023
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[262].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play116231024(uv1)
			end
		end
	...
	Play116231024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231024
		slot1.duration_ = 3.6
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play116231025(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action3_1")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116231024).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116231", "116231024", "story_v_out_116231.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116231", "116231024", "story_v_out_116231.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116231", "116231024", "story_v_out_116231.awb")

						uv0:RecordAudio("116231024", slot18)
						uv0:RecordAudio("116231024", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116231", "116231024", "story_v_out_116231.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116231", "116231024", "story_v_out_116231.awb")
				end
	...
	Play116231025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116231025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPosI06b, Vector3.New(0, 1, 2), (uv0.time_ - slot5) / slot6)
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(0, 1, 2)
			end
			...
			if uv0.time_ >= slot7 + 5 and uv0.time_ < slot7 + slot8 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116231025).content)
				uv0.text_.text = slot12

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (53 <= 0 and slot10 or slot10 * utf8.len(slot12) / slot13) > 0 and slot10 < slot15 then
					uv0.talkMaxDuration = slot15
