return {
	Play910502008 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_28 = arg_1_1.actors_["10048ui_story"].transform
			local var_4_29 = 1.8

			if var_4_29 < arg_1_1.time_ and arg_1_1.time_ <= var_4_29 + arg_4_0 then
				arg_1_1.var_.moveOldPos10048ui_story = var_4_28.localPosition
			end
			...
			if var_4_29 <= arg_1_1.time_ and arg_1_1.time_ < var_4_29 + var_4_30 then
				...
				local var_4_32 = Vector3.New(0, -1.155, -6.13)

				var_4_28.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos10048ui_story, var_4_32, var_4_31)
			...
			if arg_1_1.time_ >= var_4_29 + var_4_30 and arg_1_1.time_ < var_4_29 + var_4_30 + arg_4_0 then
				var_4_28.localPosition = Vector3.New(0, -1.155, -6.13)
			...
			local var_4_37 = arg_1_1.actors_["10048ui_story"]
			local var_4_38 = 1.8

			if var_4_38 < arg_1_1.time_ and arg_1_1.time_ <= var_4_38 + arg_4_0 and arg_1_1.var_.characterEffect10048ui_story == nil then
				arg_1_1.var_.characterEffect10048ui_story = var_4_37:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_4_38 <= arg_1_1.time_ and arg_1_1.time_ < var_4_38 + var_4_39 then
				...
				if arg_1_1.var_.characterEffect10048ui_story then
					arg_1_1.var_.characterEffect10048ui_story.fillFlat = false
				end
			end

			if arg_1_1.time_ >= var_4_38 + var_4_39 and arg_1_1.time_ < var_4_38 + var_4_39 + arg_4_0 and arg_1_1.var_.characterEffect10048ui_story then
				arg_1_1.var_.characterEffect10048ui_story.fillFlat = false
			end
			...
			local var_4_43 = 2.00000000298023
			local var_4_44 = 0.3
			...
			if var_4_43 < arg_1_1.time_ and arg_1_1.time_ <= var_4_43 + arg_4_0 then
				...
				local var_4_46 = arg_1_1:FormatText(StoryNameCfg[476].name)
				...
				local var_4_47 = arg_1_1:GetWordFromCfg(910502008)
	...
	Play910502009 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_10 < arg_7_1.time_ and arg_7_1.time_ <= var_10_10 + arg_10_0 and arg_7_1.var_.characterEffect10048ui_story == nil then
			...
			if arg_7_1.time_ >= var_10_10 + var_10_11 and arg_7_1.time_ < var_10_10 + var_10_11 + arg_10_0 and arg_7_1.var_.characterEffect10048ui_story then
				local var_10_14 = 0.5
	...
	Play910502010 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			local var_14_4 = arg_11_1.actors_["1055ui_story"].transform
			local var_14_5 = 0

			if var_14_5 < arg_11_1.time_ and arg_11_1.time_ <= var_14_5 + arg_14_0 then
				arg_11_1.var_.moveOldPos1055ui_story = var_14_4.localPosition
			end
			...
			if var_14_5 <= arg_11_1.time_ and arg_11_1.time_ < var_14_5 + var_14_6 then
				...
				local var_14_8 = Vector3.New(-0.7, -0.965, -6.2)

				var_14_4.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1055ui_story, var_14_8, var_14_7)
			...
			if arg_11_1.time_ >= var_14_5 + var_14_6 and arg_11_1.time_ < var_14_5 + var_14_6 + arg_14_0 then
				var_14_4.localPosition = Vector3.New(-0.7, -0.965, -6.2)
			...
			local var_14_13 = arg_11_1.actors_["1055ui_story"]
			local var_14_14 = 0

			if var_14_14 < arg_11_1.time_ and arg_11_1.time_ <= var_14_14 + arg_14_0 and arg_11_1.var_.characterEffect1055ui_story == nil then
				arg_11_1.var_.characterEffect1055ui_story = var_14_13:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_11_1.time_ >= var_14_14 + var_14_15 and arg_11_1.time_ < var_14_14 + var_14_15 + arg_14_0 and arg_11_1.var_.characterEffect1055ui_story then
				arg_11_1.var_.characterEffect1055ui_story.fillFlat = false
			end
			...
			if var_14_19 < arg_11_1.time_ and arg_11_1.time_ <= var_14_19 + arg_14_0 then
				...
				local var_14_21 = arg_11_1:FormatText(StoryNameCfg[481].name)
				...
				local var_14_22 = arg_11_1:GetWordFromCfg(910502010)
	...
	Play910502011 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_16 < arg_15_1.time_ and arg_15_1.time_ <= var_18_16 + arg_18_0 and arg_15_1.var_.characterEffect1055ui_story == nil then
			...
			if arg_15_1.time_ >= var_18_16 + var_18_17 and arg_15_1.time_ < var_18_16 + var_18_17 + arg_18_0 and arg_15_1.var_.characterEffect1055ui_story then
				local var_18_20 = 0.5
