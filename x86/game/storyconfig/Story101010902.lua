return {
	Play101092001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092001
		slot1.duration_ = 3.799999952315
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				if uv0.bgs_.B01b:GetComponent("SpriteRenderer") then
					slot14.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot15 = slot14.material
					uv0.var_.alphaOldValueB01b = slot15:GetColor("_Color").a
					uv0.var_.alphaMatValueB01b = slot15
				end

				uv0.var_.alphaOldValueB01b = 0
			end

			slot14 = 1.5

			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				if uv0.var_.alphaMatValueB01b then
					slot17 = uv0.var_.alphaMatValueB01b
					slot18 = slot17:GetColor("_Color")
					slot18.a = Mathf.Lerp(uv0.var_.alphaOldValueB01b, 1, (uv0.time_ - slot13) / slot14)

					slot17:SetColor("_Color", slot18)
				end
			end

			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 and uv0.var_.alphaMatValueB01b then
				slot15 = uv0.var_.alphaMatValueB01b
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(0, -0.97, -6), (uv0.time_ - slot17) / slot18)
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 then
				slot16.localPosition = Vector3.New(0, -0.97, -6)
			...
			if 1.79999995231628 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
			...
			slot22 = 0.600000023841858

			if slot21 <= uv0.time_ and uv0.time_ < slot21 + slot22 then
				slot24, slot25 = math.modf((uv0.time_ - slot21) / 0.066)
				slot20.localPosition = Vector3.New(slot25 * 0.13, slot25 * 0.13, slot25 * 0.13) + uv0.var_.shakeOldPosMainCamera
			end

			if uv0.time_ >= slot21 + slot22 and uv0.time_ < slot21 + slot22 + slot0 then
				slot20.localPosition = uv0.var_.shakeOldPosMainCamera
			end
			...
			if uv0.time_ >= slot23 + 2 and uv0.time_ < slot23 + slot24 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot26 + slot0 then
				...
				slot31 = uv0:FormatText(uv0:GetWordFromCfg(101092001).content)
				uv0.text_.text = slot31

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (5 <= 0 and slot27 or slot27 * utf8.len(slot31) / slot32) > 0 and slot27 < slot34 then
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092001", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092001", "story_v_out_101092.awb") / 1000 + slot26 then
						uv0.duration_ = slot35 + slot26
					end

					if slot30.prefab_name ~= "" and uv0.actors_[slot30.prefab_name] ~= nil then
						slot36 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot30.prefab_name].transform, "story_v_out_101092", "101092001", "story_v_out_101092.awb")

						uv0:RecordAudio("101092001", slot36)
						uv0:RecordAudio("101092001", slot36)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092001", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092001", "story_v_out_101092.awb")
				end
	...
	Play101092002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092002
		slot1.duration_ = 7.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_2018")

				uv0.callingController_:SetSelectedState("normal")

				slot14 = uv0:FormatText(uv0:GetWordFromCfg(101092002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092002", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092002", "story_v_out_101092.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_101092", "101092002", "story_v_out_101092.awb")

						uv0:RecordAudio("101092002", slot19)
						uv0:RecordAudio("101092002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092002", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092002", "story_v_out_101092.awb")
				end
	...
	Play101092003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101092003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092003", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092003", "story_v_out_101092.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_101092", "101092003", "story_v_out_101092.awb")

						uv0:RecordAudio("101092003", slot12)
						uv0:RecordAudio("101092003", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092003", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092003", "story_v_out_101092.awb")
				end
	...
	Play101092004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(101092004).content)
	...
	Play101092005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101092005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092005", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092005", "story_v_out_101092.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101092", "101092005", "story_v_out_101092.awb")

						uv0:RecordAudio("101092005", slot18)
						uv0:RecordAudio("101092005", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092005", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092005", "story_v_out_101092.awb")
				end
	...
	Play101092006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092006
		slot1.duration_ = 5.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(101092006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092006", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092006", "story_v_out_101092.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_101092", "101092006", "story_v_out_101092.awb")

						uv0:RecordAudio("101092006", slot22)
						uv0:RecordAudio("101092006", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092006", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092006", "story_v_out_101092.awb")
				end
	...
	Play101092007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092007
		slot1.duration_ = 6.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101092007).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092007", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092007", "story_v_out_101092.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101092", "101092007", "story_v_out_101092.awb")

						uv0:RecordAudio("101092007", slot18)
						uv0:RecordAudio("101092007", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092007", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092007", "story_v_out_101092.awb")
				end
	...
	Play101092008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092008
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101092008).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092008", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092008", "story_v_out_101092.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101092", "101092008", "story_v_out_101092.awb")

						uv0:RecordAudio("101092008", slot18)
						uv0:RecordAudio("101092008", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092008", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092008", "story_v_out_101092.awb")
				end
	...
	Play101092009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot15.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(-0.7, -1.08, -5.9), (uv0.time_ - slot16) / slot17)
			...
			if uv0.time_ >= slot16 + slot17 and uv0.time_ < slot16 + slot17 + slot0 then
				slot15.localPosition = Vector3.New(-0.7, -1.08, -5.9)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(101092009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092009", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092009", "story_v_out_101092.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_101092", "101092009", "story_v_out_101092.awb")

						uv0:RecordAudio("101092009", slot28)
						uv0:RecordAudio("101092009", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092009", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092009", "story_v_out_101092.awb")
				end
	...
	Play101092010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101092010).content)
				uv0.text_.text = slot7
	...
	Play101092011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092011
		slot1.duration_ = 9.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(101092011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092011", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092011", "story_v_out_101092.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_101092", "101092011", "story_v_out_101092.awb")

						uv0:RecordAudio("101092011", slot15)
						uv0:RecordAudio("101092011", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092011", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092011", "story_v_out_101092.awb")
				end
	...
	Play101092012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101092012).content)
	...
	Play101092013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(101092013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092013", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092013", "story_v_out_101092.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_101092", "101092013", "story_v_out_101092.awb")

						uv0:RecordAudio("101092013", slot14)
						uv0:RecordAudio("101092013", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092013", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092013", "story_v_out_101092.awb")
				end
	...
	Play101092014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092014
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101092014).content)
				uv0.text_.text = slot8
	...
	Play101092015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092015
		slot1.duration_ = 3.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(101092015).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092015", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092015", "story_v_out_101092.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_101092", "101092015", "story_v_out_101092.awb")

						uv0:RecordAudio("101092015", slot15)
						uv0:RecordAudio("101092015", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092015", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092015", "story_v_out_101092.awb")
				end
	...
	Play101092016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101092016).content)
				uv0.text_.text = slot8
	...
	Play101092017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(101092017).content)
	...
	Play101092018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092018
		slot1.duration_ = 7.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(101092018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092018", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092018", "story_v_out_101092.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_101092", "101092018", "story_v_out_101092.awb")

						uv0:RecordAudio("101092018", slot21)
						uv0:RecordAudio("101092018", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092018", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092018", "story_v_out_101092.awb")
				end
	...
	Play101092019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101092019).content)
				uv0.text_.text = slot8
	...
	Play101092020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(101092020).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092020", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092020", "story_v_out_101092.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_101092", "101092020", "story_v_out_101092.awb")

						uv0:RecordAudio("101092020", slot24)
						uv0:RecordAudio("101092020", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092020", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092020", "story_v_out_101092.awb")
				end
	...
	Play101092021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101092021).content)
				uv0.text_.text = slot8
	...
	Play101092022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(101092022).content)
				uv0.text_.text = slot5
	...
	Play101092023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101092023
		slot1.duration_ = 6.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(101092023).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_101092", "101092023", "story_v_out_101092.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101092", "101092023", "story_v_out_101092.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_101092", "101092023", "story_v_out_101092.awb")

						uv0:RecordAudio("101092023", slot14)
						uv0:RecordAudio("101092023", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101092", "101092023", "story_v_out_101092.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101092", "101092023", "story_v_out_101092.awb")
				end
