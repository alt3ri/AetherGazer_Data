return {
	Play113101001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101001
		slot1.duration_ = 6.665999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.799999999999 < uv0.time_ and uv0.time_ <= slot12 + slot0 and uv0.var_.characterEffect1041ui_story == nil then
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(113101001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101001", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101001", "story_v_out_113101.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_113101", "113101001", "story_v_out_113101.awb")

						uv0:RecordAudio("113101001", slot27)
						uv0:RecordAudio("113101001", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101001", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101001", "story_v_out_113101.awb")
				end
	...
	Play113101002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
			...
			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.characterEffect1041ui_story then
					...
					uv0.var_.characterEffect1041ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot11) / slot12)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(113101002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101002", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101002", "story_v_out_113101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_113101", "113101002", "story_v_out_113101.awb")

						uv0:RecordAudio("113101002", slot22)
						uv0:RecordAudio("113101002", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101002", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101002", "story_v_out_113101.awb")
				end
	...
	Play113101003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101003
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play113101004(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:PlayTimeline("1041ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3203cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(113101003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101003", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101003", "story_v_out_113101.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_113101", "113101003", "story_v_out_113101.awb")

						uv0:RecordAudio("113101003", slot17)
						uv0:RecordAudio("113101003", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101003", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101003", "story_v_out_113101.awb")
				end
	...
	Play113101004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("1042ui_story", "StoryTimeline/CharAction/1042/1042action/1042action2_1")
			end

			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1041ui_story == nil then
				uv0.var_.characterEffect1041ui_story = uv0.actors_["1041ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				if uv0.var_.characterEffect1041ui_story then
					uv0.var_.characterEffect1041ui_story.fillFlat = true
					uv0.var_.characterEffect1041ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot14) / slot15)
				end
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 and uv0.var_.characterEffect1041ui_story then
				uv0.var_.characterEffect1041ui_story.fillFlat = true
				uv0.var_.characterEffect1041ui_story.fillRatio = 0.5
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(113101004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101004", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101004", "story_v_out_113101.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_113101", "113101004", "story_v_out_113101.awb")

						uv0:RecordAudio("113101004", slot25)
						uv0:RecordAudio("113101004", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101004", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101004", "story_v_out_113101.awb")
				end
	...
	Play113101005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(113101005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101005", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101005", "story_v_out_113101.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_113101", "113101005", "story_v_out_113101.awb")

						uv0:RecordAudio("113101005", slot21)
						uv0:RecordAudio("113101005", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101005", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101005", "story_v_out_113101.awb")
				end
	...
	Play113101006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101006
		slot1.duration_ = 2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(113101006).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101006", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101006", "story_v_out_113101.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_113101", "113101006", "story_v_out_113101.awb")

						uv0:RecordAudio("113101006", slot17)
						uv0:RecordAudio("113101006", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101006", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101006", "story_v_out_113101.awb")
				end
	...
	Play113101007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(113101007).content)
	...
	Play113101008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(113101008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101008", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101008", "story_v_out_113101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_113101", "113101008", "story_v_out_113101.awb")

						uv0:RecordAudio("113101008", slot18)
						uv0:RecordAudio("113101008", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101008", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101008", "story_v_out_113101.awb")
				end
	...
	Play113101009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101009
		slot1.duration_ = 5.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(113101009).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101009", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101009", "story_v_out_113101.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_113101", "113101009", "story_v_out_113101.awb")

						uv0:RecordAudio("113101009", slot21)
						uv0:RecordAudio("113101009", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101009", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101009", "story_v_out_113101.awb")
				end
	...
	Play113101010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(113101010).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101010", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101010", "story_v_out_113101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_113101", "113101010", "story_v_out_113101.awb")

						uv0:RecordAudio("113101010", slot18)
						uv0:RecordAudio("113101010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101010", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101010", "story_v_out_113101.awb")
				end
	...
	Play113101011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(113101011).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101011", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101011", "story_v_out_113101.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_113101", "113101011", "story_v_out_113101.awb")

						uv0:RecordAudio("113101011", slot17)
						uv0:RecordAudio("113101011", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101011", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101011", "story_v_out_113101.awb")
				end
	...
	Play113101012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(113101012).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101012", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101012", "story_v_out_113101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_113101", "113101012", "story_v_out_113101.awb")

						uv0:RecordAudio("113101012", slot18)
						uv0:RecordAudio("113101012", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101012", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101012", "story_v_out_113101.awb")
				end
	...
	Play113101013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101013
		slot1.duration_ = 9.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(113101013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101013", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101013", "story_v_out_113101.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_113101", "113101013", "story_v_out_113101.awb")

						uv0:RecordAudio("113101013", slot11)
						uv0:RecordAudio("113101013", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101013", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101013", "story_v_out_113101.awb")
				end
	...
	Play113101014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPos1084ui_story = uv0.actors_["1084ui_story"].transform.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(113101014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101014", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101014", "story_v_out_113101.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_113101", "113101014", "story_v_out_113101.awb")

						uv0:RecordAudio("113101014", slot24)
						uv0:RecordAudio("113101014", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101014", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101014", "story_v_out_113101.awb")
				end
	...
	Play113101015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(113101015).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101015", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101015", "story_v_out_113101.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_113101", "113101015", "story_v_out_113101.awb")

						uv0:RecordAudio("113101015", slot17)
						uv0:RecordAudio("113101015", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101015", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101015", "story_v_out_113101.awb")
				end
	...
	Play113101016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(113101016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101016", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101016", "story_v_out_113101.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_113101", "113101016", "story_v_out_113101.awb")

						uv0:RecordAudio("113101016", slot12)
						uv0:RecordAudio("113101016", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101016", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101016", "story_v_out_113101.awb")
				end
	...
	Play113101017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(113101017).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101017", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101017", "story_v_out_113101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_113101", "113101017", "story_v_out_113101.awb")

						uv0:RecordAudio("113101017", slot18)
						uv0:RecordAudio("113101017", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101017", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101017", "story_v_out_113101.awb")
				end
	...
	Play113101018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101018
		slot1.duration_ = 3.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0:PlayTimeline("1084ui_story", "StoryTimeline/CharAction/1084/1084action/1084action13_1")
			end

			if 1.00008890058234e-12 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(113101018).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101018", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101018", "story_v_out_113101.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_113101", "113101018", "story_v_out_113101.awb")

						uv0:RecordAudio("113101018", slot24)
						uv0:RecordAudio("113101018", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101018", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101018", "story_v_out_113101.awb")
				end
	...
	Play113101019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101019
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[199].name)
			uv0.choices_[2].txt.text = uv0:FormatText(StoryChoiceCfg[200].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play113101020(uv1)
			end
	...
	Play113101020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(113101020).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101020", "story_v_out_113101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_113101", "113101020", "story_v_out_113101.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_113101", "113101020", "story_v_out_113101.awb")

						uv0:RecordAudio("113101020", slot21)
						uv0:RecordAudio("113101020", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_113101", "113101020", "story_v_out_113101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_113101", "113101020", "story_v_out_113101.awb")
				end
	...
	Play113101021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 113101021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(113101021).content)
				uv0.text_.text = slot7
