return {
	Play103031001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(103031001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031001", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031001", "story_v_out_103031.awb") / 1000 + slot18 then
						uv0.duration_ = slot27 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_103031", "103031001", "story_v_out_103031.awb")

						uv0:RecordAudio("103031001", slot28)
						uv0:RecordAudio("103031001", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031001", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031001", "story_v_out_103031.awb")
				end
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				if uv0.var_.characterEffect4010ui_story then
					...
					uv0.var_.characterEffect4010ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot14) / slot15)
				end
			end
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos4010ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot17) / slot18)
			...
			if slot25 <= uv0.time_ and uv0.time_ < slot25 + slot26 then
				slot24.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(0, -0.97, -6), (uv0.time_ - slot25) / slot26)
			...
			if uv0.time_ >= slot25 + slot26 and uv0.time_ < slot25 + slot26 + slot0 then
				slot24.localPosition = Vector3.New(0, -0.97, -6)
			...
			if slot29 <= uv0.time_ and uv0.time_ < slot29 + slot30 then
				slot28.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(0.7, -1.08, -5.9), (uv0.time_ - slot29) / slot30)
			...
			if uv0.time_ >= slot29 + slot30 and uv0.time_ < slot29 + slot30 + slot0 then
				slot28.localPosition = Vector3.New(0.7, -1.08, -5.9)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot32 + slot0 then
				...
				slot36 = uv0:FormatText(uv0:GetWordFromCfg(103031002).content)
				uv0.text_.text = slot36

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (2 <= 0 and slot33 or slot33 * utf8.len(slot36) / slot37) > 0 and slot33 < slot39 then
					uv0.talkMaxDuration = slot39

					if uv0.duration_ < slot39 + slot32 then
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031002", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031002", "story_v_out_103031.awb") / 1000 + slot32 then
						uv0.duration_ = slot40 + slot32
					end

					if slot35.prefab_name ~= "" and uv0.actors_[slot35.prefab_name] ~= nil then
						slot41 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot35.prefab_name].transform, "story_v_out_103031", "103031002", "story_v_out_103031.awb")

						uv0:RecordAudio("103031002", slot41)
						uv0:RecordAudio("103031002", slot41)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031002", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031002", "story_v_out_103031.awb")
				end
	...
	Play103031003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(103031003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031003", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031003", "story_v_out_103031.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_103031", "103031003", "story_v_out_103031.awb")

						uv0:RecordAudio("103031003", slot27)
						uv0:RecordAudio("103031003", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031003", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031003", "story_v_out_103031.awb")
				end
	...
	Play103031004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(103031004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031004", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031004", "story_v_out_103031.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_103031", "103031004", "story_v_out_103031.awb")

						uv0:RecordAudio("103031004", slot24)
						uv0:RecordAudio("103031004", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031004", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031004", "story_v_out_103031.awb")
				end
	...
	Play103031005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(103031005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031005", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031005", "story_v_out_103031.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103031", "103031005", "story_v_out_103031.awb")

						uv0:RecordAudio("103031005", slot21)
						uv0:RecordAudio("103031005", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031005", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031005", "story_v_out_103031.awb")
				end
	...
	Play103031006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(103031006).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031006", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031006", "story_v_out_103031.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_103031", "103031006", "story_v_out_103031.awb")

						uv0:RecordAudio("103031006", slot27)
						uv0:RecordAudio("103031006", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031006", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031006", "story_v_out_103031.awb")
				end
	...
	Play103031007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos4010ui_story, Vector3.New(-0.7, -1.59, -5.2), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(-0.7, -1.59, -5.2)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0.7, -1.75, -4.8), (uv0.time_ - slot12) / slot13)
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(0.7, -1.75, -4.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(103031007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031007", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031007", "story_v_out_103031.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_103031", "103031007", "story_v_out_103031.awb")

						uv0:RecordAudio("103031007", slot25)
						uv0:RecordAudio("103031007", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031007", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031007", "story_v_out_103031.awb")
				end
	...
	Play103031008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(103031008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031008", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031008", "story_v_out_103031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103031", "103031008", "story_v_out_103031.awb")

						uv0:RecordAudio("103031008", slot17)
						uv0:RecordAudio("103031008", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031008", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031008", "story_v_out_103031.awb")
				end
	...
	Play103031009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, -1.51, -4.3), (uv0.time_ - slot12) / slot13)
				slot17 = manager.ui.mainCamera.transform.position - slot11.position
				slot11.forward = Vector3.New(slot17.x, slot17.y, slot17.z)
				slot18 = slot11.localEulerAngles
				slot18.z = 0
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(0, -1.51, -4.3)
				slot16 = manager.ui.mainCamera.transform.position - slot11.position
				slot11.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot11.localEulerAngles
				slot17.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(103031009).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031009", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031009", "story_v_out_103031.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_103031", "103031009", "story_v_out_103031.awb")

						uv0:RecordAudio("103031009", slot25)
						uv0:RecordAudio("103031009", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031009", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031009", "story_v_out_103031.awb")
				end
	...
	Play103031010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(103031010).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031010", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031010", "story_v_out_103031.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_103031", "103031010", "story_v_out_103031.awb")

						uv0:RecordAudio("103031010", slot24)
						uv0:RecordAudio("103031010", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031010", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031010", "story_v_out_103031.awb")
				end
	...
	Play103031011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(103031011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031011", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031011", "story_v_out_103031.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_103031", "103031011", "story_v_out_103031.awb")

						uv0:RecordAudio("103031011", slot12)
						uv0:RecordAudio("103031011", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031011", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031011", "story_v_out_103031.awb")
				end
	...
	Play103031012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(103031012).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031012", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031012", "story_v_out_103031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103031", "103031012", "story_v_out_103031.awb")

						uv0:RecordAudio("103031012", slot17)
						uv0:RecordAudio("103031012", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031012", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031012", "story_v_out_103031.awb")
				end
	...
	Play103031013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(103031013).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031013", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031013", "story_v_out_103031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103031", "103031013", "story_v_out_103031.awb")

						uv0:RecordAudio("103031013", slot17)
						uv0:RecordAudio("103031013", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031013", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031013", "story_v_out_103031.awb")
				end
	...
	Play103031014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(103031014).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031014", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031014", "story_v_out_103031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103031", "103031014", "story_v_out_103031.awb")

						uv0:RecordAudio("103031014", slot17)
						uv0:RecordAudio("103031014", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031014", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031014", "story_v_out_103031.awb")
				end
	...
	Play103031015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(103031015).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031015", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031015", "story_v_out_103031.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_103031", "103031015", "story_v_out_103031.awb")

						uv0:RecordAudio("103031015", slot11)
						uv0:RecordAudio("103031015", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031015", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031015", "story_v_out_103031.awb")
				end
	...
	Play103031016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(103031016).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031016", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031016", "story_v_out_103031.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_103031", "103031016", "story_v_out_103031.awb")

						uv0:RecordAudio("103031016", slot24)
						uv0:RecordAudio("103031016", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031016", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031016", "story_v_out_103031.awb")
				end
	...
	Play103031017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(103031017).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031017", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031017", "story_v_out_103031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103031", "103031017", "story_v_out_103031.awb")

						uv0:RecordAudio("103031017", slot17)
						uv0:RecordAudio("103031017", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031017", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031017", "story_v_out_103031.awb")
				end
	...
	Play103031018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(103031018).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031018", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031018", "story_v_out_103031.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_103031", "103031018", "story_v_out_103031.awb")

						uv0:RecordAudio("103031018", slot11)
						uv0:RecordAudio("103031018", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031018", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031018", "story_v_out_103031.awb")
				end
	...
	Play103031019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(103031019).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031019", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031019", "story_v_out_103031.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_103031", "103031019", "story_v_out_103031.awb")

						uv0:RecordAudio("103031019", slot11)
						uv0:RecordAudio("103031019", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031019", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031019", "story_v_out_103031.awb")
				end
	...
	Play103031020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(103031020).content)
	...
	Play103031021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(103031021).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031021", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031021", "story_v_out_103031.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_103031", "103031021", "story_v_out_103031.awb")

						uv0:RecordAudio("103031021", slot11)
						uv0:RecordAudio("103031021", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031021", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031021", "story_v_out_103031.awb")
				end
	...
	Play103031022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(103031022).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031022", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031022", "story_v_out_103031.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103031", "103031022", "story_v_out_103031.awb")

						uv0:RecordAudio("103031022", slot21)
						uv0:RecordAudio("103031022", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031022", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031022", "story_v_out_103031.awb")
				end
	...
	Play103031023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos4010ui_story, Vector3.New(0.7, -1.59, -5.2), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0.7, -1.59, -5.2)
				slot15 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot10.localEulerAngles
				slot16.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(103031023).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031023", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031023", "story_v_out_103031.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_103031", "103031023", "story_v_out_103031.awb")

						uv0:RecordAudio("103031023", slot24)
						uv0:RecordAudio("103031023", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031023", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031023", "story_v_out_103031.awb")
				end
	...
	Play103031024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(103031024).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031024", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031024", "story_v_out_103031.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_103031", "103031024", "story_v_out_103031.awb")

						uv0:RecordAudio("103031024", slot16)
						uv0:RecordAudio("103031024", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031024", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031024", "story_v_out_103031.awb")
				end
	...
	Play103031025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(103031025).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031025", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031025", "story_v_out_103031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103031", "103031025", "story_v_out_103031.awb")

						uv0:RecordAudio("103031025", slot18)
						uv0:RecordAudio("103031025", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031025", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031025", "story_v_out_103031.awb")
				end
	...
	Play103031026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(103031026).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031026", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031026", "story_v_out_103031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103031", "103031026", "story_v_out_103031.awb")

						uv0:RecordAudio("103031026", slot17)
						uv0:RecordAudio("103031026", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031026", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031026", "story_v_out_103031.awb")
				end
	...
	Play103031027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(103031027).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031027", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031027", "story_v_out_103031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103031", "103031027", "story_v_out_103031.awb")

						uv0:RecordAudio("103031027", slot17)
						uv0:RecordAudio("103031027", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031027", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031027", "story_v_out_103031.awb")
				end
	...
	Play103031028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2020_tpose, Vector3.New(-0.7, -1.2, -4.1), (uv0.time_ - slot15) / slot16)
			...
			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 then
				slot14.localPosition = Vector3.New(-0.7, -1.2, -4.1)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(103031028).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031028", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031028", "story_v_out_103031.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_103031", "103031028", "story_v_out_103031.awb")

						uv0:RecordAudio("103031028", slot27)
						uv0:RecordAudio("103031028", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031028", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031028", "story_v_out_103031.awb")
				end
	...
	Play103031029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(103031029).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031029", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031029", "story_v_out_103031.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103031", "103031029", "story_v_out_103031.awb")

						uv0:RecordAudio("103031029", slot21)
						uv0:RecordAudio("103031029", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031029", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031029", "story_v_out_103031.awb")
				end
	...
	Play103031030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(103031030).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031030", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031030", "story_v_out_103031.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_103031", "103031030", "story_v_out_103031.awb")

						uv0:RecordAudio("103031030", slot27)
						uv0:RecordAudio("103031030", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031030", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031030", "story_v_out_103031.awb")
				end
	...
	Play103031031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(103031031).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_103031", "103031031", "story_v_out_103031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103031", "103031031", "story_v_out_103031.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_103031", "103031031", "story_v_out_103031.awb")

						uv0:RecordAudio("103031031", slot24)
						uv0:RecordAudio("103031031", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103031", "103031031", "story_v_out_103031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103031", "103031031", "story_v_out_103031.awb")
				end
