		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.B06a:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB06a = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueB06a = slot7
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueB06a then
					...
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueB06a, 1, (uv0.time_ - slot5) / slot6)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(101091001).content)
	...
	Play101091002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(101091002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101091", "101091002", "story_v_out_101091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101091", "101091002", "story_v_out_101091.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_101091", "101091002", "story_v_out_101091.awb")

						uv0:RecordAudio("101091002", slot19)
						uv0:RecordAudio("101091002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101091", "101091002", "story_v_out_101091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101091", "101091002", "story_v_out_101091.awb")
				end
	...
	Play101091003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(101091003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101091", "101091003", "story_v_out_101091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101091", "101091003", "story_v_out_101091.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_101091", "101091003", "story_v_out_101091.awb")

						uv0:RecordAudio("101091003", slot22)
						uv0:RecordAudio("101091003", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101091", "101091003", "story_v_out_101091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101091", "101091003", "story_v_out_101091.awb")
				end
	...
	Play101091004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(101091004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101091", "101091004", "story_v_out_101091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101091", "101091004", "story_v_out_101091.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_101091", "101091004", "story_v_out_101091.awb")

						uv0:RecordAudio("101091004", slot25)
						uv0:RecordAudio("101091004", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101091", "101091004", "story_v_out_101091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101091", "101091004", "story_v_out_101091.awb")
				end
	...
	Play101091005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(101091005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101091", "101091005", "story_v_out_101091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101091", "101091005", "story_v_out_101091.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_101091", "101091005", "story_v_out_101091.awb")

						uv0:RecordAudio("101091005", slot24)
						uv0:RecordAudio("101091005", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101091", "101091005", "story_v_out_101091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101091", "101091005", "story_v_out_101091.awb")
				end
