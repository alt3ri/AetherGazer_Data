return {
	Play319441001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441001
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play319441002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.ST72a == nil then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect10069ui_story == nil then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(319441001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441001", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441001", "story_v_out_319441.awb") / 1000 + slot18 then
						uv0.duration_ = slot27 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_319441", "319441001", "story_v_out_319441.awb")

						uv0:RecordAudio("319441001", slot28)
						uv0:RecordAudio("319441001", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441001", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441001", "story_v_out_319441.awb")
				end
	...
	Play319441002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441002).content)
	...
	Play319441003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(319441003).content)
	...
	Play319441004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319441004).content)
	...
	Play319441005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319441005).content)
				uv0.text_.text = slot4
	...
	Play319441006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
			...
			if 3 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(319441006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441006", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441006", "story_v_out_319441.awb") / 1000 + slot17 then
						uv0.duration_ = slot25 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_319441", "319441006", "story_v_out_319441.awb")

						uv0:RecordAudio("319441006", slot26)
						uv0:RecordAudio("319441006", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441006", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441006", "story_v_out_319441.awb")
				end
	...
	Play319441007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441007).content)
				uv0.text_.text = slot8
	...
	Play319441008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441008
		slot1.duration_ = 3.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(319441008).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441008", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441008", "story_v_out_319441.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_319441", "319441008", "story_v_out_319441.awb")

						uv0:RecordAudio("319441008", slot15)
						uv0:RecordAudio("319441008", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441008", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441008", "story_v_out_319441.awb")
				end
	...
	Play319441009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441009).content)
				uv0.text_.text = slot8
	...
	Play319441010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441010
		slot1.duration_ = 6.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(319441010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441010", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441010", "story_v_out_319441.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_319441", "319441010", "story_v_out_319441.awb")

						uv0:RecordAudio("319441010", slot17)
						uv0:RecordAudio("319441010", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441010", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441010", "story_v_out_319441.awb")
				end
	...
	Play319441011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441011).content)
				uv0.text_.text = slot8
	...
	Play319441012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441012
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(319441012).content)
	...
	Play319441013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319441013).content)
				uv0.text_.text = slot4
	...
	Play319441014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441014
		slot1.duration_ = 1.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(319441014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441014", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441014", "story_v_out_319441.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_319441", "319441014", "story_v_out_319441.awb")

						uv0:RecordAudio("319441014", slot16)
						uv0:RecordAudio("319441014", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441014", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441014", "story_v_out_319441.awb")
				end
	...
	Play319441015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441015).content)
				uv0.text_.text = slot8
	...
	Play319441016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319441016).content)
				uv0.text_.text = slot4
	...
	Play319441017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319441017).content)
	...
	Play319441018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(319441018).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441018", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441018", "story_v_out_319441.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_319441", "319441018", "story_v_out_319441.awb")

						uv0:RecordAudio("319441018", slot15)
						uv0:RecordAudio("319441018", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441018", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441018", "story_v_out_319441.awb")
				end
	...
	Play319441019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441019).content)
				uv0.text_.text = slot8
	...
	Play319441020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319441020).content)
				uv0.text_.text = slot5
	...
	Play319441021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319441021).content)
				uv0.text_.text = slot5
	...
	Play319441022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319441022).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441022", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441022", "story_v_out_319441.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319441", "319441022", "story_v_out_319441.awb")

						uv0:RecordAudio("319441022", slot18)
						uv0:RecordAudio("319441022", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441022", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441022", "story_v_out_319441.awb")
				end
	...
	Play319441023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441023).content)
				uv0.text_.text = slot8
	...
	Play319441024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441024
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(319441024).content)
	...
	Play319441025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441025).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441025", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441025", "story_v_out_319441.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_319441", "319441025", "story_v_out_319441.awb")

						uv0:RecordAudio("319441025", slot13)
						uv0:RecordAudio("319441025", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441025", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441025", "story_v_out_319441.awb")
				end
	...
	Play319441026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441026
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441026).content)
				uv0.text_.text = slot8
	...
	Play319441027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441027
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(319441027).content)
				uv0.text_.text = slot4
	...
	Play319441028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441028
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319441028).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441028", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441028", "story_v_out_319441.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319441", "319441028", "story_v_out_319441.awb")

						uv0:RecordAudio("319441028", slot18)
						uv0:RecordAudio("319441028", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441028", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441028", "story_v_out_319441.awb")
				end
	...
	Play319441029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441029
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441029).content)
				uv0.text_.text = slot8
	...
	Play319441030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441030
		slot1.duration_ = 5.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_130", "se_story_130__holographic", "")
			end
			...
			if 0.3 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.effect光幕1 then
				Object.Destroy(slot10)

				uv0.var_.effect光幕1 = nil
			end
			...
			if 0.5 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(319441030).content)
				uv0.text_.text = slot14
	...
	Play319441031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441031
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.566666666666667 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441031).content)
				uv0.text_.text = slot8
	...
	Play319441032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441032
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(319441032).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441032", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441032", "story_v_out_319441.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_319441", "319441032", "story_v_out_319441.awb")

						uv0:RecordAudio("319441032", slot18)
						uv0:RecordAudio("319441032", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441032", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441032", "story_v_out_319441.awb")
				end
	...
	Play319441033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441033
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441033).content)
				uv0.text_.text = slot8
	...
	Play319441034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441034
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319441034).content)
				uv0.text_.text = slot5
	...
	Play319441035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441035
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(319441035).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441035", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441035", "story_v_out_319441.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_319441", "319441035", "story_v_out_319441.awb")

						uv0:RecordAudio("319441035", slot15)
						uv0:RecordAudio("319441035", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441035", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441035", "story_v_out_319441.awb")
				end
	...
	Play319441036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441036
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(319441036).content)
				uv0.text_.text = slot8
	...
	Play319441037 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441037
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319441037).content)
				uv0.text_.text = slot5
	...
	Play319441038 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441038
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(319441038).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441038", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441038", "story_v_out_319441.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_319441", "319441038", "story_v_out_319441.awb")

						uv0:RecordAudio("319441038", slot14)
						uv0:RecordAudio("319441038", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441038", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441038", "story_v_out_319441.awb")
				end
	...
	Play319441039 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441039
		slot1.duration_ = 6.25833333333333
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if not uv0.var_.effect624 then
					slot11 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"))
					slot11.name = "624"
					uv0.var_.effect624 = slot11
				end
			...
			if 1.06599999815226 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.var_.moveOldPos1084ui_story = uv0.actors_["1084ui_story"].transform.localPosition
			end
			...
			if uv0.bgs_.ST21a_blur == nil then
			...
			if 1.1 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
			...
			if 1.25833333333333 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				uv0.talkMaxDuration = 0
				uv0.dialogCg_.alpha = 1
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(319441039).content)
				uv0.text_.text = slot21

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (55 <= 0 and slot19 or slot19 * utf8.len(slot21) / slot22) > 0 and slot19 < slot24 then
					uv0.talkMaxDuration = slot24
	...
	Play319441040 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441040
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.effect624 then
				Object.Destroy(slot3)

				uv0.var_.effect624 = nil
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(319441040).content)
				uv0.text_.text = slot6
	...
	Play319441041 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441041
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.833333333333333 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(319441041).content)
				uv0.text_.text = slot9
	...
	Play319441042 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441042
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(319441042).content)
				uv0.text_.text = slot5
	...
	Play319441043 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441043
		slot1.duration_ = 7.19933333333333
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.633333333333333 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0.mask_.enabled = true
				uv0.mask_.raycastTarget = true
			...
			if 0.366666666666667 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				if not uv0.var_.effect369 then
					slot9 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ui_red"))
					slot9.name = "369"
					uv0.var_.effect369 = slot9
				end
			...
			if 2.33333333333333 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(319441043).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_319441", "319441043", "story_v_out_319441.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_319441", "319441043", "story_v_out_319441.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_319441", "319441043", "story_v_out_319441.awb")

						uv0:RecordAudio("319441043", slot20)
						uv0:RecordAudio("319441043", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_319441", "319441043", "story_v_out_319441.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_319441", "319441043", "story_v_out_319441.awb")
				end
	...
	Play319441044 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441044
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(319441044).content)
	...
	Play319441045 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441045
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot6 = Color.New(0.9433962, 0.9433962, 0.9433962)
				slot6.a = Mathf.Lerp(0, 1, (uv0.time_ - slot3) / slot4)
				uv0.mask_.color = slot6
			end

			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 then
				slot5 = Color.New(0.9433962, 0.9433962, 0.9433962)
				slot5.a = 1
				uv0.mask_.color = slot5
			end

			if 1.1 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.mask_.enabled = true
				uv0.mask_.raycastTarget = true
			...
			slot6 = 2.23333333333333

			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot8 = Color.New(0.9433962, 0.9433962, 0.9433962)
				slot8.a = Mathf.Lerp(1, 0, (uv0.time_ - slot5) / slot6)
				uv0.mask_.color = slot8
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot7 = Color.New(0.9433962, 0.9433962, 0.9433962)
				uv0.mask_.enabled = false
				slot7.a = 0
				uv0.mask_.color = slot7
			end
			...
			if 2.26666666666667 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(319441045).content)
				uv0.text_.text = slot11
	...
	Play319441046 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 319441046
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2.6 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(319441046).content)
				uv0.text_.text = slot11
