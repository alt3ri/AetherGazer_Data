return {
	Play910502020 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_28 = arg_1_1.actors_["3044ui_story"].transform
			local var_4_29 = 1.8

			if var_4_29 < arg_1_1.time_ and arg_1_1.time_ <= var_4_29 + arg_4_0 then
				arg_1_1.var_.moveOldPos3044ui_story = var_4_28.localPosition
			end
			...
			if var_4_29 <= arg_1_1.time_ and arg_1_1.time_ < var_4_29 + var_4_30 then
				...
				local var_4_32 = Vector3.New(0, -2.22, -2.4)

				var_4_28.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos3044ui_story, var_4_32, var_4_31)
			...
			if arg_1_1.time_ >= var_4_29 + var_4_30 and arg_1_1.time_ < var_4_29 + var_4_30 + arg_4_0 then
				var_4_28.localPosition = Vector3.New(0, -2.22, -2.4)
			...
			if var_4_38 < arg_1_1.time_ and arg_1_1.time_ <= var_4_38 + arg_4_0 and arg_1_1.var_.characterEffect3044ui_story == nil then
			...
			if arg_1_1.time_ >= var_4_38 + var_4_39 and arg_1_1.time_ < var_4_38 + var_4_39 + arg_4_0 and arg_1_1.var_.characterEffect3044ui_story then
				arg_1_1.var_.characterEffect3044ui_story.fillFlat = false
			end
			...
			if var_4_43 < arg_1_1.time_ and arg_1_1.time_ <= var_4_43 + arg_4_0 then
				...
				local var_4_46 = arg_1_1:FormatText(StoryNameCfg[493].name)
				...
				local var_4_47 = arg_1_1:GetWordFromCfg(910502020)
	...
	Play910502021 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_2 = arg_7_1:FormatText(StoryNameCfg[493].name)
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(910502021)
	...
	Play910502022 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			local var_14_9 = arg_11_1.actors_["3044ui_story"]
			local var_14_10 = 0

			if var_14_10 < arg_11_1.time_ and arg_11_1.time_ <= var_14_10 + arg_14_0 and arg_11_1.var_.characterEffect3044ui_story == nil then
				arg_11_1.var_.characterEffect3044ui_story = var_14_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_14_10 <= arg_11_1.time_ and arg_11_1.time_ < var_14_10 + var_14_11 then
				...
				if arg_11_1.var_.characterEffect3044ui_story then
					...
					arg_11_1.var_.characterEffect3044ui_story.fillRatio = var_14_13
				end
			end

			if arg_11_1.time_ >= var_14_10 + var_14_11 and arg_11_1.time_ < var_14_10 + var_14_11 + arg_14_0 and arg_11_1.var_.characterEffect3044ui_story then
				local var_14_14 = 0.5

				arg_11_1.var_.characterEffect3044ui_story.fillFlat = true
				arg_11_1.var_.characterEffect3044ui_story.fillRatio = var_14_14
			end
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				local var_14_18 = arg_11_1:GetWordFromCfg(910502022)
	...
	Play910502023 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_19 < arg_15_1.time_ and arg_15_1.time_ <= var_18_19 + arg_18_0 then
				...
				local var_18_22 = arg_15_1:GetWordFromCfg(910502023)
	...
	Play910502024 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_0 + arg_22_0 then
				...
				local var_22_3 = arg_19_1:GetWordFromCfg(910502024)
