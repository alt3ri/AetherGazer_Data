return {
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_25 < arg_1_1.time_ and arg_1_1.time_ <= var_4_25 + arg_4_0 then
				...
				for iter_4_2 = 0, var_4_26 - 1 do
					...
					if var_4_27.name == "split_7" or not string.find(var_4_27.name, "split") then
			...
			if var_4_41 < arg_1_1.time_ and arg_1_1.time_ <= var_4_41 + arg_4_0 then
				...
				local var_4_45 = arg_1_1:GetWordFromCfg(910816001)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_1 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 then
				...
				for iter_10_0 = 0, var_10_2 - 1 do
					...
					if var_10_3.name == "split_7" or not string.find(var_10_3.name, "split") then
			...
			if var_10_8 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 and arg_7_1.var_.actorSpriteComps1070 == nil then
			...
			if arg_7_1.time_ >= var_10_8 + var_10_9 and arg_7_1.time_ < var_10_8 + var_10_9 + arg_10_0 and arg_7_1.var_.actorSpriteComps1070 then
				local var_10_12 = 0.5
			...
			if var_10_13 < arg_7_1.time_ and arg_7_1.time_ <= var_10_13 + arg_10_0 then
				...
				local var_10_16 = arg_7_1:GetWordFromCfg(910816002)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_1 < arg_11_1.time_ and arg_11_1.time_ <= var_14_1 + arg_14_0 then
				...
				for iter_14_0 = 0, var_14_2 - 1 do
					...
					if var_14_3.name == "split_7" or not string.find(var_14_3.name, "split") then
			...
			if var_14_13 < arg_11_1.time_ and arg_11_1.time_ <= var_14_13 + arg_14_0 then
				...
				local var_14_15 = arg_11_1:FormatText(StoryNameCfg[7].name)
				...
				local var_14_16 = arg_11_1:GetWordFromCfg(910816003)
	...
	Play910816004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_13 < arg_15_1.time_ and arg_15_1.time_ <= var_18_13 + arg_18_0 then
				...
				local var_18_15 = arg_15_1:FormatText(StoryNameCfg[318].name)
				...
				local var_18_16 = arg_15_1:GetWordFromCfg(910816004)
	...
	Play910816005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_13 < arg_19_1.time_ and arg_19_1.time_ <= var_22_13 + arg_22_0 then
				...
				local var_22_16 = arg_19_1:GetWordFromCfg(910816005)
	...
	Play910816006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_13 < arg_23_1.time_ and arg_23_1.time_ <= var_26_13 + arg_26_0 then
				...
				local var_26_16 = arg_23_1:GetWordFromCfg(910816006)
	...
	Play910816007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_13 < arg_27_1.time_ and arg_27_1.time_ <= var_30_13 + arg_30_0 then
				...
				local var_30_16 = arg_27_1:GetWordFromCfg(910816007)
	...
	Play910816008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_13 < arg_31_1.time_ and arg_31_1.time_ <= var_34_13 + arg_34_0 then
				...
				local var_34_16 = arg_31_1:GetWordFromCfg(910816008)
	...
	Play910816009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_13 < arg_35_1.time_ and arg_35_1.time_ <= var_38_13 + arg_38_0 then
				...
				local var_38_15 = arg_35_1:GetWordFromCfg(910816009)
	...
	Play910816010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_13 < arg_39_1.time_ and arg_39_1.time_ <= var_42_13 + arg_42_0 then
				...
				local var_42_16 = arg_39_1:GetWordFromCfg(910816010)
	...
	Play910816011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_13 < arg_43_1.time_ and arg_43_1.time_ <= var_46_13 + arg_46_0 then
				...
				local var_46_16 = arg_43_1:GetWordFromCfg(910816011)
	...
	Play910816012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_13 < arg_47_1.time_ and arg_47_1.time_ <= var_50_13 + arg_50_0 then
				...
				local var_50_16 = arg_47_1:GetWordFromCfg(910816012)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if var_54_1 < arg_51_1.time_ and arg_51_1.time_ <= var_54_1 + arg_54_0 then
				...
				for iter_54_0 = 0, var_54_2 - 1 do
					...
					if var_54_3.name == "split_8" or not string.find(var_54_3.name, "split") then
			...
			if var_54_13 < arg_51_1.time_ and arg_51_1.time_ <= var_54_13 + arg_54_0 then
				...
				local var_54_16 = arg_51_1:GetWordFromCfg(910816013)
	...
	Play910816014 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if var_58_13 < arg_55_1.time_ and arg_55_1.time_ <= var_58_13 + arg_58_0 then
				...
				local var_58_16 = arg_55_1:GetWordFromCfg(910816014)
	...
	Play910816015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if var_62_13 < arg_59_1.time_ and arg_59_1.time_ <= var_62_13 + arg_62_0 then
				...
				local var_62_15 = arg_59_1:GetWordFromCfg(910816015)
				...
				local var_62_19 = var_62_17 <= 0 and var_62_14 or var_62_14 * (var_62_18 / var_62_17)

				if var_62_19 > 0 and var_62_14 < var_62_19 then
					arg_59_1.talkMaxDuration = var_62_19

					if var_62_19 + var_62_13 > arg_59_1.duration_ then
						arg_59_1.duration_ = var_62_19 + var_62_13
					end
				end
			...
			local var_62_20 = math.max(var_62_14, arg_59_1.talkMaxDuration)

			if var_62_13 <= arg_59_1.time_ and arg_59_1.time_ < var_62_13 + var_62_20 then
				arg_59_1.typewritter.percent = (arg_59_1.time_ - var_62_13) / var_62_20

				arg_59_1.typewritter:SetDirty()
			end

			if arg_59_1.time_ >= var_62_13 + var_62_20 and arg_59_1.time_ < var_62_13 + var_62_20 + arg_62_0 then
	...
	Play910816016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if var_66_13 < arg_63_1.time_ and arg_63_1.time_ <= var_66_13 + arg_66_0 then
				...
				local var_66_16 = arg_63_1:GetWordFromCfg(910816016)
	...
	Play910816017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if var_70_13 < arg_67_1.time_ and arg_67_1.time_ <= var_70_13 + arg_70_0 then
				...
				local var_70_16 = arg_67_1:GetWordFromCfg(910816017)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if var_74_1 < arg_71_1.time_ and arg_71_1.time_ <= var_74_1 + arg_74_0 then
				...
				for iter_74_0 = 0, var_74_2 - 1 do
					...
					if var_74_3.name == "split_7" or not string.find(var_74_3.name, "split") then
			...
			if var_74_13 < arg_71_1.time_ and arg_71_1.time_ <= var_74_13 + arg_74_0 then
				...
				local var_74_16 = arg_71_1:GetWordFromCfg(910816018)
	...
	Play910816019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			...
			local var_78_6 = arg_75_1.actors_["1070"].transform
			local var_78_7 = 0

			if var_78_7 < arg_75_1.time_ and arg_75_1.time_ <= var_78_7 + arg_78_0 then
				arg_75_1.var_.moveOldPos1070 = var_78_6.localPosition
				var_78_6.localScale = Vector3.New(1, 1, 1)

				arg_75_1:CheckSpriteTmpPos("1070", 3)

				local var_78_8 = var_78_6.childCount

				for iter_78_4 = 0, var_78_8 - 1 do
					local var_78_9 = var_78_6:GetChild(iter_78_4)

					if var_78_9.name == "split_1_1" or not string.find(var_78_9.name, "split") then
			...
			if var_78_7 <= arg_75_1.time_ and arg_75_1.time_ < var_78_7 + var_78_10 then
				local var_78_11 = (arg_75_1.time_ - var_78_7) / var_78_10
				local var_78_12 = Vector3.New(0, -350, -180)

				var_78_6.localPosition = Vector3.Lerp(arg_75_1.var_.moveOldPos1070, var_78_12, var_78_11)
			end

			if arg_75_1.time_ >= var_78_7 + var_78_10 and arg_75_1.time_ < var_78_7 + var_78_10 + arg_78_0 then
				var_78_6.localPosition = Vector3.New(0, -350, -180)
			end
			...
			if var_78_13 < arg_75_1.time_ and arg_75_1.time_ <= var_78_13 + arg_78_0 then
				...
				local var_78_16 = "effect"

				arg_75_1:AudioAction(var_78_15, var_78_16, "ui_skip", "ui_bgm_lower_back", "")
			end

			local var_78_17 = 0
			local var_78_18 = 0.675
			...
			if var_78_17 < arg_75_1.time_ and arg_75_1.time_ <= var_78_17 + arg_78_0 then
				...
				local var_78_19 = arg_75_1:GetWordFromCfg(910816019)
