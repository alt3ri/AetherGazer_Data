return {
	Play104041001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if uv0.bgs_.B04b:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB04b = slot13:GetColor("_Color").a
					uv0.var_.alphaMatValueB04b = slot13
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.alphaMatValueB04b then
					slot15 = uv0.var_.alphaMatValueB04b
					slot16 = slot15:GetColor("_Color")
					slot16.a = Mathf.Lerp(uv0.var_.alphaOldValueB04b, 1, (uv0.time_ - slot11) / slot12)

					slot15:SetColor("_Color", slot16)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.alphaMatValueB04b then
				slot13 = uv0.var_.alphaMatValueB04b
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(104041001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041001", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041001", "story_v_out_104041.awb") / 1000 + slot21 then
						uv0.duration_ = slot30 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_104041", "104041001", "story_v_out_104041.awb")

						uv0:RecordAudio("104041001", slot31)
						uv0:RecordAudio("104041001", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041001", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041001", "story_v_out_104041.awb")
				end
	...
	Play104041002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(104041002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041002", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041002", "story_v_out_104041.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104041", "104041002", "story_v_out_104041.awb")

						uv0:RecordAudio("104041002", slot22)
						uv0:RecordAudio("104041002", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041002", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041002", "story_v_out_104041.awb")
				end
	...
	Play104041003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104041003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041003", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041003", "story_v_out_104041.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104041", "104041003", "story_v_out_104041.awb")

						uv0:RecordAudio("104041003", slot19)
						uv0:RecordAudio("104041003", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041003", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041003", "story_v_out_104041.awb")
				end
	...
	Play104041004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104041004).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041004", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041004", "story_v_out_104041.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104041", "104041004", "story_v_out_104041.awb")

						uv0:RecordAudio("104041004", slot19)
						uv0:RecordAudio("104041004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041004", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041004", "story_v_out_104041.awb")
				end
	...
	Play104041005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104041005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041005", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041005", "story_v_out_104041.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104041", "104041005", "story_v_out_104041.awb")

						uv0:RecordAudio("104041005", slot21)
						uv0:RecordAudio("104041005", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041005", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041005", "story_v_out_104041.awb")
				end
	...
	Play104041006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot12) / slot13)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(104041006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041006", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041006", "story_v_out_104041.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_104041", "104041006", "story_v_out_104041.awb")

						uv0:RecordAudio("104041006", slot28)
						uv0:RecordAudio("104041006", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041006", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041006", "story_v_out_104041.awb")
				end
	...
	Play104041007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(104041007).content)
	...
	Play104041008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104041008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041008", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041008", "story_v_out_104041.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104041", "104041008", "story_v_out_104041.awb")

						uv0:RecordAudio("104041008", slot18)
						uv0:RecordAudio("104041008", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041008", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041008", "story_v_out_104041.awb")
				end
	...
	Play104041009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104041009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041009", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041009", "story_v_out_104041.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104041", "104041009", "story_v_out_104041.awb")

						uv0:RecordAudio("104041009", slot24)
						uv0:RecordAudio("104041009", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041009", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041009", "story_v_out_104041.awb")
				end
	...
	Play104041010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104041010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041010", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041010", "story_v_out_104041.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104041", "104041010", "story_v_out_104041.awb")

						uv0:RecordAudio("104041010", slot12)
						uv0:RecordAudio("104041010", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041010", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041010", "story_v_out_104041.awb")
				end
	...
	Play104041011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104041011
		slot1.duration_ = 2.866
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(104041011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041011", "story_v_out_104041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104041", "104041011", "story_v_out_104041.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_104041", "104041011", "story_v_out_104041.awb")

						uv0:RecordAudio("104041011", slot23)
						uv0:RecordAudio("104041011", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104041", "104041011", "story_v_out_104041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104041", "104041011", "story_v_out_104041.awb")
				end
