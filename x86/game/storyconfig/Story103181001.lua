return {
	Play318101001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101001
		slot1.duration_ = 5.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1099ui_story == nil then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				slot25 = uv0:FormatText(uv0:GetWordFromCfg(318101001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101001", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101001", "story_v_out_318101.awb") / 1000 + slot20 then
						uv0.duration_ = slot29 + slot20
					end

					if slot24.prefab_name ~= "" and uv0.actors_[slot24.prefab_name] ~= nil then
						slot30 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot24.prefab_name].transform, "story_v_out_318101", "318101001", "story_v_out_318101.awb")

						uv0:RecordAudio("318101001", slot30)
						uv0:RecordAudio("318101001", slot30)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101001", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101001", "story_v_out_318101.awb")
				end
	...
	Play318101002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101002
		slot1.duration_ = 6.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1099ui_story == nil then
				uv0.var_.characterEffect1099ui_story = uv0.actors_["1099ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				if uv0.var_.characterEffect1099ui_story then
					...
					uv0.var_.characterEffect1099ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot14) / slot15)
				end
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 and uv0.var_.characterEffect1099ui_story then
				uv0.var_.characterEffect1099ui_story.fillFlat = true
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(318101002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101002", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101002", "story_v_out_318101.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_318101", "318101002", "story_v_out_318101.awb")

						uv0:RecordAudio("318101002", slot25)
						uv0:RecordAudio("318101002", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101002", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101002", "story_v_out_318101.awb")
				end
	...
	Play318101003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318101003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101003", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101003", "story_v_out_318101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_318101", "318101003", "story_v_out_318101.awb")

						uv0:RecordAudio("318101003", slot18)
						uv0:RecordAudio("318101003", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101003", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101003", "story_v_out_318101.awb")
				end
	...
	Play318101004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.characterEffect1099ui_story then
					uv0.var_.characterEffect1099ui_story.fillFlat = true
					uv0.var_.characterEffect1099ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot6) / slot7)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(318101004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101004", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101004", "story_v_out_318101.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_318101", "318101004", "story_v_out_318101.awb")

						uv0:RecordAudio("318101004", slot17)
						uv0:RecordAudio("318101004", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101004", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101004", "story_v_out_318101.awb")
				end
	...
	Play318101005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101005
		slot1.duration_ = 2.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318101005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101005", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101005", "story_v_out_318101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_318101", "318101005", "story_v_out_318101.awb")

						uv0:RecordAudio("318101005", slot16)
						uv0:RecordAudio("318101005", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101005", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101005", "story_v_out_318101.awb")
				end
	...
	Play318101006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(318101006).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101006", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101006", "story_v_out_318101.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_318101", "318101006", "story_v_out_318101.awb")

						uv0:RecordAudio("318101006", slot17)
						uv0:RecordAudio("318101006", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101006", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101006", "story_v_out_318101.awb")
				end
	...
	Play318101007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318101007).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101007", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101007", "story_v_out_318101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_318101", "318101007", "story_v_out_318101.awb")

						uv0:RecordAudio("318101007", slot16)
						uv0:RecordAudio("318101007", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101007", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101007", "story_v_out_318101.awb")
				end
	...
	Play318101008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101008
		slot1.duration_ = 9.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318101008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101008", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101008", "story_v_out_318101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318101", "318101008", "story_v_out_318101.awb")

						uv0:RecordAudio("318101008", slot10)
						uv0:RecordAudio("318101008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101008", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101008", "story_v_out_318101.awb")
				end
	...
	Play318101009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318101009).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101009", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101009", "story_v_out_318101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_318101", "318101009", "story_v_out_318101.awb")

						uv0:RecordAudio("318101009", slot18)
						uv0:RecordAudio("318101009", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101009", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101009", "story_v_out_318101.awb")
				end
	...
	Play318101010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318101010).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101010", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101010", "story_v_out_318101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318101", "318101010", "story_v_out_318101.awb")

						uv0:RecordAudio("318101010", slot10)
						uv0:RecordAudio("318101010", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101010", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101010", "story_v_out_318101.awb")
				end
	...
	Play318101011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318101011).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101011", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101011", "story_v_out_318101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_318101", "318101011", "story_v_out_318101.awb")

						uv0:RecordAudio("318101011", slot16)
						uv0:RecordAudio("318101011", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101011", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101011", "story_v_out_318101.awb")
				end
	...
	Play318101012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101012
		slot1.duration_ = 8.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318101012).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101012", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101012", "story_v_out_318101.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_318101", "318101012", "story_v_out_318101.awb")

						uv0:RecordAudio("318101012", slot16)
						uv0:RecordAudio("318101012", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101012", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101012", "story_v_out_318101.awb")
				end
	...
	Play318101013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101013
		slot1.duration_ = 3.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318101013).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101013", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101013", "story_v_out_318101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318101", "318101013", "story_v_out_318101.awb")

						uv0:RecordAudio("318101013", slot10)
						uv0:RecordAudio("318101013", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101013", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101013", "story_v_out_318101.awb")
				end
	...
	Play318101014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101014
		slot1.duration_ = 3.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(318101014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101014", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101014", "story_v_out_318101.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_318101", "318101014", "story_v_out_318101.awb")

						uv0:RecordAudio("318101014", slot12)
						uv0:RecordAudio("318101014", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101014", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101014", "story_v_out_318101.awb")
				end
	...
	Play318101015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101015
		slot1.duration_ = 2.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(318101015).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101015", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101015", "story_v_out_318101.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_318101", "318101015", "story_v_out_318101.awb")

						uv0:RecordAudio("318101015", slot24)
						uv0:RecordAudio("318101015", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101015", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101015", "story_v_out_318101.awb")
				end
	...
	Play318101016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101016
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 and uv0.var_.characterEffect1199ui_story == nil then
				uv0.var_.characterEffect1199ui_story = uv0.actors_["1199ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			slot13 = 0.166000001132488
			...
			if 1.98333333333333 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
			...
			if 4 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot25 = uv0:FormatText(uv0:GetWordFromCfg(318101016).content)
				uv0.text_.text = slot25
	...
	Play318101017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318101017).content)
	...
	Play318101018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318101018).content)
				uv0.text_.text = slot4
	...
	Play318101019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318101019).content)
				uv0.text_.text = slot4
	...
	Play318101020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318101020).content)
				uv0.text_.text = slot4
	...
	Play318101021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318101021).content)
				uv0.text_.text = slot4
	...
	Play318101022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318101022).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101022", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101022", "story_v_out_318101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_318101", "318101022", "story_v_out_318101.awb")

						uv0:RecordAudio("318101022", slot18)
						uv0:RecordAudio("318101022", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101022", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101022", "story_v_out_318101.awb")
				end
	...
	Play318101023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(318101023).content)
	...
	Play318101024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101024
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318101024).content)
				uv0.text_.text = slot4
	...
	Play318101025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101025
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318101025).content)
				uv0.text_.text = slot4
	...
	Play318101026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101026
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318101026).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101026", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101026", "story_v_out_318101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_318101", "318101026", "story_v_out_318101.awb")

						uv0:RecordAudio("318101026", slot18)
						uv0:RecordAudio("318101026", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101026", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101026", "story_v_out_318101.awb")
				end
	...
	Play318101027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101027
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(318101027).content)
	...
	Play318101028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101028
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318101028).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101028", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101028", "story_v_out_318101.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_318101", "318101028", "story_v_out_318101.awb")

						uv0:RecordAudio("318101028", slot18)
						uv0:RecordAudio("318101028", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101028", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101028", "story_v_out_318101.awb")
				end
	...
	Play318101029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101029
		slot1.duration_ = 3.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(318101029).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101029", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101029", "story_v_out_318101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_318101", "318101029", "story_v_out_318101.awb")

						uv0:RecordAudio("318101029", slot22)
						uv0:RecordAudio("318101029", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101029", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101029", "story_v_out_318101.awb")
				end
	...
	Play318101030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101030
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(318101030).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101030", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101030", "story_v_out_318101.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_318101", "318101030", "story_v_out_318101.awb")

						uv0:RecordAudio("318101030", slot13)
						uv0:RecordAudio("318101030", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101030", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101030", "story_v_out_318101.awb")
				end
	...
	Play318101031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101031
		slot1.duration_ = 5.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318101031).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101031", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101031", "story_v_out_318101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318101", "318101031", "story_v_out_318101.awb")

						uv0:RecordAudio("318101031", slot10)
						uv0:RecordAudio("318101031", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101031", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101031", "story_v_out_318101.awb")
				end
	...
	Play318101032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101032
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(318101032).content)
				uv0.text_.text = slot7
	...
	Play318101033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101033
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318101033).content)
				uv0.text_.text = slot4
	...
	Play318101034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101034
		slot1.duration_ = 2.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(318101034).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101034", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101034", "story_v_out_318101.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_318101", "318101034", "story_v_out_318101.awb")

						uv0:RecordAudio("318101034", slot25)
						uv0:RecordAudio("318101034", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101034", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101034", "story_v_out_318101.awb")
				end
	...
	Play318101035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318101035
		slot1.duration_ = 4.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(318101035).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318101", "318101035", "story_v_out_318101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318101", "318101035", "story_v_out_318101.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_318101", "318101035", "story_v_out_318101.awb")

						uv0:RecordAudio("318101035", slot21)
						uv0:RecordAudio("318101035", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318101", "318101035", "story_v_out_318101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318101", "318101035", "story_v_out_318101.awb")
				end
