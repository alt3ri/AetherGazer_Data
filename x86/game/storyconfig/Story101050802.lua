return {
	Play105082001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105082001).content)
	...
	Play105082002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082002
		slot1.duration_ = 5.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105082002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082002", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082002", "story_v_out_105082.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105082", "105082002", "story_v_out_105082.awb")

						uv0:RecordAudio("105082002", slot18)
						uv0:RecordAudio("105082002", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082002", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082002", "story_v_out_105082.awb")
				end
	...
	Play105082003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082003
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(105082003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082003", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082003", "story_v_out_105082.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_105082", "105082003", "story_v_out_105082.awb")

						uv0:RecordAudio("105082003", slot22)
						uv0:RecordAudio("105082003", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082003", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082003", "story_v_out_105082.awb")
				end
	...
	Play105082004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos4010ui_story, Vector3.New(-0.7, -1.59, -5.2), (uv0.time_ - slot12) / slot13)
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(-0.7, -1.59, -5.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0:PlayTimeline("4010ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0103cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(105082004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082004", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082004", "story_v_out_105082.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_105082", "105082004", "story_v_out_105082.awb")

						uv0:RecordAudio("105082004", slot25)
						uv0:RecordAudio("105082004", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082004", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082004", "story_v_out_105082.awb")
				end
	...
	Play105082005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082005
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(105082005).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082005", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082005", "story_v_out_105082.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_105082", "105082005", "story_v_out_105082.awb")

						uv0:RecordAudio("105082005", slot25)
						uv0:RecordAudio("105082005", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082005", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082005", "story_v_out_105082.awb")
				end
	...
	Play105082006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082006
		slot1.duration_ = 2.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("4010ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3101cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(105082006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082006", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082006", "story_v_out_105082.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_105082", "105082006", "story_v_out_105082.awb")

						uv0:RecordAudio("105082006", slot17)
						uv0:RecordAudio("105082006", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082006", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082006", "story_v_out_105082.awb")
				end
	...
	Play105082007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105082007).content)
				uv0.text_.text = slot13
	...
	Play105082008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(105082008).content)
	...
	Play105082009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(105082009).content)
	...
	Play105082010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105082010).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082010", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082010", "story_v_out_105082.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105082", "105082010", "story_v_out_105082.awb")

						uv0:RecordAudio("105082010", slot18)
						uv0:RecordAudio("105082010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082010", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082010", "story_v_out_105082.awb")
				end
	...
	Play105082011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082011
		slot1.duration_ = 4.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(105082011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082011", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082011", "story_v_out_105082.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_105082", "105082011", "story_v_out_105082.awb")

						uv0:RecordAudio("105082011", slot24)
						uv0:RecordAudio("105082011", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082011", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082011", "story_v_out_105082.awb")
				end
	...
	Play105082012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082012
		slot1.duration_ = 4.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_5", "se_story_5_cheer", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 and uv0.var_.characterEffect2020_tpose == nil then
				uv0.var_.characterEffect2020_tpose = uv0.actors_["2020_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				if uv0.var_.characterEffect2020_tpose then
					...
					uv0.var_.characterEffect2020_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot8) / slot9)
				end
			end

			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 and uv0.var_.characterEffect2020_tpose then
				uv0.var_.characterEffect2020_tpose.fillFlat = true
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2030_tpose, Vector3.New(0.7, -1.2, -4.2), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0.7, -1.2, -4.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(105082012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082012", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082012", "story_v_out_105082.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_105082", "105082012", "story_v_out_105082.awb")

						uv0:RecordAudio("105082012", slot23)
						uv0:RecordAudio("105082012", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082012", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082012", "story_v_out_105082.awb")
				end
	...
	Play105082013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105082013).content)
				uv0.text_.text = slot13

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (47 <= 0 and slot11 or slot11 * utf8.len(slot13) / slot14) > 0 and slot11 < slot16 then
					uv0.talkMaxDuration = slot16
	...
	Play105082014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082014
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(105082014).content)
	...
	Play105082015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105082015).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082015", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082015", "story_v_out_105082.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105082", "105082015", "story_v_out_105082.awb")

						uv0:RecordAudio("105082015", slot19)
						uv0:RecordAudio("105082015", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082015", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082015", "story_v_out_105082.awb")
				end
	...
	Play105082016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(105082016).content)
				uv0.text_.text = slot10
	...
	Play105082017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_5", "se_story_5_arrow", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(105082017).content)
				uv0.text_.text = slot6
	...
	Play105082018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105082018).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082018", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082018", "story_v_out_105082.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105082", "105082018", "story_v_out_105082.awb")

						uv0:RecordAudio("105082018", slot19)
						uv0:RecordAudio("105082018", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082018", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082018", "story_v_out_105082.awb")
				end
	...
	Play105082019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082019
		slot1.duration_ = 2.533
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(105082019).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082019", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082019", "story_v_out_105082.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_105082", "105082019", "story_v_out_105082.awb")

						uv0:RecordAudio("105082019", slot22)
						uv0:RecordAudio("105082019", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082019", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082019", "story_v_out_105082.awb")
				end
	...
	Play105082020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(105082020).content)
	...
	Play105082021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(105082021).content)
				uv0.text_.text = slot10
	...
	Play105082022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105082022).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082022", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082022", "story_v_out_105082.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105082", "105082022", "story_v_out_105082.awb")

						uv0:RecordAudio("105082022", slot10)
						uv0:RecordAudio("105082022", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082022", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082022", "story_v_out_105082.awb")
				end
	...
	Play105082023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105082023).content)
				uv0.text_.text = slot5
	...
	Play105082024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3005_tpose, Vector3.New(0, -1.95, -2.63), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -1.95, -2.63)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(105082024).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082024", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082024", "story_v_out_105082.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_105082", "105082024", "story_v_out_105082.awb")

						uv0:RecordAudio("105082024", slot20)
						uv0:RecordAudio("105082024", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082024", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082024", "story_v_out_105082.awb")
				end
	...
	Play105082025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1027ui_story, Vector3.New(0, -0.81, -5.8), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0, -0.81, -5.8)
				slot15 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot10.localEulerAngles
				slot16.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(105082025).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082025", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082025", "story_v_out_105082.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_105082", "105082025", "story_v_out_105082.awb")

						uv0:RecordAudio("105082025", slot24)
						uv0:RecordAudio("105082025", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082025", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082025", "story_v_out_105082.awb")
				end
	...
	Play105082026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082026
		slot1.duration_ = 1.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1080ui_story, Vector3.New(-0.7, -1.01, -6.05), (uv0.time_ - slot15) / slot16)
			...
			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 then
				slot14.localPosition = Vector3.New(-0.7, -1.01, -6.05)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				uv0:PlayTimeline("1080ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3101cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(105082026).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082026", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082026", "story_v_out_105082.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_105082", "105082026", "story_v_out_105082.awb")

						uv0:RecordAudio("105082026", slot28)
						uv0:RecordAudio("105082026", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082026", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082026", "story_v_out_105082.awb")
				end
	...
	Play105082027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082027
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105082027).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082027", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082027", "story_v_out_105082.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105082", "105082027", "story_v_out_105082.awb")

						uv0:RecordAudio("105082027", slot19)
						uv0:RecordAudio("105082027", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082027", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082027", "story_v_out_105082.awb")
				end
	...
	Play105082028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082028
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105082028).content)
				uv0.text_.text = slot5
	...
	Play105082029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082029
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(105082029).content)
				uv0.text_.text = slot4
	...
	Play105082030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082030
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_5", "se_story_5_robotstop", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(105082030).content)
				uv0.text_.text = slot6
	...
	Play105082031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082031
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_5", "se_story_5_robotcollapse", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(105082031).content)
				uv0.text_.text = slot6
	...
	Play105082032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082032
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105082032).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082032", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082032", "story_v_out_105082.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105082", "105082032", "story_v_out_105082.awb")

						uv0:RecordAudio("105082032", slot10)
						uv0:RecordAudio("105082032", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082032", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082032", "story_v_out_105082.awb")
				end
	...
	Play105082033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082033
		slot1.duration_ = 2.833
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105082033).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082033", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082033", "story_v_out_105082.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105082", "105082033", "story_v_out_105082.awb")

						uv0:RecordAudio("105082033", slot18)
						uv0:RecordAudio("105082033", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082033", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082033", "story_v_out_105082.awb")
				end
	...
	Play105082034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082034
		slot1.duration_ = 3.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105082034).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082034", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082034", "story_v_out_105082.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_105082", "105082034", "story_v_out_105082.awb")

						uv0:RecordAudio("105082034", slot21)
						uv0:RecordAudio("105082034", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082034", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082034", "story_v_out_105082.awb")
				end
	...
	Play105082035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082035
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105082035).content)
				uv0.text_.text = slot13
	...
	Play105082036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082036
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105082036).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082036", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082036", "story_v_out_105082.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105082", "105082036", "story_v_out_105082.awb")

						uv0:RecordAudio("105082036", slot18)
						uv0:RecordAudio("105082036", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082036", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082036", "story_v_out_105082.awb")
				end
	...
	Play105082037 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082037
		slot1.duration_ = 2.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(105082037).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082037", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082037", "story_v_out_105082.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_105082", "105082037", "story_v_out_105082.awb")

						uv0:RecordAudio("105082037", slot24)
						uv0:RecordAudio("105082037", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082037", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082037", "story_v_out_105082.awb")
				end
	...
	Play105082038 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082038
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105082038).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082038", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082038", "story_v_out_105082.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_105082", "105082038", "story_v_out_105082.awb")

						uv0:RecordAudio("105082038", slot21)
						uv0:RecordAudio("105082038", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082038", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082038", "story_v_out_105082.awb")
				end
	...
	Play105082039 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082039
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(105082039).content)
	...
	Play105082040 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082040
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(105082040).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082040", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082040", "story_v_out_105082.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_105082", "105082040", "story_v_out_105082.awb")

						uv0:RecordAudio("105082040", slot24)
						uv0:RecordAudio("105082040", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082040", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082040", "story_v_out_105082.awb")
				end
	...
	Play105082041 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082041
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot4 + slot0 and uv0.var_.characterEffect1080ui_story == nil then
				uv0.var_.characterEffect1080ui_story = uv0.actors_["1080ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.characterEffect1080ui_story then
					uv0.var_.characterEffect1080ui_story.fillFlat = true
					uv0.var_.characterEffect1080ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot4) / slot5)
				end
			end

			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 and uv0.var_.characterEffect1080ui_story then
				uv0.var_.characterEffect1080ui_story.fillFlat = true
				uv0.var_.characterEffect1080ui_story.fillRatio = 0.5
			end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueB14 then
					slot11 = uv0.var_.alphaMatValueB14
					slot12 = slot11:GetColor("_Color")
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueB14, 0, (uv0.time_ - slot7) / slot8)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.var_.moveOldPosB14 = uv0.bgs_.B14.transform.localPosition
			end

			slot11 = 0.001

			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPosB14, Vector3.New(0, -100, 10), (uv0.time_ - slot10) / slot11)
			end
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				if uv0.bgs_.A00:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueA00 = slot16:GetColor("_Color").a
					uv0.var_.alphaMatValueA00 = slot16
				end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				if uv0.var_.alphaMatValueA00 then
					...
					slot19.a = Mathf.Lerp(uv0.var_.alphaOldValueA00, 1, (uv0.time_ - slot14) / slot15)

					slot18:SetColor("_Color", slot19)
				end
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 and uv0.var_.alphaMatValueA00 then
			...
			if slot18 <= uv0.time_ and uv0.time_ < slot18 + slot19 then
				slot17.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1080ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot18) / slot19)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				...
				slot25 = uv0:FormatText(uv0:GetWordFromCfg(105082041).content)
				uv0.text_.text = slot25

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (9 <= 0 and slot23 or slot23 * utf8.len(slot25) / slot26) > 0 and slot23 < slot28 then
	...
	Play105082042 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082042
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105082042).content)
				uv0.text_.text = slot5
	...
	Play105082043 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082043
		slot1.duration_ = 4.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105082043).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082043", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082043", "story_v_out_105082.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105082", "105082043", "story_v_out_105082.awb")

						uv0:RecordAudio("105082043", slot10)
						uv0:RecordAudio("105082043", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082043", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082043", "story_v_out_105082.awb")
				end
	...
	Play105082044 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082044
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105082044).content)
				uv0.text_.text = slot5
	...
	Play105082045 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082045
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105082045).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082045", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082045", "story_v_out_105082.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105082", "105082045", "story_v_out_105082.awb")

						uv0:RecordAudio("105082045", slot10)
						uv0:RecordAudio("105082045", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082045", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082045", "story_v_out_105082.awb")
				end
	...
	Play105082046 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082046
		slot1.duration_ = 2.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105082046).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082046", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082046", "story_v_out_105082.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105082", "105082046", "story_v_out_105082.awb")

						uv0:RecordAudio("105082046", slot19)
						uv0:RecordAudio("105082046", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082046", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082046", "story_v_out_105082.awb")
				end
	...
	Play105082047 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082047
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(105082047).content)
				uv0.text_.text = slot8
	...
	Play105082048 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082048
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(105082048).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082048", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082048", "story_v_out_105082.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_105082", "105082048", "story_v_out_105082.awb")

						uv0:RecordAudio("105082048", slot15)
						uv0:RecordAudio("105082048", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082048", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082048", "story_v_out_105082.awb")
				end
	...
	Play105082049 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105082049
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(105082049).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_105082", "105082049", "story_v_out_105082.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105082", "105082049", "story_v_out_105082.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_105082", "105082049", "story_v_out_105082.awb")

						uv0:RecordAudio("105082049", slot13)
						uv0:RecordAudio("105082049", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105082", "105082049", "story_v_out_105082.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105082", "105082049", "story_v_out_105082.awb")
				end
