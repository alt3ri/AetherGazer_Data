...
function slot0.OnReceiveHandler(slot0, slot1)
	...
	uv0.CollectMsgPacket(true, slot2, Protocol.Unpack(slot2, slot1:getLuaStringBuffer()))
	...
	elseif slot5[slot2] then
		...
		uv1("can not find callback function!!!!", slot2, slot4)
	end
end
...
function slot0.CollectMsgPacket(slot0, slot1, slot2)
end
...
function slot0.SendBuildProtocol(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	uv0.CollectMsgPacket(false, slot6:GetId(), slot4)
end
