...
function slot0.OnExitOldRoutes(slot0)
	...
	for slot5 = #slot0.oldRoutes_, slot0:GetCoincideRoutesIndex(slot0.oldRoutes_, slot5) + 1, -1 do
...
function slot0.OnUpdateCoincideRoutes(slot0)
	...
	for slot5 = 1, slot0:GetCoincideRoutesIndex(slot0.oldRoutes_, slot5) do
