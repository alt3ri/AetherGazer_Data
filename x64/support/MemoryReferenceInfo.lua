...
function slot15.m_cBases.CreateObjectReferenceInfoContainerFromFile(slot0)
	...
	for slot8 in assert(io.open(slot8, "rb")):lines() do
...
function slot15.m_cBases.OutputMemorySnapshotSingleObject(slot0, slot1, slot2, slot3)
	...
	slot9("-- Collect single object memory reference at line:" .. tostring(slot3.m_nCurrentLine) .. slot14 .. slot3.m_strShortSrc .. "\n")
	slot9("--------------------------------------------------------\n")
	...
	slot9("-- For Object: " .. slot14 .. slot15 .. slot3.m_strObjectName .. "), have " .. tostring(slot10) .. " reference in total.\n")
	slot9("--------------------------------------------------------\n")
...
function slot15.m_cBases.OutputFilteredResult(slot0, slot1, slot2, slot3)
	...
	for slot9 in assert(io.open(slot9, "rb")):lines() do
