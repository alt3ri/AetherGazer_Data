...
function GetVirtualData(slot0)
	...
	for slot5, slot6 in ipairs(deepClone(slot3.GetTempHeroDataByTempID(slot5, slot6)).skill) do
...
function GetHeroPracticalAttr(slot0, slot1, slot2, slot3, slot4)
	...
	slot10 = slot0.dormLevel
	slot11 = slot4

	for slot10, slot11 in pairs(DormTools:GetDormAdditionByHeroID(slot0.id, slot10, slot11).attribute) do
...
function GetPolyhedronHeroPracticalAttr(slot0, slot1, slot2, slot3)
	...
	slot7.exp = 0
	slot12 = slot1.servantInfo
	slot8 = WeaponTools.CalWeaponAttribute(slot1.id, slot7, slot12)
