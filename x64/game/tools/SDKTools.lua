...
return {
	...
	SetDefaultPublicAttribute = function ()
		...
		if GameToSDK.PLATFORM_ID == 1 then
			...
			slot2.android_flower = ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_NOT_IOS)
		end
		...
		SendMessageToSDK(uv0.encode({
			...
			idfa = tostring((_G.deviceInfo or {}).idfa),
			ios_flower = ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_IOS)
		}))
	end,
	SetCurrencyPublicAttribute = function (slot0)
		...
		elseif slot0 == CurrencyConst.CURRENCY_TYPE_GOLD then
			slot1.gold_coin = ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_GOLD)
		elseif slot0 == CurrencyConst.CURRENCY_TYPE_DIAMOND then
			slot1.diamond = ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_DIAMOND)
		elseif slot0 == CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_FREE then
			slot1.free_flower = ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_FREE)
			slot1.total_flower = slot1.free_flower + ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_IOS) + ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_NOT_IOS)
			slot1.ios_flower = ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_IOS)
			slot1.android_flower = ItemTools.getItemNum(CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_NOT_IOS)
		end
