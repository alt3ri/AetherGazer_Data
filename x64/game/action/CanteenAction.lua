function slot1(slot0)
	...
	slot7 = slot0.pos
	slot2 = DormSkillData:GetSkillEffect(CanteenConst.HeroSkillType.EntrustExternAwardAdd, nil, slot7)
	slot3 = {}
...
manager.net:Bind(58023, function (slot0)
	...
	slot4 = BACKHOME_HERO_FATIGUR_REFRESH

	manager.notify:Invoke(slot4)
