...
return {
	...
	InitRedPoint = function ()
		...
		slot6 = PushSnowBallData
		slot6 = slot6.GetTeamActivityID
		slot2 = string.format("%s_%s", ActivityTools.GetRedPointKey(PushSnowBallData:GetTeamActivityID()), slot6(slot6))
