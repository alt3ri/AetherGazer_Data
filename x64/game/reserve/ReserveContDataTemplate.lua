...
function slot0.CleanCacheData(slot0)
	...
	for slot6, slot7 in pairs(slot0.team_dic) do
		slot7:UpdateServerData(ReserveTools.GetReserveTemplateByReserveType(slot0:GetTeamType(), true):GetContDataTemplateById(slot0.GetContID(slot7)):GetSingleTeamData(slot6))
	end
