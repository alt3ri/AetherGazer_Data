...
function slot0.GetNextTime(slot0)
	...
	for slot8, slot9 in ipairs({
		...
		for slot13, slot14 in ipairs(TaskData2:GetTaskIDListByType(slot13)) do
			if TaskData2:GetTask(slot13).expired_timestamp > 0 and slot2 <= slot15.expired_timestamp then
