...
local var_0_1 = class("ChatToggleGuildActivityView", var_0_0)
...
function var_0_1.RefreshGuildActivityToggle(arg_2_0, arg_2_1)
	local var_2_0 = ActivityData:GetActivityIsOpen(ActivityConst.GUILD_ACTIVITY_START) or arg_2_0.toggle_.isOn == arg_2_0.chatToggleID_ or manager.windowBar:GetWhereTag() == "guildActivity"

	SetActive(arg_2_0.gameObject_, var_2_0)
end
