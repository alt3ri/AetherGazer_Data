slot1 = class("ChatToggleGuildActivityView", import(".ChatToggleBaseView"))
...
function slot1.RefreshGuildActivityToggle(slot0, slot1)
	SetActive(slot0.gameObject_, ActivityData:GetActivityIsOpen(ActivityConst.GUILD_ACTIVITY_START) or slot0.toggle_.isOn == slot0.chatToggleID_ or manager.windowBar:GetWhereTag() == "guildActivity")
end
