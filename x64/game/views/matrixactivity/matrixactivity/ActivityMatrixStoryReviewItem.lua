...
function slot0.SetData(slot0, slot1)
	...
	slot0.m_title.text = StoryCfg[slot1] and GetI18NText(StoryCfg[slot1].name) or ""
	slot0.m_des.text = slot2 and slot2.narrativeTime and GetI18NText(StoryWordCfg[slot2.narrativeTime].content) or ""
end
