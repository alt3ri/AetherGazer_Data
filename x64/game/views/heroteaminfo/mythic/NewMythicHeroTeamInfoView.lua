slot1 = class("NewMythicHeroTeamInfoView", import("game.views.heroTeamInfo.NewHeroTeamInfoBaseView"))
...
function slot1.OnJoinClick(slot0)
	...
	for slot10 = 1, 2 do
		if slot0.params_.reserveParams.teamIndex ~= slot10 then
			...
			for slot16, slot17 in ipairs(ReserveTools.GetHeroList(ReserveParams.New(nil, slot0.params_.reserveParams.contID, slot10, slot16))) do
				if slot17 ~= 0 then
					for slot21 = 1, 3 do
