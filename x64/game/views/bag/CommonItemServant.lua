local var_0_0 = class("CommonItemServant", ReduxView)
...
function var_0_0.UpdateMaterialView(arg_15_0)
	...
	if arg_15_0.info_.number then
		arg_15_0:SetBottomText(arg_15_0.info_.number)
	end
end

function var_0_0.UpdateHeroPieceView(arg_16_0)
	if arg_16_0.info_.number then
		arg_16_0:SetBottomText(arg_16_0.info_.number)
	end
...
function var_0_0.UpdateWeaponServantView(arg_17_0)
	...
	if arg_17_0.info_.isAdd then
		arg_17_0.servantStageText_.text = "<color=#FF9500>" .. tostring(arg_17_0.info_.number) .. "</color>"
	else
		arg_17_0.servantStageText_.text = tostring(arg_17_0.info_.number)
	end
...
function var_0_0.UpdateEquipView(arg_18_0)
	arg_18_0:UpdateLevel(arg_18_0.info_.level or arg_18_0.info_.number or 1)
...
function var_0_0.UpdateHeroView(arg_21_0)
	arg_21_0:SetBottomText(arg_21_0.info_.number or 1)
...
function var_0_0.UpdateHeroSkinView(arg_22_0)
	...
	arg_22_0:UpdateIcon()
	arg_22_0:SetBottomText(arg_22_0.info_.number or 1)
end
...
function var_0_0.UpdateName(arg_26_0)
	local var_26_0 = ItemCfg[arg_26_0.info_.id]

	if var_26_0 then
		arg_26_0.nameText_.text = var_26_0.name
	end
end
...
function var_0_0.ShowNew(arg_32_0, arg_32_1)
	SetActive(arg_32_0.new_, arg_32_1)
end

function var_0_0.ShowStar(arg_33_0, arg_33_1)
	if arg_33_1 then
		arg_33_0:UpdateStar()
	else
		arg_33_0.starController_:SetSelectedState("0")
	end
end

function var_0_0.SetBottomText(arg_34_0, arg_34_1)
	arg_34_0.num_.text = arg_34_1

	if arg_34_0.boxImage_ ~= nil then
		local var_34_0 = arg_34_1 and tostring(arg_34_1) or ""

		arg_34_0.boxImage_.enabled = #var_34_0 > 0
	end
end

function var_0_0.SetBottomTextColor(arg_35_0, arg_35_1)
	arg_35_0.num_.color = arg_35_1
end

function var_0_0.SetIndex(arg_36_0, arg_36_1)
	arg_36_0.transform_:SetSiblingIndex(arg_36_1)
end

function var_0_0.ShowBlackBack(arg_37_0, arg_37_1)
	return
end

function var_0_0.UpdateTime(arg_38_0)
	local var_38_0 = arg_38_0.countdownStatusController_
	local var_38_1 = ItemCfg[arg_38_0.info_.id]
	local var_38_2 = ItemTools.GetItemExpiredTimeByInfo(arg_38_0.info_)

	if var_38_2 == nil or var_38_2 == 0 then
		var_38_0:SetSelectedState("noLimit")
	elseif ItemTools.IsItemExpired(arg_38_0.info_) then
		var_38_0:SetSelectedState("expired")
	elseif arg_38_0.info_.timeValid then
		var_38_0:SetSelectedState("countdowning")

		arg_38_0.lastTimeLabel_.text = manager.time:GetLostTimeStr(ItemTools.GetItemExpiredTimeByInfo(arg_38_0.info_), nil, true)
	else
		var_38_0:SetSelectedState("noLimit")
	end
end

function var_0_0.UpdateCamp(arg_39_0, arg_39_1)
	if arg_39_1 == 0 then
		arg_39_0.campController_:SetSelectedState("noCamp")
		SetActive(arg_39_0.campPanelGo_, false)
	else
		arg_39_0.campController_:SetSelectedState(tostring(arg_39_1))
		SetActive(arg_39_0.campPanelGo_, true)
	end

	if arg_39_0.functionTrans_ then
		UnityEngine.UI.LayoutRebuilder.ForceRebuildLayoutImmediate(arg_39_0.functionTrans_)
	end
end

function var_0_0.UpdateLevel(arg_40_0, arg_40_1)
	arg_40_0:SetBottomText(tostring(arg_40_1))
end

function var_0_0.ShowSelect(arg_41_0, arg_41_1)
	type(arg_41_1)
	...
	arg_41_0.selectTypeController_:SetSelectedState(arg_41_0.manualSelectType_ or arg_41_0.defaultSelectType_)

	if var_41_0 then
		arg_41_0.selectedController_:SetSelectedState("true")

		local var_41_1 = ItemCfg[arg_41_0.info_.id].type

		if ItemConst.ITEM_TYPE.EQUIP ~= var_41_1 then
			arg_41_0.selectNum_.text = "x" .. arg_41_1
		end
	else
		arg_41_0.selectedController_:SetSelectedState("false")
		arg_41_0:StopLongClickTimer()
	end
end

function var_0_0.HideNum(arg_42_0)
	arg_42_0:SetBottomText("")
end

function var_0_0.Show(arg_43_0, arg_43_1)
	SetActive(arg_43_0.gameObject_, arg_43_1)
end

function var_0_0.ShowFloor(arg_44_0, arg_44_1)
	arg_44_0.floorController_:SetSelectedState(arg_44_1 or ItemConst.ITEM_FLOOR.LONG)
end

function var_0_0.SetGrey(arg_45_0, arg_45_1)
	arg_45_0.geryController_:SetSelectedState(arg_45_1)
end

function var_0_0.HideServantTxt(arg_46_0)
	SetActive(arg_46_0.severantGo_, false)
end

function var_0_0.RegistCallBack(arg_47_0, arg_47_1)
	arg_47_0.clickMode_ = CLICK_MODE.SINGLE
	arg_47_0.clickFunc = arg_47_1

	SetActive(arg_47_0.longClickBtn_, false)
end

function var_0_0.RegistLongCallBack(arg_48_0, arg_48_1)
	arg_48_0.clickMode_ = CLICK_MODE.LONG
	arg_48_0.clickLongFunc = arg_48_1

	SetActive(arg_48_0.longClickBtn_, true)
end

function var_0_0.RegistCutCallBack(arg_49_0, arg_49_1)
	arg_49_0.clickCutFunc = arg_49_1
end

function var_0_0.RegistGaryCallBack(arg_50_0, arg_50_1)
	arg_50_0.clickGaryFunc = arg_50_1
end

function var_0_0.GetItemInfo(arg_51_0)
	return arg_51_0.info_
end

function var_0_0.Dispose(arg_52_0)
	var_0_0.super.Dispose(arg_52_0)

	arg_52_0.disposed_ = true
end
