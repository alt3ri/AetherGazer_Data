...
function slot0.UpdateTimer(slot0)
	...
	if ActivityData:GetActivityIsOpen(ActivityConst.GUILD_ACTIVITY_START) then
		...
		slot0.contentLabel1_.text = GetTips("ACTIVITY_CLUB_RESIGNUP")
		slot0.titleLabel_.text = GetTips("ACTIVITY_CLUB_RESIGNUP_TITLE")
	else
		slot0.statusController_:SetSelectedState("signup")

		slot0.contentLabel1_.text = GetTips("ACTIVITY_CLUB_SIGNUP")
		slot0.titleLabel_.text = GetTips("ACTIVITY_CLUB_SIGNUP_TITLE")
	end
end
