...
function slot0.indexItem(slot0, slot1, slot2)
	slot2:SetData(slot0.bonusDataList_[slot1], math.max(GuildData:GetCurrentBossRemainHp(), 0), slot1)
end
...
function slot0.InitData(slot0)
	slot0.bonusDataList_ = ClubBossCfg[GuildData:GetBossDifficulty()].reward
