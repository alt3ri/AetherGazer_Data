local var_0_0 = class("GuildActivitySPFilterView", ReduxView)
...
function var_0_0.InitDropDown(arg_3_0)
	...
	arg_3_0.sortTypeDropdown_.options:Add(UnityEngine.UI.Dropdown.OptionData.New(GetTips("ACTIVITY_CLUB_QSDK"), nil))
...
function var_0_0.UpdateList(arg_14_0)
	...
	table.sort(arg_14_0.displayHeroList_, function(arg_15_0, arg_15_1)
		...
		elseif arg_14_0.curSortType_ == 1 then
			local var_15_30, var_15_31 = arg_14_0:StarSorter(var_15_7, var_15_8)
			...
			local var_15_33, var_15_34 = arg_14_0:RareSorter(var_15_7, var_15_8)
			...
			local var_15_36, var_15_37 = arg_14_0:FightPowerSorter(var_15_7, var_15_8)
