slot1 = class("GuildActivitySPSetFightHeroView", import("game.views.heroTeamInfo.HeroTeamInfoBaseView"))
...
function slot1.UpdateHeroView(slot0)
	...
	slot4 = GameSetting.activity_club_sp_hero_fatigue_max.value[1]
	slot5 = nil

	slot0.energyItem_:SetData(slot4, GuildActivitySPData:IsFirstConfigFightRole() and slot4 or table.indexof(slot0.params_.putOffList, slot0.selectID_) and 0 or GuildActivitySPData:GetHeroFatigue(slot0.selectID_))
end
