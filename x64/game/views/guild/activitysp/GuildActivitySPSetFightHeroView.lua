...
local var_0_1 = class("GuildActivitySPSetFightHeroView", var_0_0)
...
function var_0_1.InitUI(arg_3_0)
	...
	local var_3_0 = Asset.Load("UI/GuildActivitySPUI/items/spenergy")
	local var_3_1 = Object.Instantiate(var_3_0, arg_3_0.extensionContainer_)

	arg_3_0.energyItem_ = GuildActivitySPTeamInfoEnergyItemView.New(var_3_1)
end
...
function var_0_1.UpdateHeroView(arg_5_0)
	...
	arg_5_0.fightPowerText_.text = getHeroPower(var_5_1, false)
	...
	arg_5_0.subNameText_.text = var_5_2.suffix

	arg_5_0.energyItem_:SetCurrent(arg_5_0:IsHeroInTeam(arg_5_0.selectID_))

	local var_5_3 = GameSetting.activity_club_sp_hero_fatigue_max.value[1]
	local var_5_4

	if GuildActivitySPData:IsFirstConfigFightRole() then
		var_5_4 = var_5_3
	else
		var_5_4 = table.indexof(arg_5_0.params_.putOffList, arg_5_0.selectID_) and 0 or GuildActivitySPData:GetHeroFatigue(arg_5_0.selectID_)
	end
