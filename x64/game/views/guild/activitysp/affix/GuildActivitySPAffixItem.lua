...
function var_0_0.SetData(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	if arg_6_0.affixID_ == nil then
		...
		manager.redPoint:bindUIandKey(arg_6_0.transform_, string.format("%s_%d_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, var_6_0, TalentTreeCfg[arg_6_1].race, arg_6_1))
	elseif arg_6_0.affixID_ ~= arg_6_1 then
		local var_6_1 = TalentTreeCfg[arg_6_0.affixID_].activity_id
		local var_6_2 = string.format("%s_%d_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, var_6_1, TalentTreeCfg[arg_6_0.affixID_].race, arg_6_0.affixID_)

		manager.redPoint:unbindUIandKey(arg_6_0.transform_, var_6_2)

		local var_6_3 = TalentTreeCfg[arg_6_1].activity_id
		local var_6_4 = string.format("%s_%d_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, var_6_3, TalentTreeCfg[arg_6_1].race, arg_6_1)
	...
	arg_6_0.nameText_.text = AffixTypeCfg[var_6_5].name
end
...
function var_0_0.Dispose(arg_9_0)
	...
	manager.redPoint:unbindUIandKey(arg_9_0.transform_, string.format("%s_%d_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, var_9_0, TalentTreeCfg[arg_9_0.affixID_].race, arg_9_0.affixID_))
