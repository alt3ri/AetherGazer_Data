...
function slot0.SetData(slot0, slot1, slot2, slot3)
	if slot0.affixID_ == nil then
		manager.redPoint:bindUIandKey(slot0.transform_, string.format("%s_%d_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, TalentTreeCfg[slot1].activity_id, TalentTreeCfg[slot1].race, slot1))
	elseif slot0.affixID_ ~= slot1 then
		manager.redPoint:unbindUIandKey(slot0.transform_, string.format("%s_%d_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, TalentTreeCfg[slot0.affixID_].activity_id, TalentTreeCfg[slot0.affixID_].race, slot0.affixID_))
		manager.redPoint:bindUIandKey(slot0.transform_, string.format("%s_%d_%d_%d", RedPointConst.GUILD_ACTIVITY_SP_AFFIX, TalentTreeCfg[slot1].activity_id, TalentTreeCfg[slot1].race, slot1))
	end
