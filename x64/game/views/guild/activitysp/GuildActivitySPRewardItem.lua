slot0 = class("GuildActivitySPRewardItem", ReduxView)
...
function slot0.AddListeners(slot0)
	slot0:AddBtnListener(slot0.receiveBtn_, nil, function ()
		...
		GuildActivitySPAction.RequireReceive(uv0.rateID_, uv0.receiveHandler_)
	end)
end
...
function slot0.SetData(slot0, slot1, slot2)
	...
	slot0.rewardList_ = ActivityClubSPLevelSettingCfg[slot1].reward_item_list
...
function slot0.OnReceiveReward(slot0)
	GuildActivitySPData:SetReceivedList(slot0.activityID_, slot0.rateID_)
...
function slot0.RefreshRewardState(slot0)
	slot3 = ActivityClubSPLevelSettingCfg[GuildActivitySPData:GetCurRateID(slot0.activityID_)].user_level

	if table.keyof(GuildActivitySPData:GetReceivedList(), ActivityClubSPLevelSettingCfg[slot0.rateID_].user_level) ~= nil then
		slot0.rewardController_:SetSelectedState("received")
	elseif ActivityClubSPLevelSettingCfg[slot0.rateID_].user_level <= slot3 then
