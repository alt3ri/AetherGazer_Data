...
function slot0.Ctor(slot0, slot1, slot2, slot3, slot4)
	...
	slot0.textName_.text = GetI18NText(PublicAttrCfg[slot4].name)

	SetActive(slot0.attributeImg_.gameObject, slot4 >= 151 and slot4 <= 158)

	if slot4 >= 151 and slot4 <= 158 then
		slot0.attributeImg_.sprite = HeroTools.GetSkillAttributeIcon(slot4 % 151 * 2)
	end
