...
function slot0.RefreshUI(slot0, slot1, slot2)
	slot0.id_ = slot1
	slot0.bgID_ = slot2
	slot0.bg_.sprite = getSpriteWithoutAtlas("TextureConfig/Sticker/stickerBtn/Sticker_bg_" .. slot0.bgID_)
	slot0.template_.sprite = getSpriteWithoutAtlas("TextureConfig/Sticker/stickerBtn/Sticker_button_" .. slot0.id_)
end
