...
function slot0.RefreshInfo(slot0)
	...
	slot0.textLv_.text = GetTips("LEVEL") .. string.format("%s", ComboSkillData:GetCurComboSkillLevel(slot0.comboSkillID_))
	slot0.titleText_.text = GetI18NText(HeroSkillCfg[slot1.skill_id].name)
	slot7 = "ComboSkill"
	slot8 = slot1.skill_id
	slot0.skillIcon.sprite = getSpriteViaConfig(slot7, slot8)
