...
function slot0.InitUI(slot0)
	...
	slot0.rankList = LuaList.New(handler(slot0, slot0.SetRewardItem), slot0.list2_, SoloHeartDemonRewardItem)
	slot4 = "state"
	slot0.controller = ControllerUtil.GetController(slot0.gameObject_.transform, slot4)
	slot0.leftBtnList_ = {}
