...
function slot0.OnEnter(slot0)
	...
	if slot0.leader == 0 then
		...
		slot0.m_icon.sprite = getSpriteWithoutAtlas("TextureConfig/Character/Icon/" .. PolyhedronData:GetHeroUsingSkinInfo(slot0.leader).id)
		slot0.m_name.text = GetI18NText(HeroCfg[slot0.leader].name)
	end
end
