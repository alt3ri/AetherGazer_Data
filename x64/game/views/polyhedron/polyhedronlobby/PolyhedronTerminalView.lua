...
function slot0.Init(slot0)
	...
	for slot5, slot6 in ipairs(PolyhedronTerminalCfg.all) do
		...
		slot8:RegistCallBack(handler(slot0, slot0.OnItemClick))
...
function slot0.RefreshUI(slot0)
	...
	slot0.m_infoDesLab.text = GetI18NText(slot2.desc)
	slot5, slot0.m_infoLimitTip.text = slot0:GetCanUnlock(slot0.selectId)
