...
function slot0.GetEquipData(slot0)
	slot1 = {}
	slot8 = slot0.equipFilterParams_.suit
	slot5 = HeroData
	slot7 = slot5
	slot3 = HeroTools.GetEquipMap(slot5.GetHeroList(slot7))

	for slot7, slot8 in pairs(EquipData:GetEquipListComplex(slot0.equipFilterParams_.order, slot0.equipFilterParams_.priority, slot0.equipFilterParams_.position, slot8, slot0.equipFilterParams_.skill)) do
...
function slot0.GetGiftData(slot0)
	...
	for slot6, slot7 in pairs(StoreTools.GetMaterialListByTypes(slot7)) do
		if slot7.num > 0 then
