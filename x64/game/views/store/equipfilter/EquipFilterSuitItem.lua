slot0 = class("EquipFilterSuitItem", ReduxView)
...
function slot0.SetData(slot0, slot1, slot2)
	slot0.data_ = slot1
	slot4 = slot1.cnt
	slot5 = EquipSuitCfg[slot1.id]
	slot0.name_.text = GetI18NText(slot5.name)

	SetSpriteWithoutAtlasAsync(slot0.icon_, SpritePathCfg.EquipIcon_s.path .. slot5.equip_skill_icon)
