...
function slot0.RefreshUI(slot0, slot1)
	slot0.id_ = slot1.id
	slot0.nameText_.text = GetI18NText(EquipSuitCfg[slot0.id_].name)
	slot0.iconImg_.sprite = getSpriteViaConfig("EquipIcon_s", EquipSuitCfg[slot0.id_].icon)
	slot0.shadowImg_.sprite = getSpriteViaConfig("EquipIcon_s", EquipSuitCfg[slot0.id_].icon)
