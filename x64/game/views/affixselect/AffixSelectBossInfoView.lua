slot0 = class("AffixSelectBossInfoView", ReduxView)
...
function slot0.UpdateView(slot0)
	slot1 = MonsterCfg[slot0.bossIDList_[1]]
	slot0.nameText_.text = GetMonsterName(slot0.bossIDList_)
	slot0.raceText_.text = GetTips("RACE_TYPE_" .. slot1.race)
	slot0.icon_.sprite = getSpriteWithoutAtlas(string.format("TextureConfig/VersionUI/DarkFlameUI/Boss_QualsDrill/DarkFlame_boss_0000%s", slot0.params_.index))
...
function slot0.UpdateData(slot0)
	slot0.skillList_ = GetMonsterSkillDesList(slot0.bossIDList_)
end
