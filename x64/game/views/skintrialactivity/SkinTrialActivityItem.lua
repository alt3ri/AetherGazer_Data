...
function slot0.RefreshUI(slot0)
	slot2 = HeroStandardSystemCfg[SkinTrialTools.GetHeroStandardID(slot0.skinTrialID_)].skin_id
	slot0.nameText_.text = GetI18NText(SkinCfg[slot2].name)

	if getSpriteViaConfig("SkinTrialTextrues", SkinCfg[slot2].picture_id) ~= nil then
