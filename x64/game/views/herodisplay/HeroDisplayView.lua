...
function slot0.OnEnter(slot0)
	...
	slot0.scaleIndex_ = 0
	slot0.scaleText_.text = GetI18NText(slot0.scaleTable_[slot0.scaleIndex_ + 1][1])
	...
	slot2 = OperationData:IsOperationOpen(OperationConst.SHARE_FLAG)

	SetActive(slot0.buttonSnap_.gameObject, slot2)
	SetActive(slot0.buttonSetting_.gameObject, slot2)
	slot0:LoadModel()
...
function slot0.AddListeners(slot0)
	...
	slot0:AddBtnListener(slot0.buttonWeapon_, nil, function ()
		if HeroDisplayData:GetHeroPoseList(uv0.heroID_)[uv0.poseIndex_].weaponState ~= HeroDisplayConst.WEAPON_STATE.CAN_SWITCH_WEAPON then
	...
	slot0:AddBtnListener(slot0.buttonSnap_, nil, function ()
		...
		uv0.snapView_:Snap(function ()
			...
			if uv0.showWeapon_ and HeroDisplayData:GetHeroPoseList(uv0.heroID_)[uv0.poseIndex_].weaponState ~= HeroDisplayConst.WEAPON_STATE.HIDE_WEAPON then
				slot1 = 1
			end
	...
	slot0:AddBtnListener(slot0.buttonScale_, nil, function ()
		uv0.touchView_:HideUI()
		uv0:HidePosePanel()
		uv0.scaleController_:SetSelectedState("true")

		uv0.scaleIndex_ = (uv0.scaleIndex_ + 1) % #uv0.scaleTable_
		uv0.scaleText_.text = GetI18NText(uv0.scaleTable_[uv0.scaleIndex_ + 1][1])
...
function slot0.LoadModel(slot0)
	...
	slot3 = HeroDisplayCfg[slot0.skinID_] or HeroDisplayCfg[slot0.heroID_]
...
function slot0.InitHeroExpressionParams(slot0)
	slot2 = nil
	slot2 = (not slot0:FindTrs("Face", slot0.uiTpose_.transform) or slot0:FindCom(typeof(UnityEngine.SkinnedMeshRenderer), "Face", slot0.uiTpose_.transform)) and slot0:FindCom(typeof(UnityEngine.SkinnedMeshRenderer), "face", slot0.uiTpose_.transform)
	...
	HeroDisplayData:InitHeroPose(slot1, slot0.skinID_)
...
function slot0.HeroPoseSelect(slot0, slot1)
	...
	slot0.showWeapon_ = slot2.weaponState ~= HeroDisplayConst.WEAPON_STATE.HIDE_WEAPON
...
function slot0.RefreshWeaponBtn(slot0)
	if slot0.showWeapon_ and HeroDisplayData:GetHeroPoseList(slot0.heroID_)[slot0.poseIndex_].weaponState == HeroDisplayConst.WEAPON_STATE.CAN_SWITCH_WEAPON then
