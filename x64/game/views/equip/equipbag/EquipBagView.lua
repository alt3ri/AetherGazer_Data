...
function slot0.GetEquipList(slot0)
	slot6 = slot0.info_.suitPos
	slot7 = slot0.info_.suit
	slot2 = {}

	for slot6, slot7 in ipairs(EquipData:GetEquipListComplex(slot0.info_.order, slot0.info_.priority, slot6, slot7, slot0.info_.skill)) do
