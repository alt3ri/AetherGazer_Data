...
function slot0.InitData(slot0)
	...
	if slot0.interactionCfg_ ~= nil then
		for slot5, slot6 in pairs(slot0.interactionCfg_) do
			if type(slot0.interactionCfg_[slot5]) == "table" and #slot0.interactionCfg_[slot5] ~= 0 and string.find(slot5, "delay") == nil and string.find(slot5, "talk") == nil and string.find(slot5, "weight") == nil then
