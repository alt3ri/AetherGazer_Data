slot1 = class("IndiaPuzzleNewTaskView", import("game.views.activity.Main.toggle.ActivityMainBasePanel"))
...
function slot1.InitUI(slot0)
	...
	slot5 = PuzzleNewTools.GetTaskItemClass
	slot0.scrollHelper_ = LuaList.New(handler(slot0, slot6), slot0.scrollView_, slot5(slot0.activityID_))
	slot0.taskUpdateHandler_ = handler(slot0, slot0.UpdateData)
	slot0.allReceiveController_ = ControllerUtil.GetController(slot0.listPanelTrans_, "clear")
...
function slot1.RefreshReceiveBtn(slot0)
	...
	slot0.allReceiveController_:SetSelectedState(slot1 == 1 and "true" or "false")
end
