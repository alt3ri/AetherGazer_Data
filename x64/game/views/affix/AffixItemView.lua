...
function slot0.SetData(slot0, slot1)
	...
	slot0.nameText_.text = GetI18NText(getAffixName(slot1))
	slot0.icon_.sprite = getAffixSprite(slot1)
	slot0.level_.text = slot1[2]

	slot0:Show(true)

	slot0.textInfoName_.text = GetI18NText(getAffixName(slot1))
	slot0.textInfoDesc_.text = GetI18NText(getAffixDesc(slot1))
end
