...
function slot0.UpdateAvatarView(slot0)
	...
	elseif slot0.curPageIndex_ == slot0.pageIndexS_.equip or slot0.curPageIndex_ == slot0.pageIndexS_.treasure then
		slot0.heroAvatarView_:ShowHeroModel(false)
	...
	elseif slot0.curPageIndex_ == slot0.pageIndexS_.weapon then
		...
		if slot0:GetHeroData(slot0.curHeroId_):GetWeaponServantEffect() ~= 0 then
			...
			slot0.m_weaponIcon.sprite = getSpriteWithoutAtlas("TextureConfig/WeaponServant/Portrait/" .. slot2)
		end
	else
