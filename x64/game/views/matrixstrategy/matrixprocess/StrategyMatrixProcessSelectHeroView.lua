local var_0_0 = class("StrategyMatrixProcessSelectHeroView", MatrixProcessSelectHeroView)
		...
		if arg_2_0:GetHeroEquipMaxCount() <= #var_2_5 then
			JumpTools.OpenPageByJump("strategyMatrixProcessEquipReplace", {
				...
				callback = function(arg_3_0)
					StrategyMatrixAction.QueryNextProgress(arg_2_0.matrix_activity_id, {
						var_2_0,
						arg_3_0,
...
function var_0_0.GetMatrixHeroTeam(arg_6_0)
	return StrategyMatrixData:GetMatrixHeroTeam(arg_6_0.matrix_activity_id)
end

function var_0_0.GetHeroEquipMaxCount(arg_7_0)
	return StrategyMatrixData:GetHeroEquipMaxCount(arg_7_0.matrix_activity_id)
end
