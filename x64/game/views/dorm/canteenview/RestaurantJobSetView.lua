...
function slot0.Init(slot0)
	...
	slot5 = CanteenSkillItem
	slot0.heroSkillScroll = LuaList.New(handler(slot0, slot0.heroSkillItem), slot0.uiSkillListGo_, slot5)
	...
	slot4 = "staff"
	slot0.staffController = ControllerUtil.GetController(slot0.transform_, slot4)
...
function slot0.AddUIListener(slot0)
	...
	slot4 = slot0.removeBtn_
	slot5 = nil

	slot0:AddBtnListenerScale(slot4, slot5, function ()
