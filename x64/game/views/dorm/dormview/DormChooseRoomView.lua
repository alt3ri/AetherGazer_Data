...
function slot0.Init(slot0)
	...
	slot5 = BackHomeNewHeroItem
	slot0.danceHeroStateScroll = LuaList.New(handler(slot0, slot0.indexDanceHeroItem), slot0.danceHeroUilistGo_, slot5)
	slot0.toggleGropu = {}
