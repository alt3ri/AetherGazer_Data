...
function slot0.OnEnter(slot0)
	...
	slot6 = false
	slot11 = slot0.params_.activityID

	for slot11, slot12 in ipairs(slot5) do
		if slot12 ~= 0 and not table.keyof(GetTrialHeroList(BattleConst.STAGE_TYPE_NEW.SOLO_CHALLENGE, nil, slot11), slot12) and not table.keyof(lockHeroList, slot12) then
			slot6 = true
			slot5[slot11] = 0
			slot4[slot11] = 0
		end
