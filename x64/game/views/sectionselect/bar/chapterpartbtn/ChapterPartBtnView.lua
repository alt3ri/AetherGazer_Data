...
function slot0.RefreshUI(slot0, slot1)
	if #getChapterClientCfgByChapterID(slot1).chapter_list > 1 and (slot2.id == ChapterConst.CHAPTER_CLIENT_XUHENG_PART_2_2 or slot2.id == ChapterConst.CHAPTER_CLIENT_LUWU_ZHIMING) then
		slot6 = true
