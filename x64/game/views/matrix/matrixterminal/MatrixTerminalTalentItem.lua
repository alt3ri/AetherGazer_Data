...
function slot0.RefreshData(slot0, slot1, slot2)
	...
	slot6 = getSpriteWithoutAtlas("TextureConfig/MatrixItem/MatrixTerminal/" .. slot5.icon)
	slot0.m_grayIcon.sprite = slot6
	slot0.m_icon.sprite = slot6

	if MatrixData:GetTerminalLevel() < slot5.limit_level or slot7 ~= 0 and (slot1[slot5.pre_id] or 0) == 0 then
