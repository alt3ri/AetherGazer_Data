...
function slot0.AddListeners(slot0)
	...
	slot0:AddBtnListener(slot0.receiveBtn_, nil, function ()
		TaskAction:SubmitTask(uv0:GetTaskID())
	end)
end
...
function slot0.RefreshTitle(slot0)
	slot0.titleText_.text = GetI18NText(AssignmentCfg[slot0:GetTaskID()].desc)
end
...
function slot0.RefreshReward(slot0)
	for slot5, slot6 in ipairs(AssignmentCfg[slot0:GetTaskID()].reward) do
		if slot0.rewardItems_[slot5] == nil then
			...
			slot0.rewardItems_[slot5].commonItem_:RegistCallBack(function ()
