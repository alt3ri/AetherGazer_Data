slot0 = class("RoguelikeMapView_2_1", ReduxView)
...
function slot0.RefreshTitleAndBg(slot0)
	...
	slot0.TxtTier.text = GetTips("ROGUELIKE_2_1_TITLE_" .. slot4.tier)
...
function slot0.BindRedPoint(slot0)
	manager.redPoint:bindUIandKey(slot0.BtnReward.transform, string.format("%s_%s", RedPointConst.STRATEGY_MATRIX_REWARD, slot0.activity_id))
end

function slot0.UnBindRedPoint(slot0)
	manager.redPoint:unbindUIandKey(slot0.BtnReward.transform, string.format("%s_%s", RedPointConst.STRATEGY_MATRIX_REWARD, slot0.activity_id))
end
