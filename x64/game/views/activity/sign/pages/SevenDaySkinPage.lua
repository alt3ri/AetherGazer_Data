...
slot1 = class("SevenDaySkinPage", ActivityMainBasePanel)
...
function slot1.Init(slot0)
	...
	for slot4 = 1, slot0.max_sign_day do
		table.insert(slot0.items, SevenDaySkinItem.New(slot0["btn_" .. slot4]))
	end
...
function slot1.OnSignSuccess(slot0, slot1)
	if uv0[slot1.item_list[1].id] then
...
function slot1.ShowCheckDialog(slot0)
	slot2 = GameSetting.activity_supplementary_sign.value[slot0.data:TodayBuyNum() + 1]
	slot3 = slot2[1]
	slot5 = ItemTools.getItemNum(slot3)
