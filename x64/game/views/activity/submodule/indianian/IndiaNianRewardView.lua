slot0 = class("IndiaNianRewardView", ReduxView)
...
function slot0.OnEnter(slot0)
	slot0.activityId = IndiaNianData:GetActivityID()
...
function slot0.UpdateView(slot0)
	...
	SetActive(slot0.oneKeyGo_, #TaskTools:GetCanGetActivityTaskList(slot0.activityId) > 0)
end
