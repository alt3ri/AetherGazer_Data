...
function slot0.SetData(slot0, slot1, slot2)
	...
	slot9 = slot0.activityID_

	for slot8, slot9 in ipairs(slot0.heroItemList_) do
		slot9:SetData(slot1, slot2, ReserveTools.GetHeroList(ReserveParams.New(ReserveConst.RESERVE_TYPE.SEQUENTIAL_BATTLE, slot0.activityID_, slot0.stageIndex_, slot8))[slot8])
	end
