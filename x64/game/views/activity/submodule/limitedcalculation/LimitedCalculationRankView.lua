local var_0_0 = class("LimitedCalculationRankView", ReduxView)
local var_0_1 = {
	ALL = 1,
	GUILD = 2
}
...
function var_0_0.UIName(arg_1_0)
	return LimitedCalculationTools.GetRankUIName(arg_1_0.params_.activityID)
end
...
function var_0_0.InitUI(arg_4_0)
	...
	arg_4_0.scrollHelper_ = LuaList.New(handler(arg_4_0, arg_4_0.IndexItem), arg_4_0.listGo_, LimitedCalculationRankItem)
end
...
function var_0_0.OnEnter(arg_9_0)
	...
	arg_9_0.guildToggle_.isOn = true
	arg_9_0.allToggle_.isOn = true
...
function var_0_0.RefreshList(arg_13_0)
	...
	table.sort(arg_13_0.rankList_, function(arg_14_0, arg_14_1)
