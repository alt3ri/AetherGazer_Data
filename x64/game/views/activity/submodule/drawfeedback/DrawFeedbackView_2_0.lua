...
function slot0.Show(slot0, slot1)
	...
	if slot1 then
		slot0.scrollHelper_:StartScroll(#TaskData2:GetActivityTaskSortList(ActivityConst.ACTIVITY_2_0_DRAW_FEEDBACK_TASK))
	end
end
...
function slot0.RefreshItem(slot0, slot1, slot2)
	slot2:SetData(TaskData2:GetActivityTaskSortList(ActivityConst.ACTIVITY_2_0_DRAW_FEEDBACK_TASK)[slot1].id)
end
...
function slot0.RefreshShopTime(slot0)
	...
	slot0.shopTimeText_.text = manager.time:GetLostTimeStrWith2Unit(slot1.stopTime)
