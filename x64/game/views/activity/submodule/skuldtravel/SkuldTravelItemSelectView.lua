...
function slot0.OnSelectItem(slot0, slot1)
	...
	slot0.itemnametext_.text = GetI18NText(TravelSkuldItemCfg[slot1].name)
	slot0.desctext_.text = GetI18NText(TravelSkuldItemCfg[slot1].desc)
...
function slot0.OnEnter(slot0)
	...
	slot0.itemnametext_.text = GetI18NText(TravelSkuldItemCfg[slot0.curitemid_].name)
	slot0.desctext_.text = GetI18NText(TravelSkuldItemCfg[slot0.curitemid_].desc)
