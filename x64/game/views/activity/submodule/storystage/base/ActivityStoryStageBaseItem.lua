...
function slot0.AddListeners(slot0)
	slot0:AddBtnListener(slot0.btn_, nil, function ()
		if not uv0.isOpen_ then
			ShowTips(string.format(GetTips("UNLOCK_CONDITION_ACTIVITY_TIPS"), ActivityCfg[WarchessLevelCfg[uv0.preStageID_].type].remark, WarchessLevelCfg[uv0.preStageID_].name_level))
		else
