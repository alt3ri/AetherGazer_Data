slot0 = class("SummerStorySeabedItem", ReduxView)
...
function slot0.AddTimer(slot0)
	...
	if slot2 < slot1.startTime then
		...
		slot0.timeText_.text = string.format(GetTips("OPEN_TIME"), manager.time:GetLostTimeStr(slot1.startTime))
		slot0.timer_ = Timer.New(function ()
			...
			uv2.timeText_.text = string.format(GetTips("OPEN_TIME"), manager.time:GetLostTimeStr(uv1.startTime))
		end, 1, -1)
