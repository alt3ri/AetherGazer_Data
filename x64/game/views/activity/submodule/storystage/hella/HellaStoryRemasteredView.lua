...
function slot0.OnEnter(slot0)
	...
	for slot6 = 1, 3 do
		slot0.storyChapterView_[slot6] = slot0.storyChapterView_[slot6] or HellaStoryChapterView.New(slot0[string.format("chapterBtn%s_", slot6)], ChapterClientCfg[getChapterClientCfgByChapterID(slot0.selectChapterID_).id].chapter_list[slot6])
	end
...
function slot0.AddListeners(slot0)
	...
	slot0:AddBtnListener(slot0.btnWarChess_, nil, function ()
		slot0 = getChapterClientCfgByChapterID(uv0.selectChapterID_)
...
function slot0.RefreshSelectItem(slot0)
	for slot5, slot6 in pairs(slot0.stageItemList_) do
		slot6:SelectorItem(slot0.selectStageID_)
	end
end
