...
function slot0.OnExit(slot0)
	manager.redPoint:unbindUIandKey(slot0.rewardBtn_.transform, string.format("%s_%s", RedPointConst.DESTROY_BOX_GAME_REWARD, slot0.mainActivityID_))

	slot4 = DESTROY_BOX_GAME_SELECT_STAGE
	slot5 = slot0.switchSelectItemHandler_
