...
function slot0.OnEnter(slot0)
	slot0.name1Text_.text = GetI18NText(ActivityCrossWaveCfg[slot0.chapterID_].name)
	slot0.name2Text_.text = GetI18NText(ActivityCrossWaveCfg[slot0.chapterID_].name)
