...
function slot0.InitUI(slot0)
	...
	slot4 = slot0.skinPoolID_

	for slot4, slot5 in ipairs(ActivityLimitedDrawPoolListCfg[slot4].main_icon_info) do
...
function slot0.AddUIListeners(slot0)
	...
	slot0:AddBtnListener(slot0.sceneBtn_, slot5, function ()
