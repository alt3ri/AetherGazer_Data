...
function slot0.InitUI(slot0)
	...
	slot0.list = LuaList.New(handler(slot0, slot0.IndexItem), slot0.m_list, StrongholdOperateRewardItem)
	slot4 = "reward"
	slot0.rewardController = ControllerUtil.GetController(slot0.transform_, slot4)
	slot0.specItems = {}
