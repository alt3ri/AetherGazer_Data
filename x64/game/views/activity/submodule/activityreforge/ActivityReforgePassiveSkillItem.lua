local var_0_0 = class("ActivityReforgePassiveSkillItem", ReduxView)
...
function var_0_0.SetData(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5, arg_4_6)
	...
	arg_4_0.curSkillID_ = arg_4_6
	arg_4_0.slotText_.text = GetTips("ACTIVITY_REFORGE_PASSIVE_SLOT")

	local var_4_0 = ActivityReforgeData:GetPassiveSkillUseNum() .. "/" .. #arg_4_0.skillList_
