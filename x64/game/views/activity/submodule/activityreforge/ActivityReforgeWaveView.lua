...
function slot0.InitUI(slot0)
	...
	slot0.waveTaskList_ = LuaList.New(handler(slot0, slot0.IndexWaveTaskItem), slot0.waveTaskListGo_, ActivityReforgeWaveTaskItem)
	slot0.curWaveInfoToggle_ = uv0.INFO
	slot4 = slot0.OnWaveItemClick
	slot0.waveItemClickHandle_ = handler(slot0, slot4)
...
function slot0.OnEnter(slot0)
	...
	slot0.curWaveID_ = slot0.levelCfg_.wave_list[slot0.curWaveIndex_]
	slot0.curWaveCfg_ = ActivityReforgeWaveCfg[slot0.curWaveID_]
	slot4 = slot0.curWaveID_
	slot0.curWaveTeamData_ = ActivityReforgeData:GetWaveTeamInfo(slot4)
