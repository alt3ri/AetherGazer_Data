...
function slot0.RefreshUI(slot0)
	...
	slot0.indexCon_:SetSelectedState(table.indexof(ActivityCfg[slot0.params_.mainActivityID].sub_activity_list, slot0.activityID_))

	slot4 = slot0.cfg_.name
	slot0.name_.text = GetI18NText(slot4)
...
function slot0.Update(slot0)
	...
	slot0.ans_.text = GetI18NText(slot0.curAnsCfg_.hero_comment[slot0.curChoose_])
	slot5 = "result"
