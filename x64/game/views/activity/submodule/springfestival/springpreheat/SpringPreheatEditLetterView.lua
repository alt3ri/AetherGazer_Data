...
function slot0.RefreshUI(slot0, slot1)
	...
	slot7 = "SPRING_PREHEAT_RESET"
	slot0.resetText_.text = GetTips(slot7)
...
function slot0.TrySendBlessingLetter(slot0)
	...
	slot7 = slot0.letterList_
	slot9 = slot7

	for slot8, slot9 in pairs(slot7.GetItemList(slot9)) do
