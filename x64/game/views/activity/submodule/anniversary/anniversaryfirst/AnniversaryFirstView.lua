...
function slot0.Show(slot0, slot1)
	...
	if slot1 then
		slot0.scrollHelper_:StartScroll(#TaskData2:GetActivityTaskSortList(ActivityConst.ACTIVITY_2_0_ANNIVERSARY_NORMAL_TASK))
	end
end
...
function slot0.RefreshItem(slot0, slot1, slot2)
	slot2:SetData(TaskData2:GetActivityTaskSortList(ActivityConst.ACTIVITY_2_0_ANNIVERSARY_NORMAL_TASK)[slot1].id)
end
