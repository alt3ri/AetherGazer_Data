...
function slot0.OnItemSelect(slot0, slot1, slot2, slot3, slot4)
	...
	slot8 = slot0.taskType_
	slot9 = slot2
	slot0.taskDataList_ = TaskTools:GetNoobAdvanceTaskSortList(slot8, slot9)
...
function slot0.GreatTree(slot0)
	slot0.tree_:SetSelectedHandler(nil, slot9)
...
function slot0.GetSelectIndex(slot0)
	...
	for slot6, slot7 in ipairs(slot0.groupCfgList_) do
		...
		for slot11, slot12 in ipairs(slot7[2]) do
			...
			for slot17, slot18 in pairs(TaskTools:GetNoobAdvanceTaskSortList(slot0.taskType_, slot17)) do
...
function slot0.BindRedPoint(slot0)
	for slot4, slot5 in ipairs(slot0.groupCfgList_) do
		slot9 = slot0.tree_:GetGroupRedPointContainerById(slot4)
		slot10 = string.format

		manager.redPoint:bindUIandKey(slot9, slot10("%s_%d_%d", RedPointConst.NOOB_ADVANCE, slot0.taskType_, slot4))
...
function slot0.UnbindRedPoint(slot0)
	for slot4, slot5 in ipairs(slot0.groupCfgList_) do
		...
		manager.redPoint:unbindUIandKey(slot9, slot10("%s_%d_%d", RedPointConst.NOOB_ADVANCE, slot0.taskType_, slot4))
