...
function slot0.OnConfirmBtnClick(slot0, slot1)
	...
	if slot0.changeindex_1 ~= 0 and slot0.changeindex_2 ~= 0 then
		ReserveTools.SwapTeam(ReserveConst.RESERVE_TYPE.MYTHIC_FINAL, ReserveConst.MYTHIC_CONT_ID.FINAL_MULTI, slot0.changeindex_1, slot0.changeindex_2)
...
function slot0.LaunchBattle(slot0)
	...
	slot1 = {
		[slot5] = BattleStageFactory.Produce(BattleConst.STAGE_TYPE_NEW.MYTHIC_FINAL, slot0.battleList_[slot5], slot0.activityID_, ReserveParams.New(ReserveConst.RESERVE_TYPE.MYTHIC_FINAL, ReserveConst.MYTHIC_CONT_ID.FINAL_MULTI, slot5, {
			stageType = BattleConst.STAGE_TYPE_NEW.MYTHIC_FINAL,
			stageID = slot0.battleList_[slot5],
...
function slot0.AddUIListener(slot0)
	slot0:AddBtnListener(slot0.btn_warbeganBtn_, nil, function ()
		...
		ReserveAction.SaveContData(ReserveConst.RESERVE_TYPE.MYTHIC_FINAL, ReserveConst.MYTHIC_CONT_ID.FINAL_MULTI, handler(uv0, uv0.LaunchBattle))
	end)
