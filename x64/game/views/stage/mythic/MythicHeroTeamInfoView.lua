...
local var_0_1 = class("MythicHeroTeamInfoView", var_0_0)
...
function var_0_1.Init(arg_2_0)
	...
	arg_2_0.heroHeadList_ = LuaList.New(handler(arg_2_0, arg_2_0.HeadRenderer), arg_2_0.uiListGo_, MythicHeroTeamHeadItem)
...
function var_0_1.HeadRenderer(arg_4_0, arg_4_1, arg_4_2)
	local var_4_0 = HeroViewDataProxy.New(HeroConst.HERO_DATA_TYPE.DEFAULT)

	arg_4_2:SetProxy(var_4_0)
	var_0_1.super.HeadRenderer(arg_4_0, arg_4_1, arg_4_2)

	local var_4_1 = arg_4_0.heroDataList_[arg_4_1].id

	arg_4_2:RefreshTeamTag(arg_4_0.params_.reserveParams.teamIndex, arg_4_0.teamLength_)
	arg_4_2:SetHeroLock(table.keyof(arg_4_0.lockHeroList_, var_4_1) ~= nil)
end
...
function var_0_1.IsInTeam(arg_7_0, arg_7_1)
	for iter_7_0 = 1, #arg_7_0.heroTeam_ do
		if arg_7_0.heroTeam_[iter_7_0] == arg_7_1 then
			return true
		end
	end
...
function var_0_1.OnJoinClick(arg_9_0)
	...
	for iter_9_9 = 1, 2 do
		if arg_9_0.params_.reserveParams.teamIndex ~= iter_9_9 then
			local var_9_14 = ReserveParams.New(nil, arg_9_0.params_.reserveParams.contID, iter_9_9, {
	...
	if var_9_11 then
		...
		ShowMessageBox({
			...
			OkCallback = function()
				...
				local var_10_0 = ReserveParams.New(nil, arg_9_0.params_.reserveParams.contID, var_9_11, {
					stageType = arg_9_0.params_.stageType,
					stageID = arg_9_0.params_.stageID
				})
