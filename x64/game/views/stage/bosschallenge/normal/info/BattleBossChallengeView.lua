...
function slot1.AddListeners(slot0)
	slot0:AddBtnListener(slot0.startBattleBtn_, nil, function ()
		...
		uv0:Go("/sectionSelectHero", {
			...
			reserveParams = ReserveParams.New(ReserveConst.RESERVE_TYPE.BOSS_CHALLENGE, BossTools.GetContID(BattleConst.STAGE_TYPE_NEW.STAGE_TYPE_BOSS_CHALLENGE, uv0.bossIndex_), nil, {
	...
	slot0:AddBtnListener(slot0.bgBtn_, nil, function ()
		...
		uv0.heroLockScroll_.normalizedPosition = Vector2(0, 1)
	end)
end
