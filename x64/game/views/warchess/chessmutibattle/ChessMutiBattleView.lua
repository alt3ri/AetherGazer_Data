...
function slot0.OnConfirmBtnClick(slot0, slot1)
	...
	if slot0.changeindex_1 ~= 0 and slot0.changeindex_2 ~= 0 then
		ReserveTools.SwapTeam(ReserveConst.RESERVE_TYPE.MULTI_CHESS, slot0.activityID_, slot0.changeindex_1, slot0.changeindex_2)
...
function slot0.AddUIListener(slot0)
	slot0:AddBtnListener(slot0.btn_warbeganBtn_, nil, function ()
		...
		ReserveAction.SaveMultiChessContData(uv0.xz_.x, uv0.xz_.z, uv0.times_, uv0.activityID_, function ()
			slot0 = {
				[slot4] = BattleStageFactory.Produce(BattleConst.STAGE_TYPE_NEW.STAGE_TYPE_CHESS, uv0.battleList_[slot4], uv0.activityID_, ReserveParams.New(ReserveConst.RESERVE_TYPE.MULTI_CHESS, uv0.activityID_, slot4, {
					stageType = BattleConst.STAGE_TYPE_NEW.STAGE_TYPE_CHESS,
					stageID = uv0.battleList_[index]
				}))
			}
