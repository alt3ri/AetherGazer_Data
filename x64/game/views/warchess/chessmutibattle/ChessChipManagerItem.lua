local var_0_0 = class("ChessChipManagerItem", ChipManagerItem)
...
function var_0_0.GetEnabledChipManagerID(arg_5_0)
	return (BattleTeamData:GetMimirInfo(BattleConst.STAGE_TYPE_NEW.STAGE_TYPE_CHESS, nil, nil, arg_5_0.teamID_))
end
