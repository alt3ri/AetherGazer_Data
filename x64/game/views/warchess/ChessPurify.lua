...
function slot0.indexItem(slot0, slot1, slot2)
	...
	slot2:RegisterListener(function (slot0)
		if slot0 ~= uv0.selectItem_ then
			...
			uv0.itemiconImg_.sprite = getSprite("Atlas/WarChess_BattleAtlas", WarchessItemCfg[uv0.itemList_[slot0]].icon)
			uv0.nameText_.text = GetI18NText(WarchessItemCfg[uv0.itemList_[slot0]].name)
		end
	end)
end
