...
function slot0.SetInfo(slot0, slot1)
	...
	slot0.weaponImg_.sprite = AssetEx.LoadSprite("TextureConfig/WeaponServant/Portrait/" .. slot1)

	slot0.AdaptImg_:AdaptImg()

	slot0.nameText_.text = ItemTools.getItemName(slot1)
	slot0.camp_.sprite = getSprite("Atlas/CampItemAtlas", RaceEffectCfg[slot3.race].icon)
