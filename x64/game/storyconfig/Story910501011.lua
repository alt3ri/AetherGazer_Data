return {
	Play910501001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_43 = arg_1_1.actors_["10048ui_story"]
			local var_4_44 = 1.8

			if var_4_44 < arg_1_1.time_ and arg_1_1.time_ <= var_4_44 + arg_4_0 then
				if arg_1_1.var_.characterEffect10048ui_story == nil then
					arg_1_1.var_.characterEffect10048ui_story = var_4_43:GetComponentInChildren(typeof(CharacterEffect))
				end

				local var_4_45 = arg_1_1.var_.characterEffect10048ui_story

				var_4_45.imageEffect:turnOff()

				var_4_45.interferenceEffect.enabled = true
				var_4_45.interferenceEffect.noise = 0.001
				var_4_45.interferenceEffect.simTimeScale = 1
				var_4_45.interferenceEffect.geometryOutlineColor = Color.New(0.3725, 0.88, 1, 1)
			end

			local var_4_46 = arg_1_1.actors_["10048ui_story"]
			local var_4_47 = 1.8
			local var_4_48 = 0.2

			if var_4_47 < arg_1_1.time_ and arg_1_1.time_ <= var_4_47 + arg_4_0 then
				if arg_1_1.var_.characterEffect10048ui_story == nil then
					arg_1_1.var_.characterEffect10048ui_story = var_4_46:GetComponentInChildren(typeof(CharacterEffect))
				end
			...
			if var_4_49 < arg_1_1.time_ and arg_1_1.time_ <= var_4_49 + arg_4_0 then
				...
				local var_4_52 = arg_1_1:FormatText(StoryNameCfg[476].name)
				...
				local var_4_53 = arg_1_1:GetWordFromCfg(910501001)
	...
	Play910501002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_1 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 and arg_7_1.var_.characterEffect10048ui_story == nil then
			...
			if arg_7_1.time_ >= var_10_1 + var_10_2 and arg_7_1.time_ < var_10_1 + var_10_2 + arg_10_0 and arg_7_1.var_.characterEffect10048ui_story then
				local var_10_5 = 0.5
