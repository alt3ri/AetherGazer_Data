return {
	Play105091001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105091001).content)
	...
	Play105091002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091002
		slot1.duration_ = 6.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105091002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091002", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091002", "story_v_out_105091.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105091", "105091002", "story_v_out_105091.awb")

						uv0:RecordAudio("105091002", slot10)
						uv0:RecordAudio("105091002", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091002", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091002", "story_v_out_105091.awb")
				end
	...
	Play105091003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091003
		slot1.duration_ = 3.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105091003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091003", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091003", "story_v_out_105091.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105091", "105091003", "story_v_out_105091.awb")

						uv0:RecordAudio("105091003", slot19)
						uv0:RecordAudio("105091003", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091003", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091003", "story_v_out_105091.awb")
				end
	...
	Play105091004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(105091004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091004", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091004", "story_v_out_105091.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_105091", "105091004", "story_v_out_105091.awb")

						uv0:RecordAudio("105091004", slot11)
						uv0:RecordAudio("105091004", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091004", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091004", "story_v_out_105091.awb")
				end
	...
	Play105091005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091005
		slot1.duration_ = 8.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(0.7, -1.08, -5.9), (uv0.time_ - slot15) / slot16)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(105091005).content)
				uv0.text_.text = slot23

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (19 <= 0 and slot20 or slot20 * utf8.len(slot23) / slot24) > 0 and slot20 < slot26 then
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091005", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091005", "story_v_out_105091.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_105091", "105091005", "story_v_out_105091.awb")

						uv0:RecordAudio("105091005", slot28)
						uv0:RecordAudio("105091005", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091005", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091005", "story_v_out_105091.awb")
				end
	...
	Play105091006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(-0.7, -1.09, -5.78), (uv0.time_ - slot12) / slot13)
				slot17 = manager.ui.mainCamera.transform.position - slot11.position
				slot11.forward = Vector3.New(slot17.x, slot17.y, slot17.z)
				slot18 = slot11.localEulerAngles
				slot18.z = 0
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(-0.7, -1.09, -5.78)
				slot16 = manager.ui.mainCamera.transform.position - slot11.position
				slot11.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot11.localEulerAngles
				slot17.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(105091006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091006", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091006", "story_v_out_105091.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_105091", "105091006", "story_v_out_105091.awb")

						uv0:RecordAudio("105091006", slot25)
						uv0:RecordAudio("105091006", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091006", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091006", "story_v_out_105091.awb")
				end
	...
	Play105091007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105091007).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091007", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091007", "story_v_out_105091.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105091", "105091007", "story_v_out_105091.awb")

						uv0:RecordAudio("105091007", slot19)
						uv0:RecordAudio("105091007", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091007", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091007", "story_v_out_105091.awb")
				end
	...
	Play105091008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(105091008).content)
	...
	Play105091009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105091009).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091009", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091009", "story_v_out_105091.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105091", "105091009", "story_v_out_105091.awb")

						uv0:RecordAudio("105091009", slot10)
						uv0:RecordAudio("105091009", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091009", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091009", "story_v_out_105091.awb")
				end
	...
	Play105091010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091010
		slot1.duration_ = 3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105091010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091010", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091010", "story_v_out_105091.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105091", "105091010", "story_v_out_105091.awb")

						uv0:RecordAudio("105091010", slot18)
						uv0:RecordAudio("105091010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091010", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091010", "story_v_out_105091.awb")
				end
	...
	Play105091011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(105091011).content)
	...
	Play105091012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story", "se_story_roar", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_3012")

				uv0.callingController_:SetSelectedState("normal")

				slot7 = uv0:FormatText(uv0:GetWordFromCfg(105091012).content)
	...
	Play105091013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091013
		slot1.duration_ = 2.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105091013).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091013", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091013", "story_v_out_105091.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_105091", "105091013", "story_v_out_105091.awb")

						uv0:RecordAudio("105091013", slot21)
						uv0:RecordAudio("105091013", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091013", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091013", "story_v_out_105091.awb")
				end
	...
	Play105091014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105091014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105091014).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_105091", "105091014", "story_v_out_105091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105091", "105091014", "story_v_out_105091.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_105091", "105091014", "story_v_out_105091.awb")

						uv0:RecordAudio("105091014", slot21)
						uv0:RecordAudio("105091014", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105091", "105091014", "story_v_out_105091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105091", "105091014", "story_v_out_105091.awb")
				end
