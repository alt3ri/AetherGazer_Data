return {
	Play62108001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62108001
		slot1.duration_ = 7
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play62108002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.B07a == nil then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(62108001).content)
				uv0.text_.text = slot14

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (32 <= 0 and slot10 or slot10 * utf8.len(slot14) / slot15) > 0 and slot10 < slot17 then
	...
	Play62108002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62108002
		slot1.duration_ = 5.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(62108002).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_chess_62108", "62108002", "story_v_chess_62108.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62108", "62108002", "story_v_chess_62108.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_chess_62108", "62108002", "story_v_chess_62108.awb")

						uv0:RecordAudio("62108002", slot19)
						uv0:RecordAudio("62108002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62108", "62108002", "story_v_chess_62108.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62108", "62108002", "story_v_chess_62108.awb")
				end
	...
	Play62108003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62108003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62108003).content)
	...
	Play62108004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62108004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(62108004).content)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62108", "62108004", "story_v_chess_62108.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62108", "62108004", "story_v_chess_62108.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_chess_62108", "62108004", "story_v_chess_62108.awb")

						uv0:RecordAudio("62108004", slot14)
						uv0:RecordAudio("62108004", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62108", "62108004", "story_v_chess_62108.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62108", "62108004", "story_v_chess_62108.awb")
				end
	...
	Play62108005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62108005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(62108005).content)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62108", "62108005", "story_v_chess_62108.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62108", "62108005", "story_v_chess_62108.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_chess_62108", "62108005", "story_v_chess_62108.awb")

						uv0:RecordAudio("62108005", slot11)
						uv0:RecordAudio("62108005", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62108", "62108005", "story_v_chess_62108.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62108", "62108005", "story_v_chess_62108.awb")
				end
	...
	Play62108006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62108006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62108006).content)
				uv0.text_.text = slot8
