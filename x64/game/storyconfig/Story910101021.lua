return {
	Play910102001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910102001
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if uv0.actors_["1084"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue1084 = slot11.alpha
					uv0.var_.characterEffect1084 = slot11
				end
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				if uv0.var_.characterEffect1084 then
					uv0.var_.characterEffect1084.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1084, 1, (uv0.time_ - slot10) / slot11)
				end
			end

			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 and uv0.var_.characterEffect1084 then
				uv0.var_.characterEffect1084.alpha = 1
			end
			...
			if 1 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(910102001).content)
				uv0.text_.text = slot17

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (4 <= 0 and slot13 or slot13 * utf8.len(slot17) / slot18) > 0 and slot13 < slot20 then
	...
	Play910102002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910102002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(910102002).content)
	...
	Play910102003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910102003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(910102003).content)
				uv0.text_.text = slot8
