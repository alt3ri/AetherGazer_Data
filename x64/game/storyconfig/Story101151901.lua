return {
	Play115191001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(115191001).content)
	...
	Play115191002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(115191002).content)
	...
	Play115191003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(115191003).content)
				uv0.text_.text = slot4
	...
	Play115191004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot3.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1017ui_story, Vector3.New(0, -1.01, -6.05), (uv0.time_ - slot4) / slot5)
			...
			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 then
				slot3.localPosition = Vector3.New(0, -1.01, -6.05)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(115191004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191004", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191004", "story_v_out_115191.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_115191", "115191004", "story_v_out_115191.awb")

						uv0:RecordAudio("115191004", slot19)
						uv0:RecordAudio("115191004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191004", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191004", "story_v_out_115191.awb")
				end
	...
	Play115191005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(115191005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191005", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191005", "story_v_out_115191.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_115191", "115191005", "story_v_out_115191.awb")

						uv0:RecordAudio("115191005", slot13)
						uv0:RecordAudio("115191005", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191005", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191005", "story_v_out_115191.awb")
				end
	...
	Play115191006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(115191006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191006", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191006", "story_v_out_115191.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_115191", "115191006", "story_v_out_115191.awb")

						uv0:RecordAudio("115191006", slot10)
						uv0:RecordAudio("115191006", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191006", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191006", "story_v_out_115191.awb")
				end
	...
	Play115191007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115191007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191007", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191007", "story_v_out_115191.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_115191", "115191007", "story_v_out_115191.awb")

						uv0:RecordAudio("115191007", slot15)
						uv0:RecordAudio("115191007", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191007", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191007", "story_v_out_115191.awb")
				end
	...
	Play115191008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(115191008).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191008", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191008", "story_v_out_115191.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_115191", "115191008", "story_v_out_115191.awb")

						uv0:RecordAudio("115191008", slot13)
						uv0:RecordAudio("115191008", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191008", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191008", "story_v_out_115191.awb")
				end
	...
	Play115191009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1017ui_story, Vector3.New(-0.7, -1.01, -6.05), (uv0.time_ - slot14) / slot15)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(115191009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191009", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191009", "story_v_out_115191.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_115191", "115191009", "story_v_out_115191.awb")

						uv0:RecordAudio("115191009", slot25)
						uv0:RecordAudio("115191009", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191009", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191009", "story_v_out_115191.awb")
				end
	...
	Play115191010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(115191010).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191010", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191010", "story_v_out_115191.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_115191", "115191010", "story_v_out_115191.awb")

						uv0:RecordAudio("115191010", slot13)
						uv0:RecordAudio("115191010", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191010", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191010", "story_v_out_115191.awb")
				end
	...
	Play115191011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(115191011).content)
				uv0.text_.text = slot4
	...
	Play115191012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115191012).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191012", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191012", "story_v_out_115191.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_115191", "115191012", "story_v_out_115191.awb")

						uv0:RecordAudio("115191012", slot15)
						uv0:RecordAudio("115191012", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191012", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191012", "story_v_out_115191.awb")
				end
	...
	Play115191013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(115191013).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191013", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191013", "story_v_out_115191.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_115191", "115191013", "story_v_out_115191.awb")

						uv0:RecordAudio("115191013", slot13)
						uv0:RecordAudio("115191013", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191013", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191013", "story_v_out_115191.awb")
				end
	...
	Play115191014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115191014).content)
				uv0.text_.text = slot10
	...
	Play115191015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(115191015).content)
				uv0.text_.text = slot4
	...
	Play115191016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(115191016).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191016", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191016", "story_v_out_115191.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_115191", "115191016", "story_v_out_115191.awb")

						uv0:RecordAudio("115191016", slot19)
						uv0:RecordAudio("115191016", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191016", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191016", "story_v_out_115191.awb")
				end
	...
	Play115191017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(115191017).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191017", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191017", "story_v_out_115191.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_115191", "115191017", "story_v_out_115191.awb")

						uv0:RecordAudio("115191017", slot22)
						uv0:RecordAudio("115191017", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191017", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191017", "story_v_out_115191.awb")
				end
	...
	Play115191018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115191018).content)
				uv0.text_.text = slot10
	...
	Play115191019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(115191019).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191019", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191019", "story_v_out_115191.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_115191", "115191019", "story_v_out_115191.awb")

						uv0:RecordAudio("115191019", slot10)
						uv0:RecordAudio("115191019", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191019", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191019", "story_v_out_115191.awb")
				end
	...
	Play115191020 = function (slot0, slot1)
		...
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115191020
		slot1.duration_ = 26.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(115191020).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191020", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191020", "story_v_out_115191.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_115191", "115191020", "story_v_out_115191.awb")

						uv0:RecordAudio("115191020", slot10)
						uv0:RecordAudio("115191020", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191020", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191020", "story_v_out_115191.awb")
				end
	...
	Play115191021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(115191021).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191021", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191021", "story_v_out_115191.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_115191", "115191021", "story_v_out_115191.awb")

						uv0:RecordAudio("115191021", slot18)
						uv0:RecordAudio("115191021", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191021", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191021", "story_v_out_115191.awb")
				end
	...
	Play115191022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1016ui_story, Vector3.New(-0.7, -0.95, -6.2), (uv0.time_ - slot10) / slot11)
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(-0.7, -0.95, -6.2)
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				if uv0.var_.characterEffect1016ui_story then
					uv0.var_.characterEffect1016ui_story.fillFlat = true
					uv0.var_.characterEffect1016ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot13) / slot14)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(115191022).content)
				uv0.text_.text = slot19

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (80 <= 0 and slot16 or slot16 * utf8.len(slot19) / slot20) > 0 and slot16 < slot22 then
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191022", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191022", "story_v_out_115191.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_115191", "115191022", "story_v_out_115191.awb")

						uv0:RecordAudio("115191022", slot24)
						uv0:RecordAudio("115191022", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191022", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191022", "story_v_out_115191.awb")
				end
	...
	Play115191023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(115191023).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191023", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191023", "story_v_out_115191.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_115191", "115191023", "story_v_out_115191.awb")

						uv0:RecordAudio("115191023", slot11)
						uv0:RecordAudio("115191023", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191023", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191023", "story_v_out_115191.awb")
				end
	...
	Play115191024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(115191024).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191024", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191024", "story_v_out_115191.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_115191", "115191024", "story_v_out_115191.awb")

						uv0:RecordAudio("115191024", slot13)
						uv0:RecordAudio("115191024", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191024", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191024", "story_v_out_115191.awb")
				end
	...
	Play115191025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115191025).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191025", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191025", "story_v_out_115191.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_115191", "115191025", "story_v_out_115191.awb")

						uv0:RecordAudio("115191025", slot15)
						uv0:RecordAudio("115191025", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191025", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191025", "story_v_out_115191.awb")
				end
	...
	Play115191026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(115191026).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191026", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191026", "story_v_out_115191.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_115191", "115191026", "story_v_out_115191.awb")

						uv0:RecordAudio("115191026", slot11)
						uv0:RecordAudio("115191026", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191026", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191026", "story_v_out_115191.awb")
				end
	...
	Play115191027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(115191027).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191027", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191027", "story_v_out_115191.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_115191", "115191027", "story_v_out_115191.awb")

						uv0:RecordAudio("115191027", slot17)
						uv0:RecordAudio("115191027", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191027", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191027", "story_v_out_115191.awb")
				end
	...
	Play115191028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115191028).content)
				uv0.text_.text = slot10
	...
	Play115191029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(115191029).content)
				uv0.text_.text = slot4
	...
	Play115191030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(115191030).content)
				uv0.text_.text = slot4
	...
	Play115191031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(115191031).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191031", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191031", "story_v_out_115191.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_115191", "115191031", "story_v_out_115191.awb")

						uv0:RecordAudio("115191031", slot18)
						uv0:RecordAudio("115191031", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191031", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191031", "story_v_out_115191.awb")
				end
	...
	Play115191032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(115191032).content)
	...
	Play115191033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(115191033).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191033", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191033", "story_v_out_115191.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_115191", "115191033", "story_v_out_115191.awb")

						uv0:RecordAudio("115191033", slot18)
						uv0:RecordAudio("115191033", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191033", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191033", "story_v_out_115191.awb")
				end
	...
	Play115191034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(115191034).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191034", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191034", "story_v_out_115191.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_115191", "115191034", "story_v_out_115191.awb")

						uv0:RecordAudio("115191034", slot21)
						uv0:RecordAudio("115191034", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191034", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191034", "story_v_out_115191.awb")
				end
	...
	Play115191035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(115191035).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191035", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191035", "story_v_out_115191.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_115191", "115191035", "story_v_out_115191.awb")

						uv0:RecordAudio("115191035", slot21)
						uv0:RecordAudio("115191035", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191035", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191035", "story_v_out_115191.awb")
				end
	...
	Play115191036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(115191036).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191036", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191036", "story_v_out_115191.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_115191", "115191036", "story_v_out_115191.awb")

						uv0:RecordAudio("115191036", slot17)
						uv0:RecordAudio("115191036", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191036", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191036", "story_v_out_115191.awb")
				end
	...
	Play115191037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1052ui_story, Vector3.New(0, -1.05, -6.2), (uv0.time_ - slot11) / slot12)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(115191037).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191037", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191037", "story_v_out_115191.awb") / 1000 + slot17 then
						uv0.duration_ = slot25 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_115191", "115191037", "story_v_out_115191.awb")

						uv0:RecordAudio("115191037", slot26)
						uv0:RecordAudio("115191037", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191037", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191037", "story_v_out_115191.awb")
				end
	...
	Play115191038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(115191038).content)
	...
	Play115191039 = function (slot0, slot1)
		...
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115191039
		slot1.duration_ = 20.966
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(115191039).content)
				uv0.text_.text = slot9

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (76 <= 0 and slot6 or slot6 * utf8.len(slot9) / slot10) > 0 and slot6 < slot12 then
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191039", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191039", "story_v_out_115191.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_115191", "115191039", "story_v_out_115191.awb")

						uv0:RecordAudio("115191039", slot14)
						uv0:RecordAudio("115191039", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191039", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191039", "story_v_out_115191.awb")
				end
	...
	Play115191040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(115191040).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191040", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191040", "story_v_out_115191.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_115191", "115191040", "story_v_out_115191.awb")

						uv0:RecordAudio("115191040", slot11)
						uv0:RecordAudio("115191040", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191040", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191040", "story_v_out_115191.awb")
				end
	...
	Play115191041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(115191041).content)
				uv0.text_.text = slot13
	...
	Play115191042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115191042).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_115191", "115191042", "story_v_out_115191.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115191", "115191042", "story_v_out_115191.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_115191", "115191042", "story_v_out_115191.awb")

						uv0:RecordAudio("115191042", slot15)
						uv0:RecordAudio("115191042", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115191", "115191042", "story_v_out_115191.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115191", "115191042", "story_v_out_115191.awb")
				end
