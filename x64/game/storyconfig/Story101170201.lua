return {
	Play117021001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(117021001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117021", "117021001", "story_v_out_117021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117021", "117021001", "story_v_out_117021.awb") / 1000 + slot7 then
						uv0.duration_ = slot16 + slot7
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_117021", "117021001", "story_v_out_117021.awb")

						uv0:RecordAudio("117021001", slot17)
						uv0:RecordAudio("117021001", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117021", "117021001", "story_v_out_117021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117021", "117021001", "story_v_out_117021.awb")
				end
	...
	Play117021002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021002
		slot1.duration_ = 8.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117021002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117021", "117021002", "story_v_out_117021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117021", "117021002", "story_v_out_117021.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117021", "117021002", "story_v_out_117021.awb")

						uv0:RecordAudio("117021002", slot10)
						uv0:RecordAudio("117021002", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117021", "117021002", "story_v_out_117021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117021", "117021002", "story_v_out_117021.awb")
				end
	...
	Play117021003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021003
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if uv0.bgs_.ST28_blur == nil then
			...
			if 4 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(117021003).content)
	...
	Play117021004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117021004).content)
	...
	Play117021005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117021005).content)
				uv0.text_.text = slot4
	...
	Play117021006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117021006).content)
				uv0.text_.text = slot4
	...
	Play117021007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021007
		slot1.duration_ = 9.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(117021007).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_117021", "117021007", "story_v_out_117021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117021", "117021007", "story_v_out_117021.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_117021", "117021007", "story_v_out_117021.awb")

						uv0:RecordAudio("117021007", slot17)
						uv0:RecordAudio("117021007", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117021", "117021007", "story_v_out_117021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117021", "117021007", "story_v_out_117021.awb")
				end
	...
	Play117021008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021008
		slot1.duration_ = 8.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117021008).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117021", "117021008", "story_v_out_117021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117021", "117021008", "story_v_out_117021.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117021", "117021008", "story_v_out_117021.awb")

						uv0:RecordAudio("117021008", slot10)
						uv0:RecordAudio("117021008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117021", "117021008", "story_v_out_117021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117021", "117021008", "story_v_out_117021.awb")
				end
	...
	Play117021009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117021009).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_117021", "117021009", "story_v_out_117021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117021", "117021009", "story_v_out_117021.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117021", "117021009", "story_v_out_117021.awb")

						uv0:RecordAudio("117021009", slot10)
						uv0:RecordAudio("117021009", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117021", "117021009", "story_v_out_117021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117021", "117021009", "story_v_out_117021.awb")
				end
	...
	Play117021010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117021010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(117021010).content)
