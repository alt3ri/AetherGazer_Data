return {
	Play910106001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910106001
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6 = uv0.actors_["1094"].transform

			if 1 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0.var_.moveOldPos1094 = slot6.localPosition
				slot6.localScale = Vector3.New(1, 1, 1)
				slot12 = 3

				uv0:CheckSpriteTmpPos("1094", slot12)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1094, Vector3.New(0, -350, -180), (uv0.time_ - slot7) / slot8)
			end
			...
			if 1 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if uv0.actors_["1094"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue1094 = slot11.alpha
					uv0.var_.characterEffect1094 = slot11
				end

				uv0.var_.alphaOldValue1094 = 0
			end

			slot11 = 0.5

			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				if uv0.var_.characterEffect1094 then
					uv0.var_.characterEffect1094.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1094, 1, (uv0.time_ - slot10) / slot11)
				end
			end

			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 and uv0.var_.characterEffect1094 then
				uv0.var_.characterEffect1094.alpha = 1
			end
			...
			if 1 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(910106001).content)
				uv0.text_.text = slot17

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (18 <= 0 and slot13 or slot13 * utf8.len(slot17) / slot18) > 0 and slot13 < slot20 then
	...
	Play910106002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910106002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(910106002).content)
	...
	Play910106003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910106003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.actors_["1094"].transform

			if 0.0666666666666667 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPos1094 = slot1.localPosition
				slot1.localScale = Vector3.New(1, 1, 1)
				slot7 = 3

				uv0:CheckSpriteTmpPos("1094", slot7)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1094, Vector3.New(0, -350, -180), (uv0.time_ - slot2) / slot3)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(910106003).content)
