return {
	Play102071001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot13 = 0.600000023841858

			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot15, slot16 = math.modf((uv0.time_ - slot12) / 0.066)
				slot11.localPosition = Vector3.New(slot16 * 0.13, slot16 * 0.13, slot16 * 0.13) + uv0.var_.shakeOldPosMainCamera
			end

			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = uv0.var_.shakeOldPosMainCamera
			end
			...
			if uv0.time_ >= slot14 + 0.400000023841858 and uv0.time_ < slot14 + slot15 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(102071001).content)
	...
	Play102071002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if not uv0.var_.effectMainCamera1048镜头前特效 then
					slot5 = Object.Instantiate(Asset.Load("Effect/Hero/1048/fx_1048_ui_001"))
					slot5.name = "1048镜头前特效"
					uv0.var_.effectMainCamera1048镜头前特效 = slot5
				end

				if slot3:Find("") then
					slot5.transform.parent = slot6
				else
					slot5.transform.parent = slot3
				end

				slot5.transform.localPosition = Vector3.New(0, 0, 0)
				slot5.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(102071002).content)
				uv0.text_.text = slot8

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (8 <= 0 and slot6 or slot6 * utf8.len(slot8) / slot9) > 0 and slot6 < slot11 then
	...
	Play102071003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(102071003).content)
	...
	Play102071004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102071004).content)
	...
	Play102071005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_3008")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071005", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071005", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071005", "story_v_out_102071.awb")

						uv0:RecordAudio("102071005", slot10)
						uv0:RecordAudio("102071005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071005", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071005", "story_v_out_102071.awb")
				end
	...
	Play102071006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071006
		slot1.duration_ = 2.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102071006).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071006", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071006", "story_v_out_102071.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102071", "102071006", "story_v_out_102071.awb")

						uv0:RecordAudio("102071006", slot12)
						uv0:RecordAudio("102071006", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071006", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071006", "story_v_out_102071.awb")
				end
	...
	Play102071007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071007
		slot1.duration_ = 3.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102071007).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071007", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071007", "story_v_out_102071.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102071", "102071007", "story_v_out_102071.awb")

						uv0:RecordAudio("102071007", slot12)
						uv0:RecordAudio("102071007", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071007", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071007", "story_v_out_102071.awb")
				end
	...
	Play102071008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071008
		slot1.duration_ = 3.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(102071008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071008", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071008", "story_v_out_102071.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102071", "102071008", "story_v_out_102071.awb")

						uv0:RecordAudio("102071008", slot11)
						uv0:RecordAudio("102071008", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071008", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071008", "story_v_out_102071.awb")
				end
	...
	Play102071009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(102071009).content)
				uv0.text_.text = slot4
	...
	Play102071010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071010).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071010", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071010", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071010", "story_v_out_102071.awb")

						uv0:RecordAudio("102071010", slot10)
						uv0:RecordAudio("102071010", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071010", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071010", "story_v_out_102071.awb")
				end
	...
	Play102071011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071011
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(102071011).content)
	...
	Play102071012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, -1.51, -4.3), (uv0.time_ - slot6) / slot7)
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(0, -1.51, -4.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(102071012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071012", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071012", "story_v_out_102071.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_102071", "102071012", "story_v_out_102071.awb")

						uv0:RecordAudio("102071012", slot19)
						uv0:RecordAudio("102071012", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071012", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071012", "story_v_out_102071.awb")
				end
	...
	Play102071014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(102071014).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071014", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071014", "story_v_out_102071.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102071", "102071014", "story_v_out_102071.awb")

						uv0:RecordAudio("102071014", slot25)
						uv0:RecordAudio("102071014", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071014", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071014", "story_v_out_102071.awb")
				end
	...
	Play102071015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102071015).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071015", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071015", "story_v_out_102071.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102071", "102071015", "story_v_out_102071.awb")

						uv0:RecordAudio("102071015", slot24)
						uv0:RecordAudio("102071015", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071015", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071015", "story_v_out_102071.awb")
				end
	...
	Play102071016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0.7, -1.51, -4.3), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0.7, -1.51, -4.3)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(102071016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071016", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071016", "story_v_out_102071.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_102071", "102071016", "story_v_out_102071.awb")

						uv0:RecordAudio("102071016", slot23)
						uv0:RecordAudio("102071016", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071016", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071016", "story_v_out_102071.awb")
				end
	...
	Play102071017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071017
		slot1.duration_ = 4.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102071017).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071017", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071017", "story_v_out_102071.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102071", "102071017", "story_v_out_102071.awb")

						uv0:RecordAudio("102071017", slot18)
						uv0:RecordAudio("102071017", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071017", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071017", "story_v_out_102071.awb")
				end
	...
	Play102071018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102071018).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071018", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071018", "story_v_out_102071.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102071", "102071018", "story_v_out_102071.awb")

						uv0:RecordAudio("102071018", slot24)
						uv0:RecordAudio("102071018", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071018", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071018", "story_v_out_102071.awb")
				end
	...
	Play102071019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071019
		slot1.duration_ = 3.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(102071019).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071019", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071019", "story_v_out_102071.awb") / 1000 + slot9 then
						uv0.duration_ = slot18 + slot9
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_102071", "102071019", "story_v_out_102071.awb")

						uv0:RecordAudio("102071019", slot19)
						uv0:RecordAudio("102071019", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071019", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071019", "story_v_out_102071.awb")
				end
	...
	Play102071020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102071020).content)
				uv0.text_.text = slot13

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (23 <= 0 and slot11 or slot11 * utf8.len(slot13) / slot14) > 0 and slot11 < slot16 then
					uv0.talkMaxDuration = slot16
	...
	Play102071023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071023
		slot1.duration_ = 6.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(102071023).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071023", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071023", "story_v_out_102071.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_102071", "102071023", "story_v_out_102071.awb")

						uv0:RecordAudio("102071023", slot15)
						uv0:RecordAudio("102071023", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071023", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071023", "story_v_out_102071.awb")
				end
	...
	Play102071024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071024
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_2", "se_story_2_stun", "")
			end
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0.var_.moveOldPosS0203 = uv0.bgs_.S0203.transform.localPosition
			end

			slot8 = 0.001

			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPosS0203, Vector3.New(0, -100, 10), (uv0.time_ - slot7) / slot8)
			end

			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(0, -100, 10)
			end
			...
			slot12 = uv0.bgs_.STwhite.transform

			if 1.5 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPosSTwhite = slot12.localPosition
				slot12.localScale = Vector3.New(20, 20, 20)
			end

			slot14 = 0.001

			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPosSTwhite, Vector3.New(0, 0, 0), (uv0.time_ - slot13) / slot14)
			end

			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(0, 0, 0)
			end
			...
			if uv0.time_ >= slot15 + 1.534 and uv0.time_ < slot15 + slot16 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(102071024).content)
				uv0.text_.text = slot20

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (5 <= 0 and slot18 or slot18 * utf8.len(slot20) / slot21) > 0 and slot18 < slot23 then
					uv0.talkMaxDuration = slot23
	...
	Play102071025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071025
		slot1.duration_ = 4.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071025).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071025", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071025", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071025", "story_v_out_102071.awb")

						uv0:RecordAudio("102071025", slot10)
						uv0:RecordAudio("102071025", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071025", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071025", "story_v_out_102071.awb")
				end
	...
	Play102071026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071026
		slot1.duration_ = 2.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071026).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071026", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071026", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071026", "story_v_out_102071.awb")

						uv0:RecordAudio("102071026", slot10)
						uv0:RecordAudio("102071026", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071026", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071026", "story_v_out_102071.awb")
				end
	...
	Play102071027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071027
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071027).content)
				uv0.text_.text = slot5
	...
	Play102071028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071028
		slot1.duration_ = 6.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071028).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071028", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071028", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071028", "story_v_out_102071.awb")

						uv0:RecordAudio("102071028", slot10)
						uv0:RecordAudio("102071028", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071028", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071028", "story_v_out_102071.awb")
				end
	...
	Play102071029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071029
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPosSTwhite, Vector3.New(0, -100, 10), (uv0.time_ - slot2) / slot3)
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102071029).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071029", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071029", "story_v_out_102071.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102071", "102071029", "story_v_out_102071.awb")

						uv0:RecordAudio("102071029", slot18)
						uv0:RecordAudio("102071029", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071029", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071029", "story_v_out_102071.awb")
				end
	...
	Play102071030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071030
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071030).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071030", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071030", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071030", "story_v_out_102071.awb")

						uv0:RecordAudio("102071030", slot10)
						uv0:RecordAudio("102071030", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071030", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071030", "story_v_out_102071.awb")
				end
	...
	Play102071031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071031
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071031).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071031", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071031", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071031", "story_v_out_102071.awb")

						uv0:RecordAudio("102071031", slot10)
						uv0:RecordAudio("102071031", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071031", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071031", "story_v_out_102071.awb")
				end
	...
	Play102071032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071032
		slot1.duration_ = 4.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071032).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071032", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071032", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071032", "story_v_out_102071.awb")

						uv0:RecordAudio("102071032", slot10)
						uv0:RecordAudio("102071032", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071032", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071032", "story_v_out_102071.awb")
				end
	...
	Play102071033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071033
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071033).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071033", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071033", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071033", "story_v_out_102071.awb")

						uv0:RecordAudio("102071033", slot10)
						uv0:RecordAudio("102071033", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071033", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071033", "story_v_out_102071.awb")
				end
	...
	Play102071034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071034
		slot1.duration_ = 2.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071034).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071034", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071034", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071034", "story_v_out_102071.awb")

						uv0:RecordAudio("102071034", slot10)
						uv0:RecordAudio("102071034", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071034", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071034", "story_v_out_102071.awb")
				end
	...
	Play102071035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071035
		slot1.duration_ = 6.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story", "se_story_loop_stop", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102071035).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071035", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071035", "story_v_out_102071.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102071", "102071035", "story_v_out_102071.awb")

						uv0:RecordAudio("102071035", slot12)
						uv0:RecordAudio("102071035", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071035", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071035", "story_v_out_102071.awb")
				end
	...
	Play102071036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071036
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(102071036).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071036", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071036", "story_v_out_102071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102071", "102071036", "story_v_out_102071.awb")

						uv0:RecordAudio("102071036", slot10)
						uv0:RecordAudio("102071036", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071036", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071036", "story_v_out_102071.awb")
				end
	...
	Play102071037 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071037
		slot1.duration_ = 5.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(-0.7, -0.55, -0.3), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(-0.7, -0.55, -0.3)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[46].name)
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(102071037).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071037", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071037", "story_v_out_102071.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102071", "102071037", "story_v_out_102071.awb")

						uv0:RecordAudio("102071037", slot20)
						uv0:RecordAudio("102071037", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071037", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071037", "story_v_out_102071.awb")
				end
	...
	Play102071038 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071038
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2021_tpose, Vector3.New(1.92, -0.6, 0.2), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(1.92, -0.6, 0.2)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(102071038).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071038", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071038", "story_v_out_102071.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102071", "102071038", "story_v_out_102071.awb")

						uv0:RecordAudio("102071038", slot20)
						uv0:RecordAudio("102071038", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071038", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071038", "story_v_out_102071.awb")
				end
	...
	Play102071039 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102071039
		slot1.duration_ = 3.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.characterEffect2022_tpose == nil then
				uv0.var_.characterEffect2022_tpose = uv0.actors_["2022_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				if uv0.var_.characterEffect2022_tpose then
					...
					uv0.var_.characterEffect2022_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot2) / slot3)
				end
			end

			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 and uv0.var_.characterEffect2022_tpose then
				uv0.var_.characterEffect2022_tpose.fillFlat = true
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.characterEffect2021_tpose then
					...
					uv0.var_.characterEffect2021_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot5) / slot6)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(102071039).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_102071", "102071039", "story_v_out_102071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102071", "102071039", "story_v_out_102071.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_102071", "102071039", "story_v_out_102071.awb")

						uv0:RecordAudio("102071039", slot16)
						uv0:RecordAudio("102071039", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102071", "102071039", "story_v_out_102071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102071", "102071039", "story_v_out_102071.awb")
				end
