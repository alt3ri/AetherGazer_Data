return {
	Play711390201 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390201
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.0334 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv1.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1027")
				uv1.narr_item_content.text = uv0:FormatText(uv0:GetWordFromCfg(711390201).content)
	...
	Play711390202 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390202
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1139")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390202).content)
	...
	Play711390203 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390203
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390203).content)
	...
	Play711390204 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390204
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1027")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390204).content)
	...
	Play711390205 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390205
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1139")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390205).content)
	...
	Play711390206 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390206
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1139")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390206).content)
	...
	Play711390207 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390207
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1139")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390207).content)
	...
	Play711390208 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390208
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1027")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390208).content)
	...
	Play711390209 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390209
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1139")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390209).content)
	...
	Play711390210 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390210
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1027")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390210).content)
	...
	Play711390211 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390211
		slot1.duration_ = 0.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1139")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390211).content)
	...
	Play711390212 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 711390212
		slot1.duration_ = 1.033399999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1027")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(711390212).content)
