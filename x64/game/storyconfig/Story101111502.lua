return {
	Play111152001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if uv0.time_ >= slot6 + 2.1 and uv0.time_ < slot6 + slot7 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111152001).content)
	...
	Play111152002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111152002).content)
	...
	Play111152003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152003
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111152003).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152003", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152003", "story_v_out_111152.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_111152", "111152003", "story_v_out_111152.awb")

						uv0:RecordAudio("111152003", slot19)
						uv0:RecordAudio("111152003", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152003", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152003", "story_v_out_111152.awb")
				end
	...
	Play111152004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0:PlayTimeline("1048ui_story", "StoryTimeline/CharAction/1048/1048action/1048action8_1")
			end

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0:PlayTimeline("1048ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1103cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(111152004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152004", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152004", "story_v_out_111152.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_111152", "111152004", "story_v_out_111152.awb")

						uv0:RecordAudio("111152004", slot22)
						uv0:RecordAudio("111152004", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152004", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152004", "story_v_out_111152.awb")
				end
	...
	Play111152005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111152005).content)
				uv0.text_.text = slot14
	...
	Play111152006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111152006).content)
				uv0.text_.text = slot4
	...
	Play111152007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152007
		slot1.duration_ = 2.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111152007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152007", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152007", "story_v_out_111152.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_111152", "111152007", "story_v_out_111152.awb")

						uv0:RecordAudio("111152007", slot13)
						uv0:RecordAudio("111152007", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152007", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152007", "story_v_out_111152.awb")
				end
	...
	Play111152008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152008
		slot1.duration_ = 1.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111152008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152008", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152008", "story_v_out_111152.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111152", "111152008", "story_v_out_111152.awb")

						uv0:RecordAudio("111152008", slot10)
						uv0:RecordAudio("111152008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152008", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152008", "story_v_out_111152.awb")
				end
	...
	Play111152009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111152009).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152009", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152009", "story_v_out_111152.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111152", "111152009", "story_v_out_111152.awb")

						uv0:RecordAudio("111152009", slot10)
						uv0:RecordAudio("111152009", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152009", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152009", "story_v_out_111152.awb")
				end
	...
	Play111152010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111152010).content)
				uv0.text_.text = slot8
	...
	Play111152011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152011
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111152011).content)
	...
	Play111152012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152012
		slot1.duration_ = 3.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111152012).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152012", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152012", "story_v_out_111152.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111152", "111152012", "story_v_out_111152.awb")

						uv0:RecordAudio("111152012", slot10)
						uv0:RecordAudio("111152012", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152012", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152012", "story_v_out_111152.awb")
				end
	...
	Play111152013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152013
		slot1.duration_ = 2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111152013).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152013", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152013", "story_v_out_111152.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111152", "111152013", "story_v_out_111152.awb")

						uv0:RecordAudio("111152013", slot18)
						uv0:RecordAudio("111152013", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152013", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152013", "story_v_out_111152.awb")
				end
	...
	Play111152014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152014
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111152014).content)
				uv0.text_.text = slot8
	...
	Play111152015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111152015).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152015", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152015", "story_v_out_111152.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_111152", "111152015", "story_v_out_111152.awb")

						uv0:RecordAudio("111152015", slot19)
						uv0:RecordAudio("111152015", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152015", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152015", "story_v_out_111152.awb")
				end
	...
	Play111152016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111152016).content)
				uv0.text_.text = slot8
	...
	Play111152017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111152017).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152017", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152017", "story_v_out_111152.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111152", "111152017", "story_v_out_111152.awb")

						uv0:RecordAudio("111152017", slot14)
						uv0:RecordAudio("111152017", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152017", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152017", "story_v_out_111152.awb")
				end
	...
	Play111152018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152018
		slot1.duration_ = 5.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(111152018).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152018", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152018", "story_v_out_111152.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_111152", "111152018", "story_v_out_111152.awb")

						uv0:RecordAudio("111152018", slot22)
						uv0:RecordAudio("111152018", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152018", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152018", "story_v_out_111152.awb")
				end
	...
	Play111152019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152019
		slot1.duration_ = 5.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(111152019).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152019", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152019", "story_v_out_111152.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_111152", "111152019", "story_v_out_111152.awb")

						uv0:RecordAudio("111152019", slot24)
						uv0:RecordAudio("111152019", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152019", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152019", "story_v_out_111152.awb")
				end
	...
	Play111152020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1039ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot9) / slot10)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(111152020).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152020", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152020", "story_v_out_111152.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_111152", "111152020", "story_v_out_111152.awb")

						uv0:RecordAudio("111152020", slot24)
						uv0:RecordAudio("111152020", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152020", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152020", "story_v_out_111152.awb")
				end
	...
	Play111152021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152021
		slot1.duration_ = 6.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("1048ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1301cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 and uv0.var_.characterEffect1094ui_story == nil then
				uv0.var_.characterEffect1094ui_story = uv0.actors_["1094ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				if uv0.var_.characterEffect1094ui_story then
					uv0.var_.characterEffect1094ui_story.fillFlat = true
					uv0.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot13) / slot14)
				end
			end

			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 and uv0.var_.characterEffect1094ui_story then
				uv0.var_.characterEffect1094ui_story.fillFlat = true
				uv0.var_.characterEffect1094ui_story.fillRatio = 0.5
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(111152021).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152021", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152021", "story_v_out_111152.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_111152", "111152021", "story_v_out_111152.awb")

						uv0:RecordAudio("111152021", slot24)
						uv0:RecordAudio("111152021", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152021", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152021", "story_v_out_111152.awb")
				end
	...
	Play111152022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111152022).content)
				uv0.text_.text = slot8
	...
	Play111152023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152023
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111152023).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_111152", "111152023", "story_v_out_111152.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111152", "111152023", "story_v_out_111152.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111152", "111152023", "story_v_out_111152.awb")

						uv0:RecordAudio("111152023", slot18)
						uv0:RecordAudio("111152023", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111152", "111152023", "story_v_out_111152.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111152", "111152023", "story_v_out_111152.awb")
				end
	...
	Play111152024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152024
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111152024).content)
	...
	Play111152025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111152025
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111152025).content)
				uv0.text_.text = slot4
