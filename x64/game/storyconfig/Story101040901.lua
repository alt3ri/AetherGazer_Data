return {
	Play104091001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if uv0.bgs_.B04c:GetComponent("SpriteRenderer") then
					slot8.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot9 = slot8.material
					uv0.var_.alphaOldValueB04c = slot9:GetColor("_Color").a
					uv0.var_.alphaMatValueB04c = slot9
				end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueB04c then
					slot11 = uv0.var_.alphaMatValueB04c
					slot12 = slot11:GetColor("_Color")
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueB04c, 1, (uv0.time_ - slot7) / slot8)

					slot11:SetColor("_Color", slot12)
				end
			end

			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 and uv0.var_.alphaMatValueB04c then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104091001).content)
	...
	Play104091002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104091002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091002", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091002", "story_v_out_104091.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104091", "104091002", "story_v_out_104091.awb")

						uv0:RecordAudio("104091002", slot19)
						uv0:RecordAudio("104091002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091002", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091002", "story_v_out_104091.awb")
				end
	...
	Play104091003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091003
		slot1.duration_ = 4.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(104091003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091003", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091003", "story_v_out_104091.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104091", "104091003", "story_v_out_104091.awb")

						uv0:RecordAudio("104091003", slot22)
						uv0:RecordAudio("104091003", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091003", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091003", "story_v_out_104091.awb")
				end
	...
	Play104091004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(104091004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091004", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091004", "story_v_out_104091.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_104091", "104091004", "story_v_out_104091.awb")

						uv0:RecordAudio("104091004", slot11)
						uv0:RecordAudio("104091004", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091004", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091004", "story_v_out_104091.awb")
				end
	...
	Play104091005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(104091005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091005", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091005", "story_v_out_104091.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_104091", "104091005", "story_v_out_104091.awb")

						uv0:RecordAudio("104091005", slot28)
						uv0:RecordAudio("104091005", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091005", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091005", "story_v_out_104091.awb")
				end
	...
	Play104091006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(104091006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091006", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091006", "story_v_out_104091.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_104091", "104091006", "story_v_out_104091.awb")

						uv0:RecordAudio("104091006", slot25)
						uv0:RecordAudio("104091006", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091006", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091006", "story_v_out_104091.awb")
				end
	...
	Play104091007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(104091007).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091007", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091007", "story_v_out_104091.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104091", "104091007", "story_v_out_104091.awb")

						uv0:RecordAudio("104091007", slot22)
						uv0:RecordAudio("104091007", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091007", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091007", "story_v_out_104091.awb")
				end
	...
	Play104091008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104091008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091008", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091008", "story_v_out_104091.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104091", "104091008", "story_v_out_104091.awb")

						uv0:RecordAudio("104091008", slot24)
						uv0:RecordAudio("104091008", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091008", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091008", "story_v_out_104091.awb")
				end
	...
	Play104091009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("10001_tpose", "StoryTimeline/CharAction/story10001/story10001actionlink/10001action434")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104091009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091009", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091009", "story_v_out_104091.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104091", "104091009", "story_v_out_104091.awb")

						uv0:RecordAudio("104091009", slot18)
						uv0:RecordAudio("104091009", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091009", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091009", "story_v_out_104091.awb")
				end
	...
	Play104091010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104091010).content)
				uv0.text_.text = slot13
	...
	Play104091011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091011
		slot1.duration_ = 13
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(-0.7, -1.23, -5.8), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(-0.7, -1.23, -5.8)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("10001_tpose", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface2104cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104091011).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091011", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091011", "story_v_out_104091.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104091", "104091011", "story_v_out_104091.awb")

						uv0:RecordAudio("104091011", slot18)
						uv0:RecordAudio("104091011", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091011", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091011", "story_v_out_104091.awb")
				end
	...
	Play104091012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104091012).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091012", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091012", "story_v_out_104091.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104091", "104091012", "story_v_out_104091.awb")

						uv0:RecordAudio("104091012", slot21)
						uv0:RecordAudio("104091012", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091012", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091012", "story_v_out_104091.awb")
				end
	...
	Play104091013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091013
		slot1.duration_ = 9.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104091013).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091013", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091013", "story_v_out_104091.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104091", "104091013", "story_v_out_104091.awb")

						uv0:RecordAudio("104091013", slot18)
						uv0:RecordAudio("104091013", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091013", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091013", "story_v_out_104091.awb")
				end
	...
	Play104091014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(104091014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091014", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091014", "story_v_out_104091.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_104091", "104091014", "story_v_out_104091.awb")

						uv0:RecordAudio("104091014", slot27)
						uv0:RecordAudio("104091014", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091014", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091014", "story_v_out_104091.awb")
				end
	...
	Play104091015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104091015).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091015", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091015", "story_v_out_104091.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104091", "104091015", "story_v_out_104091.awb")

						uv0:RecordAudio("104091015", slot21)
						uv0:RecordAudio("104091015", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091015", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091015", "story_v_out_104091.awb")
				end
	...
	Play104091016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104091016).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091016", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091016", "story_v_out_104091.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104091", "104091016", "story_v_out_104091.awb")

						uv0:RecordAudio("104091016", slot24)
						uv0:RecordAudio("104091016", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091016", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091016", "story_v_out_104091.awb")
				end
	...
	Play104091017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091017
		slot1.duration_ = 5.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(104091017).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091017", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091017", "story_v_out_104091.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_104091", "104091017", "story_v_out_104091.awb")

						uv0:RecordAudio("104091017", slot27)
						uv0:RecordAudio("104091017", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091017", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091017", "story_v_out_104091.awb")
				end
	...
	Play104091018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[62].name)
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(104091018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091018", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091018", "story_v_out_104091.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_104091", "104091018", "story_v_out_104091.awb")

						uv0:RecordAudio("104091018", slot16)
						uv0:RecordAudio("104091018", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091018", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091018", "story_v_out_104091.awb")
				end
	...
	Play104091019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104091019
		slot1.duration_ = 2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(104091019).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_104091", "104091019", "story_v_out_104091.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104091", "104091019", "story_v_out_104091.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_104091", "104091019", "story_v_out_104091.awb")

						uv0:RecordAudio("104091019", slot16)
						uv0:RecordAudio("104091019", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104091", "104091019", "story_v_out_104091.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104091", "104091019", "story_v_out_104091.awb")
				end
