return {
	Play108061001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.S0802:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueS0802 = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueS0802 = slot6
				end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueS0802 then
					...
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueS0802, 1, (uv0.time_ - slot4) / slot5)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(108061001).content)
				uv0.text_.text = slot15

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (14 <= 0 and slot11 or slot11 * utf8.len(slot15) / slot16) > 0 and slot11 < slot18 then
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061001", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061001", "story_v_out_108061.awb") / 1000 + slot10 then
						uv0.duration_ = slot19 + slot10
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_108061", "108061001", "story_v_out_108061.awb")

						uv0:RecordAudio("108061001", slot20)
						uv0:RecordAudio("108061001", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061001", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061001", "story_v_out_108061.awb")
				end
	...
	Play108061002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061002", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061002", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061002", "story_v_out_108061.awb")

						uv0:RecordAudio("108061002", slot10)
						uv0:RecordAudio("108061002", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061002", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061002", "story_v_out_108061.awb")
				end
	...
	Play108061003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(108061003).content)
	...
	Play108061004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061004).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061004", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061004", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061004", "story_v_out_108061.awb")

						uv0:RecordAudio("108061004", slot10)
						uv0:RecordAudio("108061004", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061004", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061004", "story_v_out_108061.awb")
				end
	...
	Play108061005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061005).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061005", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061005", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061005", "story_v_out_108061.awb")

						uv0:RecordAudio("108061005", slot10)
						uv0:RecordAudio("108061005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061005", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061005", "story_v_out_108061.awb")
				end
	...
	Play108061006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061006).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061006", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061006", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061006", "story_v_out_108061.awb")

						uv0:RecordAudio("108061006", slot10)
						uv0:RecordAudio("108061006", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061006", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061006", "story_v_out_108061.awb")
				end
	...
	Play108061007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061007).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061007", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061007", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061007", "story_v_out_108061.awb")

						uv0:RecordAudio("108061007", slot10)
						uv0:RecordAudio("108061007", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061007", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061007", "story_v_out_108061.awb")
				end
	...
	Play108061008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061008).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061008", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061008", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061008", "story_v_out_108061.awb")

						uv0:RecordAudio("108061008", slot10)
						uv0:RecordAudio("108061008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061008", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061008", "story_v_out_108061.awb")
				end
	...
	Play108061009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061009).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061009", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061009", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061009", "story_v_out_108061.awb")

						uv0:RecordAudio("108061009", slot10)
						uv0:RecordAudio("108061009", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061009", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061009", "story_v_out_108061.awb")
				end
	...
	Play108061010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061010).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061010", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061010", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061010", "story_v_out_108061.awb")

						uv0:RecordAudio("108061010", slot10)
						uv0:RecordAudio("108061010", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061010", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061010", "story_v_out_108061.awb")
				end
	...
	Play108061011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(108061011).content)
				uv0.text_.text = slot4
	...
	Play108061012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061012).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061012", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061012", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061012", "story_v_out_108061.awb")

						uv0:RecordAudio("108061012", slot10)
						uv0:RecordAudio("108061012", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061012", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061012", "story_v_out_108061.awb")
				end
	...
	Play108061013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.S0803:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueS0803 = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueS0803 = slot6
				end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueS0803 then
					...
					slot9 = slot8:GetColor("_Color")
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueS0803, 1, (uv0.time_ - slot4) / slot5)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if uv0.bgs_.S0802:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueS0802 = slot9:GetColor("_Color").a
					uv0.var_.alphaMatValueS0802 = slot9
				end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueS0802 then
					...
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueS0802, 0, (uv0.time_ - slot7) / slot8)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.var_.moveOldPosS0802 = uv0.bgs_.S0802.transform.localPosition
			end
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(108061013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061013", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061013", "story_v_out_108061.awb") / 1000 + slot14 then
						uv0.duration_ = slot23 + slot14
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_108061", "108061013", "story_v_out_108061.awb")

						uv0:RecordAudio("108061013", slot24)
						uv0:RecordAudio("108061013", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061013", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061013", "story_v_out_108061.awb")
				end
	...
	Play108061014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061014).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061014", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061014", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061014", "story_v_out_108061.awb")

						uv0:RecordAudio("108061014", slot10)
						uv0:RecordAudio("108061014", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061014", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061014", "story_v_out_108061.awb")
				end
	...
	Play108061015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(108061015).content)
				uv0.text_.text = slot4
	...
	Play108061016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061016).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061016", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061016", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061016", "story_v_out_108061.awb")

						uv0:RecordAudio("108061016", slot10)
						uv0:RecordAudio("108061016", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061016", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061016", "story_v_out_108061.awb")
				end
	...
	Play108061017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061017).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061017", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061017", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061017", "story_v_out_108061.awb")

						uv0:RecordAudio("108061017", slot10)
						uv0:RecordAudio("108061017", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061017", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061017", "story_v_out_108061.awb")
				end
	...
	Play108061018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061018).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061018", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061018", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061018", "story_v_out_108061.awb")

						uv0:RecordAudio("108061018", slot10)
						uv0:RecordAudio("108061018", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061018", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061018", "story_v_out_108061.awb")
				end
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.S0803:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueS0803 = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueS0803 = slot7
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueS0803 then
					...
					slot10 = slot9:GetColor("_Color")
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueS0803, 0, (uv0.time_ - slot5) / slot6)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				if uv0.bgs_.C06c:GetComponent("SpriteRenderer") then
					slot9.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot10 = slot9.material
					uv0.var_.alphaOldValueC06c = slot10:GetColor("_Color").a
					uv0.var_.alphaMatValueC06c = slot10
				end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				if uv0.var_.alphaMatValueC06c then
					...
					slot13.a = Mathf.Lerp(uv0.var_.alphaOldValueC06c, 1, (uv0.time_ - slot8) / slot9)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(108061019).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061019", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061019", "story_v_out_108061.awb") / 1000 + slot21 then
						uv0.duration_ = slot30 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_108061", "108061019", "story_v_out_108061.awb")

						uv0:RecordAudio("108061019", slot31)
						uv0:RecordAudio("108061019", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061019", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061019", "story_v_out_108061.awb")
				end
	...
	Play108061020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(108061020).content)
	...
	Play108061021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_3014")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061021).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061021", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061021", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061021", "story_v_out_108061.awb")

						uv0:RecordAudio("108061021", slot10)
						uv0:RecordAudio("108061021", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061021", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061021", "story_v_out_108061.awb")
				end
	...
	Play108061022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(108061022).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061022", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061022", "story_v_out_108061.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_108061", "108061022", "story_v_out_108061.awb")

						uv0:RecordAudio("108061022", slot19)
						uv0:RecordAudio("108061022", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061022", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061022", "story_v_out_108061.awb")
				end
	...
	Play108061023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3014_tpose, Vector3.New(0, -2.35, -2.9), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(0, -2.35, -2.9)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(108061023).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061023", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061023", "story_v_out_108061.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_108061", "108061023", "story_v_out_108061.awb")

						uv0:RecordAudio("108061023", slot21)
						uv0:RecordAudio("108061023", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061023", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061023", "story_v_out_108061.awb")
				end
	...
	Play108061024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(108061024).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061024", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061024", "story_v_out_108061.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_108061", "108061024", "story_v_out_108061.awb")

						uv0:RecordAudio("108061024", slot20)
						uv0:RecordAudio("108061024", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061024", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061024", "story_v_out_108061.awb")
				end
	...
	Play108061025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3014_tpose, Vector3.New(0, -2.35, -2.9), (uv0.time_ - slot2) / slot3)
				slot7 = manager.ui.mainCamera.transform.position - slot1.position
				slot1.forward = Vector3.New(slot7.x, slot7.y, slot7.z)
				slot8 = slot1.localEulerAngles
				slot8.z = 0
			...
			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 then
				slot1.localPosition = Vector3.New(0, -2.35, -2.9)
				slot6 = manager.ui.mainCamera.transform.position - slot1.position
				slot1.forward = Vector3.New(slot6.x, slot6.y, slot6.z)
				slot7 = slot1.localEulerAngles
				slot7.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(108061025).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061025", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061025", "story_v_out_108061.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_108061", "108061025", "story_v_out_108061.awb")

						uv0:RecordAudio("108061025", slot20)
						uv0:RecordAudio("108061025", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061025", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061025", "story_v_out_108061.awb")
				end
	...
	Play108061026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(108061026).content)
				uv0.text_.text = slot7
	...
	Play108061027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(108061027).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061027", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061027", "story_v_out_108061.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_108061", "108061027", "story_v_out_108061.awb")

						uv0:RecordAudio("108061027", slot13)
						uv0:RecordAudio("108061027", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061027", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061027", "story_v_out_108061.awb")
				end
	...
	Play108061028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(108061028).content)
				uv0.text_.text = slot7
	...
	Play108061029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(108061029).content)
				uv0.text_.text = slot4
	...
	Play108061030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(108061030).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061030", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061030", "story_v_out_108061.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_108061", "108061030", "story_v_out_108061.awb")

						uv0:RecordAudio("108061030", slot13)
						uv0:RecordAudio("108061030", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061030", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061030", "story_v_out_108061.awb")
				end
	...
	Play108061031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061031).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061031", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061031", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061031", "story_v_out_108061.awb")

						uv0:RecordAudio("108061031", slot10)
						uv0:RecordAudio("108061031", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061031", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061031", "story_v_out_108061.awb")
				end
	...
	Play108061032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(108061032).content)
				uv0.text_.text = slot7
	...
	Play108061033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(108061033).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061033", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061033", "story_v_out_108061.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_108061", "108061033", "story_v_out_108061.awb")

						uv0:RecordAudio("108061033", slot21)
						uv0:RecordAudio("108061033", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061033", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061033", "story_v_out_108061.awb")
				end
	...
	Play108061034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(108061034).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061034", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061034", "story_v_out_108061.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_108061", "108061034", "story_v_out_108061.awb")

						uv0:RecordAudio("108061034", slot19)
						uv0:RecordAudio("108061034", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061034", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061034", "story_v_out_108061.awb")
				end
	...
	Play108061035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061035).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061035", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061035", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061035", "story_v_out_108061.awb")

						uv0:RecordAudio("108061035", slot10)
						uv0:RecordAudio("108061035", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061035", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061035", "story_v_out_108061.awb")
				end
	...
	Play108061036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061036).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061036", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061036", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061036", "story_v_out_108061.awb")

						uv0:RecordAudio("108061036", slot10)
						uv0:RecordAudio("108061036", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061036", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061036", "story_v_out_108061.awb")
				end
	...
	Play108061037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(108061037).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_108061", "108061037", "story_v_out_108061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_108061", "108061037", "story_v_out_108061.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108061", "108061037", "story_v_out_108061.awb")

						uv0:RecordAudio("108061037", slot10)
						uv0:RecordAudio("108061037", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_108061", "108061037", "story_v_out_108061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_108061", "108061037", "story_v_out_108061.awb")
				end
