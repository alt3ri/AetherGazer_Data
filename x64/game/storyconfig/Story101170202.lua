return {
	Play117022001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117022001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(117022001).content)
	...
	Play117022002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117022002
		slot1.duration_ = 5.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if uv0.actors_["1033"]:GetComponentInChildren(typeof(CanvasGroup)) then
					uv0.var_.alphaOldValue1033 = slot4.alpha
					uv0.var_.characterEffect1033 = slot4
				end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.characterEffect1033 then
					uv0.var_.characterEffect1033.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1033, 1, (uv0.time_ - slot3) / slot4)
				end
			end

			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.characterEffect1033 then
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033, Vector3.New(0, -420, 0), (uv0.time_ - slot6) / slot7)
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				...
				if uv0.var_.actorSpriteComps1033 then
					slot14 = uv0.var_.actorSpriteComps1033
					slot16 = slot14
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(117022002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117022", "117022002", "story_v_out_117022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117022", "117022002", "story_v_out_117022.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_117022", "117022002", "story_v_out_117022.awb")

						uv0:RecordAudio("117022002", slot20)
						uv0:RecordAudio("117022002", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117022", "117022002", "story_v_out_117022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117022", "117022002", "story_v_out_117022.awb")
				end
	...
	Play117022003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117022003
		slot1.duration_ = 5.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.6 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(117022003).content)
				uv0.text_.text = slot15
	...
	Play117022004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117022004
		slot1.duration_ = 2.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				if uv0.var_.characterEffect1033 then
					uv0.var_.characterEffect1033.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1033, 1, (uv0.time_ - slot2) / slot3)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(117022004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117022", "117022004", "story_v_out_117022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117022", "117022004", "story_v_out_117022.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117022", "117022004", "story_v_out_117022.awb")

						uv0:RecordAudio("117022004", slot19)
						uv0:RecordAudio("117022004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117022", "117022004", "story_v_out_117022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117022", "117022004", "story_v_out_117022.awb")
				end
	...
	Play117022005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117022005
		slot1.duration_ = 9
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play117022006(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.TI0102 == nil then
				slot2 = Object.Instantiate(uv0.paintGo_)
				slot2:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. slot1)
				slot2.name = slot1
				slot2.transform.parent = uv0.stage_.transform
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				if uv0.var_.characterEffect1033 then
					uv0.var_.characterEffect1033.alpha = Mathf.Lerp(uv0.var_.alphaOldValue1033, 0, (uv0.time_ - slot8) / slot9)
				end
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPosTI0102 = uv0.bgs_.TI0102.transform.localPosition
			end

			slot12 = 0.001

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPosTI0102, Vector3.New(-0.5, -1, 1), (uv0.time_ - slot11) / slot12)
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(-0.5, -1, 1)
			end
			...
			slot15 = 2.73333333333333

			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPosTI0102, Vector3.New(-0.5, -0.5, 1), (uv0.time_ - slot14) / slot15)
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(-0.5, -0.5, 1)
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(117022005).content)
	...
	Play117022006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117022006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(117022006).content)
	...
	Play117022007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117022007
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(117022007).content)
	...
	Play117022008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 117022008
		slot1.duration_ = 2.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1033")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(117022008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_117022", "117022008", "story_v_out_117022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_117022", "117022008", "story_v_out_117022.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117022", "117022008", "story_v_out_117022.awb")

						uv0:RecordAudio("117022008", slot10)
						uv0:RecordAudio("117022008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_117022", "117022008", "story_v_out_117022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_117022", "117022008", "story_v_out_117022.awb")
				end
