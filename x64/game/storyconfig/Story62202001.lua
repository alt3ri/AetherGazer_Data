return {
	Play62202001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62202001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(62202001).content)
				uv0.text_.text = slot23

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (18 <= 0 and slot19 or slot19 * utf8.len(slot23) / slot24) > 0 and slot19 < slot26 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62202", "62202001", "story_v_chess_62202.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62202", "62202001", "story_v_chess_62202.awb") / 1000 + slot18 then
						uv0.duration_ = slot27 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_chess_62202", "62202001", "story_v_chess_62202.awb")

						uv0:RecordAudio("62202001", slot28)
						uv0:RecordAudio("62202001", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62202", "62202001", "story_v_chess_62202.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62202", "62202001", "story_v_chess_62202.awb")
				end
	...
	Play62202002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62202002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62202002).content)
	...
	Play62202003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62202003
		slot1.duration_ = 3.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(62202003).content)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62202", "62202003", "story_v_chess_62202.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62202", "62202003", "story_v_chess_62202.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_chess_62202", "62202003", "story_v_chess_62202.awb")

						uv0:RecordAudio("62202003", slot15)
						uv0:RecordAudio("62202003", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62202", "62202003", "story_v_chess_62202.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62202", "62202003", "story_v_chess_62202.awb")
				end
	...
	Play62202004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62202004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62202004).content)
				uv0.text_.text = slot8
	...
	Play62202005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62202005
		slot1.duration_ = 4.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(62202005).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_chess_62202", "62202005", "story_v_chess_62202.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62202", "62202005", "story_v_chess_62202.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_chess_62202", "62202005", "story_v_chess_62202.awb")

						uv0:RecordAudio("62202005", slot15)
						uv0:RecordAudio("62202005", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62202", "62202005", "story_v_chess_62202.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62202", "62202005", "story_v_chess_62202.awb")
				end
	...
	Play62202006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62202006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62202006).content)
				uv0.text_.text = slot8
	...
	Play62202007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62202007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(62202007).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_chess_62202", "62202007", "story_v_chess_62202.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62202", "62202007", "story_v_chess_62202.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_chess_62202", "62202007", "story_v_chess_62202.awb")

						uv0:RecordAudio("62202007", slot15)
						uv0:RecordAudio("62202007", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62202", "62202007", "story_v_chess_62202.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62202", "62202007", "story_v_chess_62202.awb")
				end
