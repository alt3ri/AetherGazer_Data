return {
	Play115172001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(115172001).content)
	...
	Play115172002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(115172002).content)
	...
	Play115172003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172003
		slot1.duration_ = 4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(115172003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172003", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172003", "story_v_out_115172.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_115172", "115172003", "story_v_out_115172.awb")

						uv0:RecordAudio("115172003", slot19)
						uv0:RecordAudio("115172003", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172003", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172003", "story_v_out_115172.awb")
				end
	...
	Play115172004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(115172004).content)
	...
	Play115172005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(115172005).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172005", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172005", "story_v_out_115172.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_115172", "115172005", "story_v_out_115172.awb")

						uv0:RecordAudio("115172005", slot14)
						uv0:RecordAudio("115172005", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172005", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172005", "story_v_out_115172.awb")
				end
	...
	Play115172006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_15", "se_story_15_button", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(115172006).content)
				uv0.text_.text = slot9
	...
	Play115172007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172007
		slot1.duration_ = 2.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_4029")

				uv0.callingController_:SetSelectedState("normal")

				slot12 = uv0:FormatText(uv0:GetWordFromCfg(115172007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172007", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172007", "story_v_out_115172.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_115172", "115172007", "story_v_out_115172.awb")

						uv0:RecordAudio("115172007", slot17)
						uv0:RecordAudio("115172007", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172007", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172007", "story_v_out_115172.awb")
				end
	...
	Play115172008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172008
		slot1.duration_ = 2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(115172008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172008", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172008", "story_v_out_115172.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_115172", "115172008", "story_v_out_115172.awb")

						uv0:RecordAudio("115172008", slot10)
						uv0:RecordAudio("115172008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172008", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172008", "story_v_out_115172.awb")
				end
	...
	Play115172009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172009
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(115172009).content)
				uv0.text_.text = slot9
	...
	Play115172010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172010
		slot1.duration_ = 9.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(115172010).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172010", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172010", "story_v_out_115172.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_115172", "115172010", "story_v_out_115172.awb")

						uv0:RecordAudio("115172010", slot19)
						uv0:RecordAudio("115172010", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172010", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172010", "story_v_out_115172.awb")
				end
	...
	Play115172011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1016ui_story, Vector3.New(0.7, -0.95, -6.2), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(0.7, -0.95, -6.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1016ui_story == nil then
				uv0.var_.characterEffect1016ui_story = uv0.actors_["1016ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 and uv0.var_.characterEffect1016ui_story then
				uv0.var_.characterEffect1016ui_story.fillFlat = false
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(115172011).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172011", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172011", "story_v_out_115172.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_115172", "115172011", "story_v_out_115172.awb")

						uv0:RecordAudio("115172011", slot21)
						uv0:RecordAudio("115172011", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172011", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172011", "story_v_out_115172.awb")
				end
	...
	Play115172012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.characterEffect1016ui_story then
					uv0.var_.characterEffect1016ui_story.fillFlat = true
					uv0.var_.characterEffect1016ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot5) / slot6)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(115172012).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172012", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172012", "story_v_out_115172.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_115172", "115172012", "story_v_out_115172.awb")

						uv0:RecordAudio("115172012", slot17)
						uv0:RecordAudio("115172012", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172012", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172012", "story_v_out_115172.awb")
				end
	...
	Play115172013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(115172013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172013", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172013", "story_v_out_115172.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_115172", "115172013", "story_v_out_115172.awb")

						uv0:RecordAudio("115172013", slot18)
						uv0:RecordAudio("115172013", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172013", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172013", "story_v_out_115172.awb")
				end
	...
	Play115172014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(115172014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172014", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172014", "story_v_out_115172.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_115172", "115172014", "story_v_out_115172.awb")

						uv0:RecordAudio("115172014", slot11)
						uv0:RecordAudio("115172014", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172014", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172014", "story_v_out_115172.awb")
				end
	...
	Play115172015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115172015).content)
	...
	Play115172016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(115172016).content)
				uv0.text_.text = slot4
	...
	Play115172017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115172017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115172017).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_115172", "115172017", "story_v_out_115172.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115172", "115172017", "story_v_out_115172.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_115172", "115172017", "story_v_out_115172.awb")

						uv0:RecordAudio("115172017", slot15)
						uv0:RecordAudio("115172017", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115172", "115172017", "story_v_out_115172.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115172", "115172017", "story_v_out_115172.awb")
				end
