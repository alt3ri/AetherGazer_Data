return {
	Play111101001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111101001
		slot1.duration_ = 7
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play111101002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.S0404 == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.S0404:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueS0404 = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueS0404 = slot6
				end

				uv0.var_.alphaOldValueS0404 = 0
			end

			slot5 = 1.5

			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueS0404 then
					slot8 = uv0.var_.alphaMatValueS0404
					slot9 = slot8:GetColor("_Color")
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueS0404, 1, (uv0.time_ - slot4) / slot5)

					slot8:SetColor("_Color", slot9)
				end
			end

			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 and uv0.var_.alphaMatValueS0404 then
				slot6 = uv0.var_.alphaMatValueS0404
			...
			if 2 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(111101001).content)
	...
	Play111101002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111101002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111101002).content)
	...
	Play111101003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111101003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111101003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101003", "story_v_out_111101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111101", "111101003", "story_v_out_111101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111101", "111101003", "story_v_out_111101.awb")

						uv0:RecordAudio("111101003", slot10)
						uv0:RecordAudio("111101003", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111101", "111101003", "story_v_out_111101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111101", "111101003", "story_v_out_111101.awb")
				end
	...
	Play111101004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111101004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot6.transform.localPosition = Vector3.New(0, 0, 0.15)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0:AudioAction("play", "music", "se_story", "se_story_fight_metal", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(111101004).content)
	...
	Play111101005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111101005
		slot1.duration_ = 11
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.875 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("1084ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1201cva")
			end

			if 1.875 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
			...
			if 1 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				if uv0.bgs_.D06a:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueD06a = slot15:GetColor("_Color").a
					uv0.var_.alphaMatValueD06a = slot15
				end
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				if uv0.var_.alphaMatValueD06a then
					slot17 = uv0.var_.alphaMatValueD06a
					slot18 = slot17:GetColor("_Color")
					slot18.a = Mathf.Lerp(uv0.var_.alphaOldValueD06a, 1, (uv0.time_ - slot13) / slot14)

					slot17:SetColor("_Color", slot18)
				end
			end

			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 and uv0.var_.alphaMatValueD06a then
				slot15 = uv0.var_.alphaMatValueD06a
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				if uv0.bgs_.S0404:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueS0404 = slot18:GetColor("_Color").a
					uv0.var_.alphaMatValueS0404 = slot18
				end

				uv0.var_.alphaOldValueS0404 = 1
			end
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				if uv0.var_.alphaMatValueS0404 then
					slot20 = uv0.var_.alphaMatValueS0404
					slot21 = slot20:GetColor("_Color")
					slot21.a = Mathf.Lerp(uv0.var_.alphaOldValueS0404, 0, (uv0.time_ - slot16) / slot17)

					slot20:SetColor("_Color", slot21)
				end
			end

			if uv0.time_ >= slot16 + slot17 and uv0.time_ < slot16 + slot17 + slot0 and uv0.var_.alphaMatValueS0404 then
				slot18 = uv0.var_.alphaMatValueS0404
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(111101005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101005", "story_v_out_111101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111101", "111101005", "story_v_out_111101.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_111101", "111101005", "story_v_out_111101.awb")

						uv0:RecordAudio("111101005", slot27)
						uv0:RecordAudio("111101005", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_