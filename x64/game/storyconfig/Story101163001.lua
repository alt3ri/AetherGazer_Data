return {
	Play116301001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10024ui_story, Vector3.New(0, -1, -6), (uv0.time_ - slot11) / slot12)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(116301001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301001", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301001", "story_v_out_116301.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_116301", "116301001", "story_v_out_116301.awb")

						uv0:RecordAudio("116301001", slot27)
						uv0:RecordAudio("116301001", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301001", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301001", "story_v_out_116301.awb")
				end
	...
	Play116301002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116301002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301002", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301002", "story_v_out_116301.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116301", "116301002", "story_v_out_116301.awb")

						uv0:RecordAudio("116301002", slot12)
						uv0:RecordAudio("116301002", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301002", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301002", "story_v_out_116301.awb")
				end
	...
	Play116301003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116301003).content)
	...
	Play116301004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(116301004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301004", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301004", "story_v_out_116301.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116301", "116301004", "story_v_out_116301.awb")

						uv0:RecordAudio("116301004", slot14)
						uv0:RecordAudio("116301004", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301004", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301004", "story_v_out_116301.awb")
				end
	...
	Play116301005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116301005).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301005", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301005", "story_v_out_116301.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116301", "116301005", "story_v_out_116301.awb")

						uv0:RecordAudio("116301005", slot12)
						uv0:RecordAudio("116301005", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301005", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301005", "story_v_out_116301.awb")
				end
	...
	Play116301006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116301006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301006", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301006", "story_v_out_116301.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116301", "116301006", "story_v_out_116301.awb")

						uv0:RecordAudio("116301006", slot11)
						uv0:RecordAudio("116301006", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301006", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301006", "story_v_out_116301.awb")
				end
	...
	Play116301007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116301007).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301007", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301007", "story_v_out_116301.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116301", "116301007", "story_v_out_116301.awb")

						uv0:RecordAudio("116301007", slot12)
						uv0:RecordAudio("116301007", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301007", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301007", "story_v_out_116301.awb")
				end
	...
	Play116301008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116301008).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301008", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301008", "story_v_out_116301.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116301", "116301008", "story_v_out_116301.awb")

						uv0:RecordAudio("116301008", slot11)
						uv0:RecordAudio("116301008", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301008", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301008", "story_v_out_116301.awb")
				end
	...
	Play116301009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116301009).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301009", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301009", "story_v_out_116301.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116301", "116301009", "story_v_out_116301.awb")

						uv0:RecordAudio("116301009", slot13)
						uv0:RecordAudio("116301009", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301009", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301009", "story_v_out_116301.awb")
				end
	...
	Play116301010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116301010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301010", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301010", "story_v_out_116301.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116301", "116301010", "story_v_out_116301.awb")

						uv0:RecordAudio("116301010", slot10)
						uv0:RecordAudio("116301010", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301010", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301010", "story_v_out_116301.awb")
				end
	...
	Play116301011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116301011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301011", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301011", "story_v_out_116301.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116301", "116301011", "story_v_out_116301.awb")

						uv0:RecordAudio("116301011", slot15)
						uv0:RecordAudio("116301011", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301011", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301011", "story_v_out_116301.awb")
				end
	...
	Play116301012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116301012).content)
				uv0.text_.text = slot7
	...
	Play116301013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116301013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301013", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301013", "story_v_out_116301.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116301", "116301013", "story_v_out_116301.awb")

						uv0:RecordAudio("116301013", slot18)
						uv0:RecordAudio("116301013", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301013", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301013", "story_v_out_116301.awb")
				end
	...
	Play116301014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116301014).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301014", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301014", "story_v_out_116301.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116301", "116301014", "story_v_out_116301.awb")

						uv0:RecordAudio("116301014", slot11)
						uv0:RecordAudio("116301014", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301014", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301014", "story_v_out_116301.awb")
				end
	...
	Play116301015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				if uv0.var_.characterEffect10024ui_story then
					uv0.var_.characterEffect10024ui_story.fillFlat = true
					uv0.var_.characterEffect10024ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot9) / slot10)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(116301015).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301015", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301015", "story_v_out_116301.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_116301", "116301015", "story_v_out_116301.awb")

						uv0:RecordAudio("116301015", slot25)
						uv0:RecordAudio("116301015", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301015", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301015", "story_v_out_116301.awb")
				end
	...
	Play116301016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116301016).content)
				uv0.text_.text = slot7
	...
	Play116301017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(116301017).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301017", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301017", "story_v_out_116301.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116301", "116301017", "story_v_out_116301.awb")

						uv0:RecordAudio("116301017", slot14)
						uv0:RecordAudio("116301017", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301017", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301017", "story_v_out_116301.awb")
				end
	...
	Play116301018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116301018).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301018", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301018", "story_v_out_116301.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116301", "116301018", "story_v_out_116301.awb")

						uv0:RecordAudio("116301018", slot12)
						uv0:RecordAudio("116301018", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301018", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301018", "story_v_out_116301.awb")
				end
	...
	Play116301019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116301019).content)
				uv0.text_.text = slot10
	...
	Play116301020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116301020).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301020", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301020", "story_v_out_116301.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116301", "116301020", "story_v_out_116301.awb")

						uv0:RecordAudio("116301020", slot18)
						uv0:RecordAudio("116301020", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301020", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301020", "story_v_out_116301.awb")
				end
	...
	Play116301021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(116301021).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301021", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301021", "story_v_out_116301.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116301", "116301021", "story_v_out_116301.awb")

						uv0:RecordAudio("116301021", slot22)
						uv0:RecordAudio("116301021", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301021", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301021", "story_v_out_116301.awb")
				end
	...
	Play116301022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116301022).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301022", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301022", "story_v_out_116301.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116301", "116301022", "story_v_out_116301.awb")

						uv0:RecordAudio("116301022", slot12)
						uv0:RecordAudio("116301022", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301022", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301022", "story_v_out_116301.awb")
				end
	...
	Play116301023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116301023).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301023", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301023", "story_v_out_116301.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116301", "116301023", "story_v_out_116301.awb")

						uv0:RecordAudio("116301023", slot18)
						uv0:RecordAudio("116301023", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301023", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301023", "story_v_out_116301.awb")
				end
	...
	Play116301024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116301024).content)
	...
	Play116301025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116301025).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301025", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301025", "story_v_out_116301.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116301", "116301025", "story_v_out_116301.awb")

						uv0:RecordAudio("116301025", slot18)
						uv0:RecordAudio("116301025", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301025", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301025", "story_v_out_116301.awb")
				end
	...
	Play116301026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116301026).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301026", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301026", "story_v_out_116301.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116301", "116301026", "story_v_out_116301.awb")

						uv0:RecordAudio("116301026", slot11)
						uv0:RecordAudio("116301026", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301026", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301026", "story_v_out_116301.awb")
				end
	...
	Play116301027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0, -1.1, -5.9), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(116301027).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301027", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301027", "story_v_out_116301.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_116301", "116301027", "story_v_out_116301.awb")

						uv0:RecordAudio("116301027", slot25)
						uv0:RecordAudio("116301027", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301027", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301027", "story_v_out_116301.awb")
				end
	...
	Play116301028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(116301028).content)
				uv0.text_.text = slot20
	...
	Play116301029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116301029).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116301", "116301029", "story_v_out_116301.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116301", "116301029", "story_v_out_116301.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116301", "116301029", "story_v_out_116301.awb")

						uv0:RecordAudio("116301029", slot10)
						uv0:RecordAudio("116301029", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116301", "116301029", "story_v_out_116301.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116301", "116301029", "story_v_out_116301.awb")
				end
