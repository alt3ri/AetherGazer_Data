return {
	Play114221001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(114221001).content)
	...
	Play114221002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114221002).content)
	...
	Play114221003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(114221003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221003", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221003", "story_v_out_114221.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_114221", "114221003", "story_v_out_114221.awb")

						uv0:RecordAudio("114221003", slot20)
						uv0:RecordAudio("114221003", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221003", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221003", "story_v_out_114221.awb")
				end
	...
	Play114221004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(114221004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221004", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221004", "story_v_out_114221.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_114221", "114221004", "story_v_out_114221.awb")

						uv0:RecordAudio("114221004", slot10)
						uv0:RecordAudio("114221004", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221004", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221004", "story_v_out_114221.awb")
				end
	...
	Play114221005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.actors_["10016"]:GetComponent("Image") then
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				if uv0.var_.alphaMatValue10016 then
					...
					slot13.a = Mathf.Lerp(uv0.var_.alphaOldValue10016, 1, (uv0.time_ - slot9) / slot10)
			...
			if 1.966 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0:CheckSpriteTmpPos("10015", slot21)
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot15.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10015, Vector3.New(0, -2000, -180), (uv0.time_ - slot16) / slot17)
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(114221005).content)
				uv0.text_.text = slot23

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (40 <= 0 and slot19 or slot19 * utf8.len(slot23) / slot24) > 0 and slot19 < slot26 then
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221005", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221005", "story_v_out_114221.awb") / 1000 + slot18 then
						uv0.duration_ = slot27 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_114221", "114221005", "story_v_out_114221.awb")

						uv0:RecordAudio("114221005", slot28)
						uv0:RecordAudio("114221005", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221005", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221005", "story_v_out_114221.awb")
				end
	...
	Play114221006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(114221006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221006", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221006", "story_v_out_114221.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_114221", "114221006", "story_v_out_114221.awb")

						uv0:RecordAudio("114221006", slot22)
						uv0:RecordAudio("114221006", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221006", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221006", "story_v_out_114221.awb")
				end
	...
	Play114221007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(114221007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221007", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221007", "story_v_out_114221.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_114221", "114221007", "story_v_out_114221.awb")

						uv0:RecordAudio("114221007", slot16)
						uv0:RecordAudio("114221007", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221007", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221007", "story_v_out_114221.awb")
				end
	...
	Play114221008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(114221008).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221008", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221008", "story_v_out_114221.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_114221", "114221008", "story_v_out_114221.awb")

						uv0:RecordAudio("114221008", slot10)
						uv0:RecordAudio("114221008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221008", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221008", "story_v_out_114221.awb")
				end
	...
	Play114221009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(114221009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221009", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221009", "story_v_out_114221.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_114221", "114221009", "story_v_out_114221.awb")

						uv0:RecordAudio("114221009", slot19)
						uv0:RecordAudio("114221009", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221009", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221009", "story_v_out_114221.awb")
				end
	...
	Play114221010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(114221010).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221010", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221010", "story_v_out_114221.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_114221", "114221010", "story_v_out_114221.awb")

						uv0:RecordAudio("114221010", slot16)
						uv0:RecordAudio("114221010", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221010", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221010", "story_v_out_114221.awb")
				end
	...
	Play114221011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10015, Vector3.New(0, -2000, -180), (uv0.time_ - slot9) / slot10)
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(114221011).content)
				uv0.text_.text = slot15
	...
	Play114221012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114221012).content)
				uv0.text_.text = slot4
	...
	Play114221013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(114221013).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221013", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221013", "story_v_out_114221.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_114221", "114221013", "story_v_out_114221.awb")

						uv0:RecordAudio("114221013", slot19)
						uv0:RecordAudio("114221013", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221013", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221013", "story_v_out_114221.awb")
				end
	...
	Play114221014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(114221014).content)
	...
	Play114221015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(114221015).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221015", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221015", "story_v_out_114221.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_114221", "114221015", "story_v_out_114221.awb")

						uv0:RecordAudio("114221015", slot13)
						uv0:RecordAudio("114221015", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221015", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221015", "story_v_out_114221.awb")
				end
	...
	Play114221016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(114221016).content)
				uv0.text_.text = slot7
	...
	Play114221017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114221017).content)
				uv0.text_.text = slot4
	...
	Play114221018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114221018).content)
				uv0.text_.text = slot4
	...
	Play114221019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_3020")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(114221019).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221019", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221019", "story_v_out_114221.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_114221", "114221019", "story_v_out_114221.awb")

						uv0:RecordAudio("114221019", slot10)
						uv0:RecordAudio("114221019", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221019", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221019", "story_v_out_114221.awb")
				end
	...
	Play114221020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(114221020).content)
	...
	Play114221021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(114221021).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221021", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221021", "story_v_out_114221.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_114221", "114221021", "story_v_out_114221.awb")

						uv0:RecordAudio("114221021", slot10)
						uv0:RecordAudio("114221021", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221021", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221021", "story_v_out_114221.awb")
				end
	...
	Play114221022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(114221022).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221022", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221022", "story_v_out_114221.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_114221", "114221022", "story_v_out_114221.awb")

						uv0:RecordAudio("114221022", slot17)
						uv0:RecordAudio("114221022", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221022", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221022", "story_v_out_114221.awb")
				end
	...
	Play114221023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(114221023).content)
				uv0.text_.text = slot7
	...
	Play114221024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114221024).content)
				uv0.text_.text = slot4
	...
	Play114221025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114221025).content)
				uv0.text_.text = slot4
	...
	Play114221026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(114221026).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221026", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221026", "story_v_out_114221.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_114221", "114221026", "story_v_out_114221.awb")

						uv0:RecordAudio("114221026", slot19)
						uv0:RecordAudio("114221026", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221026", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221026", "story_v_out_114221.awb")
				end
	...
	Play114221027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(114221027).content)
				uv0.text_.text = slot7
	...
	Play114221028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(114221028).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221028", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221028", "story_v_out_114221.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_114221", "114221028", "story_v_out_114221.awb")

						uv0:RecordAudio("114221028", slot10)
						uv0:RecordAudio("114221028", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221028", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221028", "story_v_out_114221.awb")
				end
	...
	Play114221029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(114221029).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221029", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221029", "story_v_out_114221.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_114221", "114221029", "story_v_out_114221.awb")

						uv0:RecordAudio("114221029", slot19)
						uv0:RecordAudio("114221029", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221029", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221029", "story_v_out_114221.awb")
				end
	...
	Play114221030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot3 = uv0.actors_["10015"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0.var_.moveOldPos10015 = slot3.localPosition
				slot3.localScale = Vector3.New(1, 1, 1)
				slot9 = 7

				uv0:CheckSpriteTmpPos("10015", slot9)
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot3.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10015, Vector3.New(0, -2000, -180), (uv0.time_ - slot4) / slot5)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPosOM0501 = uv0.bgs_.OM0501.transform.localPosition
			end
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(114221030).content)
				uv0.text_.text = slot24

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (22 <= 0 and slot20 or slot20 * utf8.len(slot24) / slot25) > 0 and slot20 < slot27 then
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221030", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221030", "story_v_out_114221.awb") / 1000 + slot19 then
						uv0.duration_ = slot28 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_114221", "114221030", "story_v_out_114221.awb")

						uv0:RecordAudio("114221030", slot29)
						uv0:RecordAudio("114221030", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221030", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221030", "story_v_out_114221.awb")
				end
	...
	Play114221031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(114221031).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_114221", "114221031", "story_v_out_114221.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114221", "114221031", "story_v_out_114221.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_114221", "114221031", "story_v_out_114221.awb")

						uv0:RecordAudio("114221031", slot10)
						uv0:RecordAudio("114221031", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114221", "114221031", "story_v_out_114221.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114221", "114221031", "story_v_out_114221.awb")
				end
