return {
	Play102111001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if uv0.bgs_.B08b:GetComponent("SpriteRenderer") then
					slot12.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot13 = slot12.material
					uv0.var_.alphaOldValueB08b = slot13:GetColor("_Color").a
					uv0.var_.alphaMatValueB08b = slot13
				end

				uv0.var_.alphaOldValueB08b = 0
			end

			slot12 = 1.5

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.alphaMatValueB08b then
					slot15 = uv0.var_.alphaMatValueB08b
					slot16 = slot15:GetColor("_Color")
					slot16.a = Mathf.Lerp(uv0.var_.alphaOldValueB08b, 1, (uv0.time_ - slot11) / slot12)

					slot15:SetColor("_Color", slot16)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.alphaMatValueB08b then
				slot13 = uv0.var_.alphaMatValueB08b
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(102111001).content)
				uv0.text_.text = slot26

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (27 <= 0 and slot22 or slot22 * utf8.len(slot26) / slot27) > 0 and slot22 < slot29 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111001", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111001", "story_v_out_102111.awb") / 1000 + slot21 then
						uv0.duration_ = slot30 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_102111", "102111001", "story_v_out_102111.awb")

						uv0:RecordAudio("102111001", slot31)
						uv0:RecordAudio("102111001", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111001", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111001", "story_v_out_102111.awb")
				end
	...
	Play102111002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111002
		slot1.duration_ = 2.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102111002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111002", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111002", "story_v_out_102111.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102111", "102111002", "story_v_out_102111.awb")

						uv0:RecordAudio("102111002", slot22)
						uv0:RecordAudio("102111002", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111002", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111002", "story_v_out_102111.awb")
				end
	...
	Play102111003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				uv0:PlayTimeline("3008ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface0104cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(102111003).content)
				uv0.text_.text = slot23

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (18 <= 0 and slot20 or slot20 * utf8.len(slot23) / slot24) > 0 and slot20 < slot26 then
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111003", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111003", "story_v_out_102111.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_102111", "102111003", "story_v_out_102111.awb")

						uv0:RecordAudio("102111003", slot28)
						uv0:RecordAudio("102111003", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111003", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111003", "story_v_out_102111.awb")
				end
	...
	Play102111004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102111004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111004", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111004", "story_v_out_102111.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102111", "102111004", "story_v_out_102111.awb")

						uv0:RecordAudio("102111004", slot21)
						uv0:RecordAudio("102111004", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111004", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111004", "story_v_out_102111.awb")
				end
	...
	Play102111005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111005
		slot1.duration_ = 4.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(102111005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111005", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111005", "story_v_out_102111.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102111", "102111005", "story_v_out_102111.awb")

						uv0:RecordAudio("102111005", slot12)
						uv0:RecordAudio("102111005", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111005", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111005", "story_v_out_102111.awb")
				end
	...
	Play102111006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, -1.51, -4.3), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0, -1.51, -4.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0:PlayTimeline("3008ui_story", "StoryTimeline/CharAction/3008/3008action/3008action7_1")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102111006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111006", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111006", "story_v_out_102111.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102111", "102111006", "story_v_out_102111.awb")

						uv0:RecordAudio("102111006", slot24)
						uv0:RecordAudio("102111006", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111006", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111006", "story_v_out_102111.awb")
				end
	...
	Play102111007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111007
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102111007).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111007", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111007", "story_v_out_102111.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102111", "102111007", "story_v_out_102111.awb")

						uv0:RecordAudio("102111007", slot24)
						uv0:RecordAudio("102111007", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111007", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111007", "story_v_out_102111.awb")
				end
	...
	Play102111008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102111008).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111008", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111008", "story_v_out_102111.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102111", "102111008", "story_v_out_102111.awb")

						uv0:RecordAudio("102111008", slot22)
						uv0:RecordAudio("102111008", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111008", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111008", "story_v_out_102111.awb")
				end
	...
	Play102111009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(102111009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111009", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111009", "story_v_out_102111.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102111", "102111009", "story_v_out_102111.awb")

						uv0:RecordAudio("102111009", slot27)
						uv0:RecordAudio("102111009", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111009", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111009", "story_v_out_102111.awb")
				end
	...
	Play102111010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102111010).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111010", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111010", "story_v_out_102111.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102111", "102111010", "story_v_out_102111.awb")

						uv0:RecordAudio("102111010", slot24)
						uv0:RecordAudio("102111010", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111010", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111010", "story_v_out_102111.awb")
				end
	...
	Play102111011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111011
		slot1.duration_ = 7.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102111011).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111011", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111011", "story_v_out_102111.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102111", "102111011", "story_v_out_102111.awb")

						uv0:RecordAudio("102111011", slot21)
						uv0:RecordAudio("102111011", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111011", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111011", "story_v_out_102111.awb")
				end
	...
	Play102111012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, -1.51, -4.3), (uv0.time_ - slot14) / slot15)
				slot19 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot19.x, slot19.y, slot19.z)
				slot20 = slot13.localEulerAngles
				slot20.z = 0
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -1.51, -4.3)
				slot18 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot18.x, slot18.y, slot18.z)
				slot19 = slot13.localEulerAngles
				slot19.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(102111012).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111012", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111012", "story_v_out_102111.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102111", "102111012", "story_v_out_102111.awb")

						uv0:RecordAudio("102111012", slot27)
						uv0:RecordAudio("102111012", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111012", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111012", "story_v_out_102111.awb")
				end
	...
	Play102111013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0.var_.moveOldPos2030_tpose = uv0.actors_["2030_tpose"].transform.localPosition
			end

			slot18 = 0.001

			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2030_tpose, Vector3.New(0.7, -1.2, -4.2), (uv0.time_ - slot17) / slot18)
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 then
				slot16.localPosition = Vector3.New(0.7, -1.2, -4.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[19].name)
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(102111013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111013", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111013", "story_v_out_102111.awb") / 1000 + slot20 then
						uv0.duration_ = slot28 + slot20
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_102111", "102111013", "story_v_out_102111.awb")

						uv0:RecordAudio("102111013", slot29)
						uv0:RecordAudio("102111013", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111013", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111013", "story_v_out_102111.awb")
				end
	...
	Play102111014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 and uv0.var_.characterEffect2030_tpose == nil then
				uv0.var_.characterEffect2030_tpose = uv0.actors_["2030_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.characterEffect2030_tpose then
					...
					uv0.var_.characterEffect2030_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot5) / slot6)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[33].name)
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(102111014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111014", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111014", "story_v_out_102111.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_102111", "102111014", "story_v_out_102111.awb")

						uv0:RecordAudio("102111014", slot16)
						uv0:RecordAudio("102111014", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111014", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111014", "story_v_out_102111.awb")
				end
	...
	Play102111015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111015
		slot1.duration_ = 5
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play102111016(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.characterEffect2030_tpose == nil then
				uv0.var_.characterEffect2030_tpose = uv0.actors_["2030_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 and uv0.var_.characterEffect2030_tpose then
				uv0.var_.characterEffect2030_tpose.fillFlat = false
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(102111015).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111015", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111015", "story_v_out_102111.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_102111", "102111015", "story_v_out_102111.awb")

						uv0:RecordAudio("102111015", slot16)
						uv0:RecordAudio("102111015", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111015", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111015", "story_v_out_102111.awb")
				end
	...
	Play102111016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2030_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2020_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(102111016).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111016", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111016", "story_v_out_102111.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102111", "102111016", "story_v_out_102111.awb")

						uv0:RecordAudio("102111016", slot27)
						uv0:RecordAudio("102111016", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111016", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111016", "story_v_out_102111.awb")
				end
	...
	Play102111017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[41].name)
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_20301")

				uv0.callingController_:SetSelectedState("normal")

				slot8 = uv0:FormatText(uv0:GetWordFromCfg(102111017).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111017", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111017", "story_v_out_102111.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_102111", "102111017", "story_v_out_102111.awb")

						uv0:RecordAudio("102111017", slot13)
						uv0:RecordAudio("102111017", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111017", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111017", "story_v_out_102111.awb")
				end
	...
	Play102111018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111018
		slot1.duration_ = 2.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(102111018).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111018", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111018", "story_v_out_102111.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_102111", "102111018", "story_v_out_102111.awb")

						uv0:RecordAudio("102111018", slot13)
						uv0:RecordAudio("102111018", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111018", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111018", "story_v_out_102111.awb")
				end
	...
	Play102111019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_2", "se_story_2_knives", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(102111019).content)
	...
	Play102111020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102111020).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111020", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111020", "story_v_out_102111.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102111", "102111020", "story_v_out_102111.awb")

						uv0:RecordAudio("102111020", slot18)
						uv0:RecordAudio("102111020", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111020", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111020", "story_v_out_102111.awb")
				end
	...
	Play102111021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(102111021).content)
	...
	Play102111022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102111022).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111022", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111022", "story_v_out_102111.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102111", "102111022", "story_v_out_102111.awb")

						uv0:RecordAudio("102111022", slot18)
						uv0:RecordAudio("102111022", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111022", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111022", "story_v_out_102111.awb")
				end
	...
	Play102111023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111023
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102111023).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111023", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111023", "story_v_out_102111.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102111", "102111023", "story_v_out_102111.awb")

						uv0:RecordAudio("102111023", slot24)
						uv0:RecordAudio("102111023", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111023", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111023", "story_v_out_102111.awb")
				end
	...
	Play102111024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0.7, -1.75, -4.8), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0.7, -1.75, -4.8)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0:PlayTimeline("3009ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3104cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102111024).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111024", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111024", "story_v_out_102111.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102111", "102111024", "story_v_out_102111.awb")

						uv0:RecordAudio("102111024", slot22)
						uv0:RecordAudio("102111024", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111024", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111024", "story_v_out_102111.awb")
				end
	...
	Play102111025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("3008ui_story", "StoryTimeline/CharAction/3008/3008action/3008action7_2")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102111025).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111025", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111025", "story_v_out_102111.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102111", "102111025", "story_v_out_102111.awb")

						uv0:RecordAudio("102111025", slot18)
						uv0:RecordAudio("102111025", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111025", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111025", "story_v_out_102111.awb")
				end
	...
	Play102111026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111026
		slot1.duration_ = 4.533
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play102111027(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.characterEffect3009ui_story == nil then
				uv0.var_.characterEffect3009ui_story = uv0.actors_["3009ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 and uv0.var_.characterEffect3009ui_story then
				uv0.var_.characterEffect3009ui_story.fillFlat = false
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("3009ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1104cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102111026).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111026", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111026", "story_v_out_102111.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102111", "102111026", "story_v_out_102111.awb")

						uv0:RecordAudio("102111026", slot17)
						uv0:RecordAudio("102111026", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111026", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111026", "story_v_out_102111.awb")
				end
	...
	Play102111027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111027
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(102111027).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111027", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111027", "story_v_out_102111.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102111", "102111027", "story_v_out_102111.awb")

						uv0:RecordAudio("102111027", slot18)
						uv0:RecordAudio("102111027", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111027", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111027", "story_v_out_102111.awb")
				end
	...
	Play102111028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111028
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102111028).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111028", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111028", "story_v_out_102111.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102111", "102111028", "story_v_out_102111.awb")

						uv0:RecordAudio("102111028", slot17)
						uv0:RecordAudio("102111028", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111028", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111028", "story_v_out_102111.awb")
				end
	...
	Play102111029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111029
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot15.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot16) / slot17)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(102111029).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111029", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111029", "story_v_out_102111.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102111", "102111029", "story_v_out_102111.awb")

						uv0:RecordAudio("102111029", slot27)
						uv0:RecordAudio("102111029", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111029", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111029", "story_v_out_102111.awb")
				end
	...
	Play102111030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111030
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0, -1.75, -4.8), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0, -1.75, -4.8)
				slot15 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot10.localEulerAngles
				slot16.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(102111030).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111030", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111030", "story_v_out_102111.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_102111", "102111030", "story_v_out_102111.awb")

						uv0:RecordAudio("102111030", slot23)
						uv0:RecordAudio("102111030", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111030", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111030", "story_v_out_102111.awb")
				end
	...
	Play102111031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111031
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				if uv0.var_.characterEffect3009ui_story then
					uv0.var_.characterEffect3009ui_story.fillFlat = true
					uv0.var_.characterEffect3009ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot2) / slot3)
				end
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(102111031).content)
				uv0.text_.text = slot11
	...
	Play102111032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102111032
		slot1.duration_ = 6.466
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(102111032).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111032", "story_v_out_102111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102111", "102111032", "story_v_out_102111.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102111", "102111032", "story_v_out_102111.awb")

						uv0:RecordAudio("102111032", slot17)
						uv0:RecordAudio("102111032", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102111", "102111032", "story_v_out_102111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102111", "102111032", "story_v_out_102111.awb")
				end
