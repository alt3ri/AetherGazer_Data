return {
	Play102112001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112001
		slot1.duration_ = 6.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.8 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect3009ui_story == nil then
			...
			if 1.79999995231628 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(102112001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112001", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112001", "story_v_out_102112.awb") / 1000 + slot18 then
						uv0.duration_ = slot27 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_102112", "102112001", "story_v_out_102112.awb")

						uv0:RecordAudio("102112001", slot28)
						uv0:RecordAudio("102112001", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112001", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112001", "story_v_out_102112.awb")
				end
	...
	Play102112002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect3009ui_story == nil then
				uv0.var_.characterEffect3009ui_story = uv0.actors_["3009ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.characterEffect3009ui_story then
					...
					uv0.var_.characterEffect3009ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot6) / slot7)
				end
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.characterEffect3009ui_story then
				uv0.var_.characterEffect3009ui_story.fillFlat = true
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102112002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112002", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112002", "story_v_out_102112.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102112", "102112002", "story_v_out_102112.awb")

						uv0:RecordAudio("102112002", slot22)
						uv0:RecordAudio("102112002", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112002", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112002", "story_v_out_102112.awb")
				end
	...
	Play102112003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112003
		slot1.duration_ = 4.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(102112003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112003", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112003", "story_v_out_102112.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102112", "102112003", "story_v_out_102112.awb")

						uv0:RecordAudio("102112003", slot25)
						uv0:RecordAudio("102112003", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112003", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112003", "story_v_out_102112.awb")
				end
	...
	Play102112004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102112004).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112004", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112004", "story_v_out_102112.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102112", "102112004", "story_v_out_102112.awb")

						uv0:RecordAudio("102112004", slot22)
						uv0:RecordAudio("102112004", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112004", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112004", "story_v_out_102112.awb")
				end
	...
	Play102112005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102112005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112005", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112005", "story_v_out_102112.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102112", "102112005", "story_v_out_102112.awb")

						uv0:RecordAudio("102112005", slot24)
						uv0:RecordAudio("102112005", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112005", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112005", "story_v_out_102112.awb")
				end
	...
	Play102112006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(102112006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112006", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112006", "story_v_out_102112.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_102112", "102112006", "story_v_out_102112.awb")

						uv0:RecordAudio("102112006", slot16)
						uv0:RecordAudio("102112006", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112006", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112006", "story_v_out_102112.awb")
				end
	...
	Play102112007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos4010ui_story, Vector3.New(0, -1.59, -5.2), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, -1.59, -5.2)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102112007).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112007", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112007", "story_v_out_102112.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102112", "102112007", "story_v_out_102112.awb")

						uv0:RecordAudio("102112007", slot22)
						uv0:RecordAudio("102112007", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112007", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112007", "story_v_out_102112.awb")
				end
	...
	Play102112008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112008
		slot1.duration_ = 2.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0:PlayTimeline("3008ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3203cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102112008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112008", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112008", "story_v_out_102112.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102112", "102112008", "story_v_out_102112.awb")

						uv0:RecordAudio("102112008", slot21)
						uv0:RecordAudio("102112008", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112008", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112008", "story_v_out_102112.awb")
				end
	...
	Play102112009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(102112009).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112009", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112009", "story_v_out_102112.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102112", "102112009", "story_v_out_102112.awb")

						uv0:RecordAudio("102112009", slot22)
						uv0:RecordAudio("102112009", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112009", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112009", "story_v_out_102112.awb")
				end
	...
	Play102112010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112010
		slot1.duration_ = 3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102112010).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112010", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112010", "story_v_out_102112.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102112", "102112010", "story_v_out_102112.awb")

						uv0:RecordAudio("102112010", slot21)
						uv0:RecordAudio("102112010", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112010", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112010", "story_v_out_102112.awb")
				end
	...
	Play102112011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102112011).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112011", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112011", "story_v_out_102112.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102112", "102112011", "story_v_out_102112.awb")

						uv0:RecordAudio("102112011", slot24)
						uv0:RecordAudio("102112011", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112011", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112011", "story_v_out_102112.awb")
				end
	...
	Play102112012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(102112012).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112012", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112012", "story_v_out_102112.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102112", "102112012", "story_v_out_102112.awb")

						uv0:RecordAudio("102112012", slot21)
						uv0:RecordAudio("102112012", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112012", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112012", "story_v_out_102112.awb")
				end
	...
	Play102112013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot15) / slot16)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(102112013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112013", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112013", "story_v_out_102112.awb") / 1000 + slot17 then
						uv0.duration_ = slot25 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_102112", "102112013", "story_v_out_102112.awb")

						uv0:RecordAudio("102112013", slot26)
						uv0:RecordAudio("102112013", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112013", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112013", "story_v_out_102112.awb")
				end
	...
	Play102112014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 102112014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0:PlayTimeline("4010ui_story", "StoryTimeline/CharAction/story4010/story4010action/4010action7_1")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(102112014).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_102112", "102112014", "story_v_out_102112.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_102112", "102112014", "story_v_out_102112.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102112", "102112014", "story_v_out_102112.awb")

						uv0:RecordAudio("102112014", slot24)
						uv0:RecordAudio("102112014", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_102112", "102112014", "story_v_out_102112.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_102112", "102112014", "story_v_out_102112.awb")
				end
