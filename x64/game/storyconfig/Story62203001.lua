return {
	Play62203001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(62203001).content)
				uv0.text_.text = slot23

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (27 <= 0 and slot19 or slot19 * utf8.len(slot23) / slot24) > 0 and slot19 < slot26 then
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203001", "story_v_chess_62203.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62203", "62203001", "story_v_chess_62203.awb") / 1000 + slot18 then
						uv0.duration_ = slot27 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_chess_62203", "62203001", "story_v_chess_62203.awb")

						uv0:RecordAudio("62203001", slot28)
						uv0:RecordAudio("62203001", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62203", "62203001", "story_v_chess_62203.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62203", "62203001", "story_v_chess_62203.awb")
				end
	...
	Play62203002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203002
		slot1.duration_ = 5
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play62203003(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.actors_["1111_1"] == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.actors_["1111_1"]:GetComponent("Image") then
				uv0.var_.highlightMatValue1111_1 = slot4
			end

			slot4 = 0.2

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.highlightMatValue1111_1 then
					slot6 = Mathf.Lerp(1, 0.5, (uv0.time_ - slot3) / slot4)
					slot7 = uv0.var_.highlightMatValue1111_1
					slot8 = slot7.color
					slot8.r = slot6
					slot8.g = slot6
					slot8.b = slot6
			...
			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.highlightMatValue1111_1 then
				slot5 = 0.5
				slot6 = uv0.var_.highlightMatValue1111_1
				slot7 = slot6.color
				slot7.r = slot5
				slot7.g = slot5
				slot7.b = slot5
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1111ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot6) / slot7)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(62203002).content)
				uv0.text_.text = slot11

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (68 <= 0 and slot9 or slot9 * utf8.len(slot11) / slot12) > 0 and slot9 < slot14 then
	...
	Play62203003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(62203003).content)
	...
	Play62203004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203004
		slot1.duration_ = 6.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(62203004).content)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203004", "story_v_chess_62203.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62203", "62203004", "story_v_chess_62203.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_chess_62203", "62203004", "story_v_chess_62203.awb")

						uv0:RecordAudio("62203004", slot10)
						uv0:RecordAudio("62203004", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62203", "62203004", "story_v_chess_62203.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62203", "62203004", "story_v_chess_62203.awb")
				end
	...
	Play62203005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203005
		slot1.duration_ = 7.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(62203005).content)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203005", "story_v_chess_62203.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62203", "62203005", "story_v_chess_62203.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_chess_62203", "62203005", "story_v_chess_62203.awb")

						uv0:RecordAudio("62203005", slot18)
						uv0:RecordAudio("62203005", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62203", "62203005", "story_v_chess_62203.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62203", "62203005", "story_v_chess_62203.awb")
				end
	...
	Play62203006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(62203006).content)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203006", "story_v_chess_62203.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62203", "62203006", "story_v_chess_62203.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_chess_62203", "62203006", "story_v_chess_62203.awb")

						uv0:RecordAudio("62203006", slot12)
						uv0:RecordAudio("62203006", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62203", "62203006", "story_v_chess_62203.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62203", "62203006", "story_v_chess_62203.awb")
				end
	...
	Play62203007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62203007).content)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203007", "story_v_chess_62203.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62203", "62203007", "story_v_chess_62203.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_chess_62203", "62203007", "story_v_chess_62203.awb")

						uv0:RecordAudio("62203007", slot13)
						uv0:RecordAudio("62203007", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62203", "62203007", "story_v_chess_62203.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62203", "62203007", "story_v_chess_62203.awb")
				end
	...
	Play62203008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62203008).content)
				uv0.text_.text = slot8
	...
	Play62203009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62203009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(62203009).content)
				uv0.text_.text = slot4
