return {
	Play62203001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_2 < arg_1_1.time_ and arg_1_1.time_ <= var_4_2 + arg_4_0 then
				...
				local var_4_5 = arg_1_1.bgs_.B03d
			...
			if var_4_35 < arg_1_1.time_ and arg_1_1.time_ <= var_4_35 + arg_4_0 then
				arg_1_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action2_1")
			end
			...
			if var_4_49 < arg_1_1.time_ and arg_1_1.time_ <= var_4_49 + arg_4_0 then
				...
				local var_4_53 = arg_1_1:GetWordFromCfg(62203001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203001", "story_v_chess_62203.awb") ~= 0 then
					local var_4_58 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203001", "story_v_chess_62203.awb") / 1000
					...
					if var_4_53.prefab_name ~= "" and arg_1_1.actors_[var_4_53.prefab_name] ~= nil then
						local var_4_59 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_53.prefab_name].transform, "story_v_chess_62203", "62203001", "story_v_chess_62203.awb")

						arg_1_1:RecordAudio("62203001", var_4_59)
						arg_1_1:RecordAudio("62203001", var_4_59)
					else
	...
	Play62203002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 62203002
		arg_7_1.duration_ = 5
		...
		function arg_7_1.playNext_(arg_9_0)
			if arg_9_0 == 1 then
				arg_7_0:Play62203003(arg_7_1)
			end
		end

		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			local var_10_0 = "1111_1"
			...
			local var_10_3 = arg_7_1.actors_["1111_1"]
			local var_10_4 = 0

			if var_10_4 < arg_7_1.time_ and arg_7_1.time_ <= var_10_4 + arg_10_0 then
				local var_10_5 = var_10_3:GetComponent("Image")

				if var_10_5 then
					arg_7_1.var_.highlightMatValue1111_1 = var_10_5
				end
			end
			...
			if var_10_4 <= arg_7_1.time_ and arg_7_1.time_ < var_10_4 + var_10_6 then
				...
				if arg_7_1.var_.highlightMatValue1111_1 then
					local var_10_8 = Mathf.Lerp(1, 0.5, var_10_7)
					local var_10_9 = arg_7_1.var_.highlightMatValue1111_1
			...
			if arg_7_1.time_ >= var_10_4 + var_10_6 and arg_7_1.time_ < var_10_4 + var_10_6 + arg_10_0 and arg_7_1.var_.highlightMatValue1111_1 then
				local var_10_11 = 0.5
				local var_10_12 = arg_7_1.var_.highlightMatValue1111_1
				local var_10_13 = var_10_12.color

				var_10_13.r = var_10_11
				var_10_13.g = var_10_11
				var_10_13.b = var_10_11
				var_10_12.color = var_10_13
			end

			local var_10_14 = arg_7_1.actors_["1111ui_story"].transform
			local var_10_15 = 0

			if var_10_15 < arg_7_1.time_ and arg_7_1.time_ <= var_10_15 + arg_10_0 then
				arg_7_1.var_.moveOldPos1111ui_story = var_10_14.localPosition
			end
			...
			if var_10_15 <= arg_7_1.time_ and arg_7_1.time_ < var_10_15 + var_10_16 then
				...
				var_10_14.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos1111ui_story, var_10_18, var_10_17)
			...
			if var_10_23 < arg_7_1.time_ and arg_7_1.time_ <= var_10_23 + arg_10_0 then
				...
				local var_10_25 = arg_7_1:GetWordFromCfg(62203002)
				...
				local var_10_29 = var_10_27 <= 0 and var_10_24 or var_10_24 * (var_10_28 / var_10_27)

				if var_10_29 > 0 and var_10_24 < var_10_29 then
					arg_7_1.talkMaxDuration = var_10_29

					if var_10_29 + var_10_23 > arg_7_1.duration_ then
						arg_7_1.duration_ = var_10_29 + var_10_23
					end
				end
			...
			local var_10_30 = math.max(var_10_24, arg_7_1.talkMaxDuration)

			if var_10_23 <= arg_7_1.time_ and arg_7_1.time_ < var_10_23 + var_10_30 then
				arg_7_1.typewritter.percent = (arg_7_1.time_ - var_10_23) / var_10_30

				arg_7_1.typewritter:SetDirty()
			end

			if arg_7_1.time_ >= var_10_23 + var_10_30 and arg_7_1.time_ < var_10_23 + var_10_30 + arg_10_0 then
	...
	Play62203003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 62203003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play62203004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_0 + arg_14_0 then
				...
				local var_14_2 = arg_11_1:GetWordFromCfg(62203003)
	...
	Play62203004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 62203004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play62203005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_0 < arg_15_1.time_ and arg_15_1.time_ <= var_18_0 + arg_18_0 then
				...
				arg_15_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_4013")

				arg_15_1.callingController_:SetSelectedState("normal")

				local var_18_3 = arg_15_1:GetWordFromCfg(62203004)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203004", "story_v_chess_62203.awb") ~= 0 then
					local var_18_8 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203004", "story_v_chess_62203.awb") / 1000
					...
					if var_18_3.prefab_name ~= "" and arg_15_1.actors_[var_18_3.prefab_name] ~= nil then
						local var_18_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_15_1.actors_[var_18_3.prefab_name].transform, "story_v_chess_62203", "62203004", "story_v_chess_62203.awb")

						arg_15_1:RecordAudio("62203004", var_18_9)
						arg_15_1:RecordAudio("62203004", var_18_9)
					else
						arg_15_1:AudioAction("play", "voice", "story_v_chess_62203", "62203004", "story_v_chess_62203.awb")
					end

					arg_15_1:RecordHistoryTalkVoice("story_v_chess_62203", "62203004", "story_v_chess_62203.awb")
				end
	...
	Play62203005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 62203005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play62203006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_1 <= arg_19_1.time_ and arg_19_1.time_ < var_22_1 + var_22_2 then
				...
				local var_22_4 = Vector3.New(0, -0.83, -6)
			...
			if arg_19_1.time_ >= var_22_1 + var_22_2 and arg_19_1.time_ < var_22_1 + var_22_2 + arg_22_0 then
				var_22_0.localPosition = Vector3.New(0, -0.83, -6)
			...
			if var_22_10 < arg_19_1.time_ and arg_19_1.time_ <= var_22_10 + arg_22_0 then
				arg_19_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1304cva")
			end

			local var_22_11 = arg_19_1.actors_["1111ui_story"]
			local var_22_12 = 0

			if var_22_12 < arg_19_1.time_ and arg_19_1.time_ <= var_22_12 + arg_22_0 and arg_19_1.var_.characterEffect1111ui_story == nil then
				arg_19_1.var_.characterEffect1111ui_story = var_22_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_19_1.time_ >= var_22_12 + var_22_13 and arg_19_1.time_ < var_22_12 + var_22_13 + arg_22_0 and arg_19_1.var_.characterEffect1111ui_story then
				arg_19_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if var_22_15 < arg_19_1.time_ and arg_19_1.time_ <= var_22_15 + arg_22_0 then
				...
				local var_22_18 = arg_19_1:GetWordFromCfg(62203005)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203005", "story_v_chess_62203.awb") ~= 0 then
					local var_22_23 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203005", "story_v_chess_62203.awb") / 1000
					...
					if var_22_18.prefab_name ~= "" and arg_19_1.actors_[var_22_18.prefab_name] ~= nil then
						local var_22_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_19_1.actors_[var_22_18.prefab_name].transform, "story_v_chess_62203", "62203005", "story_v_chess_62203.awb")

						arg_19_1:RecordAudio("62203005", var_22_24)
						arg_19_1:RecordAudio("62203005", var_22_24)
					else
						arg_19_1:AudioAction("play", "voice", "story_v_chess_62203", "62203005", "story_v_chess_62203.awb")
					end

					arg_19_1:RecordHistoryTalkVoice("story_v_chess_62203", "62203005", "story_v_chess_62203.awb")
				end
	...
	Play62203006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 62203006
		arg_23_1.duration_ = 9.433
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play62203007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_1 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				arg_23_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action4_2")
			end
			...
			if var_26_2 < arg_23_1.time_ and arg_23_1.time_ <= var_26_2 + arg_26_0 then
				...
				local var_26_5 = arg_23_1:GetWordFromCfg(62203006)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203006", "story_v_chess_62203.awb") ~= 0 then
					local var_26_10 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203006", "story_v_chess_62203.awb") / 1000
					...
					if var_26_5.prefab_name ~= "" and arg_23_1.actors_[var_26_5.prefab_name] ~= nil then
						local var_26_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_23_1.actors_[var_26_5.prefab_name].transform, "story_v_chess_62203", "62203006", "story_v_chess_62203.awb")

						arg_23_1:RecordAudio("62203006", var_26_11)
						arg_23_1:RecordAudio("62203006", var_26_11)
					else
						arg_23_1:AudioAction("play", "voice", "story_v_chess_62203", "62203006", "story_v_chess_62203.awb")
					end

					arg_23_1:RecordHistoryTalkVoice("story_v_chess_62203", "62203006", "story_v_chess_62203.awb")
				end
	...
	Play62203007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 62203007
		...
		function arg_27_1.playNext_(arg_29_0)
			if arg_29_0 == 1 then
				arg_27_0:Play62203008(arg_27_1)
			end
		end
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_6 < arg_27_1.time_ and arg_27_1.time_ <= var_30_6 + arg_30_0 then
				...
				local var_30_8 = arg_27_1:FormatText(StoryNameCfg[49].name)
				...
				arg_27_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_4013")

				arg_27_1.callingController_:SetSelectedState("normal")

				local var_30_9 = arg_27_1:GetWordFromCfg(62203007)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203007", "story_v_chess_62203.awb") ~= 0 then
					local var_30_14 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203007", "story_v_chess_62203.awb") / 1000
					...
					if var_30_9.prefab_name ~= "" and arg_27_1.actors_[var_30_9.prefab_name] ~= nil then
						local var_30_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_27_1.actors_[var_30_9.prefab_name].transform, "story_v_chess_62203", "62203007", "story_v_chess_62203.awb")

						arg_27_1:RecordAudio("62203007", var_30_15)
						arg_27_1:RecordAudio("62203007", var_30_15)
					else
						arg_27_1:AudioAction("play", "voice", "story_v_chess_62203", "62203007", "story_v_chess_62203.awb")
					end

					arg_27_1:RecordHistoryTalkVoice("story_v_chess_62203", "62203007", "story_v_chess_62203.awb")
				end
	...
	Play62203008 = function(arg_31_0, arg_31_1)
		arg_31_1.time_ = 0
		arg_31_1.frameCnt_ = 0
		arg_31_1.state_ = "playing"
		arg_31_1.curTalkId_ = 62203008
		...
		function arg_31_1.playNext_(arg_33_0)
			if arg_33_0 == 1 then
				arg_31_0:Play62203009(arg_31_1)
			end
		end
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_9 < arg_31_1.time_ and arg_31_1.time_ <= var_34_9 + arg_34_0 then
				...
				local var_34_12 = arg_31_1:GetWordFromCfg(62203008)
	...
	Play62203009 = function(arg_35_0, arg_35_1)
		arg_35_1.time_ = 0
		arg_35_1.frameCnt_ = 0
		arg_35_1.state_ = "playing"
		arg_35_1.curTalkId_ = 62203009
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_0 < arg_35_1.time_ and arg_35_1.time_ <= var_38_0 + arg_38_0 then
				...
				local var_38_2 = arg_35_1:GetWordFromCfg(62203009)
