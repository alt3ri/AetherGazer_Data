return {
	Play105031001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031001
		slot1.duration_ = 4.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if uv0.bgs_.S0506a:GetComponent("SpriteRenderer") then
					slot8.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot9 = slot8.material
					uv0.var_.alphaOldValueS0506a = slot9:GetColor("_Color").a
					uv0.var_.alphaMatValueS0506a = slot9
				end

				uv0.var_.alphaOldValueS0506a = 0
			end

			slot8 = 1.5

			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueS0506a then
					slot11 = uv0.var_.alphaMatValueS0506a
					slot12 = slot11:GetColor("_Color")
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueS0506a, 1, (uv0.time_ - slot7) / slot8)

					slot11:SetColor("_Color", slot12)
				end
			end

			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 and uv0.var_.alphaMatValueS0506a then
				slot9 = uv0.var_.alphaMatValueS0506a
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				for slot17, slot18 in pairs(uv0.bgs_) do
					if slot17 ~= "S0506a" then
						slot18.transform.localPosition = Vector3.New(0, 100, 0)
					end
				end
			end

			if 1.4 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(105031001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031001", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031001", "story_v_out_105031.awb") / 1000 + slot15 then
						uv0.duration_ = slot24 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_105031", "105031001", "story_v_out_105031.awb")

						uv0:RecordAudio("105031001", slot25)
						uv0:RecordAudio("105031001", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031001", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031001", "story_v_out_105031.awb")
				end
	...
	Play105031002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031002
		slot1.duration_ = 6.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105031002).content)
	...
	Play105031003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(105031003).content)
	...
	Play105031004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031004
		slot1.duration_ = 8.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_5", "se_story_5_horseattack", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				for slot14, slot15 in pairs(uv0.bgs_) do
					if slot14 ~= "S0506" then
						slot15.transform.localPosition = Vector3.New(0, 100, 0)
					end
				end
			end

			slot7 = uv0.bgs_.S0506.transform

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosS0506 = slot7.localPosition
				slot7.localScale = Vector3.New(1.4, 1.4, 1.4)
			end

			slot9 = 3.2

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPosS0506, Vector3.New(3.8, -1.2, 10), (uv0.time_ - slot8) / slot9)
			end

			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(3.8, -1.2, 10)
			end

			if 2.8 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.shakeOldPos = manager.ui.mainCamera.transform.localPosition
			end
			...
			if uv0.time_ >= slot13 + 3.2 and uv0.time_ < slot13 + slot14 + slot0 then
				uv0.allBtn_.enabled = true
			end

			slot16 = 1.025

			if 3.2 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0.talkMaxDuration = 0
				uv0.dialogCg_.alpha = 1
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(105031004).content)
				uv0.text_.text = slot18

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (41 <= 0 and slot16 or slot16 * utf8.len(slot18) / slot19) > 0 and slot16 < slot21 then
	...
	Play105031005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031005", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031005", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031005", "story_v_out_105031.awb")

						uv0:RecordAudio("105031005", slot10)
						uv0:RecordAudio("105031005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031005", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031005", "story_v_out_105031.awb")
				end
	...
	Play105031006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(105031006).content)
	...
	Play105031007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031007
		slot1.duration_ = 8.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.var_.characterEffect1036ui_story == nil then
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(-0.7, -1.09, -5.78), (uv0.time_ - slot6) / slot7)
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(-0.7, -1.09, -5.78)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if uv0.bgs_.S0506:GetComponent("SpriteRenderer") then
					slot11.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot12 = slot11.material
					uv0.var_.alphaOldValueS0506 = slot12:GetColor("_Color").a
					uv0.var_.alphaMatValueS0506 = slot12
				end

				uv0.var_.alphaOldValueS0506 = 1
			end

			slot11 = 1.5

			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				if uv0.var_.alphaMatValueS0506 then
					slot14 = uv0.var_.alphaMatValueS0506
					slot15 = slot14:GetColor("_Color")
					slot15.a = Mathf.Lerp(uv0.var_.alphaOldValueS0506, 0, (uv0.time_ - slot10) / slot11)

					slot14:SetColor("_Color", slot15)
				end
			end

			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 and uv0.var_.alphaMatValueS0506 then
				slot12 = uv0.var_.alphaMatValueS0506
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				if uv0.bgs_.B04f:GetComponent("SpriteRenderer") then
					slot15.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot16 = slot15.material
					uv0.var_.alphaOldValueB04f = slot16:GetColor("_Color").a
					uv0.var_.alphaMatValueB04f = slot16
				end

				uv0.var_.alphaOldValueB04f = 0
			end

			slot15 = 1.5

			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				if uv0.var_.alphaMatValueB04f then
					slot18 = uv0.var_.alphaMatValueB04f
					slot19 = slot18:GetColor("_Color")
					slot19.a = Mathf.Lerp(uv0.var_.alphaOldValueB04f, 1, (uv0.time_ - slot14) / slot15)

					slot18:SetColor("_Color", slot19)
				end
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 and uv0.var_.alphaMatValueB04f then
				slot16 = uv0.var_.alphaMatValueB04f
			...
			if 3 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				uv0.talkMaxDuration = 0
				uv0.dialogCg_.alpha = 1
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(105031007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031007", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031007", "story_v_out_105031.awb") / 1000 + slot20 then
						uv0.duration_ = slot28 + slot20
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_105031", "105031007", "story_v_out_105031.awb")

						uv0:RecordAudio("105031007", slot29)
						uv0:RecordAudio("105031007", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031007", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031007", "story_v_out_105031.awb")
				end
	...
	Play105031008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(105031008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031008", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031008", "story_v_out_105031.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_105031", "105031008", "story_v_out_105031.awb")

						uv0:RecordAudio("105031008", slot22)
						uv0:RecordAudio("105031008", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031008", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031008", "story_v_out_105031.awb")
				end
	...
	Play105031009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(105031009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031009", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031009", "story_v_out_105031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_105031", "105031009", "story_v_out_105031.awb")

						uv0:RecordAudio("105031009", slot17)
						uv0:RecordAudio("105031009", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031009", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031009", "story_v_out_105031.awb")
				end
	...
	Play105031010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot12) / slot13)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(105031010).content)
				uv0.text_.text = slot23

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (42 <= 0 and slot20 or slot20 * utf8.len(slot23) / slot24) > 0 and slot20 < slot26 then
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031010", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031010", "story_v_out_105031.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_105031", "105031010", "story_v_out_105031.awb")

						uv0:RecordAudio("105031010", slot28)
						uv0:RecordAudio("105031010", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031010", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031010", "story_v_out_105031.awb")
				end
	...
	Play105031011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(105031011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031011", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031011", "story_v_out_105031.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_105031", "105031011", "story_v_out_105031.awb")

						uv0:RecordAudio("105031011", slot11)
						uv0:RecordAudio("105031011", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031011", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031011", "story_v_out_105031.awb")
				end
	...
	Play105031012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031012
		slot1.duration_ = 2.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(105031012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031012", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031012", "story_v_out_105031.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_105031", "105031012", "story_v_out_105031.awb")

						uv0:RecordAudio("105031012", slot20)
						uv0:RecordAudio("105031012", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031012", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031012", "story_v_out_105031.awb")
				end
	...
	Play105031013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(105031013).content)
				uv0.text_.text = slot7
	...
	Play105031014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031014
		slot1.duration_ = 8.366
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031014).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031014", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031014", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031014", "story_v_out_105031.awb")

						uv0:RecordAudio("105031014", slot10)
						uv0:RecordAudio("105031014", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031014", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031014", "story_v_out_105031.awb")
				end
	...
	Play105031015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031015).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031015", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031015", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031015", "story_v_out_105031.awb")

						uv0:RecordAudio("105031015", slot10)
						uv0:RecordAudio("105031015", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031015", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031015", "story_v_out_105031.awb")
				end
	...
	Play105031016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105031016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031016", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031016", "story_v_out_105031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105031", "105031016", "story_v_out_105031.awb")

						uv0:RecordAudio("105031016", slot18)
						uv0:RecordAudio("105031016", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031016", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031016", "story_v_out_105031.awb")
				end
	...
	Play105031017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031017
		slot1.duration_ = 1.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(105031017).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031017", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031017", "story_v_out_105031.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_105031", "105031017", "story_v_out_105031.awb")

						uv0:RecordAudio("105031017", slot22)
						uv0:RecordAudio("105031017", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031017", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031017", "story_v_out_105031.awb")
				end
	...
	Play105031018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105031018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031018", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031018", "story_v_out_105031.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105031", "105031018", "story_v_out_105031.awb")

						uv0:RecordAudio("105031018", slot19)
						uv0:RecordAudio("105031018", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031018", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031018", "story_v_out_105031.awb")
				end
	...
	Play105031019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(105031019).content)
				uv0.text_.text = slot7
	...
	Play105031020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(105031020).content)
				uv0.text_.text = slot4
	...
	Play105031021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031021
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031021).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031021", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031021", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031021", "story_v_out_105031.awb")

						uv0:RecordAudio("105031021", slot10)
						uv0:RecordAudio("105031021", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031021", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031021", "story_v_out_105031.awb")
				end
	...
	Play105031022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105031022).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031022", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031022", "story_v_out_105031.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105031", "105031022", "story_v_out_105031.awb")

						uv0:RecordAudio("105031022", slot19)
						uv0:RecordAudio("105031022", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031022", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031022", "story_v_out_105031.awb")
				end
	...
	Play105031023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(105031023).content)
				uv0.text_.text = slot11

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (55 <= 0 and slot9 or slot9 * utf8.len(slot11) / slot12) > 0 and slot9 < slot14 then
	...
	Play105031024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105031024).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031024", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031024", "story_v_out_105031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105031", "105031024", "story_v_out_105031.awb")

						uv0:RecordAudio("105031024", slot18)
						uv0:RecordAudio("105031024", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031024", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031024", "story_v_out_105031.awb")
				end
	...
	Play105031025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031025
		slot1.duration_ = 5.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(0.7, -1.09, -5.78), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0.7, -1.09, -5.78)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(105031025).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031025", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031025", "story_v_out_105031.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_105031", "105031025", "story_v_out_105031.awb")

						uv0:RecordAudio("105031025", slot27)
						uv0:RecordAudio("105031025", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031025", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031025", "story_v_out_105031.awb")
				end
	...
	Play105031026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031026
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(105031026).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031026", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031026", "story_v_out_105031.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_105031", "105031026", "story_v_out_105031.awb")

						uv0:RecordAudio("105031026", slot13)
						uv0:RecordAudio("105031026", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031026", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031026", "story_v_out_105031.awb")
				end
	...
	Play105031027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031027
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(105031027).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031027", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031027", "story_v_out_105031.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_105031", "105031027", "story_v_out_105031.awb")

						uv0:RecordAudio("105031027", slot21)
						uv0:RecordAudio("105031027", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031027", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031027", "story_v_out_105031.awb")
				end
	...
	Play105031028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031028
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("1084ui_story", "StoryTimeline/CharAction/1084/1084actionlink/1084action4913")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105031028).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031028", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031028", "story_v_out_105031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105031", "105031028", "story_v_out_105031.awb")

						uv0:RecordAudio("105031028", slot18)
						uv0:RecordAudio("105031028", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031028", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031028", "story_v_out_105031.awb")
				end
	...
	Play105031029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031029
		slot1.duration_ = 4.566
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105031029).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031029", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031029", "story_v_out_105031.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105031", "105031029", "story_v_out_105031.awb")

						uv0:RecordAudio("105031029", slot18)
						uv0:RecordAudio("105031029", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031029", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031029", "story_v_out_105031.awb")
				end
	...
	Play105031030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031030
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(105031030).content)
				uv0.text_.text = slot12

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (64 <= 0 and slot9 or slot9 * utf8.len(slot12) / slot13) > 0 and slot9 < slot15 then
					uv0.talkMaxDuration = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031030", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031030", "story_v_out_105031.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_105031", "105031030", "story_v_out_105031.awb")

						uv0:RecordAudio("105031030", slot17)
						uv0:RecordAudio("105031030", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031030", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031030", "story_v_out_105031.awb")
				end
	...
	Play105031031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031031
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(105031031).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031031", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031031", "story_v_out_105031.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105031", "105031031", "story_v_out_105031.awb")

						uv0:RecordAudio("105031031", slot19)
						uv0:RecordAudio("105031031", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031031", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031031", "story_v_out_105031.awb")
				end
	...
	Play105031032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031032
		slot1.duration_ = 5
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play105031033(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPosB04f = uv0.bgs_.B04f.transform.localPosition
			end

			slot3 = 0.001

			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPosB04f, Vector3.New(0, -100, 10), (uv0.time_ - slot2) / slot3)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(105031032).content)
				uv0.text_.text = slot9

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (61 <= 0 and slot7 or slot7 * utf8.len(slot9) / slot10) > 0 and slot7 < slot12 then
	...
	Play105031033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031033
		slot1.duration_ = 4.566
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031033).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031033", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031033", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031033", "story_v_out_105031.awb")

						uv0:RecordAudio("105031033", slot10)
						uv0:RecordAudio("105031033", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031033", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031033", "story_v_out_105031.awb")
				end
	...
	Play105031034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031034
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031034).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031034", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031034", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031034", "story_v_out_105031.awb")

						uv0:RecordAudio("105031034", slot10)
						uv0:RecordAudio("105031034", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031034", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031034", "story_v_out_105031.awb")
				end
	...
	Play105031035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031035
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031035).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031035", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031035", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031035", "story_v_out_105031.awb")

						uv0:RecordAudio("105031035", slot10)
						uv0:RecordAudio("105031035", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031035", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031035", "story_v_out_105031.awb")
				end
	...
	Play105031036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031036
		slot1.duration_ = 2.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031036).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031036", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031036", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031036", "story_v_out_105031.awb")

						uv0:RecordAudio("105031036", slot10)
						uv0:RecordAudio("105031036", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031036", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031036", "story_v_out_105031.awb")
				end
	...
	Play105031037 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031037
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(105031037).content)
				uv0.text_.text = slot4
	...
	Play105031038 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031038
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031038).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031038", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031038", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031038", "story_v_out_105031.awb")

						uv0:RecordAudio("105031038", slot10)
						uv0:RecordAudio("105031038", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031038", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031038", "story_v_out_105031.awb")
				end
	...
	Play105031039 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031039
		slot1.duration_ = 4.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031039).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031039", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031039", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031039", "story_v_out_105031.awb")

						uv0:RecordAudio("105031039", slot10)
						uv0:RecordAudio("105031039", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031039", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031039", "story_v_out_105031.awb")
				end
	...
	Play105031040 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031040
		slot1.duration_ = 2.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031040).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031040", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031040", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031040", "story_v_out_105031.awb")

						uv0:RecordAudio("105031040", slot10)
						uv0:RecordAudio("105031040", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031040", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031040", "story_v_out_105031.awb")
				end
	...
	Play105031041 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031041
		slot1.duration_ = 7.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031041).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031041", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031041", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031041", "story_v_out_105031.awb")

						uv0:RecordAudio("105031041", slot10)
						uv0:RecordAudio("105031041", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031041", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031041", "story_v_out_105031.awb")
				end
	...
	Play105031042 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031042
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_5", "se_story_5_brain", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.var_.moveOldPosS0501 = uv0.bgs_.S0501.transform.localPosition
			end

			slot7 = 0.001

			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPosS0501, Vector3.New(0, -100, 10), (uv0.time_ - slot6) / slot7)
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(0, -100, 10)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(105031042).content)
				uv0.text_.text = slot13

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (6 <= 0 and slot11 or slot11 * utf8.len(slot13) / slot14) > 0 and slot11 < slot16 then
					uv0.talkMaxDuration = slot16
	...
	Play105031043 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031043
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_5", "se_story_5_cup", "")
			end

			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0.var_.moveOldPosSTblack = uv0.bgs_.STblack.transform.localPosition
			end

			slot5 = 0.001

			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot3.localPosition = Vector3.Lerp(uv0.var_.moveOldPosSTblack, Vector3.New(0, -100, 10), (uv0.time_ - slot4) / slot5)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(105031043).content)
				uv0.text_.text = slot12

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (1 <= 0 and slot9 or slot9 * utf8.len(slot12) / slot13) > 0 and slot9 < slot15 then
					uv0.talkMaxDuration = slot15
	...
	Play105031044 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031044
		slot1.duration_ = 3.266
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(105031044).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031044", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031044", "story_v_out_105031.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_105031", "105031044", "story_v_out_105031.awb")

						uv0:RecordAudio("105031044", slot12)
						uv0:RecordAudio("105031044", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031044", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031044", "story_v_out_105031.awb")
				end
	...
	Play105031045 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031045
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(105031045).content)
				uv0.text_.text = slot4
	...
	Play105031046 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031046
		slot1.duration_ = 4.066
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031046).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031046", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031046", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031046", "story_v_out_105031.awb")

						uv0:RecordAudio("105031046", slot10)
						uv0:RecordAudio("105031046", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031046", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031046", "story_v_out_105031.awb")
				end
	...
	Play105031047 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031047
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031047).content)
				uv0.text_.text = slot5
	...
	Play105031048 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031048
		slot1.duration_ = 1.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031048).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031048", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031048", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031048", "story_v_out_105031.awb")

						uv0:RecordAudio("105031048", slot10)
						uv0:RecordAudio("105031048", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031048", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031048", "story_v_out_105031.awb")
				end
	...
	Play105031049 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031049
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031049).content)
				uv0.text_.text = slot5
	...
	Play105031050 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031050
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031050).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_105031", "105031050", "story_v_out_105031.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_105031", "105031050", "story_v_out_105031.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105031", "105031050", "story_v_out_105031.awb")

						uv0:RecordAudio("105031050", slot10)
						uv0:RecordAudio("105031050", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_105031", "105031050", "story_v_out_105031.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_105031", "105031050", "story_v_out_105031.awb")
				end
	...
	Play105031051 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 105031051
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(105031051).content)
				uv0.text_.text = slot5
