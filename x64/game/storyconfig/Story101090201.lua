return {
	Play109021001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021001
		slot1.duration_ = 8.3
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play109021002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.C02b == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.C02b:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueC02b = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueC02b = slot6
				end

				uv0.var_.alphaOldValueC02b = 0
			end

			slot5 = 1.5

			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueC02b then
					slot8 = uv0.var_.alphaMatValueC02b
					slot9 = slot8:GetColor("_Color")
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueC02b, 1, (uv0.time_ - slot4) / slot5)

					slot8:SetColor("_Color", slot9)
				end
			end

			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 and uv0.var_.alphaMatValueC02b then
				slot6 = uv0.var_.alphaMatValueC02b
			...
			if 1.8 < uv0.time_ and uv0.time_ <= slot11 + slot0 and uv0.var_.characterEffect1084ui_story == nil then
			...
			if 2 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(109021001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021001", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021001", "story_v_out_109021.awb") / 1000 + slot19 then
						uv0.duration_ = slot28 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						slot29 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_109021", "109021001", "story_v_out_109021.awb")

						uv0:RecordAudio("109021001", slot29)
						uv0:RecordAudio("109021001", slot29)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021001", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021001", "story_v_out_109021.awb")
				end
	...
	Play109021002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021002
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1099ui_story, Vector3.New(0.7, -1.08, -5.9), (uv0.time_ - slot10) / slot11)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(109021002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021002", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021002", "story_v_out_109021.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_109021", "109021002", "story_v_out_109021.awb")

						uv0:RecordAudio("109021002", slot22)
						uv0:RecordAudio("109021002", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021002", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021002", "story_v_out_109021.awb")
				end
	...
	Play109021003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(109021003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021003", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021003", "story_v_out_109021.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_109021", "109021003", "story_v_out_109021.awb")

						uv0:RecordAudio("109021003", slot11)
						uv0:RecordAudio("109021003", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021003", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021003", "story_v_out_109021.awb")
				end
	...
	Play109021004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021004
		slot1.duration_ = 8.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(109021004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021004", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021004", "story_v_out_109021.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_109021", "109021004", "story_v_out_109021.awb")

						uv0:RecordAudio("109021004", slot18)
						uv0:RecordAudio("109021004", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021004", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021004", "story_v_out_109021.awb")
				end
	...
	Play109021005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.var_.characterEffect1050ui_story == nil then
			...
			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.characterEffect1050ui_story then
				uv0.var_.characterEffect1050ui_story.fillFlat = false
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1099ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot9) / slot10)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0:PlayTimeline("1050ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface2104cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(109021005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021005", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021005", "story_v_out_109021.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_109021", "109021005", "story_v_out_109021.awb")

						uv0:RecordAudio("109021005", slot25)
						uv0:RecordAudio("109021005", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021005", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021005", "story_v_out_109021.awb")
				end
	...
	Play109021006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("1084ui_story", "StoryTimeline/CharAction/1084/1084actionlink/1084action4912")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(109021006).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021006", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021006", "story_v_out_109021.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_109021", "109021006", "story_v_out_109021.awb")

						uv0:RecordAudio("109021006", slot18)
						uv0:RecordAudio("109021006", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021006", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021006", "story_v_out_109021.awb")
				end
	...
	Play109021007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021007
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(109021007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021007", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021007", "story_v_out_109021.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_109021", "109021007", "story_v_out_109021.awb")

						uv0:RecordAudio("109021007", slot17)
						uv0:RecordAudio("109021007", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021007", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021007", "story_v_out_109021.awb")
				end
	...
	Play109021008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 and uv0.var_.characterEffect1038ui_story == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(109021008).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021008", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021008", "story_v_out_109021.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_109021", "109021008", "story_v_out_109021.awb")

						uv0:RecordAudio("109021008", slot25)
						uv0:RecordAudio("109021008", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021008", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021008", "story_v_out_109021.awb")
				end
	...
	Play109021009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(109021009).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021009", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021009", "story_v_out_109021.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_109021", "109021009", "story_v_out_109021.awb")

						uv0:RecordAudio("109021009", slot11)
						uv0:RecordAudio("109021009", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021009", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021009", "story_v_out_109021.awb")
				end
	...
	Play109021010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(109021010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021010", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021010", "story_v_out_109021.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_109021", "109021010", "story_v_out_109021.awb")

						uv0:RecordAudio("109021010", slot13)
						uv0:RecordAudio("109021010", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021010", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021010", "story_v_out_109021.awb")
				end
	...
	Play109021011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021011
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[84].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play109021012(uv1)
			end
		end
	...
	Play109021012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(109021012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021012", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021012", "story_v_out_109021.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_109021", "109021012", "story_v_out_109021.awb")

						uv0:RecordAudio("109021012", slot10)
						uv0:RecordAudio("109021012", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021012", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021012", "story_v_out_109021.awb")
				end
	...
	Play109021013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(109021013).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021013", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021013", "story_v_out_109021.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_109021", "109021013", "story_v_out_109021.awb")

						uv0:RecordAudio("109021013", slot18)
						uv0:RecordAudio("109021013", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021013", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021013", "story_v_out_109021.awb")
				end
	...
	Play109021014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(109021014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021014", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021014", "story_v_out_109021.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_109021", "109021014", "story_v_out_109021.awb")

						uv0:RecordAudio("109021014", slot21)
						uv0:RecordAudio("109021014", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021014", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021014", "story_v_out_109021.awb")
				end
	...
	Play109021015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(109021015).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021015", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021015", "story_v_out_109021.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_109021", "109021015", "story_v_out_109021.awb")

						uv0:RecordAudio("109021015", slot17)
						uv0:RecordAudio("109021015", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021015", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021015", "story_v_out_109021.awb")
				end
	...
	Play109021016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(109021016).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021016", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021016", "story_v_out_109021.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_109021", "109021016", "story_v_out_109021.awb")

						uv0:RecordAudio("109021016", slot17)
						uv0:RecordAudio("109021016", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021016", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021016", "story_v_out_109021.awb")
				end
	...
	Play109021017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 109021017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(109021017).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_109021", "109021017", "story_v_out_109021.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_109021", "109021017", "story_v_out_109021.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_109021", "109021017", "story_v_out_109021.awb")

						uv0:RecordAudio("109021017", slot17)
						uv0:RecordAudio("109021017", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_109021", "109021017", "story_v_out_109021.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_109021", "109021017", "story_v_out_109021.awb")
				end
