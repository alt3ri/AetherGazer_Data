return {
	Play104101001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.79999995231628 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2070_tpose, Vector3.New(0, -0.49, -3.1), (uv0.time_ - slot10) / slot11)
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(0, -0.49, -3.1)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104101001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101001", "story_v_out_104101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104101", "104101001", "story_v_out_104101.awb") / 1000 + slot14 then
						uv0.duration_ = slot23 + slot14
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104101", "104101001", "story_v_out_104101.awb")

						uv0:RecordAudio("104101001", slot24)
						uv0:RecordAudio("104101001", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104101", "104101001", "story_v_out_104101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104101", "104101001", "story_v_out_104101.awb")
				end
	...
	Play104101002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story", "se_story_fight_normalgun", "")
			end
			...
			slot9 = 0.600000023841858

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot11, slot12 = math.modf((uv0.time_ - slot8) / 0.066)
				slot7.localPosition = Vector3.New(slot12 * 0.13, slot12 * 0.13, slot12 * 0.13) + uv0.var_.shakeOldPosMainCamera
			end

			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = uv0.var_.shakeOldPosMainCamera
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104101002).content)
				uv0.text_.text = slot13

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (8 <= 0 and slot11 or slot11 * utf8.len(slot13) / slot14) > 0 and slot11 < slot16 then
	...
	Play104101003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2070_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot2) / slot3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104101003).content)
	...
	Play104101004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104101004).content)
	...
	Play104101005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if uv0.bgs_.S0408:GetComponent("SpriteRenderer") then
					slot7.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot8 = slot7.material
					uv0.var_.alphaOldValueS0408 = slot8:GetColor("_Color").a
					uv0.var_.alphaMatValueS0408 = slot8
				end

				uv0.var_.alphaOldValueS0408 = 0
			end

			slot7 = 1.5

			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.alphaMatValueS0408 then
					slot10 = uv0.var_.alphaMatValueS0408
					slot11 = slot10:GetColor("_Color")
					slot11.a = Mathf.Lerp(uv0.var_.alphaOldValueS0408, 1, (uv0.time_ - slot6) / slot7)

					slot10:SetColor("_Color", slot11)
				end
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.alphaMatValueS0408 then
				slot8 = uv0.var_.alphaMatValueS0408
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if uv0.bgs_.B13:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB13 = slot11:GetColor("_Color").a
					uv0.var_.alphaMatValueB13 = slot11
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				if uv0.var_.alphaMatValueB13 then
					slot13 = uv0.var_.alphaMatValueB13
					slot14 = slot13:GetColor("_Color")
					slot14.a = Mathf.Lerp(uv0.var_.alphaOldValueB13, 0, (uv0.time_ - slot9) / slot10)

					slot13:SetColor("_Color", slot14)
				end
			end

			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.alphaMatValueB13 then
			...
			if uv0.time_ >= slot11 + 3 and uv0.time_ < slot11 + slot12 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 3 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(104101005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101005", "story_v_out_104101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104101", "104101005", "story_v_out_104101.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104101", "104101005", "story_v_out_104101.awb")

						uv0:RecordAudio("104101005", slot22)
						uv0:RecordAudio("104101005", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104101", "104101005", "story_v_out_104101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104101", "104101005", "story_v_out_104101.awb")
				end
	...
	Play104101006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101006
		slot1.duration_ = 5
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play104101007(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.actors_["2019_tpose"] == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.var_.characterEffect2019_tpose == nil then
				uv0.var_.characterEffect2019_tpose = uv0.actors_["2019_tpose"]:GetComponentInChildren(typeof(CharacterEffect))
			end

			slot4 = 0.1

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.characterEffect2019_tpose then
					uv0.var_.characterEffect2019_tpose.fillFlat = true
					uv0.var_.characterEffect2019_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot3) / slot4)
				end
			end

			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.characterEffect2019_tpose then
				uv0.var_.characterEffect2019_tpose.fillFlat = true
				uv0.var_.characterEffect2019_tpose.fillRatio = 0.5
			end

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.var_.moveOldPos2019_tpose = uv0.actors_["2019_tpose"].transform.localPosition
			end

			slot7 = 0.001

			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2019_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot6) / slot7)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(104101006).content)
	...
	Play104101007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(104101007).content)
	...
	Play104101008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101008
		slot1.duration_ = 8.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104101008).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101008", "story_v_out_104101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104101", "104101008", "story_v_out_104101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104101", "104101008", "story_v_out_104101.awb")

						uv0:RecordAudio("104101008", slot10)
						uv0:RecordAudio("104101008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104101", "104101008", "story_v_out_104101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104101", "104101008", "story_v_out_104101.awb")
				end
	...
	Play104101009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104101009).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101009", "story_v_out_104101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104101", "104101009", "story_v_out_104101.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104101", "104101009", "story_v_out_104101.awb")

						uv0:RecordAudio("104101009", slot12)
						uv0:RecordAudio("104101009", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104101", "104101009", "story_v_out_104101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104101", "104101009", "story_v_out_104101.awb")
				end
	...
	Play104101010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101010
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[27].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play104101011(uv1)
			end
		end
	...
	Play104101011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.leftNameTxt_.text = uv0:FormatText(StoryNameCfg[64].name)
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104101011).content)
	...
	Play104101012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104101012).content)
				uv0.text_.text = slot7
	...
	Play104101013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104101013).content)
				uv0.text_.text = slot5
	...
	Play104101014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101014
		slot1.duration_ = 6.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if uv0.bgs_.S0408a:GetComponent("SpriteRenderer") then
					slot4.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot5 = slot4.material
					uv0.var_.alphaOldValueS0408a = slot5:GetColor("_Color").a
					uv0.var_.alphaMatValueS0408a = slot5
				end

				uv0.var_.alphaOldValueS0408a = 1
			end

			slot4 = 1.5

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.alphaMatValueS0408a then
					slot7 = uv0.var_.alphaMatValueS0408a
					slot8 = slot7:GetColor("_Color")
					slot8.a = Mathf.Lerp(uv0.var_.alphaOldValueS0408a, 0, (uv0.time_ - slot3) / slot4)

					slot7:SetColor("_Color", slot8)
				end
			end

			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.alphaMatValueS0408a then
				slot5 = uv0.var_.alphaMatValueS0408a
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPosS0408a = uv0.bgs_.S0408a.transform.localPosition
			end

			slot10 = 0.1

			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPosS0408a, Vector3.New(0, -100, 0), (uv0.time_ - slot9) / slot10)
			end
			...
			if uv0.time_ >= slot11 + 1.8 and uv0.time_ < slot11 + slot12 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 1.8 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(104101014).content)
	...
	Play104101015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101015
		slot1.duration_ = 8.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104101015).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101015", "story_v_out_104101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104101", "104101015", "story_v_out_104101.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104101", "104101015", "story_v_out_104101.awb")

						uv0:RecordAudio("104101015", slot19)
						uv0:RecordAudio("104101015", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104101", "104101015", "story_v_out_104101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104101", "104101015", "story_v_out_104101.awb")
				end
	...
	Play104101016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104101016).content)
	...
	Play104101017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(104101017).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101017", "story_v_out_104101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104101", "104101017", "story_v_out_104101.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_104101", "104101017", "story_v_out_104101.awb")

						uv0:RecordAudio("104101017", slot15)
						uv0:RecordAudio("104101017", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104101", "104101017", "story_v_out_104101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104101", "104101017", "story_v_out_104101.awb")
				end
	...
	Play104101018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(104101018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101018", "story_v_out_104101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104101", "104101018", "story_v_out_104101.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_104101", "104101018", "story_v_out_104101.awb")

						uv0:RecordAudio("104101018", slot11)
						uv0:RecordAudio("104101018", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104101", "104101018", "story_v_out_104101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104101", "104101018", "story_v_out_104101.awb")
				end
	...
	Play104101019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104101019).content)
				uv0.text_.text = slot8
	...
	Play104101020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104101020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104101020).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101020", "story_v_out_104101.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104101", "104101020", "story_v_out_104101.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104101", "104101020", "story_v_out_104101.awb")

						uv0:RecordAudio("104101020", slot10)
						uv0:RecordAudio("104101020", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104101", "104101020", "story_v_out_104101.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104101", "104101020", "story_v_out_104101.awb")
				end
