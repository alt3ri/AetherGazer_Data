return {
	Play317152001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_30 < arg_1_1.time_ and arg_1_1.time_ <= var_4_30 + arg_4_0 then
				...
				local var_4_33 = arg_1_1:GetWordFromCfg(317152001)
	...
	Play317152002 = function(arg_7_0, arg_7_1)
		arg_7_1.time_ = 0
		arg_7_1.frameCnt_ = 0
		arg_7_1.state_ = "playing"
		arg_7_1.curTalkId_ = 317152002
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_17 < arg_7_1.time_ and arg_7_1.time_ <= var_10_17 + arg_10_0 then
				arg_7_1:PlayTimeline("1093ui_story", "StoryTimeline/CharAction/1093/1093action/1093action2_1")
			end
			...
			if var_10_19 < arg_7_1.time_ and arg_7_1.time_ <= var_10_19 + arg_10_0 then
				...
				local var_10_22 = arg_7_1:GetWordFromCfg(317152002)
				...
				if manager.audio:GetVoiceLength("story_v_out_317152", "317152002", "story_v_out_317152.awb") ~= 0 then
					local var_10_27 = manager.audio:GetVoiceLength("story_v_out_317152", "317152002", "story_v_out_317152.awb") / 1000
					...
					if var_10_22.prefab_name ~= "" and arg_7_1.actors_[var_10_22.prefab_name] ~= nil then
						local var_10_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_7_1.actors_[var_10_22.prefab_name].transform, "story_v_out_317152", "317152002", "story_v_out_317152.awb")

						arg_7_1:RecordAudio("317152002", var_10_28)
						arg_7_1:RecordAudio("317152002", var_10_28)
					else
						arg_7_1:AudioAction("play", "voice", "story_v_out_317152", "317152002", "story_v_out_317152.awb")
					end

					arg_7_1:RecordHistoryTalkVoice("story_v_out_317152", "317152002", "story_v_out_317152.awb")
				end
	...
	Play317152003 = function(arg_11_0, arg_11_1)
		arg_11_1.time_ = 0
		arg_11_1.frameCnt_ = 0
		arg_11_1.state_ = "playing"
		arg_11_1.curTalkId_ = 317152003
		...
		function arg_11_1.playNext_(arg_13_0)
			if arg_13_0 == 1 then
				arg_11_0:Play317152004(arg_11_1)
			end
		end
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			local var_14_19 = arg_11_1.actors_["1093ui_story"].transform
			local var_14_20 = 0

			if var_14_20 < arg_11_1.time_ and arg_11_1.time_ <= var_14_20 + arg_14_0 then
				arg_11_1.var_.moveOldPos1093ui_story = var_14_19.localPosition
			end
			...
			if var_14_20 <= arg_11_1.time_ and arg_11_1.time_ < var_14_20 + var_14_21 then
				...
				var_14_19.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1093ui_story, var_14_23, var_14_22)
			...
			local var_14_28 = arg_11_1.actors_["1093ui_story"]
			local var_14_29 = 0

			if var_14_29 < arg_11_1.time_ and arg_11_1.time_ <= var_14_29 + arg_14_0 and arg_11_1.var_.characterEffect1093ui_story == nil then
				arg_11_1.var_.characterEffect1093ui_story = var_14_28:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_14_29 <= arg_11_1.time_ and arg_11_1.time_ < var_14_29 + var_14_30 then
				...
				if arg_11_1.var_.characterEffect1093ui_story then
					...
					arg_11_1.var_.characterEffect1093ui_story.fillRatio = var_14_32
				end
			end

			if arg_11_1.time_ >= var_14_29 + var_14_30 and arg_11_1.time_ < var_14_29 + var_14_30 + arg_14_0 and arg_11_1.var_.characterEffect1093ui_story then
				local var_14_33 = 0.5

				arg_11_1.var_.characterEffect1093ui_story.fillFlat = true
				arg_11_1.var_.characterEffect1093ui_story.fillRatio = var_14_33
			end
			...
			if var_14_34 < arg_11_1.time_ and arg_11_1.time_ <= var_14_34 + arg_14_0 then
				...
				local var_14_37 = arg_11_1:GetWordFromCfg(317152003)
				...
				if manager.audio:GetVoiceLength("story_v_out_317152", "317152003", "story_v_out_317152.awb") ~= 0 then
					local var_14_42 = manager.audio:GetVoiceLength("story_v_out_317152", "317152003", "story_v_out_317152.awb") / 1000
					...
					if var_14_37.prefab_name ~= "" and arg_11_1.actors_[var_14_37.prefab_name] ~= nil then
						local var_14_43 = LuaForUtil.PlayVoiceWithCriLipsync(arg_11_1.actors_[var_14_37.prefab_name].transform, "story_v_out_317152", "317152003", "story_v_out_317152.awb")

						arg_11_1:RecordAudio("317152003", var_14_43)
						arg_11_1:RecordAudio("317152003", var_14_43)
					else
						arg_11_1:AudioAction("play", "voice", "story_v_out_317152", "317152003", "story_v_out_317152.awb")
					end

					arg_11_1:RecordHistoryTalkVoice("story_v_out_317152", "317152003", "story_v_out_317152.awb")
				end
	...
	Play317152004 = function(arg_15_0, arg_15_1)
		arg_15_1.time_ = 0
		arg_15_1.frameCnt_ = 0
		arg_15_1.state_ = "playing"
		arg_15_1.curTalkId_ = 317152004
		...
		function arg_15_1.playNext_(arg_17_0)
			if arg_17_0 == 1 then
				arg_15_0:Play317152005(arg_15_1)
			end
		end
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_15 < arg_15_1.time_ and arg_15_1.time_ <= var_18_15 + arg_18_0 then
				...
				local var_18_17 = arg_15_1:GetWordFromCfg(317152004)
	...
	Play317152005 = function(arg_19_0, arg_19_1)
		arg_19_1.time_ = 0
		arg_19_1.frameCnt_ = 0
		arg_19_1.state_ = "playing"
		arg_19_1.curTalkId_ = 317152005
		...
		function arg_19_1.playNext_(arg_21_0)
			if arg_21_0 == 1 then
				arg_19_0:Play317152006(arg_19_1)
			end
		end
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_0 < arg_19_1.time_ and arg_19_1.time_ <= var_22_0 + arg_22_0 then
				...
				local var_22_2 = arg_19_1:FormatText(StoryNameCfg[558].name)
				...
				arg_19_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10047")

				arg_19_1.callingController_:SetSelectedState("normal")

				local var_22_3 = arg_19_1:GetWordFromCfg(317152005)
				...
				if manager.audio:GetVoiceLength("story_v_out_317152", "317152005", "story_v_out_317152.awb") ~= 0 then
					local var_22_8 = manager.audio:GetVoiceLength("story_v_out_317152", "317152005", "story_v_out_317152.awb") / 1000
					...
					if var_22_3.prefab_name ~= "" and arg_19_1.actors_[var_22_3.prefab_name] ~= nil then
						local var_22_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_19_1.actors_[var_22_3.prefab_name].transform, "story_v_out_317152", "317152005", "story_v_out_317152.awb")

						arg_19_1:RecordAudio("317152005", var_22_9)
						arg_19_1:RecordAudio("317152005", var_22_9)
					else
						arg_19_1:AudioAction("play", "voice", "story_v_out_317152", "317152005", "story_v_out_317152.awb")
					end

					arg_19_1:RecordHistoryTalkVoice("story_v_out_317152", "317152005", "story_v_out_317152.awb")
				end
	...
	Play317152006 = function(arg_23_0, arg_23_1)
		arg_23_1.time_ = 0
		arg_23_1.frameCnt_ = 0
		arg_23_1.state_ = "playing"
		arg_23_1.curTalkId_ = 317152006
		arg_23_1.duration_ = 1.533
		...
		function arg_23_1.playNext_(arg_25_0)
			if arg_25_0 == 1 then
				arg_23_0:Play317152007(arg_23_1)
			end
		end
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_0 + arg_26_0 then
				...
				local var_26_2 = arg_23_1:FormatText(StoryNameCfg[479].name)
				...
				arg_23_1.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1015")

				arg_23_1.callingController_:SetSelectedState("normal")

				local var_26_3 = arg_23_1:GetWordFromCfg(317152006)
				...
				if manager.audio:GetVoiceLength("story_v_out_317152", "317152006", "story_v_out_317152.awb") ~= 0 then
					local var_26_8 = manager.audio:GetVoiceLength("story_v_out_317152", "317152006", "story_v_out_317152.awb") / 1000
					...
					if var_26_3.prefab_name ~= "" and arg_23_1.actors_[var_26_3.prefab_name] ~= nil then
						local var_26_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_23_1.actors_[var_26_3.prefab_name].transform, "story_v_out_317152", "317152006", "story_v_out_317152.awb")

						arg_23_1:RecordAudio("317152006", var_26_9)
						arg_23_1:RecordAudio("317152006", var_26_9)
					else
						arg_23_1:AudioAction("play", "voice", "story_v_out_317152", "317152006", "story_v_out_317152.awb")
					end

					arg_23_1:RecordHistoryTalkVoice("story_v_out_317152", "317152006", "story_v_out_317152.awb")
				end
	...
	Play317152007 = function(arg_27_0, arg_27_1)
		arg_27_1.time_ = 0
		arg_27_1.frameCnt_ = 0
		arg_27_1.state_ = "playing"
		arg_27_1.curTalkId_ = 317152007
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_22 < arg_27_1.time_ and arg_27_1.time_ <= var_30_22 + arg_30_0 then
				...
				local var_30_24 = LeanTween.value(arg_27_1.dialog_, 0, 1, 0.3)

				var_30_24:setOnUpdate(LuaHelper.FloatAction(function(arg_31_0)
					arg_27_1.dialogCg_.alpha = arg_31_0
				end))
				var_30_24:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_27_1.dialog_)
					var_30_24:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_30_25 = arg_27_1:GetWordFromCfg(317152007)
			...
			local var_30_30 = var_30_22 + 0.3
			local var_30_31 = math.max(var_30_23, arg_27_1.talkMaxDuration)
