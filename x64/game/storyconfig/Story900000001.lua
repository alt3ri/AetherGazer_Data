	...
	Play900000008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1033", slot17)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1038", slot20)
	...
	Play900000009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1019", slot16)
	...
	Play900000014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				...
				if uv0.var_.actorSpriteComps1019 then
					slot16 = uv0.var_.actorSpriteComps1019
					slot18 = slot16
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1038", slot19)
	...
	Play900000017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1019", slot19)
	...
	Play900000018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1019", slot10)
