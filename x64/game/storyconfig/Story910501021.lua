return {
	Play910501007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910501007
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(910501007).content)
	...
	Play910501008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910501008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10048ui_story, Vector3.New(0.7, -1.155, -6.13), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0.7, -1.155, -6.13)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 and uv0.var_.characterEffect10048ui_story == nil then
			...
			if 0.034000001847744 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				if uv0.var_.characterEffect10048ui_story == nil then
					uv0.var_.characterEffect10048ui_story = uv0.actors_["10048ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
				end

				slot18 = uv0.var_.characterEffect10048ui_story
			...
			if 0.034000001847744 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				if uv0.var_.characterEffect10048ui_story == nil then
					uv0.var_.characterEffect10048ui_story = uv0.actors_["10048ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
				end

				uv0.var_.characterEffect10048ui_story.imageEffect:turnOn(false)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot25 = uv0:FormatText(uv0:GetWordFromCfg(910501008).content)
	...
	Play910501009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910501009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(910501009).content)
	...
	Play910501010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910501010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(910501010).content)
	...
	Play910501011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910501011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(910501011).content)
