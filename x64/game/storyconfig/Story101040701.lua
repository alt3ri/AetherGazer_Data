return {
	Play104071001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if uv0.bgs_.B06a:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB06a = slot13:GetColor("_Color").a
					uv0.var_.alphaMatValueB06a = slot13
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.alphaMatValueB06a then
					slot15 = uv0.var_.alphaMatValueB06a
					slot16 = slot15:GetColor("_Color")
					slot16.a = Mathf.Lerp(uv0.var_.alphaOldValueB06a, 1, (uv0.time_ - slot11) / slot12)

					slot15:SetColor("_Color", slot16)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.alphaMatValueB06a then
				slot13 = uv0.var_.alphaMatValueB06a
			...
			if 2 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				slot25 = uv0:FormatText(uv0:GetWordFromCfg(104071001).content)
				uv0.text_.text = slot25

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (19 <= 0 and slot21 or slot21 * utf8.len(slot25) / slot26) > 0 and slot21 < slot28 then
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071001", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071001", "story_v_out_104071.awb") / 1000 + slot20 then
						uv0.duration_ = slot29 + slot20
					end

					if slot24.prefab_name ~= "" and uv0.actors_[slot24.prefab_name] ~= nil then
						slot30 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot24.prefab_name].transform, "story_v_out_104071", "104071001", "story_v_out_104071.awb")

						uv0:RecordAudio("104071001", slot30)
						uv0:RecordAudio("104071001", slot30)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071001", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071001", "story_v_out_104071.awb")
				end
	...
	Play104071002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(0.7, -1.23, -5.8), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0.7, -1.23, -5.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(104071002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071002", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071002", "story_v_out_104071.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104071", "104071002", "story_v_out_104071.awb")

						uv0:RecordAudio("104071002", slot22)
						uv0:RecordAudio("104071002", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071002", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071002", "story_v_out_104071.awb")
				end
	...
	Play104071003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104071003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071003", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071003", "story_v_out_104071.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104071", "104071003", "story_v_out_104071.awb")

						uv0:RecordAudio("104071003", slot12)
						uv0:RecordAudio("104071003", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071003", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071003", "story_v_out_104071.awb")
				end
	...
	Play104071004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071004
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.characterEffect10001_tpose then
					...
					uv0.var_.characterEffect10001_tpose.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot6) / slot7)
				end
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(0, -0.97, -6), (uv0.time_ - slot15) / slot16)
				slot20 = manager.ui.mainCamera.transform.position - slot14.position
				slot14.forward = Vector3.New(slot20.x, slot20.y, slot20.z)
				slot21 = slot14.localEulerAngles
				slot21.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(104071004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071004", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071004", "story_v_out_104071.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_104071", "104071004", "story_v_out_104071.awb")

						uv0:RecordAudio("104071004", slot28)
						uv0:RecordAudio("104071004", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071004", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071004", "story_v_out_104071.awb")
				end
	...
	Play104071005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104071005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071005", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071005", "story_v_out_104071.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104071", "104071005", "story_v_out_104071.awb")

						uv0:RecordAudio("104071005", slot24)
						uv0:RecordAudio("104071005", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071005", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071005", "story_v_out_104071.awb")
				end
	...
	Play104071006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104071006).content)
	...
	Play104071007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(0, -1.09, -5.78), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, -1.09, -5.78)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(104071007).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071007", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071007", "story_v_out_104071.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104071", "104071007", "story_v_out_104071.awb")

						uv0:RecordAudio("104071007", slot22)
						uv0:RecordAudio("104071007", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071007", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071007", "story_v_out_104071.awb")
				end
	...
	Play104071008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104071008).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071008", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071008", "story_v_out_104071.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104071", "104071008", "story_v_out_104071.awb")

						uv0:RecordAudio("104071008", slot13)
						uv0:RecordAudio("104071008", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071008", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071008", "story_v_out_104071.awb")
				end
	...
	Play104071009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/1036/1036action/1036action5_2")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg
 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104071022).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071022", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071022", "story_v_out_104071.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104071", "104071022", "story_v_out_104071.awb")

						uv0:RecordAudio("104071022", slot24)
						uv0:RecordAudio("104071022", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071022", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071022", "story_v_out_104071.awb")
				end
	...
	Play104071023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071023
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104071023).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071023", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071023", "story_v_out_104071.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104071", "104071023", "story_v_out_104071.awb")

						uv0:RecordAudio("104071023", slot12)
						uv0:RecordAudio("104071023", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071023", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071023", "story_v_out_104071.awb")
				end
	...
	Play104071024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071024
		slot1.duration_ = 6.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				if uv0.bgs_.B06a:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB06a = slot4:GetColor("_Color").a
					uv0.var_.alphaMatValueB06a = slot4
				end

				uv0.var_.alphaOldValueB06a = 1
			end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				if uv0.var_.alphaMatValueB06a then
					slot6 = uv0.var_.alphaMatValueB06a
					slot7 = slot6:GetColor("_Color")
					slot7.a = Mathf.Lerp(uv0.var_.alphaOldValueB06a, 0, (uv0.time_ - slot2) / slot3)

					slot6:SetColor("_Color", slot7)
				end
			end

			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 and uv0.var_.alphaMatValueB06a then
				slot4 = uv0.var_.alphaMatValueB06a
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPosB06a = uv0.bgs_.B06a.transform.localPosition
			end

			slot6 = 0.001

			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPosB06a, Vector3.New(0, -100, 10), (uv0.time_ - slot5) / slot6)
			end
			...
			if uv0.time_ >= slot15 + 1.5 and uv0.time_ < slot15 + slot16 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(104071024).content)
	...
	Play104071025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071025
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104071025).content)
	...
	Play104071026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071026
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104071026).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071026", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071026", "story_v_out_104071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104071", "104071026", "story_v_out_104071.awb")

						uv0:RecordAudio("104071026", slot10)
						uv0:RecordAudio("104071026", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071026", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071026", "story_v_out_104071.awb")
				end
	...
	Play104071027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071027
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104071027).content)
				uv0.text_.text = slot5
	...
	Play104071028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071028
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104071028).content)
				uv0.text_.text = slot7
	...
	Play104071029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071029
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(104071029).content)
	...
	Play104071030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071030
		slot1.duration_ = 8.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104071030).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071030", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071030", "story_v_out_104071.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104071", "104071030", "story_v_out_104071.awb")

						uv0:RecordAudio("104071030", slot10)
						uv0:RecordAudio("104071030", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071030", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071030", "story_v_out_104071.awb")
				end
	...
	Play104071031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071031
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104071031).content)
				uv0.text_.text = slot5
	...
	Play104071032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071032
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104071032).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071032", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071032", "story_v_out_104071.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104071", "104071032", "story_v_out_104071.awb")

						uv0:RecordAudio("104071032", slot19)
						uv0:RecordAudio("104071032", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071032", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071032", "story_v_out_104071.awb")
				end
	...
	Play104071033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071033
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104071033).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071033", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071033", "story_v_out_104071.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104071", "104071033", "story_v_out_104071.awb")

						uv0:RecordAudio("104071033", slot13)
						uv0:RecordAudio("104071033", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071033", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071033", "story_v_out_104071.awb")
				end
	...
	Play104071034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071034
		slot1.duration_ = 6.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:PlayTimeline("1037ui_story", "StoryTimeline/CharAction/1037/1037actionlink/1037action456")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(104071034).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071034", "story_v_out_104071.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104071", "104071034", "story_v_out_104071.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_104071", "104071034", "story_v_out_104071.awb")

						uv0:RecordAudio("104071034", slot15)
						uv0:RecordAudio("104071034", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104071", "104071034", "story_v_out_104071.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104071", "104071034", "story_v_out_104071.awb")
				end
	...
	Play104071035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071035
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(104071035).content)
	...
	Play104071036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104071036
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104071036).content)
				uv0.text_.text = slot5
