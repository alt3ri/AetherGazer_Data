return {
	Play116311001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(116311001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311001", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311001", "story_v_out_116311.awb") / 1000 + slot9 then
						uv0.duration_ = slot18 + slot9
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116311", "116311001", "story_v_out_116311.awb")

						uv0:RecordAudio("116311001", slot19)
						uv0:RecordAudio("116311001", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311001", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311001", "story_v_out_116311.awb")
				end
	...
	Play116311002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 and uv0.var_.characterEffect1059ui_story == nil then
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 and uv0.var_.characterEffect1059ui_story then
				uv0.var_.characterEffect1059ui_story.fillFlat = false
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(116311002).content)
				uv0.text_.text = slot26

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (14 <= 0 and slot23 or slot23 * utf8.len(slot26) / slot27) > 0 and slot23 < slot29 then
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311002", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311002", "story_v_out_116311.awb") / 1000 + slot22 then
						uv0.duration_ = slot30 + slot22
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_116311", "116311002", "story_v_out_116311.awb")

						uv0:RecordAudio("116311002", slot31)
						uv0:RecordAudio("116311002", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311002", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311002", "story_v_out_116311.awb")
				end
	...
	Play116311003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311003
		slot1.duration_ = 3.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("1148ui_story", "StoryTimeline/CharAction/1048/1048actionlink/1048action493")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116311003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311003", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311003", "story_v_out_116311.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116311", "116311003", "story_v_out_116311.awb")

						uv0:RecordAudio("116311003", slot18)
						uv0:RecordAudio("116311003", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311003", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311003", "story_v_out_116311.awb")
				end
	...
	Play116311004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311004
		slot1.duration_ = 5.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0:ShowWeapon(uv0.var_["1148ui_story" .. "Animator"].transform, true)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(116311004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311004", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311004", "story_v_out_116311.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116311", "116311004", "story_v_out_116311.awb")

						uv0:RecordAudio("116311004", slot24)
						uv0:RecordAudio("116311004", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311004", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311004", "story_v_out_116311.awb")
				end
	...
	Play116311005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116311005).content)
	...
	Play116311006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116311006).content)
	...
	Play116311007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311007
		slot1.duration_ = 5.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.6 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116311007).content)
	...
	Play116311008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116311008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311008", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311008", "story_v_out_116311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116311", "116311008", "story_v_out_116311.awb")

						uv0:RecordAudio("116311008", slot10)
						uv0:RecordAudio("116311008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311008", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311008", "story_v_out_116311.awb")
				end
	...
	Play116311009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311009
		slot1.duration_ = 2.966
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116311009).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311009", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311009", "story_v_out_116311.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116311", "116311009", "story_v_out_116311.awb")

						uv0:RecordAudio("116311009", slot18)
						uv0:RecordAudio("116311009", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311009", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311009", "story_v_out_116311.awb")
				end
	...
	Play116311010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(116311010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311010", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311010", "story_v_out_116311.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_116311", "116311010", "story_v_out_116311.awb")

						uv0:RecordAudio("116311010", slot25)
						uv0:RecordAudio("116311010", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311010", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311010", "story_v_out_116311.awb")
				end
	...
	Play116311011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116311011).content)
	...
	Play116311012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311012
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116311012).content)
	...
	Play116311013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116311013).content)
				uv0.text_.text = slot10
	...
	Play116311014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.999999999999999 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.mask_.enabled = true
				uv0.mask_.raycastTarget = false
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosSK0205 = uv0.bgs_.SK0205.transform.localPosition
			end

			slot9 = 0.001

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPosSK0205, Vector3.New(-0.1, 3, 0), (uv0.time_ - slot8) / slot9)
			end

			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(-0.1, 3, 0)
			end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPosSK0205, Vector3.New(-0.1, 3, 0.8), (uv0.time_ - slot11) / slot12)
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(-0.1, 3, 0.8)
			end

			if 3.034 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPosSK0205 = uv0.bgs_.SK0205.transform.localPosition
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPosSK0205, Vector3.New(0, 1, 9), (uv0.time_ - slot14) / slot15)
			end
			...
			if 3.134 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0.var_.moveOldPosSK0205 = uv0.bgs_.SK0205.transform.localPosition
			end
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPosSK0205, Vector3.New(0, 1, 10), (uv0.time_ - slot17) / slot18)
			end
			...
			if uv0.time_ >= slot19 + 8.134 and uv0.time_ < slot19 + slot20 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if 3 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(116311014).content)
				uv0.text_.text = slot26
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311014", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311014", "story_v_out_116311.awb") / 1000 + slot21 then
						uv0.duration_ = slot30 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_116311", "116311014", "story_v_out_116311.awb")

						uv0:RecordAudio("116311014", slot31)
						uv0:RecordAudio("116311014", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311014", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311014", "story_v_out_116311.awb")
				end
	...
	Play116311015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116311015).content)
	...
	Play116311016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311016
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116311016).content)
				uv0.text_.text = slot4
	...
	Play116311017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116311017).content)
				uv0.text_.text = slot4
	...
	Play116311018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116311018).content)
				uv0.text_.text = slot4
	...
	Play116311019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116311019).content)
				uv0.text_.text = slot4
	...
	Play116311020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116311020).content)
				uv0.text_.text = slot4
	...
	Play116311021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311021
		slot1.duration_ = 4.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116311021).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311021", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311021", "story_v_out_116311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116311", "116311021", "story_v_out_116311.awb")

						uv0:RecordAudio("116311021", slot10)
						uv0:RecordAudio("116311021", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311021", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311021", "story_v_out_116311.awb")
				end
	...
	Play116311022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116311022).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311022", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311022", "story_v_out_116311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116311", "116311022", "story_v_out_116311.awb")

						uv0:RecordAudio("116311022", slot10)
						uv0:RecordAudio("116311022", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311022", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311022", "story_v_out_116311.awb")
				end
	...
	Play116311023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311023
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116311023).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311023", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311023", "story_v_out_116311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116311", "116311023", "story_v_out_116311.awb")

						uv0:RecordAudio("116311023", slot10)
						uv0:RecordAudio("116311023", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311023", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311023", "story_v_out_116311.awb")
				end
	...
	Play116311024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116311024).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311024", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311024", "story_v_out_116311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116311", "116311024", "story_v_out_116311.awb")

						uv0:RecordAudio("116311024", slot10)
						uv0:RecordAudio("116311024", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311024", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311024", "story_v_out_116311.awb")
				end
	...
	Play116311025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116311025).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311025", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311025", "story_v_out_116311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116311", "116311025", "story_v_out_116311.awb")

						uv0:RecordAudio("116311025", slot10)
						uv0:RecordAudio("116311025", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311025", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311025", "story_v_out_116311.awb")
				end
	...
	Play116311026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311026
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116311026).content)
				uv0.text_.text = slot4
	...
	Play116311027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311027
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116311027).content)
				uv0.text_.text = slot4
	...
	Play116311028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116311028
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116311028).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116311", "116311028", "story_v_out_116311.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116311", "116311028", "story_v_out_116311.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116311", "116311028", "story_v_out_116311.awb")

						uv0:RecordAudio("116311028", slot10)
						uv0:RecordAudio("116311028", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116311", "116311028", "story_v_out_116311.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116311", "116311028", "story_v_out_116311.awb")
				end
