return {
	Play318212001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212001
		slot1.duration_ = 4.80000000184774
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play318212002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.k15f == nil then
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1150ui_story, Vector3.New(0, -1.01, -6.2), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(0, -1.01, -6.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1150ui_story == nil then
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 and uv0.var_.characterEffect1150ui_story then
				uv0.var_.characterEffect1150ui_story.fillFlat = false
			end
			...
			if 0.8 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				uv0:AudioAction("play", "music", "bgm_activity_2_10_story_visbane_factory", "bgm_activity_2_10_story_visbane_factory", "bgm_activity_2_10_story_visbane_factory.awb")
			end
			...
			if 2.03400000184774 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(318212001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212001", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212001", "story_v_out_318212.awb") / 1000 + slot18 then
						uv0.duration_ = slot27 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_318212", "318212001", "story_v_out_318212.awb")

						uv0:RecordAudio("318212001", slot28)
						uv0:RecordAudio("318212001", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212001", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212001", "story_v_out_318212.awb")
				end
	...
	Play318212002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212002
		slot1.duration_ = 5.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318212002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212002", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212002", "story_v_out_318212.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318212", "318212002", "story_v_out_318212.awb")

						uv0:RecordAudio("318212002", slot10)
						uv0:RecordAudio("318212002", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212002", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212002", "story_v_out_318212.awb")
				end
	...
	Play318212003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212003
		slot1.duration_ = 4.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1150ui_story, Vector3.New(-0.7, -1.01, -6.2), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(-0.7, -1.01, -6.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1150ui_story == nil then
				uv0.var_.characterEffect1150ui_story = uv0.actors_["1150ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				if uv0.var_.characterEffect1150ui_story then
					...
					uv0.var_.characterEffect1150ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot14) / slot15)
				end
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 and uv0.var_.characterEffect1150ui_story then
				uv0.var_.characterEffect1150ui_story.fillFlat = true
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(318212003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212003", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212003", "story_v_out_318212.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_318212", "318212003", "story_v_out_318212.awb")

						uv0:RecordAudio("318212003", slot25)
						uv0:RecordAudio("318212003", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212003", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212003", "story_v_out_318212.awb")
				end
	...
	Play318212004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(318212004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212004", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212004", "story_v_out_318212.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_318212", "318212004", "story_v_out_318212.awb")

						uv0:RecordAudio("318212004", slot12)
						uv0:RecordAudio("318212004", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212004", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212004", "story_v_out_318212.awb")
				end
	...
	Play318212005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212005
		slot1.duration_ = 2.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318212005).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212005", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212005", "story_v_out_318212.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318212", "318212005", "story_v_out_318212.awb")

						uv0:RecordAudio("318212005", slot10)
						uv0:RecordAudio("318212005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212005", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212005", "story_v_out_318212.awb")
				end
	...
	Play318212006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212006
		slot1.duration_ = 3.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1150ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot17) / slot18)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(318212006).content)
				uv0.text_.text = slot23
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212006", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212006", "story_v_out_318212.awb") / 1000 + slot19 then
						uv0.duration_ = slot27 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_318212", "318212006", "story_v_out_318212.awb")

						uv0:RecordAudio("318212006", slot28)
						uv0:RecordAudio("318212006", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212006", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212006", "story_v_out_318212.awb")
				end
	...
	Play318212007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318212007).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212007", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212007", "story_v_out_318212.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318212", "318212007", "story_v_out_318212.awb")

						uv0:RecordAudio("318212007", slot10)
						uv0:RecordAudio("318212007", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212007", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212007", "story_v_out_318212.awb")
				end
	...
	Play318212008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(318212008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212008", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212008", "story_v_out_318212.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_318212", "318212008", "story_v_out_318212.awb")

						uv0:RecordAudio("318212008", slot22)
						uv0:RecordAudio("318212008", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212008", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212008", "story_v_out_318212.awb")
				end
	...
	Play318212009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212009
		slot1.duration_ = 7.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.characterEffect1093ui_story then
					uv0.var_.characterEffect1093ui_story.fillFlat = true
					uv0.var_.characterEffect1093ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot6) / slot7)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(318212009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212009", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212009", "story_v_out_318212.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_318212", "318212009", "story_v_out_318212.awb")

						uv0:RecordAudio("318212009", slot17)
						uv0:RecordAudio("318212009", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212009", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212009", "story_v_out_318212.awb")
				end
	...
	Play318212010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318212010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212010", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212010", "story_v_out_318212.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_318212", "318212010", "story_v_out_318212.awb")

						uv0:RecordAudio("318212010", slot16)
						uv0:RecordAudio("318212010", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212010", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212010", "story_v_out_318212.awb")
				end
	...
	Play318212011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(318212011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212011", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212011", "story_v_out_318212.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_318212", "318212011", "story_v_out_318212.awb")

						uv0:RecordAudio("318212011", slot27)
						uv0:RecordAudio("318212011", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212011", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212011", "story_v_out_318212.awb")
				end
	...
	Play318212012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1150ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot9) / slot10)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 and uv0.var_.characterEffect1150ui_story == nil then
				uv0.var_.characterEffect1150ui_story = uv0.actors_["1150ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				if uv0.var_.characterEffect1150ui_story then
					uv0.var_.characterEffect1150ui_story.fillFlat = true
					uv0.var_.characterEffect1150ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot12) / slot13)
				end
			end

			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 and uv0.var_.characterEffect1150ui_story then
				uv0.var_.characterEffect1150ui_story.fillFlat = true
				uv0.var_.characterEffect1150ui_story.fillRatio = 0.5
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(318212012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212012", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212012", "story_v_out_318212.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_318212", "318212012", "story_v_out_318212.awb")

						uv0:RecordAudio("318212012", slot23)
						uv0:RecordAudio("318212012", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212012", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212012", "story_v_out_318212.awb")
				end
	...
	Play318212013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212013
		slot1.duration_ = 8.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(318212013).content)
				uv0.text_.text = slot18
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212013", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212013", "story_v_out_318212.awb") / 1000 + slot14 then
						uv0.duration_ = slot22 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						slot23 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_318212", "318212013", "story_v_out_318212.awb")

						uv0:RecordAudio("318212013", slot23)
						uv0:RecordAudio("318212013", slot23)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212013", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212013", "story_v_out_318212.awb")
				end
	...
	Play318212014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(318212014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212014", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212014", "story_v_out_318212.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_318212", "318212014", "story_v_out_318212.awb")

						uv0:RecordAudio("318212014", slot24)
						uv0:RecordAudio("318212014", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212014", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212014", "story_v_out_318212.awb")
				end
	...
	Play318212015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318212015).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212015", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212015", "story_v_out_318212.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_318212", "318212015", "story_v_out_318212.awb")

						uv0:RecordAudio("318212015", slot16)
						uv0:RecordAudio("318212015", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212015", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212015", "story_v_out_318212.awb")
				end
	...
	Play318212016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212016
		slot1.duration_ = 7.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(318212016).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212016", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212016", "story_v_out_318212.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_318212", "318212016", "story_v_out_318212.awb")

						uv0:RecordAudio("318212016", slot12)
						uv0:RecordAudio("318212016", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212016", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212016", "story_v_out_318212.awb")
				end
	...
	Play318212017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(318212017).content)
				uv0.text_.text = slot7
	...
	Play318212018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(318212018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212018", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212018", "story_v_out_318212.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_318212", "318212018", "story_v_out_318212.awb")

						uv0:RecordAudio("318212018", slot13)
						uv0:RecordAudio("318212018", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212018", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212018", "story_v_out_318212.awb")
				end
	...
	Play318212019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212019
		slot1.duration_ = 5.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(318212019).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212019", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212019", "story_v_out_318212.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_318212", "318212019", "story_v_out_318212.awb")

						uv0:RecordAudio("318212019", slot16)
						uv0:RecordAudio("318212019", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212019", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212019", "story_v_out_318212.awb")
				end
	...
	Play318212020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318212020).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212020", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212020", "story_v_out_318212.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318212", "318212020", "story_v_out_318212.awb")

						uv0:RecordAudio("318212020", slot10)
						uv0:RecordAudio("318212020", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212020", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212020", "story_v_out_318212.awb")
				end
	...
	Play318212021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212021
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318212021).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212021", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212021", "story_v_out_318212.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318212", "318212021", "story_v_out_318212.awb")

						uv0:RecordAudio("318212021", slot10)
						uv0:RecordAudio("318212021", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212021", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212021", "story_v_out_318212.awb")
				end
	...
	Play318212022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212022
		slot1.duration_ = 9.833
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318212022).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212022", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212022", "story_v_out_318212.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318212", "318212022", "story_v_out_318212.awb")

						uv0:RecordAudio("318212022", slot10)
						uv0:RecordAudio("318212022", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212022", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212022", "story_v_out_318212.awb")
				end
	...
	Play318212023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1150ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318212023).content)
				uv0.text_.text = slot13

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (13 <= 0 and slot11 or slot11 * utf8.len(slot13) / slot14) > 0 and slot11 < slot16 then
	...
	Play318212024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212024
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318212024).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212024", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212024", "story_v_out_318212.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_318212", "318212024", "story_v_out_318212.awb")

						uv0:RecordAudio("318212024", slot18)
						uv0:RecordAudio("318212024", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212024", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212024", "story_v_out_318212.awb")
				end
	...
	Play318212025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(318212025).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212025", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212025", "story_v_out_318212.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_318212", "318212025", "story_v_out_318212.awb")

						uv0:RecordAudio("318212025", slot24)
						uv0:RecordAudio("318212025", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212025", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212025", "story_v_out_318212.awb")
				end
	...
	Play318212026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212026
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318212026).content)
				uv0.text_.text = slot13
	...
	Play318212027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212027
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318212027).content)
	...
	Play318212028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212028
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(318212028).content)
				uv0.text_.text = slot4
	...
	Play318212029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212029
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(318212029).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212029", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212029", "story_v_out_318212.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_318212", "318212029", "story_v_out_318212.awb")

						uv0:RecordAudio("318212029", slot18)
						uv0:RecordAudio("318212029", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212029", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212029", "story_v_out_318212.awb")
				end
	...
	Play318212030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212030
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318212030).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212030", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212030", "story_v_out_318212.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318212", "318212030", "story_v_out_318212.awb")

						uv0:RecordAudio("318212030", slot10)
						uv0:RecordAudio("318212030", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212030", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212030", "story_v_out_318212.awb")
				end
	...
	Play318212031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212031
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play318212032(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:PlayTimeline("1199ui_story", "StoryTimeline/CharAction/story1199/story1199action/1199action5_2")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(318212031).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212031", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212031", "story_v_out_318212.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_318212", "318212031", "story_v_out_318212.awb")

						uv0:RecordAudio("318212031", slot11)
						uv0:RecordAudio("318212031", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212031", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212031", "story_v_out_318212.awb")
				end
	...
	Play318212032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212032
		slot1.duration_ = 1.999999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(318212032).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212032", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212032", "story_v_out_318212.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_318212", "318212032", "story_v_out_318212.awb")

						uv0:RecordAudio("318212032", slot27)
						uv0:RecordAudio("318212032", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212032", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212032", "story_v_out_318212.awb")
				end
	...
	Play318212033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212033
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 and uv0.var_.characterEffect1150ui_story == nil then
				uv0.var_.characterEffect1150ui_story = uv0.actors_["1150ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.characterEffect1150ui_story then
					uv0.var_.characterEffect1150ui_story.fillFlat = true
					uv0.var_.characterEffect1150ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot11) / slot12)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.characterEffect1150ui_story then
				uv0.var_.characterEffect1150ui_story.fillFlat = true
				uv0.var_.characterEffect1150ui_story.fillRatio = 0.5
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(318212033).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212033", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212033", "story_v_out_318212.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_318212", "318212033", "story_v_out_318212.awb")

						uv0:RecordAudio("318212033", slot22)
						uv0:RecordAudio("318212033", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212033", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212033", "story_v_out_318212.awb")
				end
	...
	Play318212034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212034
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(318212034).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212034", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212034", "story_v_out_318212.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_318212", "318212034", "story_v_out_318212.awb")

						uv0:RecordAudio("318212034", slot24)
						uv0:RecordAudio("318212034", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212034", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212034", "story_v_out_318212.awb")
				end
	...
	Play318212035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212035
		slot1.duration_ = 7.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1199ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot14) / slot15)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(318212035).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212035", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212035", "story_v_out_318212.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_318212", "318212035", "story_v_out_318212.awb")

						uv0:RecordAudio("318212035", slot25)
						uv0:RecordAudio("318212035", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212035", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212035", "story_v_out_318212.awb")
				end
	...
	Play318212036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212036
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(318212036).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212036", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212036", "story_v_out_318212.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_318212", "318212036", "story_v_out_318212.awb")

						uv0:RecordAudio("318212036", slot10)
						uv0:RecordAudio("318212036", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212036", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212036", "story_v_out_318212.awb")
				end
	...
	Play318212037 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212037
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(318212037).content)
				uv0.text_.text = slot7
	...
	Play318212038 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 318212038
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(318212038).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_318212", "318212038", "story_v_out_318212.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_318212", "318212038", "story_v_out_318212.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_318212", "318212038", "story_v_out_318212.awb")

						uv0:RecordAudio("318212038", slot14)
						uv0:RecordAudio("318212038", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_318212", "318212038", "story_v_out_318212.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_318212", "318212038", "story_v_out_318212.awb")
				end
