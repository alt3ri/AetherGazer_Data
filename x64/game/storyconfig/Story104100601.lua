return {
	Play410061001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_121_04", "se_story_121_04_wind_loop", "")
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(410061001).content)
	...
	Play410061002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(410061002).content)
	...
	Play410061003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 and uv0.var_.actorSpriteComps1056 == nil then
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				...
				if uv0.var_.actorSpriteComps1056 then
					slot18 = uv0.var_.actorSpriteComps1056
					slot20 = slot18
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(410061003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061003", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061003", "story_v_out_410061.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_410061", "410061003", "story_v_out_410061.awb")

						uv0:RecordAudio("410061003", slot24)
						uv0:RecordAudio("410061003", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061003", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061003", "story_v_out_410061.awb")
				end
	...
	Play410061004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061004
		slot1.duration_ = 6.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(410061004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061004", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061004", "story_v_out_410061.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_410061", "410061004", "story_v_out_410061.awb")

						uv0:RecordAudio("410061004", slot19)
						uv0:RecordAudio("410061004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061004", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061004", "story_v_out_410061.awb")
				end
	...
	Play410061005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(410061005).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061005", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061005", "story_v_out_410061.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_410061", "410061005", "story_v_out_410061.awb")

						uv0:RecordAudio("410061005", slot19)
						uv0:RecordAudio("410061005", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061005", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061005", "story_v_out_410061.awb")
				end
	...
	Play410061006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(410061006).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061006", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061006", "story_v_out_410061.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_410061", "410061006", "story_v_out_410061.awb")

						uv0:RecordAudio("410061006", slot19)
						uv0:RecordAudio("410061006", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061006", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061006", "story_v_out_410061.awb")
				end
	...
	Play410061007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(410061007).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061007", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061007", "story_v_out_410061.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_410061", "410061007", "story_v_out_410061.awb")

						uv0:RecordAudio("410061007", slot19)
						uv0:RecordAudio("410061007", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061007", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061007", "story_v_out_410061.awb")
				end
	...
	Play410061008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(410061008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061008", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061008", "story_v_out_410061.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_410061", "410061008", "story_v_out_410061.awb")

						uv0:RecordAudio("410061008", slot13)
						uv0:RecordAudio("410061008", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061008", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061008", "story_v_out_410061.awb")
				end
	...
	Play410061009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(410061009).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061009", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061009", "story_v_out_410061.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_410061", "410061009", "story_v_out_410061.awb")

						uv0:RecordAudio("410061009", slot13)
						uv0:RecordAudio("410061009", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061009", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061009", "story_v_out_410061.awb")
				end
	...
	Play410061010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(410061010).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061010", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061010", "story_v_out_410061.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_410061", "410061010", "story_v_out_410061.awb")

						uv0:RecordAudio("410061010", slot19)
						uv0:RecordAudio("410061010", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061010", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061010", "story_v_out_410061.awb")
				end
	...
	Play410061011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 410061011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(410061011).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_410061", "410061011", "story_v_out_410061.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_410061", "410061011", "story_v_out_410061.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_410061", "410061011", "story_v_out_410061.awb")

						uv0:RecordAudio("410061011", slot13)
						uv0:RecordAudio("410061011", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_410061", "410061011", "story_v_out_410061.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_410061", "410061011", "story_v_out_410061.awb")
				end
