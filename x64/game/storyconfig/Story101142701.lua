return {
	Play114271001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(114271001).content)
	...
	Play114271002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114271002).content)
	...
	Play114271003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114271003).content)
				uv0.text_.text = slot4
	...
	Play114271004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0:CheckSpriteTmpPos("10015", slot11)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10015, Vector3.New(0, -350, -180), (uv0.time_ - slot6) / slot7)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(114271004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114271", "114271004", "story_v_out_114271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114271", "114271004", "story_v_out_114271.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_114271", "114271004", "story_v_out_114271.awb")

						uv0:RecordAudio("114271004", slot20)
						uv0:RecordAudio("114271004", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114271", "114271004", "story_v_out_114271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114271", "114271004", "story_v_out_114271.awb")
				end
	...
	Play114271005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(114271005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114271", "114271005", "story_v_out_114271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114271", "114271005", "story_v_out_114271.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_114271", "114271005", "story_v_out_114271.awb")

						uv0:RecordAudio("114271005", slot10)
						uv0:RecordAudio("114271005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114271", "114271005", "story_v_out_114271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114271", "114271005", "story_v_out_114271.awb")
				end
	...
	Play114271006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(114271006).content)
	...
	Play114271007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114271007).content)
				uv0.text_.text = slot4
	...
	Play114271008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114271008).content)
				uv0.text_.text = slot4
	...
	Play114271009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271009
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114271009).content)
				uv0.text_.text = slot4
	...
	Play114271010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(114271010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114271", "114271010", "story_v_out_114271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114271", "114271010", "story_v_out_114271.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_114271", "114271010", "story_v_out_114271.awb")

						uv0:RecordAudio("114271010", slot19)
						uv0:RecordAudio("114271010", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114271", "114271010", "story_v_out_114271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114271", "114271010", "story_v_out_114271.awb")
				end
	...
	Play114271011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_activity_1_4_3", "se_story_activity_1_4_3_raise", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(114271011).content)
				uv0.text_.text = slot14

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (56 <= 0 and slot12 or slot12 * utf8.len(slot14) / slot15) > 0 and slot12 < slot17 then
					uv0.talkMaxDuration = slot17
	...
	Play114271012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271012
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(114271012).content)
	...
	Play114271013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(114271013).content)
				uv0.text_.text = slot4
	...
	Play114271014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 114271014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(114271014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_114271", "114271014", "story_v_out_114271.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_114271", "114271014", "story_v_out_114271.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_114271", "114271014", "story_v_out_114271.awb")

						uv0:RecordAudio("114271014", slot13)
						uv0:RecordAudio("114271014", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_114271", "114271014", "story_v_out_114271.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_114271", "114271014", "story_v_out_114271.awb")
				end
