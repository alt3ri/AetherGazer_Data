return {
	Play62106001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62106001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(62106001).content)
				uv0.text_.text = slot14

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (31 <= 0 and slot10 or slot10 * utf8.len(slot14) / slot15) > 0 and slot10 < slot17 then
	...
	Play62106002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62106002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(62106002).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_chess_62106", "62106002", "story_v_chess_62106.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62106", "62106002", "story_v_chess_62106.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_chess_62106", "62106002", "story_v_chess_62106.awb")

						uv0:RecordAudio("62106002", slot19)
						uv0:RecordAudio("62106002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62106", "62106002", "story_v_chess_62106.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62106", "62106002", "story_v_chess_62106.awb")
				end
	...
	Play62106003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62106003
		slot1.duration_ = 7.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(62106003).content)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62106", "62106003", "story_v_chess_62106.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62106", "62106003", "story_v_chess_62106.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_chess_62106", "62106003", "story_v_chess_62106.awb")

						uv0:RecordAudio("62106003", slot15)
						uv0:RecordAudio("62106003", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62106", "62106003", "story_v_chess_62106.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62106", "62106003", "story_v_chess_62106.awb")
				end
	...
	Play62106004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62106004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62106004).content)
	...
	Play62106005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62106005
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play62106006(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action3_2")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(62106005).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_chess_62106", "62106005", "story_v_chess_62106.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_chess_62106", "62106005", "story_v_chess_62106.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_chess_62106", "62106005", "story_v_chess_62106.awb")

						uv0:RecordAudio("62106005", slot15)
						uv0:RecordAudio("62106005", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_chess_62106", "62106005", "story_v_chess_62106.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_chess_62106", "62106005", "story_v_chess_62106.awb")
				end
	...
	Play62106006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 62106006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(62106006).content)
				uv0.text_.text = slot8
