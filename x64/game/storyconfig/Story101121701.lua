return {
	Play112171001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171001
		slot1.duration_ = 4.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(112171001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171001", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171001", "story_v_out_112171.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_112171", "112171001", "story_v_out_112171.awb")

						uv0:RecordAudio("112171001", slot27)
						uv0:RecordAudio("112171001", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171001", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171001", "story_v_out_112171.awb")
				end
	...
	Play112171002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171002
		slot1.duration_ = 7.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(112171002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171002", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171002", "story_v_out_112171.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112171", "112171002", "story_v_out_112171.awb")

						uv0:RecordAudio("112171002", slot22)
						uv0:RecordAudio("112171002", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171002", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171002", "story_v_out_112171.awb")
				end
	...
	Play112171003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171003
		slot1.duration_ = 3.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1081ui_story, Vector3.New(0, -0.92, -5.8), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, -0.92, -5.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(112171003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171003", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171003", "story_v_out_112171.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_112171", "112171003", "story_v_out_112171.awb")

						uv0:RecordAudio("112171003", slot25)
						uv0:RecordAudio("112171003", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171003", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171003", "story_v_out_112171.awb")
				end
	...
	Play112171004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(112171004).content)
	...
	Play112171005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(112171005).content)
	...
	Play112171006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171006
		slot1.duration_ = 2.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112171006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171006", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171006", "story_v_out_112171.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_112171", "112171006", "story_v_out_112171.awb")

						uv0:RecordAudio("112171006", slot10)
						uv0:RecordAudio("112171006", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171006", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171006", "story_v_out_112171.awb")
				end
	...
	Play112171007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171007
		slot1.duration_ = 7.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.H04:GetComponent("SpriteRenderer") then
					slot6.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot7 = slot6.material
					uv0.var_.alphaOldValueH04 = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueH04 = slot7
				end

				uv0.var_.alphaOldValueH04 = 1
			end

			slot6 = 2

			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueH04 then
					slot9 = uv0.var_.alphaMatValueH04
					slot10 = slot9:GetColor("_Color")
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueH04, 0, (uv0.time_ - slot5) / slot6)

					slot9:SetColor("_Color", slot10)
				end
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.alphaMatValueH04 then
				slot7 = uv0.var_.alphaMatValueH04
			...
			if uv0.time_ >= slot7 + 2.6 and uv0.time_ < slot7 + slot8 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_activity_1_2_1", "se_story_activity_1_2_1_huge_waves02", "")
			end
			...
			if 2.6 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(112171007).content)
	...
	Play112171008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_activity_1_2_1", "se_story_activity_1_2_1_whale", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(112171008).content)
	...
	Play112171009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171009
		slot1.duration_ = 7
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play112171010(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.SA0108 == nil then
				slot2 = Object.Instantiate(uv0.paintGo_)
				slot2:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. slot1)
				slot2.name = slot1
				slot2.transform.parent = uv0.stage_.transform
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if uv0.bgs_.H04:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueH04 = slot8:GetColor("_Color").a
					uv0.var_.alphaMatValueH04 = slot8
				end

				uv0.var_.alphaOldValueH04 = 0
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.alphaMatValueH04 then
					slot10 = uv0.var_.alphaMatValueH04
					slot11 = slot10:GetColor("_Color")
					slot11.a = Mathf.Lerp(uv0.var_.alphaOldValueH04, 1, (uv0.time_ - slot6) / slot7)

					slot10:SetColor("_Color", slot11)
				end
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.alphaMatValueH04 then
				slot8 = uv0.var_.alphaMatValueH04
			...
			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(112171009).content)
	...
	Play112171010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(112171010).content)
				uv0.text_.text = slot4
	...
	Play112171011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_activity_1_2_1", "se_story_activity_1_2_1_huge_waves03", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(112171011).content)
				uv0.text_.text = slot6
	...
	Play112171012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_1127")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112171012).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171012", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171012", "story_v_out_112171.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_112171", "112171012", "story_v_out_112171.awb")

						uv0:RecordAudio("112171012", slot10)
						uv0:RecordAudio("112171012", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171012", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171012", "story_v_out_112171.awb")
				end
	...
	Play112171013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112171013).content)
				uv0.text_.text = slot5
	...
	Play112171014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171014
		slot1.duration_ = 3.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112171014).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171014", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171014", "story_v_out_112171.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_112171", "112171014", "story_v_out_112171.awb")

						uv0:RecordAudio("112171014", slot10)
						uv0:RecordAudio("112171014", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171014", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171014", "story_v_out_112171.awb")
				end
	...
	Play112171015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112171015).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171015", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171015", "story_v_out_112171.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_112171", "112171015", "story_v_out_112171.awb")

						uv0:RecordAudio("112171015", slot10)
						uv0:RecordAudio("112171015", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171015", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171015", "story_v_out_112171.awb")
				end
	...
	Play112171016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171016
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot13 + slot0 and uv0.var_.characterEffect1039ui_story == nil then
			...
			if 4 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(112171016).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171016", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171016", "story_v_out_112171.awb") / 1000 + slot15 then
						uv0.duration_ = slot24 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_112171", "112171016", "story_v_out_112171.awb")

						uv0:RecordAudio("112171016", slot25)
						uv0:RecordAudio("112171016", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171016", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171016", "story_v_out_112171.awb")
				end
	...
	Play112171017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171017
		slot1.duration_ = 7.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(112171017).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171017", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171017", "story_v_out_112171.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112171", "112171017", "story_v_out_112171.awb")

						uv0:RecordAudio("112171017", slot22)
						uv0:RecordAudio("112171017", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171017", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171017", "story_v_out_112171.awb")
				end
	...
	Play112171018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171018
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(112171018).content)
	...
	Play112171019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171019
		slot1.duration_ = 6.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(112171019).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171019", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171019", "story_v_out_112171.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_112171", "112171019", "story_v_out_112171.awb")

						uv0:RecordAudio("112171019", slot18)
						uv0:RecordAudio("112171019", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171019", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171019", "story_v_out_112171.awb")
				end
	...
	Play112171020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1127ui_story, Vector3.New(0.7, -0.81, -5.8), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1127ui_story == nil then
				uv0.var_.characterEffect1127ui_story = uv0.actors_["1127ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 and uv0.var_.characterEffect1127ui_story then
				uv0.var_.characterEffect1127ui_story.fillFlat = false
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(112171020).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112171", "112171020", "story_v_out_112171.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112171", "112171020", "story_v_out_112171.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_112171", "112171020", "story_v_out_112171.awb")

						uv0:RecordAudio("112171020", slot21)
						uv0:RecordAudio("112171020", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112171", "112171020", "story_v_out_112171.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112171", "112171020", "story_v_out_112171.awb")
				end
	...
	Play112171021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112171021
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(112171021).content)
				uv0.text_.text = slot10
