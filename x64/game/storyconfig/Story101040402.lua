return {
	Play104042001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if uv0.bgs_.S0403:GetComponent("SpriteRenderer") then
					slot10.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot11 = slot10.material
					uv0.var_.alphaOldValueS0403 = slot11:GetColor("_Color").a
					uv0.var_.alphaMatValueS0403 = slot11
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				if uv0.var_.alphaMatValueS0403 then
					...
					slot14.a = Mathf.Lerp(uv0.var_.alphaOldValueS0403, 1, (uv0.time_ - slot9) / slot10)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104042001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042001", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042001", "story_v_out_104042.awb") / 1000 + slot14 then
						uv0.duration_ = slot23 + slot14
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104042", "104042001", "story_v_out_104042.awb")

						uv0:RecordAudio("104042001", slot24)
						uv0:RecordAudio("104042001", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042001", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042001", "story_v_out_104042.awb")
				end
	...
	Play104042002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104042002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042002", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042002", "story_v_out_104042.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104042", "104042002", "story_v_out_104042.awb")

						uv0:RecordAudio("104042002", slot13)
						uv0:RecordAudio("104042002", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042002", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042002", "story_v_out_104042.awb")
				end
	...
	Play104042003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(104042003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042003", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042003", "story_v_out_104042.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_104042", "104042003", "story_v_out_104042.awb")

						uv0:RecordAudio("104042003", slot14)
						uv0:RecordAudio("104042003", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042003", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042003", "story_v_out_104042.awb")
				end
	...
	Play104042004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104042004).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042004", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042004", "story_v_out_104042.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104042", "104042004", "story_v_out_104042.awb")

						uv0:RecordAudio("104042004", slot13)
						uv0:RecordAudio("104042004", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042004", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042004", "story_v_out_104042.awb")
				end
	...
	Play104042005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104042005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042005", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042005", "story_v_out_104042.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104042", "104042005", "story_v_out_104042.awb")

						uv0:RecordAudio("104042005", slot10)
						uv0:RecordAudio("104042005", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042005", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042005", "story_v_out_104042.awb")
				end
	...
	Play104042006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104042006).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042006", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042006", "story_v_out_104042.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104042", "104042006", "story_v_out_104042.awb")

						uv0:RecordAudio("104042006", slot10)
						uv0:RecordAudio("104042006", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042006", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042006", "story_v_out_104042.awb")
				end
	...
	Play104042007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(104042007).content)
	...
	Play104042008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104042008).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042008", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042008", "story_v_out_104042.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104042", "104042008", "story_v_out_104042.awb")

						uv0:RecordAudio("104042008", slot10)
						uv0:RecordAudio("104042008", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042008", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042008", "story_v_out_104042.awb")
				end
	...
	Play104042009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(104042009).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042009", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042009", "story_v_out_104042.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104042", "104042009", "story_v_out_104042.awb")

						uv0:RecordAudio("104042009", slot10)
						uv0:RecordAudio("104042009", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042009", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042009", "story_v_out_104042.awb")
				end
	...
	Play104042010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(104042010).content)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.S0403:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueS0403 = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueS0403 = slot7
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueS0403 then
					...
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueS0403, 0, (uv0.time_ - slot5) / slot6)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosS0403 = uv0.bgs_.S0403.transform.localPosition
			end
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				if uv0.bgs_.B04b:GetComponent("SpriteRenderer") then
					slot13.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot14 = slot13.material
					uv0.var_.alphaOldValueB04b = slot14:GetColor("_Color").a
					uv0.var_.alphaMatValueB04b = slot14
				end
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				if uv0.var_.alphaMatValueB04b then
					...
					slot17.a = Mathf.Lerp(uv0.var_.alphaOldValueB04b, 1, (uv0.time_ - slot12) / slot13)
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot15.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(-0.7, -0.97, -6), (uv0.time_ - slot16) / slot17)
			...
			if uv0.time_ >= slot16 + slot17 and uv0.time_ < slot16 + slot17 + slot0 then
				slot15.localPosition = Vector3.New(-0.7, -0.97, -6)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				...
				slot27 = uv0:FormatText(uv0:GetWordFromCfg(104042011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042011", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042011", "story_v_out_104042.awb") / 1000 + slot22 then
						uv0.duration_ = slot31 + slot22
					end

					if slot26.prefab_name ~= "" and uv0.actors_[slot26.prefab_name] ~= nil then
						slot32 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot26.prefab_name].transform, "story_v_out_104042", "104042011", "story_v_out_104042.awb")

						uv0:RecordAudio("104042011", slot32)
						uv0:RecordAudio("104042011", slot32)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042011", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042011", "story_v_out_104042.awb")
				end
	...
	Play104042012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(104042012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042012", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042012", "story_v_out_104042.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104042", "104042012", "story_v_out_104042.awb")

						uv0:RecordAudio("104042012", slot22)
						uv0:RecordAudio("104042012", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042012", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042012", "story_v_out_104042.awb")
				end
	...
	Play104042013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104042013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042013", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042013", "story_v_out_104042.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104042", "104042013", "story_v_out_104042.awb")

						uv0:RecordAudio("104042013", slot12)
						uv0:RecordAudio("104042013", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042013", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042013", "story_v_out_104042.awb")
				end
	...
	Play104042014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(104042014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042014", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042014", "story_v_out_104042.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_104042", "104042014", "story_v_out_104042.awb")

						uv0:RecordAudio("104042014", slot25)
						uv0:RecordAudio("104042014", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042014", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042014", "story_v_out_104042.awb")
				end
	...
	Play104042015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104042015).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042015", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042015", "story_v_out_104042.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104042", "104042015", "story_v_out_104042.awb")

						uv0:RecordAudio("104042015", slot24)
						uv0:RecordAudio("104042015", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042015", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042015", "story_v_out_104042.awb")
				end
	...
	Play104042016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042016", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042016", "story_v_out_104042.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104042", "104042016", "story_v_out_104042.awb")

						uv0:RecordAudio("104042016", slot18)
						uv0:RecordAudio("104042016", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042016", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042016", "story_v_out_104042.awb")
				end
	...
	Play104042017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(104042017).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042017", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042017", "story_v_out_104042.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104042", "104042017", "story_v_out_104042.awb")

						uv0:RecordAudio("104042017", slot13)
						uv0:RecordAudio("104042017", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042017", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042017", "story_v_out_104042.awb")
				end
	...
	Play104042018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(104042018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042018", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042018", "story_v_out_104042.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_104042", "104042018", "story_v_out_104042.awb")

						uv0:RecordAudio("104042018", slot15)
						uv0:RecordAudio("104042018", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042018", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042018", "story_v_out_104042.awb")
				end
	...
	Play104042019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042019).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042019", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042019", "story_v_out_104042.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104042", "104042019", "story_v_out_104042.awb")

						uv0:RecordAudio("104042019", slot18)
						uv0:RecordAudio("104042019", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042019", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042019", "story_v_out_104042.awb")
				end
	...
	Play104042020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042020).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042020", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042020", "story_v_out_104042.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104042", "104042020", "story_v_out_104042.awb")

						uv0:RecordAudio("104042020", slot18)
						uv0:RecordAudio("104042020", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042020", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042020", "story_v_out_104042.awb")
				end
	...
	Play104042021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042021).content)
				uv0.text_.text = slot13
	...
	Play104042022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042022).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042022", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042022", "story_v_out_104042.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104042", "104042022", "story_v_out_104042.awb")

						uv0:RecordAudio("104042022", slot18)
						uv0:RecordAudio("104042022", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042022", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042022", "story_v_out_104042.awb")
				end
	...
	Play104042023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(0.7, -1.23, -5.8), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0.7, -1.23, -5.8)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104042023).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042023", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042023", "story_v_out_104042.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104042", "104042023", "story_v_out_104042.awb")

						uv0:RecordAudio("104042023", slot21)
						uv0:RecordAudio("104042023", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042023", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042023", "story_v_out_104042.awb")
				end
	...
	Play104042024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104042024).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042024", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042024", "story_v_out_104042.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104042", "104042024", "story_v_out_104042.awb")

						uv0:RecordAudio("104042024", slot24)
						uv0:RecordAudio("104042024", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042024", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042024", "story_v_out_104042.awb")
				end
	...
	Play104042025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042025).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042025", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042025", "story_v_out_104042.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104042", "104042025", "story_v_out_104042.awb")

						uv0:RecordAudio("104042025", slot18)
						uv0:RecordAudio("104042025", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042025", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042025", "story_v_out_104042.awb")
				end
	...
	Play104042026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104042026).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042026", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042026", "story_v_out_104042.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104042", "104042026", "story_v_out_104042.awb")

						uv0:RecordAudio("104042026", slot12)
						uv0:RecordAudio("104042026", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042026", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042026", "story_v_out_104042.awb")
				end
	...
	Play104042027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042027).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042027", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042027", "story_v_out_104042.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104042", "104042027", "story_v_out_104042.awb")

						uv0:RecordAudio("104042027", slot18)
						uv0:RecordAudio("104042027", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042027", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042027", "story_v_out_104042.awb")
				end
	...
	Play104042028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042028).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042028", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042028", "story_v_out_104042.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104042", "104042028", "story_v_out_104042.awb")

						uv0:RecordAudio("104042028", slot18)
						uv0:RecordAudio("104042028", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042028", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042028", "story_v_out_104042.awb")
				end
	...
	Play104042029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(104042029).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042029", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042029", "story_v_out_104042.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_104042", "104042029", "story_v_out_104042.awb")

						uv0:RecordAudio("104042029", slot17)
						uv0:RecordAudio("104042029", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042029", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042029", "story_v_out_104042.awb")
				end
	...
	Play104042030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104042030).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042030", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042030", "story_v_out_104042.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104042", "104042030", "story_v_out_104042.awb")

						uv0:RecordAudio("104042030", slot18)
						uv0:RecordAudio("104042030", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042030", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042030", "story_v_out_104042.awb")
				end
	...
	Play104042031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104042031).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042031", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042031", "story_v_out_104042.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104042", "104042031", "story_v_out_104042.awb")

						uv0:RecordAudio("104042031", slot24)
						uv0:RecordAudio("104042031", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042031", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042031", "story_v_out_104042.awb")
				end
	...
	Play104042032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(104042032).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042032", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042032", "story_v_out_104042.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_104042", "104042032", "story_v_out_104042.awb")

						uv0:RecordAudio("104042032", slot17)
						uv0:RecordAudio("104042032", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042032", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042032", "story_v_out_104042.awb")
				end
	...
	Play104042033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(104042033).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042033", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042033", "story_v_out_104042.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_104042", "104042033", "story_v_out_104042.awb")

						uv0:RecordAudio("104042033", slot11)
						uv0:RecordAudio("104042033", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042033", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042033", "story_v_out_104042.awb")
				end
	...
	Play104042034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(0, -1.23, -5.8), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -1.23, -5.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(104042034).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042034", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042034", "story_v_out_104042.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_104042", "104042034", "story_v_out_104042.awb")

						uv0:RecordAudio("104042034", slot27)
						uv0:RecordAudio("104042034", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042034", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042034", "story_v_out_104042.awb")
				end
	...
	Play104042035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104042035).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042035", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042035", "story_v_out_104042.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104042", "104042035", "story_v_out_104042.awb")

						uv0:RecordAudio("104042035", slot24)
						uv0:RecordAudio("104042035", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042035", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042035", "story_v_out_104042.awb")
				end
	...
	Play104042036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104042036).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042036", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042036", "story_v_out_104042.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104042", "104042036", "story_v_out_104042.awb")

						uv0:RecordAudio("104042036", slot21)
						uv0:RecordAudio("104042036", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042036", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042036", "story_v_out_104042.awb")
				end
	...
	Play104042037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(104042037).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042037", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042037", "story_v_out_104042.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_104042", "104042037", "story_v_out_104042.awb")

						uv0:RecordAudio("104042037", slot27)
						uv0:RecordAudio("104042037", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042037", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042037", "story_v_out_104042.awb")
				end
	...
	Play104042038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(104042038).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042038", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042038", "story_v_out_104042.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_104042", "104042038", "story_v_out_104042.awb")

						uv0:RecordAudio("104042038", slot25)
						uv0:RecordAudio("104042038", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042038", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042038", "story_v_out_104042.awb")
				end
	...
	Play104042039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104042039).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042039", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042039", "story_v_out_104042.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104042", "104042039", "story_v_out_104042.awb")

						uv0:RecordAudio("104042039", slot21)
						uv0:RecordAudio("104042039", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042039", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042039", "story_v_out_104042.awb")
				end
	...
	Play104042040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(104042040).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_104042", "104042040", "story_v_out_104042.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104042", "104042040", "story_v_out_104042.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_104042", "104042040", "story_v_out_104042.awb")

						uv0:RecordAudio("104042040", slot17)
						uv0:RecordAudio("104042040", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104042", "104042040", "story_v_out_104042.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104042", "104042040", "story_v_out_104042.awb")
				end
