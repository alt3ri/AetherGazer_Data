return {
	Play111041001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.fswt_.text = uv0:FormatText(uv0:GetWordFromCfg(111041001).content)
			...
			slot3 = 17
			slot4 = 1.02
			slot7, slot8 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(111041001).content), 1)
			...
			slot9 = math.max(1.02, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_111041", "111041001", "story_v_out_111041.awb") / 1000 > 0 and 1 < slot14 and uv0.duration_ < slot14 + slot12 then
				slot13 = slot14
	...
	Play111041002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 19
			slot3 = 1.14
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(111041001).content), 2)
			...
			slot8 = math.max(1.14, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_111041", "111041002", "story_v_out_111041.awb") / 1000 > 0 and 1 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
	...
	Play111041003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 23
			slot3 = 1.48
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(111041001).content), 3)
			...
			slot8 = math.max(1.48, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_111041", "111041003", "story_v_out_111041.awb") / 1000 > 0 and 1 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play111041004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = 29
			slot3 = 1.74
			slot6, slot7 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(111041001).content), 4)
			...
			slot8 = math.max(1.74, uv0.talkMaxDuration)
			...
			if manager.audio:GetVoiceLength("story_v_out_111041", "111041004", "story_v_out_111041.awb") / 1000 > 0 and 1 < slot11 and uv0.duration_ < slot11 + slot9 then
				slot10 = slot11
				uv0.duration_ = slot11 + slot9
			end
	...
	Play111041005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.D09:GetComponent("SpriteRenderer") then
					slot6.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot7 = slot6.material
					uv0.var_.alphaOldValueD09 = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueD09 = slot7
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueD09 then
					...
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueD09, 1, (uv0.time_ - slot5) / slot6)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(111041005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041005", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041005", "story_v_out_111041.awb") / 1000 + slot11 then
						uv0.duration_ = slot20 + slot11
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_111041", "111041005", "story_v_out_111041.awb")

						uv0:RecordAudio("111041005", slot21)
						uv0:RecordAudio("111041005", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041005", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041005", "story_v_out_111041.awb")
				end
	...
	Play111041006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041006", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041006", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041006", "story_v_out_111041.awb")

						uv0:RecordAudio("111041006", slot10)
						uv0:RecordAudio("111041006", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041006", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041006", "story_v_out_111041.awb")
				end
	...
	Play111041007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111041007).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041007", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041007", "story_v_out_111041.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_111041", "111041007", "story_v_out_111041.awb")

						uv0:RecordAudio("111041007", slot19)
						uv0:RecordAudio("111041007", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041007", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041007", "story_v_out_111041.awb")
				end
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.characterEffect1094ui_story then
					...
					uv0.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot3) / slot4)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041008).content)
	...
	Play111041009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041009).content)
	...
	Play111041010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041010).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041010", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041010", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041010", "story_v_out_111041.awb")

						uv0:RecordAudio("111041010", slot10)
						uv0:RecordAudio("111041010", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041010", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041010", "story_v_out_111041.awb")
				end
	...
	Play111041011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041011).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041011", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041011", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041011", "story_v_out_111041.awb")

						uv0:RecordAudio("111041011", slot15)
						uv0:RecordAudio("111041011", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041011", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041011", "story_v_out_111041.awb")
				end
	...
	Play111041012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041012).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041012", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041012", "story_v_out_111041.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_111041", "111041012", "story_v_out_111041.awb")

						uv0:RecordAudio("111041012", slot13)
						uv0:RecordAudio("111041012", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041012", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041012", "story_v_out_111041.awb")
				end
	...
	Play111041013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041013).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041013", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041013", "story_v_out_111041.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_111041", "111041013", "story_v_out_111041.awb")

						uv0:RecordAudio("111041013", slot13)
						uv0:RecordAudio("111041013", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041013", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041013", "story_v_out_111041.awb")
				end
	...
	Play111041014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041014).content)
				uv0.text_.text = slot8
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041014", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041014", "story_v_out_111041.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_111041", "111041014", "story_v_out_111041.awb")

						uv0:RecordAudio("111041014", slot13)
						uv0:RecordAudio("111041014", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041014", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041014", "story_v_out_111041.awb")
				end
	...
	Play111041015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041015).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041015", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041015", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041015", "story_v_out_111041.awb")

						uv0:RecordAudio("111041015", slot15)
						uv0:RecordAudio("111041015", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041015", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041015", "story_v_out_111041.awb")
				end
	...
	Play111041016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if uv0.bgs_.D06_1:GetComponent("SpriteRenderer") then
					slot8.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot9 = slot8.material
					uv0.var_.alphaOldValueD06_1 = slot9:GetColor("_Color").a
					uv0.var_.alphaMatValueD06_1 = slot9
				end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueD06_1 then
					...
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueD06_1, 1, (uv0.time_ - slot7) / slot8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if uv0.bgs_.D09:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueD09 = slot12:GetColor("_Color").a
					uv0.var_.alphaMatValueD09 = slot12
				end
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				if uv0.var_.alphaMatValueD09 then
					...
					slot15.a = Mathf.Lerp(uv0.var_.alphaOldValueD09, 0, (uv0.time_ - slot10) / slot11)
			...
			if 3.2 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(111041016).content)
	...
	Play111041017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(-0.7, -0.97, -6), (uv0.time_ - slot3) / slot4)
				slot8 = manager.ui.mainCamera.transform.position - slot2.position
				slot2.forward = Vector3.New(slot8.x, slot8.y, slot8.z)
				slot9 = slot2.localEulerAngles
				slot9.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111041017).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041017", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041017", "story_v_out_111041.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_111041", "111041017", "story_v_out_111041.awb")

						uv0:RecordAudio("111041017", slot19)
						uv0:RecordAudio("111041017", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041017", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041017", "story_v_out_111041.awb")
				end
	...
	Play111041018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041018).content)
				uv0.text_.text = slot8
	...
	Play111041019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041019).content)
				uv0.text_.text = slot5
	...
	Play111041020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111041020).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041020", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041020", "story_v_out_111041.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_111041", "111041020", "story_v_out_111041.awb")

						uv0:RecordAudio("111041020", slot19)
						uv0:RecordAudio("111041020", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041020", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041020", "story_v_out_111041.awb")
				end
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.characterEffect1048ui_story then
					...
					uv0.var_.characterEffect1048ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot6) / slot7)
				end
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1039ui_story, Vector3.New(0, -1.01, -5.9), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, -1.01, -5.9)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(111041021).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041021", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041021", "story_v_out_111041.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_111041", "111041021", "story_v_out_111041.awb")

						uv0:RecordAudio("111041021", slot22)
						uv0:RecordAudio("111041021", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041021", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041021", "story_v_out_111041.awb")
				end
	...
	Play111041022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(111041022).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041022", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041022", "story_v_out_111041.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_111041", "111041022", "story_v_out_111041.awb")

						uv0:RecordAudio("111041022", slot11)
						uv0:RecordAudio("111041022", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041022", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041022", "story_v_out_111041.awb")
				end
	...
	Play111041023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111041023).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041023", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041023", "story_v_out_111041.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111041", "111041023", "story_v_out_111041.awb")

						uv0:RecordAudio("111041023", slot18)
						uv0:RecordAudio("111041023", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041023", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041023", "story_v_out_111041.awb")
				end
	...
	Play111041024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.characterEffect1048ui_story then
					uv0.var_.characterEffect1048ui_story.fillFlat = true
					uv0.var_.characterEffect1048ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot7) / slot8)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(111041024).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041024", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041024", "story_v_out_111041.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_111041", "111041024", "story_v_out_111041.awb")

						uv0:RecordAudio("111041024", slot20)
						uv0:RecordAudio("111041024", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041024", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041024", "story_v_out_111041.awb")
				end
	...
	Play111041025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.var_.characterEffect1048ui_story == nil then
				uv0.var_.characterEffect1048ui_story = uv0.actors_["1048ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.characterEffect1048ui_story then
				uv0.var_.characterEffect1048ui_story.fillFlat = false
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(111041025).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041025", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041025", "story_v_out_111041.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_111041", "111041025", "story_v_out_111041.awb")

						uv0:RecordAudio("111041025", slot17)
						uv0:RecordAudio("111041025", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041025", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041025", "story_v_out_111041.awb")
				end
	...
	Play111041026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041026).content)
				uv0.text_.text = slot8
	...
	Play111041027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041027).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041027", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041027", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041027", "story_v_out_111041.awb")

						uv0:RecordAudio("111041027", slot15)
						uv0:RecordAudio("111041027", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041027", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041027", "story_v_out_111041.awb")
				end
	...
	Play111041028 = function (slot0, slot1)
		...
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111041028
		slot1.duration_ = 8.73333333333333
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1048ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot6) / slot7)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1039ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot12) / slot13)
			...
			if 3.73333333333333 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot18 = uv0:FormatText(uv0:GetWordFromCfg(111041028).content)
	...
	Play111041029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0.var_.moveOldPosD999 = uv0.bgs_.D999.transform.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.bgs_.D999:GetComponent("SpriteRenderer") then
				slot7.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
				slot8 = slot7.material
				uv0.var_.alphaOldValueD999 = slot8:GetColor("_Color").a
				uv0.var_.alphaMatValueD999 = slot8
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.alphaMatValueD999 then
					...
					slot11.a = Mathf.Lerp(uv0.var_.alphaOldValueD999, 0.3, (uv0.time_ - slot6) / slot7)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(111041029).content)
	...
	Play111041030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041030).content)
				uv0.text_.text = slot5
	...
	Play111041031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041031).content)
				uv0.text_.text = slot4
	...
	Play111041032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041032).content)
				uv0.text_.text = slot4
	...
	Play111041033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.D999:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueD999 = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueD999 = slot6
				end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueD999 then
					slot8 = uv0.var_.alphaMatValueD999
					slot9 = slot8:GetColor("_Color")
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueD999, 0, (uv0.time_ - slot4) / slot5)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111041033).content)
				uv0.text_.text = slot14
	...
	Play111041034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_otis")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041034).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041034", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041034", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041034", "story_v_out_111041.awb")

						uv0:RecordAudio("111041034", slot10)
						uv0:RecordAudio("111041034", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041034", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041034", "story_v_out_111041.awb")
				end
	...
	Play111041035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041035).content)
				uv0.text_.text = slot5
	...
	Play111041036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041036).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041036", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041036", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041036", "story_v_out_111041.awb")

						uv0:RecordAudio("111041036", slot10)
						uv0:RecordAudio("111041036", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041036", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041036", "story_v_out_111041.awb")
				end
	...
	Play111041037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041037).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041037", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041037", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041037", "story_v_out_111041.awb")

						uv0:RecordAudio("111041037", slot10)
						uv0:RecordAudio("111041037", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041037", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041037", "story_v_out_111041.awb")
				end
	...
	Play111041038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041038).content)
				uv0.text_.text = slot5
	...
	Play111041039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041039).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041039", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041039", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041039", "story_v_out_111041.awb")

						uv0:RecordAudio("111041039", slot10)
						uv0:RecordAudio("111041039", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041039", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041039", "story_v_out_111041.awb")
				end
	...
	Play111041040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041040).content)
				uv0.text_.text = slot5
	...
	Play111041041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041041).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041041", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041041", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041041", "story_v_out_111041.awb")

						uv0:RecordAudio("111041041", slot10)
						uv0:RecordAudio("111041041", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041041", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041041", "story_v_out_111041.awb")
				end
	...
	Play111041042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041042).content)
				uv0.text_.text = slot5
	...
	Play111041043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041043).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041043", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041043", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041043", "story_v_out_111041.awb")

						uv0:RecordAudio("111041043", slot10)
						uv0:RecordAudio("111041043", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041043", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041043", "story_v_out_111041.awb")
				end
	...
	Play111041044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041044).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041044", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041044", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041044", "story_v_out_111041.awb")

						uv0:RecordAudio("111041044", slot10)
						uv0:RecordAudio("111041044", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041044", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041044", "story_v_out_111041.awb")
				end
	...
	Play111041045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041045).content)
				uv0.text_.text = slot4
	...
	Play111041046 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041046).content)
				uv0.text_.text = slot5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if uv0.bgs_.D06_1:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueD06_1 = slot5:GetColor("_Color").a
					uv0.var_.alphaMatValueD06_1 = slot5
				end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.alphaMatValueD06_1 then
					...
					slot8 = slot7:GetColor("_Color")
					slot8.a = Mathf.Lerp(uv0.var_.alphaOldValueD06_1, 1, (uv0.time_ - slot3) / slot4)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if uv0.bgs_.AS0103:GetComponent("SpriteRenderer") then
					slot7.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot8 = slot7.material
					uv0.var_.alphaOldValueAS0103 = slot8:GetColor("_Color").a
					uv0.var_.alphaMatValueAS0103 = slot8
				end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.alphaMatValueAS0103 then
					...
					slot11 = slot10:GetColor("_Color")
					slot11.a = Mathf.Lerp(uv0.var_.alphaOldValueAS0103, 0, (uv0.time_ - slot6) / slot7)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(111041048).content)
				uv0.text_.text = slot15
	...
	Play111041049 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041049).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041049", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041049", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041049", "story_v_out_111041.awb")

						uv0:RecordAudio("111041049", slot10)
						uv0:RecordAudio("111041049", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041049", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041049", "story_v_out_111041.awb")
				end
	...
	Play111041050 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041050).content)
				uv0.text_.text = slot5
	...
	Play111041051 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041051).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041051", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041051", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041051", "story_v_out_111041.awb")

						uv0:RecordAudio("111041051", slot10)
						uv0:RecordAudio("111041051", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041051", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041051", "story_v_out_111041.awb")
				end
	...
	Play111041052 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041052).content)
				uv0.text_.text = slot4
	...
	Play111041053 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041053).content)
				uv0.text_.text = slot5
	...
	Play111041054 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041054).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041054", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041054", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041054", "story_v_out_111041.awb")

						uv0:RecordAudio("111041054", slot10)
						uv0:RecordAudio("111041054", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041054", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041054", "story_v_out_111041.awb")
				end
	...
	Play111041055 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041055).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041055", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041055", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041055", "story_v_out_111041.awb")

						uv0:RecordAudio("111041055", slot10)
						uv0:RecordAudio("111041055", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041055", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041055", "story_v_out_111041.awb")
				end
	...
	Play111041056 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041056).content)
				uv0.text_.text = slot5
	...
	Play111041057 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041057).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041057", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041057", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041057", "story_v_out_111041.awb")

						uv0:RecordAudio("111041057", slot10)
						uv0:RecordAudio("111041057", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041057", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041057", "story_v_out_111041.awb")
				end
	...
	Play111041058 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041058).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041058", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041058", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041058", "story_v_out_111041.awb")

						uv0:RecordAudio("111041058", slot10)
						uv0:RecordAudio("111041058", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041058", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041058", "story_v_out_111041.awb")
				end
	...
	Play111041059 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041059).content)
				uv0.text_.text = slot5
	...
	Play111041060 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041060).content)
				uv0.text_.text = slot4
	...
	Play111041061 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041061).content)
				uv0.text_.text = slot4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.alphaMatValueD06_1 then
					slot7 = uv0.var_.alphaMatValueD06_1
					slot8 = slot7:GetColor("_Color")
					slot8.a = Mathf.Lerp(uv0.var_.alphaOldValueD06_1, 0, (uv0.time_ - slot3) / slot4)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111041062).content)
				uv0.text_.text = slot13
	...
	Play111041063 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041063).content)
				uv0.text_.text = slot4
	...
	Play111041064 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041064).content)
				uv0.text_.text = slot4
	...
	Play111041065 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041065).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041065", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041065", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041065", "story_v_out_111041.awb")

						uv0:RecordAudio("111041065", slot10)
						uv0:RecordAudio("111041065", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041065", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041065", "story_v_out_111041.awb")
				end
	...
	Play111041066 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041066).content)
				uv0.text_.text = slot5
	...
	Play111041067 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041067).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041067", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041067", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041067", "story_v_out_111041.awb")

						uv0:RecordAudio("111041067", slot10)
						uv0:RecordAudio("111041067", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041067", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041067", "story_v_out_111041.awb")
				end
	...
	Play111041068 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041068).content)
				uv0.text_.text = slot4
	...
	Play111041069 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041069).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041069", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041069", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041069", "story_v_out_111041.awb")

						uv0:RecordAudio("111041069", slot10)
						uv0:RecordAudio("111041069", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041069", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041069", "story_v_out_111041.awb")
				end
	...
	Play111041070 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041070).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041070", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041070", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041070", "story_v_out_111041.awb")

						uv0:RecordAudio("111041070", slot10)
						uv0:RecordAudio("111041070", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041070", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041070", "story_v_out_111041.awb")
				end
	...
	Play111041071 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041071).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041071", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041071", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041071", "story_v_out_111041.awb")

						uv0:RecordAudio("111041071", slot10)
						uv0:RecordAudio("111041071", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041071", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041071", "story_v_out_111041.awb")
				end
	...
	Play111041072 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041072).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041072", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041072", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041072", "story_v_out_111041.awb")

						uv0:RecordAudio("111041072", slot10)
						uv0:RecordAudio("111041072", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041072", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041072", "story_v_out_111041.awb")
				end
	...
	Play111041073 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041073).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041073", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041073", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041073", "story_v_out_111041.awb")

						uv0:RecordAudio("111041073", slot10)
						uv0:RecordAudio("111041073", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041073", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041073", "story_v_out_111041.awb")
				end
	...
	Play111041074 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041074).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041074", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041074", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041074", "story_v_out_111041.awb")

						uv0:RecordAudio("111041074", slot10)
						uv0:RecordAudio("111041074", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041074", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041074", "story_v_out_111041.awb")
				end
	...
	Play111041075 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041075).content)
				uv0.text_.text = slot4
	...
	Play111041076 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041076).content)
				uv0.text_.text = slot4
	...
	Play111041077 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041077).content)
				uv0.text_.text = slot4
	...
	Play111041078 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_heidie")

				uv0.callingController_:SetSelectedState("normal")

				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041078).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041078", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041078", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041078", "story_v_out_111041.awb")

						uv0:RecordAudio("111041078", slot10)
						uv0:RecordAudio("111041078", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041078", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041078", "story_v_out_111041.awb")
				end
	...
	Play111041079 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041079).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041079", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041079", "story_v_out_111041.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111041", "111041079", "story_v_out_111041.awb")

						uv0:RecordAudio("111041079", slot10)
						uv0:RecordAudio("111041079", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041079", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041079", "story_v_out_111041.awb")
				end
	...
	Play111041080 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041080).content)
				uv0.text_.text = slot4
	...
	Play111041081 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3.2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111041081).content)
				uv0.text_.text = slot13
	...
	Play111041082 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041082).content)
				uv0.text_.text = slot4
	...
	Play111041083 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if uv0.bgs_.ST01a:GetComponent("SpriteRenderer") then
					slot5.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot6 = slot5.material
					uv0.var_.alphaOldValueST01a = slot6:GetColor("_Color").a
					uv0.var_.alphaMatValueST01a = slot6
				end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.alphaMatValueST01a then
					...
					slot9 = slot8:GetColor("_Color")
					slot9.a = Mathf.Lerp(uv0.var_.alphaOldValueST01a, 0, (uv0.time_ - slot4) / slot5)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if uv0.bgs_.B13a:GetComponent("SpriteRenderer") then
					slot8.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot9 = slot8.material
					uv0.var_.alphaOldValueB13a = slot9:GetColor("_Color").a
					uv0.var_.alphaMatValueB13a = slot9
				end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueB13a then
					...
					slot12 = slot11:GetColor("_Color")
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueB13a, 1, (uv0.time_ - slot7) / slot8)
			...
			if 3.43333333333333 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(111041083).content)
				uv0.text_.text = slot15
	...
	Play111041084 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041084).content)
				uv0.text_.text = slot4
	...
	Play111041085 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041085).content)
				uv0.text_.text = slot4
	...
	Play111041086 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041086).content)
				uv0.text_.text = slot5
	...
	Play111041087 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041087).content)
				uv0.text_.text = slot4
	...
	Play111041088 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				if uv0.var_.characterEffect1094ui_story then
					uv0.var_.characterEffect1094ui_story.fillFlat = true
					uv0.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot6) / slot7)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(111041088).content)
	...
	Play111041089 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111041089).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041089", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041089", "story_v_out_111041.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111041", "111041089", "story_v_out_111041.awb")

						uv0:RecordAudio("111041089", slot18)
						uv0:RecordAudio("111041089", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041089", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041089", "story_v_out_111041.awb")
				end
	...
	Play111041090 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111041090).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041090", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041090", "story_v_out_111041.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111041", "111041090", "story_v_out_111041.awb")

						uv0:RecordAudio("111041090", slot14)
						uv0:RecordAudio("111041090", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041090", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041090", "story_v_out_111041.awb")
				end
	...
	Play111041091 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041091).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041091", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041091", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041091", "story_v_out_111041.awb")

						uv0:RecordAudio("111041091", slot15)
						uv0:RecordAudio("111041091", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041091", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041091", "story_v_out_111041.awb")
				end
	...
	Play111041092 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041092).content)
				uv0.text_.text = slot8
	...
	Play111041093 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111041093).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041093", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041093", "story_v_out_111041.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111041", "111041093", "story_v_out_111041.awb")

						uv0:RecordAudio("111041093", slot14)
						uv0:RecordAudio("111041093", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041093", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041093", "story_v_out_111041.awb")
				end
	...
	Play111041094 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041094).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041094", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041094", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041094", "story_v_out_111041.awb")

						uv0:RecordAudio("111041094", slot15)
						uv0:RecordAudio("111041094", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041094", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041094", "story_v_out_111041.awb")
				end
	...
	Play111041095 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111041095).content)
	...
	Play111041096 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111041096).content)
				uv0.text_.text = slot4
	...
	Play111041097 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041097).content)
				uv0.text_.text = slot8
	...
	Play111041098 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041098).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041098", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041098", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041098", "story_v_out_111041.awb")

						uv0:RecordAudio("111041098", slot15)
						uv0:RecordAudio("111041098", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041098", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041098", "story_v_out_111041.awb")
				end
	...
	Play111041099 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041099).content)
				uv0.text_.text = slot8
	...
	Play111041100 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041100).content)
				uv0.text_.text = slot5
	...
	Play111041101 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111041101).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041101", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041101", "story_v_out_111041.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111041", "111041101", "story_v_out_111041.awb")

						uv0:RecordAudio("111041101", slot14)
						uv0:RecordAudio("111041101", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041101", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041101", "story_v_out_111041.awb")
				end
	...
	Play111041102 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041102).content)
				uv0.text_.text = slot8
	...
	Play111041103 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041103).content)
				uv0.text_.text = slot5
	...
	Play111041104 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041104).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041104", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041104", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041104", "story_v_out_111041.awb")

						uv0:RecordAudio("111041104", slot15)
						uv0:RecordAudio("111041104", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041104", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041104", "story_v_out_111041.awb")
				end
	...
	Play111041105 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041105).content)
				uv0.text_.text = slot8
	...
	Play111041106 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041106).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041106", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041106", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041106", "story_v_out_111041.awb")

						uv0:RecordAudio("111041106", slot15)
						uv0:RecordAudio("111041106", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041106", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041106", "story_v_out_111041.awb")
				end
	...
	Play111041107 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111041107).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041107", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041107", "story_v_out_111041.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111041", "111041107", "story_v_out_111041.awb")

						uv0:RecordAudio("111041107", slot14)
						uv0:RecordAudio("111041107", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041107", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041107", "story_v_out_111041.awb")
				end
	...
	Play111041108 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041108).content)
				uv0.text_.text = slot8
	...
	Play111041109 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111041109).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041109", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041109", "story_v_out_111041.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111041", "111041109", "story_v_out_111041.awb")

						uv0:RecordAudio("111041109", slot14)
						uv0:RecordAudio("111041109", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041109", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041109", "story_v_out_111041.awb")
				end
	...
	Play111041110 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041110).content)
				uv0.text_.text = slot8
	...
	Play111041111 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041111).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041111", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041111", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041111", "story_v_out_111041.awb")

						uv0:RecordAudio("111041111", slot15)
						uv0:RecordAudio("111041111", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041111", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041111", "story_v_out_111041.awb")
				end
	...
	Play111041112 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111041112).content)
				uv0.text_.text = slot7
	...
	Play111041113 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041113).content)
				uv0.text_.text = slot5
	...
	Play111041114 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111041114).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041114", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041114", "story_v_out_111041.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111041", "111041114", "story_v_out_111041.awb")

						uv0:RecordAudio("111041114", slot14)
						uv0:RecordAudio("111041114", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041114", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041114", "story_v_out_111041.awb")
				end
	...
	Play111041115 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041115).content)
				uv0.text_.text = slot8
	...
	Play111041116 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(111041116).content)
				uv0.text_.text = slot11
	...
	Play111041117 = function (slot0, slot1)
		...
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 111041117
		slot1.duration_ = 14.4666666666667
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				if uv0.var_.characterEffect1066ui_story then
					...
					uv0.var_.characterEffect1066ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot12) / slot13)
				end
			end
			...
			if slot18 <= uv0.time_ and uv0.time_ < slot18 + slot19 then
				slot17.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(0.7, -1.08, -5.9), (uv0.time_ - slot18) / slot19)
			...
			if slot21 <= uv0.time_ and uv0.time_ < slot21 + slot22 then
				slot20.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1066ui_story, Vector3.New(-0.7, -0.77, -6.1), (uv0.time_ - slot21) / slot22)
			...
			if uv0.time_ >= slot21 + slot22 and uv0.time_ < slot21 + slot22 + slot0 then
				slot20.localPosition = Vector3.New(-0.7, -0.77, -6.1)
			...
			if manager.audio:GetVoiceLength("story_v_out_111041", "111041117", "story_v_out_111041.awb") / 1000 > 0 and 8.236 < slot27 and uv0.duration_ < slot27 + slot25 then
				slot26 = slot27
			...
			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot28 + slot0 then
				...
				slot33 = uv0:FormatText(uv0:GetWordFromCfg(111041117).content)
				uv0.text_.text = slot33

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (42 <= 0 and slot29 or slot29 * utf8.len(slot33) / slot34) > 0 and slot29 < slot36 then
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041117", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041117", "story_v_out_111041.awb") / 1000 + slot28 then
						uv0.duration_ = slot37 + slot28
					end

					if slot32.prefab_name ~= "" and uv0.actors_[slot32.prefab_name] ~= nil then
						slot38 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot32.prefab_name].transform, "story_v_out_111041", "111041117", "story_v_out_111041.awb")

						uv0:RecordAudio("111041117", slot38)
						uv0:RecordAudio("111041117", slot38)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041117", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041117", "story_v_out_111041.awb")
				end
	...
	Play111041118 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041118).content)
				uv0.text_.text = slot8
	...
	Play111041119 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111041", "111041119", "story_v_out_111041.awb") / 1000 > 0 and 11.834 < slot7 and uv0.duration_ < slot7 + slot5 then
				slot6 = slot7
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(111041119).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041119", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041119", "story_v_out_111041.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_111041", "111041119", "story_v_out_111041.awb")

						uv0:RecordAudio("111041119", slot17)
						uv0:RecordAudio("111041119", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041119", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041119", "story_v_out_111041.awb")
				end
	...
	Play111041120 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041120).content)
				uv0.text_.text = slot8
	...
	Play111041121 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111041", "111041121", "story_v_out_111041.awb") / 1000 > 0 and 4.678 < slot8 and uv0.duration_ < slot8 + slot6 then
				slot7 = slot8
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(111041121).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041121", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041121", "story_v_out_111041.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111041", "111041121", "story_v_out_111041.awb")

						uv0:RecordAudio("111041121", slot18)
						uv0:RecordAudio("111041121", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041121", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041121", "story_v_out_111041.awb")
				end
	...
	Play111041122 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1094ui_story, Vector3.New(0, -0.84, -6.1), (uv0.time_ - slot10) / slot11)
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(0, -0.84, -6.1)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				if uv0.var_.characterEffect1094ui_story then
					uv0.var_.characterEffect1094ui_story.fillFlat = true
					uv0.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot15) / slot16)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				slot24 = uv0:FormatText(uv0:GetWordFromCfg(111041122).content)
				uv0.text_.text = slot24

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (43 <= 0 and slot21 or slot21 * utf8.len(slot24) / slot25) > 0 and slot21 < slot27 then
	...
	Play111041123 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041123).content)
				uv0.text_.text = slot5
	...
	Play111041124 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041124).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041124", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041124", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041124", "story_v_out_111041.awb")

						uv0:RecordAudio("111041124", slot15)
						uv0:RecordAudio("111041124", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041124", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041124", "story_v_out_111041.awb")
				end
	...
	Play111041125 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041125).content)
				uv0.text_.text = slot8
	...
	Play111041126 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111041126).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041126", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041126", "story_v_out_111041.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111041", "111041126", "story_v_out_111041.awb")

						uv0:RecordAudio("111041126", slot14)
						uv0:RecordAudio("111041126", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041126", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041126", "story_v_out_111041.awb")
				end
	...
	Play111041127 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041127).content)
				uv0.text_.text = slot8
	...
	Play111041128 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041128).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041128", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041128", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041128", "story_v_out_111041.awb")

						uv0:RecordAudio("111041128", slot15)
						uv0:RecordAudio("111041128", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041128", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041128", "story_v_out_111041.awb")
				end
	...
	Play111041129 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111041129).content)
				uv0.text_.text = slot8
	...
	Play111041130 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111041130).content)
				uv0.text_.text = slot5
	...
	Play111041131 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(111041131).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_111041", "111041131", "story_v_out_111041.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111041", "111041131", "story_v_out_111041.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111041", "111041131", "story_v_out_111041.awb")

						uv0:RecordAudio("111041131", slot15)
						uv0:RecordAudio("111041131", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111041", "111041131", "story_v_out_111041.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111041", "111041131", "story_v_out_111041.awb")
				end
	...
	Play111041132 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(111041132).content)
				uv0.text_.text = slot7
