	...
	Play111111001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2.33333333333333 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111111001).content)
	...
	Play111111002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111111002).content)
	...
	Play111111003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111111003).content)
	...
	Play111111004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(111111004).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_111111", "111111004", "story_v_out_111111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111111", "111111004", "story_v_out_111111.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_111111", "111111004", "story_v_out_111111.awb")

						uv0:RecordAudio("111111004", slot19)
						uv0:RecordAudio("111111004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111111", "111111004", "story_v_out_111111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111111", "111111004", "story_v_out_111111.awb")
				end
	...
	Play111111005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111111005).content)
	...
	Play111111006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(111111006).content)
				uv0.text_.text = slot4
	...
	Play111111007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111111007).content)
				uv0.text_.text = slot5
	...
	Play111111008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111111008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_111111", "111111008", "story_v_out_111111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111111", "111111008", "story_v_out_111111.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111111", "111111008", "story_v_out_111111.awb")

						uv0:RecordAudio("111111008", slot14)
						uv0:RecordAudio("111111008", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111111", "111111008", "story_v_out_111111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111111", "111111008", "story_v_out_111111.awb")
				end
	...
	Play111111009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111111009).content)
				uv0.text_.text = slot8
	...
	Play111111010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(111111010).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_111111", "111111010", "story_v_out_111111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_111111", "111111010", "story_v_out_111111.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111111", "111111010", "story_v_out_111111.awb")

						uv0:RecordAudio("111111010", slot14)
						uv0:RecordAudio("111111010", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_111111", "111111010", "story_v_out_111111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_111111", "111111010", "story_v_out_111111.awb")
				end
	...
	Play111111011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(111111011).content)
				uv0.text_.text = slot8
	...
	Play111111012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(111111012).content)
				uv0.text_.text = slot5
