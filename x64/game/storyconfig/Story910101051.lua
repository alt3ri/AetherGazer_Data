return {
	Play910105001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910105001
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if uv0.actors_["1039"]:GetComponent("Image") then
					uv0.var_.alphaMatValue1039 = slot11
					uv0.var_.alphaOldValue1039 = slot11.color.a
				end
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				if uv0.var_.alphaMatValue1039 then
					slot14 = uv0.var_.alphaMatValue1039.color
					slot14.a = Mathf.Lerp(uv0.var_.alphaOldValue1039, 1, (uv0.time_ - slot10) / slot11)
					uv0.var_.alphaMatValue1039.color = slot14
				end
			end

			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 and uv0.var_.alphaMatValue1039 then
				slot12 = uv0.var_.alphaMatValue1039
				slot13 = slot12.color
				slot13.a = 1
				slot12.color = slot13
			end
			...
			if 1 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(910105001).content)
	...
	Play910105002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910105002
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(910105002).content)
	...
	Play910105003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910105003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.0333333333333333 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(910105003).content)
	...
	Play910105004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910105004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(910105004).content)
				uv0.text_.text = slot5
	...
	Play910105005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910105005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(910105005).content)
				uv0.text_.text = slot5
	...
	Play910105006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 910105006
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(910105006).content)
				uv0.text_.text = slot5
