return {
	Play115032001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032001
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play115032002(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.RO0104 == nil then
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPosRO0104 = uv0.bgs_.RO0104.transform.localPosition
			end

			slot12 = 0.001

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPosRO0104, Vector3.New(0, 1, 9.5), (uv0.time_ - slot11) / slot12)
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPosRO0104, Vector3.New(0, 1, 10), (uv0.time_ - slot14) / slot15)
			end
			...
			if uv0.time_ >= slot16 + 2.299998 and uv0.time_ < slot16 + slot17 + slot0 then
				uv0.allBtn_.enabled = true
			end
			...
			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				slot18.localPosition = Vector3.Lerp(uv0.var_.moveOldPosRO0104, Vector3.New(0, 1, 9.5), (uv0.time_ - slot19) / slot20)
			end

			if uv0.time_ >= slot19 + slot20 and uv0.time_ < slot19 + slot20 + slot0 then
				slot18.localPosition = Vector3.New(0, 1, 9.5)
			end
			...
			slot24 = 2.33333333333333

			if 1.23333333333333 < uv0.time_ and uv0.time_ <= slot23 + slot0 then
			...
			if 2.599999999999 < uv0.time_ and uv0.time_ <= slot25 + slot0 then
				...
				slot29 = uv0:FormatText(uv0:GetWordFromCfg(115032001).content)
	...
	Play115032002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(115032002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115032", "115032002", "story_v_out_115032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115032", "115032002", "story_v_out_115032.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_115032", "115032002", "story_v_out_115032.awb")

						uv0:RecordAudio("115032002", slot10)
						uv0:RecordAudio("115032002", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115032", "115032002", "story_v_out_115032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115032", "115032002", "story_v_out_115032.awb")
				end
	...
	Play115032003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(115032003).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_115032", "115032003", "story_v_out_115032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115032", "115032003", "story_v_out_115032.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_115032", "115032003", "story_v_out_115032.awb")

						uv0:RecordAudio("115032003", slot10)
						uv0:RecordAudio("115032003", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115032", "115032003", "story_v_out_115032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115032", "115032003", "story_v_out_115032.awb")
				end
	...
	Play115032004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1024ui_story == nil then
			...
			if 4 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(115032004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115032", "115032004", "story_v_out_115032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115032", "115032004", "story_v_out_115032.awb") / 1000 + slot16 then
						uv0.duration_ = slot25 + slot16
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_115032", "115032004", "story_v_out_115032.awb")

						uv0:RecordAudio("115032004", slot26)
						uv0:RecordAudio("115032004", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115032", "115032004", "story_v_out_115032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115032", "115032004", "story_v_out_115032.awb")
				end
	...
	Play115032005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032005
		slot1.duration_ = 2.966666666666
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot11 = uv0.var_.characterEffect10014ui_story
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(115032005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115032", "115032005", "story_v_out_115032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115032", "115032005", "story_v_out_115032.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_115032", "115032005", "story_v_out_115032.awb")

						uv0:RecordAudio("115032005", slot24)
						uv0:RecordAudio("115032005", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115032", "115032005", "story_v_out_115032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115032", "115032005", "story_v_out_115032.awb")
				end
	...
	Play115032006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(115032006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_115032", "115032006", "story_v_out_115032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115032", "115032006", "story_v_out_115032.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_115032", "115032006", "story_v_out_115032.awb")

						uv0:RecordAudio("115032006", slot14)
						uv0:RecordAudio("115032006", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115032", "115032006", "story_v_out_115032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115032", "115032006", "story_v_out_115032.awb")
				end
	...
	Play115032007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115032007).content)
	...
	Play115032008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032008
		slot1.duration_ = 5.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(115032008).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_115032", "115032008", "story_v_out_115032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115032", "115032008", "story_v_out_115032.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_115032", "115032008", "story_v_out_115032.awb")

						uv0:RecordAudio("115032008", slot15)
						uv0:RecordAudio("115032008", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115032", "115032008", "story_v_out_115032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115032", "115032008", "story_v_out_115032.awb")
				end
	...
	Play115032009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032009
		slot1.duration_ = 2.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(115032009).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_115032", "115032009", "story_v_out_115032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115032", "115032009", "story_v_out_115032.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_115032", "115032009", "story_v_out_115032.awb")

						uv0:RecordAudio("115032009", slot10)
						uv0:RecordAudio("115032009", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115032", "115032009", "story_v_out_115032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115032", "115032009", "story_v_out_115032.awb")
				end
	...
	Play115032010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(115032010).content)
				uv0.text_.text = slot9
				...
				if manager.audio:GetVoiceLength("story_v_out_115032", "115032010", "story_v_out_115032.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_115032", "115032010", "story_v_out_115032.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_115032", "115032010", "story_v_out_115032.awb")

						uv0:RecordAudio("115032010", slot14)
						uv0:RecordAudio("115032010", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_115032", "115032010", "story_v_out_115032.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_115032", "115032010", "story_v_out_115032.awb")
				end
	...
	Play115032011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 115032011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(115032011).content)
