return {
	...
	Play910814003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				local var_14_18 = arg_11_1:GetWordFromCfg(910814003)
	...
	Play910814004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_13 < arg_15_1.time_ and arg_15_1.time_ <= var_18_13 + arg_18_0 then
				...
				local var_18_15 = arg_15_1:GetWordFromCfg(910814004)
	...
	Play910814005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_13 < arg_19_1.time_ and arg_19_1.time_ <= var_22_13 + arg_22_0 then
				...
				local var_22_16 = arg_19_1:GetWordFromCfg(910814005)
	...
	Play910814006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_13 < arg_23_1.time_ and arg_23_1.time_ <= var_26_13 + arg_26_0 then
				...
				local var_26_16 = arg_23_1:GetWordFromCfg(910814006)
	...
	Play910814007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_13 < arg_27_1.time_ and arg_27_1.time_ <= var_30_13 + arg_30_0 then
				...
				local var_30_16 = arg_27_1:GetWordFromCfg(910814007)
	...
	Play910814008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_13 < arg_31_1.time_ and arg_31_1.time_ <= var_34_13 + arg_34_0 then
				...
				local var_34_16 = arg_31_1:GetWordFromCfg(910814008)
	...
	Play910814009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_13 < arg_35_1.time_ and arg_35_1.time_ <= var_38_13 + arg_38_0 then
				...
				local var_38_16 = arg_35_1:GetWordFromCfg(910814009)
	...
	Play910814010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_13 < arg_39_1.time_ and arg_39_1.time_ <= var_42_13 + arg_42_0 then
				...
				local var_42_16 = arg_39_1:GetWordFromCfg(910814010)
	...
	Play910814011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_13 < arg_43_1.time_ and arg_43_1.time_ <= var_46_13 + arg_46_0 then
				...
				local var_46_16 = arg_43_1:GetWordFromCfg(910814011)
	...
	Play910814012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_13 < arg_47_1.time_ and arg_47_1.time_ <= var_50_13 + arg_50_0 then
				...
				local var_50_16 = arg_47_1:GetWordFromCfg(910814012)
	...
	Play910814013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			local var_54_6 = arg_51_1.actors_["1070"].transform
			local var_54_7 = 0

			if var_54_7 < arg_51_1.time_ and arg_51_1.time_ <= var_54_7 + arg_54_0 then
				arg_51_1.var_.moveOldPos1070 = var_54_6.localPosition
			...
			if var_54_7 <= arg_51_1.time_ and arg_51_1.time_ < var_54_7 + var_54_10 then
				...
				var_54_6.localPosition = Vector3.Lerp(arg_51_1.var_.moveOldPos1070, var_54_12, var_54_11)
			end
			...
			if var_54_13 < arg_51_1.time_ and arg_51_1.time_ <= var_54_13 + arg_54_0 then
				...
				local var_54_16 = "effect"

				arg_51_1:AudioAction(var_54_15, var_54_16, "ui_skip", "ui_bgm_lower_back", "")
			end
			...
			if var_54_17 < arg_51_1.time_ and arg_51_1.time_ <= var_54_17 + arg_54_0 then
				...
				local var_54_19 = arg_51_1:FormatText(StoryNameCfg[7].name)
				...
				local var_54_20 = arg_51_1:GetWordFromCfg(910814013)
			...
			local var_54_25 = math.max(var_54_18, arg_51_1.talkMaxDuration)

			if var_54_17 <= arg_51_1.time_ and arg_51_1.time_ < var_54_17 + var_54_25 then
				arg_51_1.typewritter.percent = (arg_51_1.time_ - var_54_17) / var_54_25

				arg_51_1.typewritter:SetDirty()
			end

			if arg_51_1.time_ >= var_54_17 + var_54_25 and arg_51_1.time_ < var_54_17 + var_54_25 + arg_54_0 then
