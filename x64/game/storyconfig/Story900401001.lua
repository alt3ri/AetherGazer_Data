	...
	Play900401003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv1.narr_chapter_text.text = uv0:FormatText(uv0:GetWordFromCfg(900401001).content)
				uv1.narr_time_text.text = uv0:FormatText(uv0:GetWordFromCfg(900401002).content)
			...
			if 0.0334 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv1.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_littleboyb")
				uv1.narr_item_content.text = uv0:FormatText(uv0:GetWordFromCfg(900401003).content)
	...
	Play900401004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401004).content)
	...
	Play900401005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401005).content)
	...
	Play900401006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_yakuzab")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401006).content)
	...
	Play900401007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401007).content)
	...
	Play900401008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_citizenwc")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401008).content)
	...
	Play900401009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401009).content)
	...
	Play900401010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10026_split_1")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401010).content)
	...
	Play900401011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10026_split_1")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401011).content)
	...
	Play900401012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_littleboyb")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401012).content)
	...
	Play900401013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10022_split_6")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401013).content)
	...
	Play900401014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401014).content)
	...
	Play900401015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10022_split_1")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401015).content)
	...
	Play900401016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_yakuzab")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401016).content)
	...
	Play900401017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_yakuzab")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401017).content)
	...
	Play900401018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_yakuzab")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401018).content)
	...
	Play900401019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401019).content)
	...
	Play900401020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_yakuzab")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401020).content)
	...
	Play900401021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_yakuzab")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401021).content)
	...
	Play900401022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10022_split_6")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401022).content)
	...
	Play900401023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10022_split_6")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401023).content)
	...
	Play900401024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401024).content)
	...
	Play900401025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("TextureConfig/Story/Character/" .. "story_10022_split_1")
				uv0.narr_item_content.text = uv1:FormatText(uv1:GetWordFromCfg(900401025).content)
