return {
	Play101111001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.B02d:GetComponent("SpriteRenderer") then
					slot6.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot7 = slot6.material
					uv0.var_.alphaOldValueB02d = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueB02d = slot7
				end

				uv0.var_.alphaOldValueB02d = 0
			end

			slot6 = 1.5

			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueB02d then
					slot9 = uv0.var_.alphaMatValueB02d
					slot10 = slot9:GetColor("_Color")
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueB02d, 1, (uv0.time_ - slot5) / slot6)

					slot9:SetColor("_Color", slot10)
				end
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.alphaMatValueB02d then
				slot7 = uv0.var_.alphaMatValueB02d
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(101111001).content)
	...
	Play101111002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(101111002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111002", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111002", "story_v_out_101111.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_101111", "101111002", "story_v_out_101111.awb")

						uv0:RecordAudio("101111002", slot21)
						uv0:RecordAudio("101111002", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111002", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111002", "story_v_out_101111.awb")
				end
	...
	Play101111003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111003
		slot1.duration_ = 7.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(101111003).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111003", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111003", "story_v_out_101111.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_101111", "101111003", "story_v_out_101111.awb")

						uv0:RecordAudio("101111003", slot22)
						uv0:RecordAudio("101111003", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111003", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111003", "story_v_out_101111.awb")
				end
	...
	Play101111004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111004
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101111004).content)
				uv0.text_.text = slot13

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (50 <= 0 and slot11 or slot11 * utf8.len(slot13) / slot14) > 0 and slot11 < slot16 then
	...
	Play101111005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(101111005).content)
	...
	Play101111006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111006
		slot1.duration_ = 6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(101111006).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111006", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111006", "story_v_out_101111.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_101111", "101111006", "story_v_out_101111.awb")

						uv0:RecordAudio("101111006", slot18)
						uv0:RecordAudio("101111006", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111006", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111006", "story_v_out_101111.awb")
				end
	...
	Play101111007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101111007).content)
	...
	Play101111008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(101111008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111008", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111008", "story_v_out_101111.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_101111", "101111008", "story_v_out_101111.awb")

						uv0:RecordAudio("101111008", slot15)
						uv0:RecordAudio("101111008", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111008", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111008", "story_v_out_101111.awb")
				end
	...
	Play101111009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111009
		slot1.duration_ = 9.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(101111009).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111009", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111009", "story_v_out_101111.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_101111", "101111009", "story_v_out_101111.awb")

						uv0:RecordAudio("101111009", slot21)
						uv0:RecordAudio("101111009", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111009", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111009", "story_v_out_101111.awb")
				end
	...
	Play101111010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(101111010).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111010", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111010", "story_v_out_101111.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_101111", "101111010", "story_v_out_101111.awb")

						uv0:RecordAudio("101111010", slot10)
						uv0:RecordAudio("101111010", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111010", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111010", "story_v_out_101111.awb")
				end
	...
	Play101111011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111011
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2030_tpose, Vector3.New(0.7, -1.2, -4.2), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0.7, -1.2, -4.2)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(101111011).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111011", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111011", "story_v_out_101111.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_101111", "101111011", "story_v_out_101111.awb")

						uv0:RecordAudio("101111011", slot21)
						uv0:RecordAudio("101111011", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111011", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111011", "story_v_out_101111.awb")
				end
	...
	Play101111012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(101111012).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111012", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111012", "story_v_out_101111.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_101111", "101111012", "story_v_out_101111.awb")

						uv0:RecordAudio("101111012", slot10)
						uv0:RecordAudio("101111012", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111012", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111012", "story_v_out_101111.awb")
				end
	...
	Play101111013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111013
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(101111013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111013", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111013", "story_v_out_101111.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_101111", "101111013", "story_v_out_101111.awb")

						uv0:RecordAudio("101111013", slot16)
						uv0:RecordAudio("101111013", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111013", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111013", "story_v_out_101111.awb")
				end
	...
	Play101111014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111014
		slot1.duration_ = 8.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(101111014).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111014", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111014", "story_v_out_101111.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_101111", "101111014", "story_v_out_101111.awb")

						uv0:RecordAudio("101111014", slot16)
						uv0:RecordAudio("101111014", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111014", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111014", "story_v_out_101111.awb")
				end
	...
	Play101111015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2030_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot6) / slot7)
				slot11 = manager.ui.mainCamera.transform.position - slot5.position
				slot5.forward = Vector3.New(slot11.x, slot11.y, slot11.z)
				slot12 = slot5.localEulerAngles
				slot12.z = 0
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2020_tpose, Vector3.New(0, 100, 0), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(101111015).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111015", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111015", "story_v_out_101111.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_101111", "101111015", "story_v_out_101111.awb")

						uv0:RecordAudio("101111015", slot25)
						uv0:RecordAudio("101111015", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111015", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111015", "story_v_out_101111.awb")
				end
	...
	Play101111016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111016
		slot1.duration_ = 2.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(101111016).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111016", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111016", "story_v_out_101111.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_101111", "101111016", "story_v_out_101111.awb")

						uv0:RecordAudio("101111016", slot21)
						uv0:RecordAudio("101111016", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111016", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111016", "story_v_out_101111.awb")
				end
	...
	Play101111017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111017
		slot1.duration_ = 8.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2020_tpose, Vector3.New(-0.7, -1.2, -4.1), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(-0.7, -1.2, -4.1)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(101111017).content)
				uv0.text_.text = slot21

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (20 <= 0 and slot18 or slot18 * utf8.len(slot21) / slot22) > 0 and slot18 < slot24 then
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111017", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111017", "story_v_out_101111.awb") / 1000 + slot17 then
						uv0.duration_ = slot25 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_101111", "101111017", "story_v_out_101111.awb")

						uv0:RecordAudio("101111017", slot26)
						uv0:RecordAudio("101111017", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111017", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111017", "story_v_out_101111.awb")
				end
	...
	Play101111018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111018
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2030_tpose, Vector3.New(0.7, -1.2, -4.2), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0.7, -1.2, -4.2)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(101111018).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111018", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111018", "story_v_out_101111.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_101111", "101111018", "story_v_out_101111.awb")

						uv0:RecordAudio("101111018", slot20)
						uv0:RecordAudio("101111018", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111018", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111018", "story_v_out_101111.awb")
				end
	...
	Play101111019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111019
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(101111019).content)
				uv0.text_.text = slot11
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111019", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111019", "story_v_out_101111.awb") / 1000 + slot7 then
						uv0.duration_ = slot15 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_101111", "101111019", "story_v_out_101111.awb")

						uv0:RecordAudio("101111019", slot16)
						uv0:RecordAudio("101111019", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111019", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111019", "story_v_out_101111.awb")
				end
	...
	Play101111020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111020
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(101111020).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111020", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111020", "story_v_out_101111.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_101111", "101111020", "story_v_out_101111.awb")

						uv0:RecordAudio("101111020", slot27)
						uv0:RecordAudio("101111020", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111020", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111020", "story_v_out_101111.awb")
				end
	...
	Play101111021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111021
		slot1.duration_ = 5.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(101111021).content)
				uv0.text_.text = slot17
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111021", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111021", "story_v_out_101111.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_101111", "101111021", "story_v_out_101111.awb")

						uv0:RecordAudio("101111021", slot22)
						uv0:RecordAudio("101111021", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111021", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111021", "story_v_out_101111.awb")
				end
	...
	Play101111022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111022
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(101111022).content)
				uv0.text_.text = slot20
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111022", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111022", "story_v_out_101111.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_101111", "101111022", "story_v_out_101111.awb")

						uv0:RecordAudio("101111022", slot25)
						uv0:RecordAudio("101111022", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111022", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111022", "story_v_out_101111.awb")
				end
	...
	Play101111023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111023
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(0, -0.71, -6), (uv0.time_ - slot14) / slot15)
				slot19 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot19.x, slot19.y, slot19.z)
				slot20 = slot13.localEulerAngles
				slot20.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				slot21 = uv0:FormatText(uv0:GetWordFromCfg(101111023).content)
				uv0.text_.text = slot21
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111023", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111023", "story_v_out_101111.awb") / 1000 + slot17 then
						uv0.duration_ = slot25 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						slot26 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_101111", "101111023", "story_v_out_101111.awb")

						uv0:RecordAudio("101111023", slot26)
						uv0:RecordAudio("101111023", slot26)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111023", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111023", "story_v_out_101111.awb")
				end
	...
	Play101111024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111024
		slot1.duration_ = 7.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(101111024).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111024", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111024", "story_v_out_101111.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_101111", "101111024", "story_v_out_101111.awb")

						uv0:RecordAudio("101111024", slot13)
						uv0:RecordAudio("101111024", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111024", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111024", "story_v_out_101111.awb")
				end
	...
	Play101111025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111025
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(101111025).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111025", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111025", "story_v_out_101111.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_101111", "101111025", "story_v_out_101111.awb")

						uv0:RecordAudio("101111025", slot10)
						uv0:RecordAudio("101111025", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111025", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111025", "story_v_out_101111.awb")
				end
	...
	Play101111026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111026
		slot1.duration_ = 3.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(101111026).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111026", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111026", "story_v_out_101111.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_101111", "101111026", "story_v_out_101111.awb")

						uv0:RecordAudio("101111026", slot15)
						uv0:RecordAudio("101111026", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111026", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111026", "story_v_out_101111.awb")
				end
	...
	Play101111027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111027
		slot1.duration_ = 3.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				if uv0.var_.characterEffect1011ui_story then
					uv0.var_.characterEffect1011ui_story.fillFlat = true
					uv0.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot4) / slot5)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(101111027).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111027", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111027", "story_v_out_101111.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_101111", "101111027", "story_v_out_101111.awb")

						uv0:RecordAudio("101111027", slot15)
						uv0:RecordAudio("101111027", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111027", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111027", "story_v_out_101111.awb")
				end
	...
	Play101111028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111028
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(101111028).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111028", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111028", "story_v_out_101111.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_101111", "101111028", "story_v_out_101111.awb")

						uv0:RecordAudio("101111028", slot11)
						uv0:RecordAudio("101111028", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111028", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111028", "story_v_out_101111.awb")
				end
	...
	Play101111029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111029
		slot1.duration_ = 9.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(101111029).content)
				uv0.text_.text = slot15
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111029", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111029", "story_v_out_101111.awb") / 1000 + slot11 then
						uv0.duration_ = slot19 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_101111", "101111029", "story_v_out_101111.awb")

						uv0:RecordAudio("101111029", slot20)
						uv0:RecordAudio("101111029", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111029", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111029", "story_v_out_101111.awb")
				end
	...
	Play101111030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 101111030
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(101111030).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_101111", "101111030", "story_v_out_101111.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_101111", "101111030", "story_v_out_101111.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_101111", "101111030", "story_v_out_101111.awb")

						uv0:RecordAudio("101111030", slot12)
						uv0:RecordAudio("101111030", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_101111", "101111030", "story_v_out_101111.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_101111", "101111030", "story_v_out_101111.awb")
				end
