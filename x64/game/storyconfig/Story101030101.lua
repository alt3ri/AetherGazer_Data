return {
	Play103011001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011001
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if uv0.bgs_.B03b:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB03b = slot13:GetColor("_Color").a
					uv0.var_.alphaMatValueB03b = slot13
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				if uv0.var_.alphaMatValueB03b then
					slot15 = uv0.var_.alphaMatValueB03b
					slot16 = slot15:GetColor("_Color")
					slot16.a = Mathf.Lerp(uv0.var_.alphaOldValueB03b, 1, (uv0.time_ - slot11) / slot12)

					slot15:SetColor("_Color", slot16)
				end
			end

			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.alphaMatValueB03b then
				slot13 = uv0.var_.alphaMatValueB03b
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(103011001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011001", "story_v_out_103011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103011", "103011001", "story_v_out_103011.awb") / 1000 + slot21 then
						uv0.duration_ = slot30 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						slot31 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_103011", "103011001", "story_v_out_103011.awb")

						uv0:RecordAudio("103011001", slot31)
						uv0:RecordAudio("103011001", slot31)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103011", "103011001", "story_v_out_103011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103011", "103011001", "story_v_out_103011.awb")
				end
	...
	Play103011002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011002
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play103011003(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/1036/1036actionlink/1036action476")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(103011002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011002", "story_v_out_103011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103011", "103011002", "story_v_out_103011.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_103011", "103011002", "story_v_out_103011.awb")

						uv0:RecordAudio("103011002", slot12)
						uv0:RecordAudio("103011002", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103011", "103011002", "story_v_out_103011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103011", "103011002", "story_v_out_103011.awb")
				end
	...
	Play103011003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103011003).content)
	...
	Play103011004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011004
		slot1.duration_ = 4.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/1036/1036actionlink/1036action465")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(103011004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011004", "story_v_out_103011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103011", "103011004", "story_v_out_103011.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_103011", "103011004", "story_v_out_103011.awb")

						uv0:RecordAudio("103011004", slot15)
						uv0:RecordAudio("103011004", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103011", "103011004", "story_v_out_103011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103011", "103011004", "story_v_out_103011.awb")
				end
	...
	Play103011005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103011005).content)
				uv0.text_.text = slot8
	...
	Play103011006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(103011006).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011006", "story_v_out_103011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103011", "103011006", "story_v_out_103011.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_103011", "103011006", "story_v_out_103011.awb")

						uv0:RecordAudio("103011006", slot15)
						uv0:RecordAudio("103011006", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103011", "103011006", "story_v_out_103011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103011", "103011006", "story_v_out_103011.awb")
				end
	...
	Play103011007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(103011007).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011007", "story_v_out_103011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103011", "103011007", "story_v_out_103011.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_103011", "103011007", "story_v_out_103011.awb")

						uv0:RecordAudio("103011007", slot12)
						uv0:RecordAudio("103011007", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103011", "103011007", "story_v_out_103011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103011", "103011007", "story_v_out_103011.awb")
				end
	...
	Play103011008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103011008).content)
				uv0.text_.text = slot8
	...
	Play103011009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(103011009).content)
				uv0.text_.text = slot10
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011009", "story_v_out_103011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103011", "103011009", "story_v_out_103011.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_103011", "103011009", "story_v_out_103011.awb")

						uv0:RecordAudio("103011009", slot15)
						uv0:RecordAudio("103011009", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103011", "103011009", "story_v_out_103011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103011", "103011009", "story_v_out_103011.awb")
				end
	...
	Play103011010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011010
		slot1.duration_ = 6.3
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(103011010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103011", "103011010", "story_v_out_103011.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_103011", "103011010", "story_v_out_103011.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_103011", "103011010", "story_v_out_103011.awb")

						uv0:RecordAudio("103011010", slot11)
						uv0:RecordAudio("103011010", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_103011", "103011010", "story_v_out_103011.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_103011", "103011010", "story_v_out_103011.awb")
				end
	...
	Play103011011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 103011011
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(103011011).content)
				uv0.text_.text = slot8
