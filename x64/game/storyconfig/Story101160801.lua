return {
	Play116081001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081001
		slot1.duration_ = 8.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.8 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
			...
			if 1.8 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect1029ui_story == nil then
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1029ui_story, Vector3.New(0, -1.09, -6.2), (uv0.time_ - slot10) / slot11)
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(0, -1.09, -6.2)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot23 = uv0:FormatText(uv0:GetWordFromCfg(116081001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081001", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081001", "story_v_out_116081.awb") / 1000 + slot18 then
						uv0.duration_ = slot27 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						slot28 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_116081", "116081001", "story_v_out_116081.awb")

						uv0:RecordAudio("116081001", slot28)
						uv0:RecordAudio("116081001", slot28)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081001", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081001", "story_v_out_116081.awb")
				end
	...
	Play116081002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081002
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[242].name)
			uv0.choices_[2].txt.text = uv0:FormatText(StoryChoiceCfg[243].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play116081003(uv1)
			end
	...
	Play116081003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116081003).content)
				uv0.text_.text = slot7

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (30 <= 0 and slot3 or slot3 * utf8.len(slot7) / slot8) > 0 and slot3 < slot10 then
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081003", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081003", "story_v_out_116081.awb") / 1000 + slot2 then
						uv0.duration_ = slot11 + slot2
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116081", "116081003", "story_v_out_116081.awb")

						uv0:RecordAudio("116081003", slot12)
						uv0:RecordAudio("116081003", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081003", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081003", "story_v_out_116081.awb")
				end
	...
	Play116081004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081004
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116081004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081004", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081004", "story_v_out_116081.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116081", "116081004", "story_v_out_116081.awb")

						uv0:RecordAudio("116081004", slot11)
						uv0:RecordAudio("116081004", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081004", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081004", "story_v_out_116081.awb")
				end
	...
	Play116081005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081005
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081005).content)
	...
	Play116081006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081006
		slot1.duration_ = 5.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(116081006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081006", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081006", "story_v_out_116081.awb") / 1000 + slot5 then
						uv0.duration_ = slot13 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						slot14 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116081", "116081006", "story_v_out_116081.awb")

						uv0:RecordAudio("116081006", slot14)
						uv0:RecordAudio("116081006", slot14)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081006", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081006", "story_v_out_116081.awb")
				end
	...
	Play116081007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116081007).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081007", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081007", "story_v_out_116081.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116081", "116081007", "story_v_out_116081.awb")

						uv0:RecordAudio("116081007", slot12)
						uv0:RecordAudio("116081007", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081007", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081007", "story_v_out_116081.awb")
				end
	...
	Play116081008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081008
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081008).content)
				uv0.text_.text = slot8
	...
	Play116081009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot10 = uv0:FormatText(uv0:GetWordFromCfg(116081009).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081009", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081009", "story_v_out_116081.awb") / 1000 + slot6 then
						uv0.duration_ = slot14 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						slot15 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116081", "116081009", "story_v_out_116081.awb")

						uv0:RecordAudio("116081009", slot15)
						uv0:RecordAudio("116081009", slot15)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081009", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081009", "story_v_out_116081.awb")
				end
	...
	Play116081010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081010
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot3.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1029ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot4) / slot5)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0, -1.1, -5.9), (uv0.time_ - slot12) / slot13)
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(0, -1.1, -5.9)
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot17 + slot0 and uv0.var_.characterEffect10025ui_story == nil then
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				if uv0.var_.characterEffect10025ui_story then
					...
					uv0.var_.characterEffect10025ui_story.fillRatio = Mathf.Lerp(0, 0.5, (uv0.time_ - slot17) / slot18)
				end
			end

			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 and uv0.var_.characterEffect10025ui_story then
				uv0.var_.characterEffect10025ui_story.fillFlat = true
			...
			slot24 = 0.733333333333333

			if 2.2 < uv0.time_ and uv0.time_ <= slot23 + slot0 then
			...
			if 4 < uv0.time_ and uv0.time_ <= slot25 + slot0 then
				...
				slot29 = uv0:FormatText(uv0:GetWordFromCfg(116081010).content)
				uv0.text_.text = slot29

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (25 <= 0 and slot26 or slot26 * utf8.len(slot29) / slot30) > 0 and slot26 < slot32 then
	...
	Play116081011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081011
		slot1.duration_ = 0.016666666666
		...
		function slot1.onSingleLineFinish_()
			...
			uv0.choices_[1].txt.text = uv0:FormatText(StoryChoiceCfg[244].name)
		end

		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play116081012(uv1)
			end
		end
	...
	Play116081012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(116081012).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081012", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081012", "story_v_out_116081.awb") / 1000 + slot6 then
						uv0.duration_ = slot15 + slot6
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						slot16 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_116081", "116081012", "story_v_out_116081.awb")

						uv0:RecordAudio("116081012", slot16)
						uv0:RecordAudio("116081012", slot16)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081012", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081012", "story_v_out_116081.awb")
				end
	...
	Play116081013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081013
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081013).content)
				uv0.text_.text = slot8
	...
	Play116081014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081014
		slot1.duration_ = 4.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0, -1.1, -5.9), (uv0.time_ - slot5) / slot6)
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(0, -1.1, -5.9)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116081014).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081014", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081014", "story_v_out_116081.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116081", "116081014", "story_v_out_116081.awb")

						uv0:RecordAudio("116081014", slot17)
						uv0:RecordAudio("116081014", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081014", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081014", "story_v_out_116081.awb")
				end
	...
	Play116081015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081015
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116081015).content)
				uv0.text_.text = slot7
	...
	Play116081016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081016
		slot1.duration_ = 6.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("10025ui_story", "StoryTimeline/CharAction/story10025/story10025actionlink/10025action442")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116081016).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081016", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081016", "story_v_out_116081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116081", "116081016", "story_v_out_116081.awb")

						uv0:RecordAudio("116081016", slot18)
						uv0:RecordAudio("116081016", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081016", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081016", "story_v_out_116081.awb")
				end
	...
	Play116081017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081017
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081017).content)
				uv0.text_.text = slot8
	...
	Play116081018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081018
		slot1.duration_ = 5.4
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116081018).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081018", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081018", "story_v_out_116081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116081", "116081018", "story_v_out_116081.awb")

						uv0:RecordAudio("116081018", slot18)
						uv0:RecordAudio("116081018", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081018", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081018", "story_v_out_116081.awb")
				end
	...
	Play116081019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081019
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116081019).content)
				uv0.text_.text = slot7
	...
	Play116081020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081020
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116081020).content)
	...
	Play116081021 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081021
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0, -1.1, -5.9), (uv0.time_ - slot10) / slot11)
				slot15 = manager.ui.mainCamera.transform.position - slot9.position
				slot9.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot9.localEulerAngles
				slot16.z = 0
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(0, -1.1, -5.9)
				slot14 = manager.ui.mainCamera.transform.position - slot9.position
				slot9.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot9.localEulerAngles
				slot15.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(116081021).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081021", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081021", "story_v_out_116081.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_116081", "116081021", "story_v_out_116081.awb")

						uv0:RecordAudio("116081021", slot21)
						uv0:RecordAudio("116081021", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081021", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081021", "story_v_out_116081.awb")
				end
	...
	Play116081022 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081022
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116081022).content)
				uv0.text_.text = slot7
	...
	Play116081023 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081023
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116081023).content)
				uv0.text_.text = slot4
	...
	Play116081024 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081024
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116081024).content)
	...
	Play116081025 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081025
		slot1.duration_ = 6.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116081025).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081025", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081025", "story_v_out_116081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116081", "116081025", "story_v_out_116081.awb")

						uv0:RecordAudio("116081025", slot18)
						uv0:RecordAudio("116081025", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081025", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081025", "story_v_out_116081.awb")
				end
	...
	Play116081026 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081026
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081026).content)
				uv0.text_.text = slot8
	...
	Play116081027 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081027
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116081027).content)
				uv0.text_.text = slot4
	...
	Play116081028 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081028
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116081028).content)
				uv0.text_.text = slot4
	...
	Play116081029 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081029
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116081029).content)
				uv0.text_.text = slot5
	...
	Play116081030 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081030
		slot1.duration_ = 7.066666666666
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play116081031(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if 2 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPosST18a = uv0.bgs_.ST18a.transform.localPosition
			end

			slot3 = 0.001

			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPosST18a, Vector3.New(1.5, 1, 6), (uv0.time_ - slot2) / slot3)
			end

			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 then
				slot1.localPosition = Vector3.New(1.5, 1, 6)
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPosST18a, Vector3.New(1, 0.5, 6), (uv0.time_ - slot5) / slot6)
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(1, 0.5, 6)
			end

			if 5.51666666666667 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosST18a = uv0.bgs_.ST18a.transform.localPosition
			end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPosST18a, Vector3.New(1, 1, 6), (uv0.time_ - slot8) / slot9)
			end

			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(1, 1, 6)
			end
			...
			if 5.51666666666667 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0.var_.shakeOldPosST18a = uv0.bgs_.ST18a.transform.localPosition
			end

			slot16 = 0.6

			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot18, slot19 = math.modf((uv0.time_ - slot15) / 0.099)
				slot14.localPosition = Vector3.New(slot19 * 0.01, slot19 * 0.01, slot19 * 0) + uv0.var_.shakeOldPosST18a
			end

			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 then
				slot14.localPosition = uv0.var_.shakeOldPosST18a
			end
			...
			if slot18 <= uv0.time_ and uv0.time_ < slot18 + slot19 then
				slot17.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot18) / slot19)
			...
			if uv0.time_ >= slot20 + 2.11666666666667 and uv0.time_ < slot20 + slot21 + slot0 then
			...
			if 1.966 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot26 = uv0:FormatText(uv0:GetWordFromCfg(116081030).content)
				uv0.text_.text = slot26

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (40 <= 0 and slot23 or slot23 * utf8.len(slot26) / slot27) > 0 and slot23 < slot29 then
	...
	Play116081031 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081031
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				slot9 = uv0:FormatText(uv0:GetWordFromCfg(116081031).content)
				uv0.text_.text = slot9
	...
	Play116081032 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081032
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116081032).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081032", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081032", "story_v_out_116081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116081", "116081032", "story_v_out_116081.awb")

						uv0:RecordAudio("116081032", slot18)
						uv0:RecordAudio("116081032", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081032", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081032", "story_v_out_116081.awb")
				end
	...
	Play116081033 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081033
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081033).content)
				uv0.text_.text = slot8
	...
	Play116081034 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081034
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.fswt_.text = uv0:FormatText(uv0:GetWordFromCfg(116081034).content)
			...
			slot9 = 17
			slot10 = 1.13333333333333
			slot13, slot14 = uv0:GetPercentByPara(uv0:FormatText(uv0:GetWordFromCfg(116081034).content), 1)
			...
			slot15 = math.max(1.13333333333333, uv0.talkMaxDuration)
			...
			if 1.9 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				uv0.var_.moveOldPos10025ui_story = uv0.actors_["10025ui_story"].transform.localPosition
			end
	...
	Play116081035 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081035
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if uv0.bgs_.ST18a:GetComponent("SpriteRenderer") then
					slot4.material = uv0.transpaintGo_:GetComponent("SpriteRenderer").material
					slot5 = slot4.material
					uv0.var_.alphaOldValueST18a = slot5:GetColor("_Color").a
					uv0.var_.alphaMatValueST18a = slot5
				end

				uv0.var_.alphaOldValueST18a = 0
			end

			slot4 = 2

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.alphaMatValueST18a then
					slot7 = uv0.var_.alphaMatValueST18a
					slot8 = slot7:GetColor("_Color")
					slot8.a = Mathf.Lerp(uv0.var_.alphaOldValueST18a, 1, (uv0.time_ - slot3) / slot4)

					slot7:SetColor("_Color", slot8)
				end
			end

			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.alphaMatValueST18a then
				slot5 = uv0.var_.alphaMatValueST18a
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0:PlayTimeline("10025ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface1101cva")
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(116081035).content)
				uv0.text_.text = slot16
	...
	Play116081036 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081036
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116081036).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081036", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081036", "story_v_out_116081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116081", "116081036", "story_v_out_116081.awb")

						uv0:RecordAudio("116081036", slot18)
						uv0:RecordAudio("116081036", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081036", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081036", "story_v_out_116081.awb")
				end
	...
	Play116081037 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081037
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116081037).content)
				uv0.text_.text = slot7
	...
	Play116081038 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081038
		slot1.duration_ = 4.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116081038).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081038", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081038", "story_v_out_116081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116081", "116081038", "story_v_out_116081.awb")

						uv0:RecordAudio("116081038", slot18)
						uv0:RecordAudio("116081038", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081038", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081038", "story_v_out_116081.awb")
				end
	...
	Play116081039 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081039
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081039).content)
				uv0.text_.text = slot8
	...
	Play116081040 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081040
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("10025ui_story", "StoryTimeline/CharAction/story10025/story10025actionlink/10025action483")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116081040).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081040", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081040", "story_v_out_116081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116081", "116081040", "story_v_out_116081.awb")

						uv0:RecordAudio("116081040", slot18)
						uv0:RecordAudio("116081040", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081040", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081040", "story_v_out_116081.awb")
				end
	...
	Play116081041 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081041
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081041).content)
				uv0.text_.text = slot8
	...
	Play116081042 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081042
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(116081042).content)
				uv0.text_.text = slot12
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081042", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081042", "story_v_out_116081.awb") / 1000 + slot8 then
						uv0.duration_ = slot16 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						slot17 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116081", "116081042", "story_v_out_116081.awb")

						uv0:RecordAudio("116081042", slot17)
						uv0:RecordAudio("116081042", slot17)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081042", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081042", "story_v_out_116081.awb")
				end
	...
	Play116081043 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081043
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0:PlayTimeline("10025ui_story", "StoryTimeline/CharAction/story10025/story10025actionlink/10025action434")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116081043).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081043", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081043", "story_v_out_116081.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116081", "116081043", "story_v_out_116081.awb")

						uv0:RecordAudio("116081043", slot12)
						uv0:RecordAudio("116081043", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081043", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081043", "story_v_out_116081.awb")
				end
	...
	Play116081044 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081044
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(116081044).content)
				uv0.text_.text = slot7
	...
	Play116081045 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081045
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116081045).content)
				uv0.text_.text = slot4
	...
	Play116081046 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081046
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(116081046).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081046", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081046", "story_v_out_116081.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116081", "116081046", "story_v_out_116081.awb")

						uv0:RecordAudio("116081046", slot18)
						uv0:RecordAudio("116081046", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081046", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081046", "story_v_out_116081.awb")
				end
	...
	Play116081047 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081047
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(116081047).content)
				uv0.text_.text = slot8
	...
	Play116081048 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081048
		slot1.duration_ = 7
		...
		function slot1.playNext_(slot0)
			if slot0 == 1 then
				uv0:Play116081049(uv1)
			end
		end

		function slot1.onSingleLineUpdate_(slot0)
			if uv0.bgs_.SK0109 == nil then
				slot2 = Object.Instantiate(uv0.paintGo_)
				slot2:GetComponent("SpriteRenderer").sprite = getSpriteWithoutAtlas("TextureConfig/Background/" .. slot1)
				slot2.name = slot1
				slot2.transform.parent = uv0.stage_.transform
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(116081048).content)
				uv0.text_.text = slot15

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (18 <= 0 and slot13 or slot13 * utf8.len(slot15) / slot16) > 0 and slot13 < slot18 then
	...
	Play116081049 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081049
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116081049).content)
				uv0.text_.text = slot4
	...
	Play116081050 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081050
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116081050).content)
				uv0.text_.text = slot4
	...
	Play116081051 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081051
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot4 = uv0:FormatText(uv0:GetWordFromCfg(116081051).content)
				uv0.text_.text = slot4
	...
	Play116081052 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081052
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116081052).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081052", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081052", "story_v_out_116081.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116081", "116081052", "story_v_out_116081.awb")

						uv0:RecordAudio("116081052", slot10)
						uv0:RecordAudio("116081052", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081052", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081052", "story_v_out_116081.awb")
				end
	...
	Play116081053 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081053
		slot1.duration_ = 4.2
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116081053).content)
				uv0.text_.text = slot5
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081053", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081053", "story_v_out_116081.awb") / 1000 + slot1 then
						uv0.duration_ = slot9 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						slot10 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116081", "116081053", "story_v_out_116081.awb")

						uv0:RecordAudio("116081053", slot10)
						uv0:RecordAudio("116081053", slot10)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081053", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081053", "story_v_out_116081.awb")
				end
	...
	Play116081054 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081054
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(116081054).content)
				uv0.text_.text = slot5
	...
	Play116081055 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081055
		slot1.duration_ = 9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot12 + slot0 and uv0.var_.characterEffect10025ui_story == nil then
				uv0.var_.characterEffect10025ui_story = uv0.actors_["10025ui_story"]:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(116081055).content)
				uv0.text_.text = slot19

				LuaForUtil.ClearLinePrefixSymbol(uv0.text_)

				if (20 <= 0 and slot15 or slot15 * utf8.len(slot19) / slot20) > 0 and slot15 < slot22 then
	...
	Play116081056 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 116081056
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(116081056).content)
				uv0.text_.text = slot6
				...
				if manager.audio:GetVoiceLength("story_v_out_116081", "116081056", "story_v_out_116081.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_116081", "116081056", "story_v_out_116081.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116081", "116081056", "story_v_out_116081.awb")

						uv0:RecordAudio("116081056", slot11)
						uv0:RecordAudio("116081056", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_116081", "116081056", "story_v_out_116081.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_116081", "116081056", "story_v_out_116081.awb")
				end
