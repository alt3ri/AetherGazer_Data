return {
	Play104121001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121001
		slot1.duration_ = 4.53266666666667
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if uv0.bgs_.B04f:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueB04f = slot9:GetColor("_Color").a
					uv0.var_.alphaMatValueB04f = slot9
				end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				if uv0.var_.alphaMatValueB04f then
					slot11 = uv0.var_.alphaMatValueB04f
					slot12 = slot11:GetColor("_Color")
					slot12.a = Mathf.Lerp(uv0.var_.alphaOldValueB04f, 1, (uv0.time_ - slot7) / slot8)

					slot11:SetColor("_Color", slot12)
				end
			end

			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 and uv0.var_.alphaMatValueB04f then
				slot9 = uv0.var_.alphaMatValueB04f
			...
			if uv0.time_ >= slot10 + 1.66666666666667 and uv0.time_ < slot10 + slot11 + slot0 then
			...
			if 1.66666666666667 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104121001).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121001", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121001", "story_v_out_104121.awb") / 1000 + slot14 then
						uv0.duration_ = slot23 + slot14
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104121", "104121001", "story_v_out_104121.awb")

						uv0:RecordAudio("104121001", slot24)
						uv0:RecordAudio("104121001", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121001", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121001", "story_v_out_104121.awb")
				end
	...
	Play104121002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0:PlayTimeline("1019ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface2102cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104121002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121002", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121002", "story_v_out_104121.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104121", "104121002", "story_v_out_104121.awb")

						uv0:RecordAudio("104121002", slot12)
						uv0:RecordAudio("104121002", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121002", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121002", "story_v_out_104121.awb")
				end
	...
	Play104121003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121003
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(104121003).content)
				uv0.text_.text = slot7
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121003", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121003", "story_v_out_104121.awb") / 1000 + slot3 then
						uv0.duration_ = slot11 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						slot12 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104121", "104121003", "story_v_out_104121.awb")

						uv0:RecordAudio("104121003", slot12)
						uv0:RecordAudio("104121003", slot12)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121003", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121003", "story_v_out_104121.awb")
				end
	...
	Play104121004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121004
		slot1.duration_ = 5.5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface2102cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104121004).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121004", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121004", "story_v_out_104121.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104121", "104121004", "story_v_out_104121.awb")

						uv0:RecordAudio("104121004", slot19)
						uv0:RecordAudio("104121004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121004", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121004", "story_v_out_104121.awb")
				end
	...
	Play104121005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				slot6 = uv0:FormatText(uv0:GetWordFromCfg(104121005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121005", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121005", "story_v_out_104121.awb") / 1000 + slot2 then
						uv0.duration_ = slot10 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						slot11 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_104121", "104121005", "story_v_out_104121.awb")

						uv0:RecordAudio("104121005", slot11)
						uv0:RecordAudio("104121005", slot11)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121005", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121005", "story_v_out_104121.awb")
				end
	...
	Play104121006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121006
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(0, -1.23, -5.8), (uv0.time_ - slot12) / slot13)
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(0, -1.23, -5.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(104121006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121006", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121006", "story_v_out_104121.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_104121", "104121006", "story_v_out_104121.awb")

						uv0:RecordAudio("104121006", slot25)
						uv0:RecordAudio("104121006", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121006", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121006", "story_v_out_104121.awb")
				end
	...
	Play104121007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121007
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104121007).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121007", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121007", "story_v_out_104121.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104121", "104121007", "story_v_out_104121.awb")

						uv0:RecordAudio("104121007", slot24)
						uv0:RecordAudio("104121007", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121007", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121007", "story_v_out_104121.awb")
				end
	...
	Play104121008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(0.7, -1.23, -5.8), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0.7, -1.23, -5.8)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				uv0:PlayTimeline("10001_tpose", "StoryTimeline/CharAction/story10001/story10001action/10001action5_1")
			end

			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0:PlayTimeline("10001_tpose", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3203cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(104121008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121008", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121008", "story_v_out_104121.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_104121", "104121008", "story_v_out_104121.awb")

						uv0:RecordAudio("104121008", slot27)
						uv0:RecordAudio("104121008", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121008", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121008", "story_v_out_104121.awb")
				end
	...
	Play104121009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121009
		slot1.duration_ = 2.7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0:PlayTimeline("1036ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3102cva")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104121009).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121009", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121009", "story_v_out_104121.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104121", "104121009", "story_v_out_104121.awb")

						uv0:RecordAudio("104121009", slot24)
						uv0:RecordAudio("104121009", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121009", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121009", "story_v_out_104121.awb")
				end
	...
	Play104121010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121010
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0:PlayTimeline("10001_tpose", "StoryTimeline/CharAction/story10001/story10001actionlink/10001action454")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104121010).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121010", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121010", "story_v_out_104121.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104121", "104121010", "story_v_out_104121.awb")

						uv0:RecordAudio("104121010", slot18)
						uv0:RecordAudio("104121010", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121010", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121010", "story_v_out_104121.awb")
				end
	...
	Play104121011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121011
		slot1.duration_ = 4.9
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				slot22 = uv0:FormatText(uv0:GetWordFromCfg(104121011).content)
				uv0.text_.text = slot22
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121011", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121011", "story_v_out_104121.awb") / 1000 + slot18 then
						uv0.duration_ = slot26 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						slot27 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_104121", "104121011", "story_v_out_104121.awb")

						uv0:RecordAudio("104121011", slot27)
						uv0:RecordAudio("104121011", slot27)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121011", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121011", "story_v_out_104121.awb")
				end
	...
	Play104121012 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121012
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10001_tpose, Vector3.New(-0.7, -1.23, -5.8), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(-0.7, -1.23, -5.8)
				slot15 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot10.localEulerAngles
				slot16.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				slot19 = uv0:FormatText(uv0:GetWordFromCfg(104121012).content)
				uv0.text_.text = slot19
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121012", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121012", "story_v_out_104121.awb") / 1000 + slot15 then
						uv0.duration_ = slot23 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						slot24 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104121", "104121012", "story_v_out_104121.awb")

						uv0:RecordAudio("104121012", slot24)
						uv0:RecordAudio("104121012", slot24)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121012", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121012", "story_v_out_104121.awb")
				end
	...
	Play104121013 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121013
		slot1.duration_ = 4.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(0.7, -1.09, -5.78), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0.7, -1.09, -5.78)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104121013).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121013", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121013", "story_v_out_104121.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104121", "104121013", "story_v_out_104121.awb")

						uv0:RecordAudio("104121013", slot21)
						uv0:RecordAudio("104121013", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121013", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121013", "story_v_out_104121.awb")
				end
	...
	Play104121014 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121014
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104121014).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121014", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121014", "story_v_out_104121.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104121", "104121014", "story_v_out_104121.awb")

						uv0:RecordAudio("104121014", slot19)
						uv0:RecordAudio("104121014", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121014", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121014", "story_v_out_104121.awb")
				end
	...
	Play104121015 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121015
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				slot13 = uv0:FormatText(uv0:GetWordFromCfg(104121015).content)
				uv0.text_.text = slot13
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121015", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121015", "story_v_out_104121.awb") / 1000 + slot9 then
						uv0.duration_ = slot17 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						slot18 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104121", "104121015", "story_v_out_104121.awb")

						uv0:RecordAudio("104121015", slot18)
						uv0:RecordAudio("104121015", slot18)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121015", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121015", "story_v_out_104121.awb")
				end
	...
	Play104121016 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121016
		slot1.duration_ = 6.133
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104121016).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121016", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121016", "story_v_out_104121.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104121", "104121016", "story_v_out_104121.awb")

						uv0:RecordAudio("104121016", slot21)
						uv0:RecordAudio("104121016", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121016", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121016", "story_v_out_104121.awb")
				end
	...
	Play104121017 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121017
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(104121017).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121017", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121017", "story_v_out_104121.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104121", "104121017", "story_v_out_104121.awb")

						uv0:RecordAudio("104121017", slot19)
						uv0:RecordAudio("104121017", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121017", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121017", "story_v_out_104121.awb")
				end
	...
	Play104121018 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121018
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				slot12 = uv0:FormatText(uv0:GetWordFromCfg(104121018).content)
	...
	Play104121019 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121019
		slot1.duration_ = 4.016666666666
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.var_.moveOldPosS0409 = uv0.bgs_.S0409.transform.localPosition
			end

			slot7 = 0.001

			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPosS0409, Vector3.New(0, 1, 7), (uv0.time_ - slot6) / slot7)
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(0, 1, 7)
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPosS0409, Vector3.New(0, 1, 5), (uv0.time_ - slot9) / slot10)
			end

			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, 1, 5)
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(104121019).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121019", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121019", "story_v_out_104121.awb") / 1000 + slot11 then
						uv0.duration_ = slot20 + slot11
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104121", "104121019", "story_v_out_104121.awb")

						uv0:RecordAudio("104121019", slot21)
						uv0:RecordAudio("104121019", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121019", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121019", "story_v_out_104121.awb")
				end
	...
	Play104121020 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 104121020
		slot1.duration_ = 4.8
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPosS0409, Vector3.New(0, 1, 10), (uv0.time_ - slot8) / slot9)
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(104121020).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104121", "104121020", "story_v_out_104121.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_104121", "104121020", "story_v_out_104121.awb") / 1000 + slot10 then
						uv0.duration_ = slot19 + slot10
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						slot20 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_104121", "104121020", "story_v_out_104121.awb")

						uv0:RecordAudio("104121020", slot20)
						uv0:RecordAudio("104121020", slot20)
					else
						uv0:AudioAction("play", "voice", "story_v_out_104121", "104121020", "story_v_out_104121.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_104121", "104121020", "story_v_out_104121.awb")
				end
