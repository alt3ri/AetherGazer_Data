return {
	Play112022001 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022001
		slot1.duration_ = 7
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if uv0.bgs_.H01a:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueH01a = slot5:GetColor("_Color").a
					uv0.var_.alphaMatValueH01a = slot5
				end

				uv0.var_.alphaOldValueH01a = 0
			end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				if uv0.var_.alphaMatValueH01a then
					slot7 = uv0.var_.alphaMatValueH01a
					slot8 = slot7:GetColor("_Color")
					slot8.a = Mathf.Lerp(uv0.var_.alphaOldValueH01a, 1, (uv0.time_ - slot3) / slot4)

					slot7:SetColor("_Color", slot8)
				end
			end

			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.alphaMatValueH01a then
				slot5 = uv0.var_.alphaMatValueH01a
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(112022001).content)
	...
	Play112022002 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022002
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(112022002).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022002", "story_v_out_112022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112022", "112022002", "story_v_out_112022.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_112022", "112022002", "story_v_out_112022.awb")

						uv0:RecordAudio("112022002", slot19)
						uv0:RecordAudio("112022002", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112022", "112022002", "story_v_out_112022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112022", "112022002", "story_v_out_112022.awb")
				end
	...
	Play112022003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022003
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot7 = uv0:FormatText(uv0:GetWordFromCfg(112022003).content)
	...
	Play112022004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022004
		slot1.duration_ = 9.1
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				slot14 = uv0:FormatText(uv0:GetWordFromCfg(112022004).content)
				uv0.text_.text = slot14
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022004", "story_v_out_112022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112022", "112022004", "story_v_out_112022.awb") / 1000 + slot10 then
						uv0.duration_ = slot18 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						slot19 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_112022", "112022004", "story_v_out_112022.awb")

						uv0:RecordAudio("112022004", slot19)
						uv0:RecordAudio("112022004", slot19)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112022", "112022004", "story_v_out_112022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112022", "112022004", "story_v_out_112022.awb")
				end
	...
	Play112022005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022005
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				slot17 = uv0:FormatText(uv0:GetWordFromCfg(112022005).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022005", "story_v_out_112022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112022", "112022005", "story_v_out_112022.awb") / 1000 + slot13 then
						uv0.duration_ = slot21 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						slot22 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112022", "112022005", "story_v_out_112022.awb")

						uv0:RecordAudio("112022005", slot22)
						uv0:RecordAudio("112022005", slot22)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112022", "112022005", "story_v_out_112022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112022", "112022005", "story_v_out_112022.awb")
				end
	...
	Play112022006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022006
		slot1.duration_ = 4.6
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				slot8 = uv0:FormatText(uv0:GetWordFromCfg(112022006).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022006", "story_v_out_112022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112022", "112022006", "story_v_out_112022.awb") / 1000 + slot4 then
						uv0.duration_ = slot12 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						slot13 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_112022", "112022006", "story_v_out_112022.awb")

						uv0:RecordAudio("112022006", slot13)
						uv0:RecordAudio("112022006", slot13)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112022", "112022006", "story_v_out_112022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112022", "112022006", "story_v_out_112022.awb")
				end
	...
	Play112022007 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022007
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				slot5 = uv0:FormatText(uv0:GetWordFromCfg(112022007).content)
	...
	Play112022008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022008
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				slot20 = uv0:FormatText(uv0:GetWordFromCfg(112022008).content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022008", "story_v_out_112022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112022", "112022008", "story_v_out_112022.awb") / 1000 + slot16 then
						uv0.duration_ = slot24 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						slot25 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_112022", "112022008", "story_v_out_112022.awb")

						uv0:RecordAudio("112022008", slot25)
						uv0:RecordAudio("112022008", slot25)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112022", "112022008", "story_v_out_112022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112022", "112022008", "story_v_out_112022.awb")
				end
	...
	Play112022009 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022009
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				slot16 = uv0:FormatText(uv0:GetWordFromCfg(112022009).content)
				uv0.text_.text = slot16
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022009", "story_v_out_112022.awb") ~= 0 then
					if uv0.duration_ < manager.audio:GetVoiceLength("story_v_out_112022", "112022009", "story_v_out_112022.awb") / 1000 + slot12 then
						uv0.duration_ = slot20 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						slot21 = LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_112022", "112022009", "story_v_out_112022.awb")

						uv0:RecordAudio("112022009", slot21)
						uv0:RecordAudio("112022009", slot21)
					else
						uv0:AudioAction("play", "voice", "story_v_out_112022", "112022009", "story_v_out_112022.awb")
					end

					uv0:RecordHistoryTalkVoice("story_v_out_112022", "112022009", "story_v_out_112022.awb")
				end
	...
	Play112022010 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022010
		slot1.duration_ = 5
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				slot11 = uv0:FormatText(uv0:GetWordFromCfg(112022010).content)
	...
	Play112022011 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.frameCnt_ = 0
		slot1.state_ = "playing"
		slot1.curTalkId_ = 112022011
		slot1.duration_ = 6.599999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.6 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if uv0.bgs_.H01a:GetComponent("SpriteRenderer") then
					...
					uv0.var_.alphaOldValueH01a = slot7:GetColor("_Color").a
					uv0.var_.alphaMatValueH01a = slot7
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				if uv0.var_.alphaMatValueH01a then
					slot9 = uv0.var_.alphaMatValueH01a
					slot10 = slot9:GetColor("_Color")
					slot10.a = Mathf.Lerp(uv0.var_.alphaOldValueH01a, 0, (uv0.time_ - slot5) / slot6)

					slot9:SetColor("_Color", slot10)
				end
			end

			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.alphaMatValueH01a then
				slot7 = uv0.var_.alphaMatValueH01a
				slot8 = slot7:GetColor("_Color")
				slot8.a = 0
			...
			if 1.599999999999 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
			...
			if 1.599999999999 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.talkMaxDuration = 0
				...
				slot15 = uv0:FormatText(uv0:GetWordFromCfg(112022011).content)
