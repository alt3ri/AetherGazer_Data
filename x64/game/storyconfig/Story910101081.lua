return {
	Play910108001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_24 = arg_1_1.actors_["1066"].transform
			local var_4_25 = 0.5

			if var_4_25 < arg_1_1.time_ and arg_1_1.time_ <= var_4_25 + arg_4_0 then
				arg_1_1.var_.moveOldPos1066 = var_4_24.localPosition
			...
			if var_4_25 <= arg_1_1.time_ and arg_1_1.time_ < var_4_25 + var_4_28 then
				...
				var_4_24.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1066, var_4_30, var_4_29)
			end
			...
			local var_4_31 = arg_1_1.actors_["1066"]
			local var_4_32 = 0.5
			...
			if var_4_32 < arg_1_1.time_ and arg_1_1.time_ <= var_4_32 + arg_4_0 then
				...
				if var_4_33 then
					arg_1_1.var_.alphaOldValue1066 = var_4_33.alpha
					arg_1_1.var_.characterEffect1066 = var_4_33
				end
			...
			if var_4_32 <= arg_1_1.time_ and arg_1_1.time_ < var_4_32 + var_4_34 then
				...
				local var_4_36 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1066, 1, var_4_35)

				if arg_1_1.var_.characterEffect1066 then
					arg_1_1.var_.characterEffect1066.alpha = var_4_36
				end
			end

			if arg_1_1.time_ >= var_4_32 + var_4_34 and arg_1_1.time_ < var_4_32 + var_4_34 + arg_4_0 and arg_1_1.var_.characterEffect1066 then
			...
			if var_4_37 < arg_1_1.time_ and arg_1_1.time_ <= var_4_37 + arg_4_0 then
				...
				local var_4_40 = arg_1_1:FormatText(StoryNameCfg[32].name)
				...
				local var_4_41 = arg_1_1:GetWordFromCfg(910108001)
	...
	Play910108002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(910108002)
	...
	Play910108003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_0 + arg_14_0 then
				...
				local var_14_3 = arg_11_1:GetWordFromCfg(910108003)
	...
	Play910108004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			local var_18_0 = arg_15_1.actors_["1066"].transform
			local var_18_1 = 0.0666666666666667

			if var_18_1 < arg_15_1.time_ and arg_15_1.time_ <= var_18_1 + arg_18_0 then
				arg_15_1.var_.moveOldPos1066 = var_18_0.localPosition
			...
			if var_18_1 <= arg_15_1.time_ and arg_15_1.time_ < var_18_1 + var_18_4 then
				...
				var_18_0.localPosition = Vector3.Lerp(arg_15_1.var_.moveOldPos1066, var_18_6, var_18_5)
			end
			...
			if var_18_7 < arg_15_1.time_ and arg_15_1.time_ <= var_18_7 + arg_18_0 then
				...
				local var_18_9 = arg_15_1:FormatText(StoryNameCfg[32].name)
				...
				local var_18_10 = arg_15_1:GetWordFromCfg(910108004)
	...
	Play910108005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			local var_22_0 = arg_19_1.actors_["1066"].transform
			local var_22_1 = 0

			if var_22_1 < arg_19_1.time_ and arg_19_1.time_ <= var_22_1 + arg_22_0 then
				arg_19_1.var_.moveOldPos1066 = var_22_0.localPosition
			...
			if var_22_1 <= arg_19_1.time_ and arg_19_1.time_ < var_22_1 + var_22_4 then
				...
				var_22_0.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos1066, var_22_6, var_22_5)
			end
			...
			if var_22_7 < arg_19_1.time_ and arg_19_1.time_ <= var_22_7 + arg_22_0 then
				...
				local var_22_9 = arg_19_1:FormatText(StoryNameCfg[32].name)
				...
				local var_22_10 = arg_19_1:GetWordFromCfg(910108005)
