...
slot1 = {
	...
	InitInviteData = function (slot0, slot1)
		...
		for slot5, slot6 in pairs(ActivityInviteCfg.get_id_list_by_activity_id[slot5]) do
	...
	UpdateReward = function (slot0, slot1)
		slot3 = nil
		slot8 = ActivityInviteCfg[slot1].hero_id

		for slot8, slot9 in pairs(slot0.heroPlotTable[slot8]) do
