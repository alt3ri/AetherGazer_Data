...
function slot0.InitCurLevelData(slot0, slot1, slot2)
	...
	slot7 = slot1
	slot0.curLevelData_.canUseGold = slot0.activityData_[ActivityTools.GetMainActivityId(slot7)].goldMax
	slot0.curLevelData_.waveDataList = {}
	slot6 = slot0.curLevelData_.curLevelID

	for slot6, slot7 in pairs(ActivityReforgeLevelCfg[slot6].wave_list) do
		slot8 = {
			waveID = slot7,
			teamID = 0,
			isPass = false
...
function slot0.SetCurLevelData(slot0, slot1)
	...
	slot5 = slot0.curLevelData_.curLevelID

	for slot5, slot6 in pairs(ActivityReforgeLevelCfg[slot5].wave_list) do
		slot7 = {
			waveID = slot6,
			teamID = 0,
			isPass = false
...
function slot0.FinishChapter(slot0, slot1)
	...
	slot7 = slot3.reward_money

	slot0:AddCacheAddGoldNum(slot7)
