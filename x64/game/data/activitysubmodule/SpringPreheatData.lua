...
function slot0.InitData(slot0, slot1)
	...
	for slot5, slot6 in ipairs(slot0.GetPoolItemList(slot6)) do
	...
	slot0:ModifyPraySelection(slot6)

	slot7 = slot0

	for slot6, slot7 in ipairs(slot0.GetProgressRewardList(slot7)) do
...
function slot0.HasRewardCanAcquire(slot0)
	...
	for slot4, slot5 in ipairs(slot0.GetProgressRewardList(slot5)) do
