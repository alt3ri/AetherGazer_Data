...
function slot0.GetStageAffix(slot0)
	...
	for slot11, slot12 in pairs(ReserveTools.GetReserveTemplateByReserveType(ReserveConst.RESERVE_TYPE.SOLO_CHALLENGE):GetContDataTemplateById(slot0.GetContID(slot11)):GetAffixList(slot0.GetTeamIndex(slot12))) do
		if slot12 ~= 0 then
