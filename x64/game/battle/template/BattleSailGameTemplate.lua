local var_0_0 = class("BattleSailGameTemplate", BattleBaseStageTemplate)
...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.cfg = BattleSailGameStageCfg[arg_1_1]
end
...
function var_0_0.GetDest(arg_5_0)
	local var_5_0 = SailGameData:GetCurGameData(arg_5_0.activityID_)
	local var_5_1 = var_5_0.curStageIndex

	return var_5_0.eventList[var_5_1].order
end
