slot0 = class("BattleDestroyBoxGameTemplate", BattleBaseStageTemplate)
...
function slot0.GetDest(slot0)
	return DestroyBoxGameData:GetSelectID(DestroyBoxGameCfg[DestroyBoxGameCfg.get_id_list_by_activity_id[slot0:GetActivityID()][1]].main_activity_id)
end
