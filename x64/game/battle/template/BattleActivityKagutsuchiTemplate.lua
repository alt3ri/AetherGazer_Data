slot0 = class("BattleActivityKagutsuchiTemplate", BattleBaseStageTemplate)
...
function slot0.Ctor(slot0, slot1, slot2)
	...
	slot0.cfg = BattleKagutsuchiStageCfg[slot1]
	slot0.day = KagutsuchiWorkData:GetDay()
	slot0.cost = KagutsuchiWorkData:GetPlayGridData(KagutsuchiWorkData:GetIndexByStageId(slot1)):GetCost()
end
...
function slot0.GetStageAffix(slot0)
	...
	for slot8, slot9 in pairs(KagutsuchiTalentData:GetUnlockTalentIdList()) do
		table.insert(slot1, TalentTreeCfg[slot9].affix_id)
		table.insert(slot2, KagutsuchiTalentData:GetTalentLevel(slot9))
...
function slot0.GetGridCost(slot0)
	return slot0.cost or 0
end
