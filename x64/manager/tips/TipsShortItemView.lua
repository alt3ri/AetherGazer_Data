...
function slot0.EndDisplay(slot0)
	LeanTween.scale(slot0.gameObject_, Vector3(1, 0.1, 1), 0.1):setDelay(1.5)

	slot1 = nil
	slot1 = LeanTween.scale(slot0.gameObject_, Vector3.zero, 0.1):setDelay(1.6):setOnComplete(System.Action(function ()
		uv0:FinishAction()
