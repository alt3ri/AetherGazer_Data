...
function slot0.Ctor(slot0)
	...
	slot0.frameTimer_ = FrameTimer.New(function ()
		for slot4, slot5 in pairs(uv0.connectionS_) do
			slot0 = false or slot5:GetIsNeedShowQuanQuan()
		end
...
function slot0.ChatConnect(slot0, slot1, slot2)
	return deferred.new(function (slot0)
		uv0.chatTcpConnection_:Connect(uv1, uv2, function (slot0)
...
function slot0.ChatReconnect(slot0)
	return deferred.new(function (slot0)
		uv0.chatTcpConnection_:Reconnect(function (slot0)
			uv0:resolve(slot0)
		end)
	end)
end
...
function slot0.ChatSendWithLoading(slot0, slot1, slot2, slot3)
	...
	return deferred.new(function (slot0)
		...
		uv0.chatTcpConnection_:SendSync(uv1, uv2, uv3, function (slot0)
			uv0:resolve(slot0)
		end, uv4, uv5, uv6)
...
function slot0.ChatSendSyncNoEnqueue(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	return deferred.new(function (slot0)
		uv0.chatTcpConnection_:SendSyncNoEnqueue(uv1, uv2, uv3, function (slot0)
			uv0:resolve(slot0)
...
function slot0.Send(slot0, slot1, slot2, slot3)
	...
	return deferred.new(function (slot0)
		uv0.tcpConnection_:SendSync(uv1, uv2, uv3, function (slot0)
			uv0:resolve(slot0)
		end, uv4, uv5, uv6)
	end)
end
...
function slot0.GetMainSendingPacketNum(slot0)
	return slot0.tcpConnection_:GetSendingPacketNum()
end
