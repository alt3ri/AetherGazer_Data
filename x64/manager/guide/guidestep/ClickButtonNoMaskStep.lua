...
function slot0.Play(slot0)
	...
	if slot0.disableBtnEvent then
		slot0.eventTriggerListener = slot1.gameObject:AddComponent(typeof(EventTriggerListener))

		slot0.eventTriggerListener:AddListenerType1(UnityEngine.EventSystems.EventTriggerType.PointerClick, LuaHelper.EventTriggerAction1(function (slot0, slot1)
			uv0:OnStepEnd()
		end))
...
function slot0.OnStepEnd(slot0)
	...
	if slot0.btnCallBack then
		slot0:Component().onClick:RemoveListener(slot0.btnCallBack)
